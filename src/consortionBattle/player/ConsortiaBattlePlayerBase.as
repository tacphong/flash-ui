package consortionBattle.player
{
   ...
   public class ConsortiaBattlePlayerBase extends SceneCharacterPlayerBase
   {
      ...
      private var _sceneCharacterLoaderBody:consortionBattle.player.ConsBatLoaderHeadOrBody;
      
      private var _sceneCharacterLoaderHead:consortionBattle.player.ConsBatLoaderHeadOrBody;
      
      private var _loadComplete:Boolean = false;
      
      public function ConsortiaBattlePlayerBase(param1:consortionBattle.player.ConsortiaBattlePlayerInfo, param2:Function = null)
      {
      ...
      {
         this._sceneCharacterLoaderHead = new consortionBattle.player.ConsBatLoaderHeadOrBody(this._playerData,1);
      ...
      private function sceneCharacterLoaderHeadCallBack(param1:consortionBattle.player.ConsBatLoaderHeadOrBody, param2:Boolean = true) : void
      {
      ...
      {
         this._sceneCharacterLoaderBody = new consortionBattle.player.ConsBatLoaderHeadOrBody(this._playerData,2);
         this._sceneCharacterLoaderBody.load(this.sceneCharacterLoaderBodyNaturalCallBack);
      }
      
      private function sceneCharacterLoaderBodyNaturalCallBack(param1:consortionBattle.player.ConsBatLoaderHeadOrBody, param2:Boolean = true) : void
      {
