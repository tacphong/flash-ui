package trainer.controller
{
   public class NewHandGuideManager
   {
      ...
      private static var _instance:trainer.controller.NewHandGuideManager;
      ...
      public static function get Instance() : trainer.controller.NewHandGuideManager
      {
         if(!_instance)
         {
            _instance = new trainer.controller.NewHandGuideManager(new NewHandGuideManagerEnforcer());
         }
         return _instance;
      }
