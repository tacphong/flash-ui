package trainer.controller
{
   ...
   public class NewHandQueue
   {
      ...
      private static var _instance:trainer.controller.NewHandQueue;
      ...
      public static function get Instance() : trainer.controller.NewHandQueue
      {
         if(!_instance)
         {
            _instance = new trainer.controller.NewHandQueue(new NewHandQueueEnforcer());
         }
         return _instance;
      }
