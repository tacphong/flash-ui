package trainer.controller
{
   ...
   public class LevelRewardManager
   {
      ...
      private static var _instance:trainer.controller.LevelRewardManager;
      ...
      public static function get Instance() : trainer.controller.LevelRewardManager
      {
         if(_instance == null)
         {
            _instance = new trainer.controller.LevelRewardManager();
         }
         return _instance;
      }
