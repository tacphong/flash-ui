package trainer.controller
{
   ...
   public class WeakGuildManager
   {
      ...
      private static var _instance:trainer.controller.WeakGuildManager;
      ...
      public static function get Instance() : trainer.controller.WeakGuildManager
      {
         if(_instance == null)
         {
            _instance = new trainer.controller.WeakGuildManager();
         }
         return _instance;
      }
      ...
      {
         return (PlayerManager.Instance.Self.Grade <= this.LV ? Boolean(true) : Boolean(false)) && PathManager.solveUserGuildEnable();
      }
