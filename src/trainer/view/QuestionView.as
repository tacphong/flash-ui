package trainer.view
{
   ...
   public class QuestionView extends Question
   {
      ...
      private var _item1:trainer.view.QuestionItemView;
      
      private var _item2:trainer.view.QuestionItemView;
      ...
      public function setData(param1:int, param2:Array, param3:int, param4:InventoryItemInfo = null) : void
      {
         ...
         else if(Boolean(this._cell.parent))
         {
      ...
      {
         var _loc2_:trainer.view.QuestionItemView = param1.currentTarget as QuestionItemView;
