package trainer.view
{
   ...
   public class ExplainPowerThree extends BaseExplainFrame
   {
      ...
      private function initView() : void
      {
         ...
         this._bmpNameBgThree.x = _loc2_.x;
         this._bmpNameBgThree.y = _loc2_.y;
         addChild(this._bmpNameBgThree);
         _loc1_ = ComponentFactory.Instance.creatCustomObject("trainer.explain.posPowerBg");
         this._bmpNameBgPower = ComponentFactory.Instance.creatBitmap("asset.explain.nameBgSmall");
         this._bmpNameBgPower.x = _loc1_.x;
         this._bmpNameBgPower.y = _loc1_.y;
