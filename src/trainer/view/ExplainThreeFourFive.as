package trainer.view
{
   ...
   public class ExplainThreeFourFive extends BaseExplainFrame
   {
      ...
      private function initView() : void
      {
         ...
         addChild(this._bmpFour);
         var _loc2_:Point = ComponentFactory.Instance.creatCustomObject("trainer.explain.posThreeUpBg");
         this._bmpNameBg1 = ComponentFactory.Instance.creatBitmap("asset.explain.nameBg1");
         this._bmpNameBg1.x = _loc2_.x;
         this._bmpNameBg1.y = _loc2_.y;
         addChild(this._bmpNameBg1);
         _loc1_ = ComponentFactory.Instance.creatCustomObject("trainer.explain.posFourBg");
         this._bmpNameBg2 = ComponentFactory.Instance.creatBitmap("asset.explain.nameBg1");
         this._bmpNameBg2.x = _loc1_.x;
         this._bmpNameBg2.y = _loc1_.y;
