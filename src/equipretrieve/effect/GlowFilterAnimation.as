package equipretrieve.effect
{
   ...
   public dynamic class GlowFilterAnimation extends EventDispatcher
   {
      ...
      public function start(param1:DisplayObject, param2:Boolean = false, param3:uint = 16711680, param4:Number = 1, param5:Number = 6, param6:Number = 6, param7:Number = 2, param8:int = 1, param9:Boolean = false, param10:Boolean = false) : void
      {
