   ...
   public class RetrieveBagcell extends BagCell
   {
      ...
      override public function dragDrop(param1:DragEffect) : void
      {
         ...
         if(param1.data is InventoryItemInfo)
         {
            ...
            {
               if(_bagType == 11 || _loc2_.BagType == 11 || _bagType == 51 || _loc2_.BagType == 51)
               {
                  if(param1.action == DragEffect.SPLIT)
                  {
                     param1.action = DragEffect.NONE;
                  }
                  else if(_bagType != 11 && _bagType != 51)
                  {
      ...
      {
         if(Boolean(info) && (info.CategoryID == 10 || info.CategoryID == 11 || info.CategoryID == 12 || info.CategoryID == 20))
         {
