package equipretrieve
{
   ...
   public class RetrieveController
   {
      ...
      private static var _instance:equipretrieve.RetrieveController;
       
      
      private var _viewMouseEvtBoolean:Boolean = true;
      
      private var _view:equipretrieve.RetrieveFrame;
      ...
      public static function get Instance() : equipretrieve.RetrieveController
      {
         if(_instance == null)
         {
            _instance = new equipretrieve.RetrieveController();
         }
         return _instance;
      }
      ...
      public function get view() : equipretrieve.RetrieveFrame
      {
         return this._view;
      }
