package equipretrieve
{
   ...
   public class RetrieveModel
   {
      ...
      private static var _instance:equipretrieve.RetrieveModel;
      ...
      public static function get Instance() : equipretrieve.RetrieveModel
      {
         if(_instance == null)
         {
            _instance = new equipretrieve.RetrieveModel();
         }
         return _instance;
      }
      ...
      {
         if(Boolean(this._CellsInfoArr[param1].info))
         {
