package bigBugleRank.views
{
   import bigBugleRank.BigBugleRankManager;
   import bigBugleRank.data.BigBugleRankVo;
   ...
   public class BigBugleRankView extends Sprite implements IRightView
   {
      ...
      public function BigBugleRankView()
      {
         super();
      }
      ...
      {
         BigBugleRankManager.instance.view = this;
         this.initView();
         this.updateView();
         this.initTimer();
      }
      ...
      {
         this._bg = ComponentFactory.Instance.creat("wonderfulactivity.bigBugleRank.bg");
         addChild(this._bg);
         ...
         this._rankLabelTxt.text = LanguageMgr.GetTranslation("bigBugleRank.rankLabel",5000);
      ...
      public function updateView() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:BigBugleRankVo = null;
         var _loc3_:GmActivityInfo = BigBugleRankManager.instance.xmlData;
         ...
         this._checkBg.tipData = LanguageMgr.GetTranslation("bigBugleRank.helpTxt",_loc3_.remain2);
         _loc6_ = BigBugleRankManager.instance.rankList;
         _loc1_ = BigBugleRankManager.instance.myConsume;
         this._myRank = -1;
         var _loc7_:int = 0;
         while(_loc7_ <= _loc6_.length - 1)
         {
            _loc2_ = _loc6_[_loc7_] as BigBugleRankVo;
         ...
         if(this._myRank >= 0)
         {
            ...
            else
            {
               ...
               _loc8_ = (_loc6_[this._myRank - 1] as BigBugleRankVo).consume - _loc1_ + 1;
               this._rankLabelTxt.text = LanguageMgr.GetTranslation("bigBugleRank.rankLabel",_loc8_);
            }
            if(BigBugleRankManager.instance.status == 2)
            {
               this._rankLabelTxt.visible = true;
         ...
         else
         {
            ...
            if(_loc6_.length > 0)
            {
               _loc8_ = (_loc6_[_loc6_.length - 1] as BigBugleRankVo).consume - _loc1_ + 1;
            }
            else
            {
               _loc8_ = 1;
            }
            this._outOfRankLabel.text = LanguageMgr.GetTranslation("bigBugle.outOfRank");
            this._rankLabelTxt.text = LanguageMgr.GetTranslation("bigBugleRank.outOfRankLabel",_loc1_,_loc8_);
            if(BigBugleRankManager.instance.status == 2)
            {
               this._rankLabelTxt.visible = true;
               this._rankLabelTxt.textColor = 16711680;
      ...
      {
         var _loc1_:BigBugleRankItem = null;
         var _loc2_:Array = BigBugleRankManager.instance.rankList;
         var _loc3_:Array = BigBugleRankManager.instance.xmlData.giftbagArray;
         this._vbox.removeAllChild();
         var _loc4_:int = 0;
         while(_loc4_ <= _loc2_.length - 1)
         {
            _loc1_ = new BigBugleRankItem(_loc4_);
      ...
      {
         var _loc1_:Date = DateUtils.getDateByStr(BigBugleRankManager.instance.xmlData.endTime);
      ...
      {
         BigBugleRankManager.instance.view = null;
         WonderfulActivityManager.Instance.delTimerFun("consumeRank");
