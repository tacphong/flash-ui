package bigBugleRank.views
{
   ...
   public class BigBugleRankItem extends Sprite implements Disposeable
   {
      ...
      private var vo:BigBugleRankVo;
      
      public function BigBugleRankItem(param1:int)
      {
         super();
         this.index = param1;
         this.initView();
      ...
      public function setData(param1:BigBugleRankVo, param2:GiftBagInfo) : void
      {
