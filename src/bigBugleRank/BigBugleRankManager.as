package bigBugleRank
{
   ...
   public class BigBugleRankManager
   {
      
      private static var _instance:bigBugleRank.BigBugleRankManager;
      ...
      public var view:BigBugleRankView;
      ...
      public function BigBugleRankManager()
      {
         super();
      }
      
      public static function get instance() : bigBugleRank.BigBugleRankManager
      {
         if(!_instance)
         {
            _instance = new bigBugleRank.BigBugleRankManager();
         }
         return _instance;
      }
      ...
      {
         SocketManager.Instance.addEventListener(BigBugleRankEvent.UPDATE,this.__updateInfo);
      }
      
      protected function __updateInfo(param1:BigBugleRankEvent) : void
      {
         var _loc2_:* = 0;
         var _loc3_:* = 0;
         var _loc4_:BigBugleRankVo = null;
         ...
         if(_loc6_)
         {
            ...
            {
               _loc8_[this.actId] = new LeftViewInfoVo(ActivityType.BIGBULE_RANK,"· " + this.xmlData.activityName,this.xmlData.icon);
