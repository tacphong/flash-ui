package changeColor.view
{
   ...
   public class ChangeColorFrame extends Frame
   {
      ...
      private var _changeColorLeftView:changeColor.view.ChangeColorLeftView;
      
      private var _changeColorRightView:changeColor.view.ChangeColorRightView;
      ...
      override protected function init() : void
      {
         ...
         super.init();
         this._changeColorLeftView = new changeColor.view.ChangeColorLeftView();
         addToContent(this._changeColorLeftView);
         this._changeColorRightView = new changeColor.view.ChangeColorRightView();
      ...
      {
         if(Boolean(param1.data.itemInfo) && param1.data.itemInfo.NeedSex != (this._changeColorController.changeColorModel.self.Sex == true ? 1 : 2))
         {
            SoundManager.instance.play("008");
