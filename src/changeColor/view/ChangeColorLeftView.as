package changeColor.view
{
   ...
   public class ChangeColorLeftView extends Sprite implements Disposeable
   {
      ...
      private var _cell:changeColor.view.ColorEditCell;
      ...
      {
         if(Boolean((param1.target as BagCell).info) && this._model.currentItem == null)
         {
      ...
      private function initView() : void
      {
         ...
         this._cell = new changeColor.view.ColorEditCell(_loc2_);
      ...
      {
         this._model.self.setPartStyle(this._model.currentItem.CategoryID,this._model.self.Sex ? int(1) : int(2),PlayerManager.Instance.Self.getPartStyle(this._model.currentItem.CategoryID),PlayerManager.Instance.Self.getPartColor(this._model.currentItem.CategoryID),true);
      ...
      private function checkColorChanged(param1:String, param2:String) : Boolean
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc3_ = !StringHelper.isNullOrEmpty(_loc5_[_loc8_]) && _loc5_[_loc8_] != "undefined";
            _loc4_ = !StringHelper.isNullOrEmpty(_loc6_[_loc8_]) && _loc6_[_loc8_] != "undefined";
            if((_loc3_ || _loc4_) && _loc5_[_loc8_] != _loc6_[_loc8_])
            {
               return true;
            }
            _loc8_++;
