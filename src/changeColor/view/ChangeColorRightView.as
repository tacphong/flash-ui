package changeColor.view
{
   ...
   public class ChangeColorRightView extends Sprite implements Disposeable
   {
      ...
      private var _bag:changeColor.view.ColorChangeBagListView;
      ...
      private function init() : void
      {
         ...
         this._bag = new changeColor.view.ColorChangeBagListView();
      ...
      private function sendChangeColor() : void
      {
         ...
         var _loc3_:int = BagInfo.PROPBAG;
         var _loc4_:int = this._model.place;
         var _loc5_:int = this._model.currentItem.BagType;
         var _loc6_:int = this._model.currentItem.Place;
         _loc1_ = this._model.currentItem.Color;
         _loc2_ = this._model.currentItem.Skin;
         var _loc7_:int = EquipType.COLORCARD;
         this._model.initColor = _loc1_;
         this._model.initSkinColor = _loc2_;
         SocketManager.Instance.out.sendChangeColor(_loc3_,_loc4_,_loc5_,_loc6_,_loc1_,_loc2_,_loc7_);
