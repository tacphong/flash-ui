package exitPrompt
{
   ...
   public class ExitPromptManager
   {
      ...
      private static var _instance:exitPrompt.ExitPromptManager;
       
      
      private var _exitPromptView:exitPrompt.ExitPromptFrame;
      ...
      public static function get Instance() : exitPrompt.ExitPromptManager
      {
         if(_instance == null)
         {
            _instance = new exitPrompt.ExitPromptManager();
         }
         return _instance;
      }
