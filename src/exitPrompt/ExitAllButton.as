package exitPrompt
{
   ...
   public class ExitAllButton extends Component
   {
      ...
      private var _dayMissionBt:exitPrompt.ExitButtonItem;
      
      private var _dayMissionSprite:exitPrompt.MissionSprite;
      
      private var _actMissionBt:exitPrompt.ExitButtonItem;
      
      private var _actMissionSprite:exitPrompt.MissionSprite;
      
      private var _emailBt:BaseButton;
      
      private var _viewArr:Array;
      
      private var _model:exitPrompt.ExitPromptModel;
      ...
      public function start() : void
      {
         ...
         this._model = new exitPrompt.ExitPromptModel();
         ...
         this._dayMissionSprite = new exitPrompt.MissionSprite(this._model.list0Arr);
         ...
         this._actMissionSprite = new exitPrompt.MissionSprite(this._model.list1Arr);
