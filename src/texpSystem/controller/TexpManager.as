package texpSystem.controller
{
   ...
   public class TexpManager extends EventDispatcher
   {
      ...
      private static var _instance:texpSystem.controller.TexpManager;
      ...
      public static function get Instance() : texpSystem.controller.TexpManager
      {
         if(!_instance)
         {
            _instance = new texpSystem.controller.TexpManager(new TexpManagerEnforcer());
         }
         return _instance;
      }
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:TexpExp = null;
         var _loc4_:int = 1;
         while(_loc4_ <= MAX_LV)
         {
            _loc3_ = this._texpExp[_loc4_];
            if(param1 < _loc3_.GP)
            {
               break;
            }
      ...
      {
         if(Boolean(param1.changedProperties["hpTexpExp"]))
         {
         ...
         if(Boolean(param1.changedProperties["attTexpExp"]))
         {
         ...
         if(Boolean(param1.changedProperties["defTexpExp"]))
         {
         ...
         if(Boolean(param1.changedProperties["spdTexpExp"]))
         {
         ...
         if(Boolean(param1.changedProperties["lukTexpExp"]))
         {
