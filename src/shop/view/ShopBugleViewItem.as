package shop.view
{
   ...
   public class ShopBugleViewItem extends Sprite implements ISelectable, Disposeable
   {
      ...
      private var _cell:shop.view.ShopItemCell;
      ...
      public function ShopBugleViewItem(param1:int = 0, param2:String = "", param3:int = 0, param4:shop.view.ShopItemCell = null)
      {
         super();
         buttonMode = true;
         this._type = param1;
      ...
      {
         this._bg.setFrame(param1 ? int(2) : int(1));
      }
