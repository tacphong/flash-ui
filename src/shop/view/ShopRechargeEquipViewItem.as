package shop.view
{
   ...
   public class ShopRechargeEquipViewItem extends ShopCartItem implements Disposeable
   {
      ...
      public function set itemInfo(param1:InventoryItemInfo) : void
      {
         ...
         {
            if(Boolean(this._shopItems[_loc2_].getItemPrice(1).IsMoneyType))
            {
      ...
      private function resetRadioBtn() : void
      {
         ...
         {
            if(Boolean(this._shopItems[_loc1_].getItemPrice(1).IsMixed) || Boolean(this._shopItems[_loc1_].getItemPrice(2).IsMixed))
            {
