package shop.view
{
   ...
   public class ShopCartItem extends Sprite implements Disposeable
   {
      ...
      protected var _cell:shop.view.ShopPlayerCell;
      ...
      protected function cartItemSelectVBoxInit() : void
      {
         ...
         while(_loc2_ < 4)
         {
            if(this._shopItemInfo.getItemPrice(_loc2_).IsValid)
            {
               _loc1_ = ComponentFactory.Instance.creatComponentByStylename("shop.CartItemSelectBtn");
               _loc1_.text = this._shopItemInfo.getItemPrice(_loc2_).toString() + "/" + this._shopItemInfo.getTimeToString(_loc2_);
