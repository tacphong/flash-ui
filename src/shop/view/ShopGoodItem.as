package shop.view
{
   ...
   public class ShopGoodItem extends Sprite implements ISelectable, Disposeable
   {
      ...
      private var _itemCell:shop.view.ShopItemCell;
      ...
      public function get itemCell() : shop.view.ShopItemCell
      {
      ...
      protected function creatItemCell() : shop.view.ShopItemCell
      {
      ...
      private function updateCount() : void
      {
         if(Boolean(this._shopItemInfo))
         {
            if(Boolean(this._shopItemInfo.Label) && (this._shopItemInfo.Label == LIMIT_LABEL || this._shopItemInfo.Label == FREE_LIMIT_LABEL))
            {
      ...
      private function __onResponse(param1:FrameEvent) : void
      {
         ...
         var _loc7_:int = 0;
         SoundManager.instance.play("008");
         var _loc8_:BaseAlerFrame = param1.target as BaseAlerFrame;
         _loc8_.removeEventListener(FrameEvent.RESPONSE,this.__onResponse);
         _loc8_.dispose();
         if(param1.responseCode == FrameEvent.ENTER_CLICK || param1.responseCode == FrameEvent.SUBMIT_CLICK)
         {
            ...
            SocketManager.Instance.out.sendBuyGoods(_loc2_,_loc3_,_loc4_,_loc6_,_loc5_);
         }
      }
      ...
      {
         if(Boolean(this._shopItemInfo) && this._shopItemInfo.isFree)
         {
            return;
         }
