package shop.view
{
   ...
   public class ShopLeftViewPropCollection
   {
      ...
      public var lastItem:shop.view.ShopPlayerCell;
      ...
      public var playerCells:Vector.<shop.view.ShopPlayerCell>;
      ...
      public var checkOutPanel:shop.view.ShopCheckOutView;
      ...
      {
         var _loc1_:shop.view.ShopPlayerCell = null;
         ...
         var _loc2_:int = 0;
         while(_loc2_ < PLAYER_MAX_EQUIP_CNT)
         {
            _loc1_ = CellFactory.instance.createShopPlayerItemCell() as ShopPlayerCell;
            PositionUtils.setPos(_loc1_,"shop.PlayerCellPos_" + String(_loc2_));
            this.playerCells.push(_loc1_);
            this.dressView.addChild(_loc1_);
            _loc2_++;
         }
