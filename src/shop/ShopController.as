package shop
{
   ...
   public class ShopController extends BaseStateView
   {
      ...
      private var _model:shop.ShopModel;
      ...
      public function buyItems(param1:Array, param2:Boolean, param3:String = "") : void
      {
         ...
         while(_loc11_ < param1.length)
         {
            ...
            _loc6_.push(_loc4_.currentBuyType);
            _loc7_.push(_loc4_.Color);
            _loc9_.push(_loc4_.place);
            if(_loc4_.CategoryID == EquipType.FACE)
            {
               _loc10_.push(_loc4_.skin);
            }
            else
            {
               _loc10_.push("");
            }
            _loc8_.push(param2 ? _loc4_.dressing : false);
            _loc11_++;
         }
      ...
      public function get model() : shop.ShopModel
      {
         return this._model;
      }
      ...
      public function presentItems(param1:Array, param2:String, param3:String) : void
      {
         ...
         while(_loc9_ < param1.length)
         {
            ...
            if(_loc4_.CategoryID == EquipType.FACE)
            {
               _loc8_.push(this._model.currentModel.Skin);
            }
            else
            {
               _loc8_.push("");
         ...
         SocketManager.Instance.out.sendPresentGoods(_loc5_,_loc6_,_loc7_,param2,param3,_loc8_);
      }
      ...
      {
         this._model = new shop.ShopModel();
