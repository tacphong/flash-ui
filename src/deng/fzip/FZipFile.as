package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         param1.writeShort(this._versionHost << 8 | 20);
         param1.writeShort(this._filenameEncoding == "utf-8" ? int(2048) : int(0));
         param1.writeShort(this.isCompressed ? int(COMPRESSION_DEFLATED) : int(COMPRESSION_NONE));
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         var _loc5_:uint = this._sizeExtra;
         while(_loc5_ > 4)
         {
      ...
      internal function parseContent(param1:IDataInput) : void
      {
         ...
         if(this._compressionMethod === COMPRESSION_DEFLATED && !this._encrypted)
         {
            ...
            else if(this._hasAdler32)
            {
               ...
               _loc2_ = uint(~this._deflateSpeedOption << 6 & 192);
      ...
      protected function uncompress() : void
      {
         ...
         if(this.isCompressed && this._content.length > 0)
         {
            ...
            else
            {
               ...
               {
                  _loc2_.avail_in = _loc2_.avail_out = 10;
