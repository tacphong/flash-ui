package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      public function serialize(param1:IDataOutput, param2:Boolean = false) : void
      {
         ...
         var _loc6_:uint = 0;
         var _loc7_:int = 0;
         var _loc8_:deng.fzip.FZipFile = null;
         if(param1 != null && this.filesList.length > 0)
         {
            _loc3_ = String(param1.endian);
      ...
      {
         return Boolean(this.filesList) ? uint(this.filesList.length) : uint(0);
      }
      ...
      {
         return this.addFileAt(Boolean(this.filesList) ? uint(this.filesList.length) : uint(0),param1,param2,param3);
      }
      
      public function addFileFromString(param1:String, param2:String, param3:String = "utf-8", param4:Boolean = true) : deng.fzip.FZipFile
      {
         return this.addFileFromStringAt(Boolean(this.filesList) ? uint(this.filesList.length) : uint(0),param1,param2,param3,param4);
      }
      ...
      public function addFileAt(param1:uint, param2:String, param3:ByteArray = null, param4:Boolean = true) : deng.fzip.FZipFile
      {
         ...
         var _loc5_:deng.fzip.FZipFile = new deng.fzip.FZipFile();
      ...
      public function addFileFromStringAt(param1:uint, param2:String, param3:String, param4:String = "utf-8", param5:Boolean = true) : deng.fzip.FZipFile
      {
         ...
         var _loc6_:deng.fzip.FZipFile = new deng.fzip.FZipFile();
