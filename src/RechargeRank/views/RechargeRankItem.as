package RechargeRank.views
{
   ...
   public class RechargeRankItem extends Sprite implements Disposeable
   {
      ...
      private function initView() : void
      {
         ...
         {
            case 0:
               this._bg = ComponentFactory.Instance.creat("wonderfulactivity.rechargeRank.itemBg0");
               break;
            case 1:
               this._bg = ComponentFactory.Instance.creat("wonderfulactivity.rechargeRank.itemBg1");
         }
         addChild(this._bg);
         this._topThreeIcon = ComponentFactory.Instance.creatComponentByStylename("wonderful.rechargeRank.topThree");
         addChild(this._topThreeIcon);
         this._topThreeIcon.visible = false;
         this._placeTxt = ComponentFactory.Instance.creatComponentByStylename("wonderful.rechargeRank.placeTxt");
         this._placeTxt.text = "4th";
         addChild(this._placeTxt);
         this._nameTxt = ComponentFactory.Instance.creatComponentByStylename("wonderful.rechargeRank.nameTxt");
         this._nameTxt.text = "小妹也带刀";
         addChild(this._nameTxt);
         this._prizeHBox = ComponentFactory.Instance.creatComponentByStylename("wonderful.rechargeRank.hbox");
