package tofflist.view
{
   ...
   public class TofflistView extends Sprite implements Disposeable
   {
      ...
      private var _leftView:tofflist.view.TofflistLeftView;
      
      private var _lightsMc:MovieClip;
      
      private var _rightView:tofflist.view.TofflistRightView;
      ...
      public function get rightView() : tofflist.view.TofflistRightView
      {
      ...
      private function init() : void
      {
         ...
         this._leftView = new tofflist.view.TofflistLeftView();
         addChild(this._leftView);
         this._rightView = new tofflist.view.TofflistRightView(this._contro);
