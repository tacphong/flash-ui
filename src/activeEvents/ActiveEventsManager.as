package activeEvents
{
   ...
   public class ActiveEventsManager
   {
      ...
      private static var _instance:activeEvents.ActiveEventsManager;
       
      
      private var _model:activeEvents.ActiveEventsModel;
      
      public function ActiveEventsManager()
      {
         super();
         this._model = new activeEvents.ActiveEventsModel();
      }
      
      public static function get Instance() : activeEvents.ActiveEventsManager
      {
         if(_instance == null)
         {
            _instance = new activeEvents.ActiveEventsManager();
         }
         return _instance;
      }
      ...
      public function get model() : activeEvents.ActiveEventsModel
      {
         return this._model;
      }
   }
