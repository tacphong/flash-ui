package activeEvents
{
   ...
   public class ActiveController extends EventDispatcher
   {
      ...
      private static var _instance:activeEvents.ActiveController;
      ...
      public static function get instance() : activeEvents.ActiveController
      {
         if(!_instance)
         {
            _instance = new activeEvents.ActiveController();
         }
         return _instance;
      }
