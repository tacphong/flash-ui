package activeEvents.view
{
   ...
   public class ActiveMainFrame extends Frame
   {
      ...
      private var _currentItem:activeEvents.view.ActiveMainItem;
      ...
      private function upData() : void
      {
         ...
         var _loc2_:activeEvents.view.ActiveMainItem = null;
         this._list.disposeAllChildren();
         var _loc3_:Array = this._control.actives;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            _loc1_ = _loc3_[_loc4_] as ActiveEventsInfo;
            if(_loc1_.Type < 10)
            {
               _loc2_ = new activeEvents.view.ActiveMainItem();
               _loc2_.info = _loc1_;
               _loc2_.addEventListener(ActiveConductEvent.ONLINK,this._onClickItemHandler);
      ...
      {
         var _loc2_:activeEvents.view.ActiveMainItem = param1.currentTarget as ActiveMainItem;
         this.displayerActiveContext(_loc2_);
      }
      
      private function displayerActiveContext(param1:activeEvents.view.ActiveMainItem) : void
      {
         if(!param1)
         {
            return;
      ...
      {
         var _loc1_:activeEvents.view.ActiveMainItem = null;
