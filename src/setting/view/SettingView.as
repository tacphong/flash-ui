package setting.view
{
   ...
   public class SettingView extends BaseAlerFrame
   {
      ...
      private function initView() : void
      {
         ...
         _loc1_ = null;
         var _loc2_:AlertInfo = new AlertInfo(LanguageMgr.GetTranslation("tank.game.ToolStripView.set"));
         ...
         var _loc3_:Point = ComponentFactory.Instance.creatCustomObject("setting.sliderBg1");
         _loc1_ = ComponentFactory.Instance.creatCustomObject("setting.sliderBg2");
         this._sliderBg1 = ComponentFactory.Instance.creatBitmap("asset.setting.sliderBg");
         this._sliderBg1.x = _loc3_.x;
         this._sliderBg1.y = _loc3_.y;
         addToContent(this._sliderBg1);
         this._sliderBg2 = ComponentFactory.Instance.creatBitmap("asset.setting.sliderBg");
         this._sliderBg2.x = _loc1_.x;
         this._sliderBg2.y = _loc1_.y;
