package setting.controll
{
   ...
   public class SettingController
   {
      ...
      private static var _instance:setting.controll.SettingController;
      ...
      public static function get Instance() : setting.controll.SettingController
      {
         if(!_instance)
         {
            _instance = new setting.controll.SettingController();
         }
         return _instance;
      }
      ...
      {
         if(Boolean(this._settingView) && Boolean(this._settingView.parent))
         {
            this.hide();
         }
         else
