package quest
{
   ...
   public class QuestRewardCell extends Sprite implements Disposeable
   {
      ...
      {
         this.bgStyle1.visible = param1 == TaskMainFrame.NORMAL ? Boolean(true) : Boolean(false);
      ...
      public function set opitional(param1:Boolean) : void
      {
         ...
         {
            this.bgStyle1.setFrame(param1 ? int(2) : int(1));
         }
         else
         {
            this.bgStyle2.setFrame(param1 ? int(2) : int(1));
         }
      }
      ...
      public function dispose() : void
      {
         ...
         this.nameTxt = null;
         if(Boolean(this.bgStyle1))
         {
            ObjectUtils.disposeObject(this.bgStyle1);
         }
         this.bgStyle1 = null;
         if(Boolean(this.bgStyle2))
         {
