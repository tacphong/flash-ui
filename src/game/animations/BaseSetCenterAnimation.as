package game.animations
{
   ...
   public class BaseSetCenterAnimation extends BaseAnimate
   {
      ...
      protected var _tween:game.animations.BaseStageTween;
      ...
      public function BaseSetCenterAnimation(param1:Number, param2:Number, param3:int = 0, param4:Boolean = false, param5:int = 0, param6:int = 4, param7:Object = null)
      {
         ...
         _loc9_ = StageTweenStrategys.getTweenClassNameByShortName(_loc8_.strategy);
         _finished = false;
         this._life = param3;
         _level = param5;
         if(Boolean(param7) && param7.priority != null)
         {
            _level = param7.priority;
         }
         if(Boolean(param7) && param7.duration != null)
         {
