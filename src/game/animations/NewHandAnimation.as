package game.animations
{
   ...
   public class NewHandAnimation extends BaseSetCenterAnimation
   {
      ...
      override public function prepare(param1:AnimationSet) : void
      {
         ...
         _target.x = _target.x < param1.minX ? Number(param1.minX) : (_target.x > 0 ? Number(0) : Number(_target.x));
         _target.y = _target.y < param1.minY ? Number(param1.minY) : (_target.y > 0 ? Number(0) : Number(_target.y));
      }
