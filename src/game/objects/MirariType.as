package game.objects
{
   public class MirariType
   {
      ...
      public static const LockAngl:int = 3;
      ...
      public static const ReversePlayer:int = 11;
      
      public static const ReduceStrength:int = 12;
      
      public static const Attack:int = 13;
      
      public static const Defense:int = 14;
       
      
      public function MirariType()
      {
         super();
      }
   }
