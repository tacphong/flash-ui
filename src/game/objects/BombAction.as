      ...
      public function execute(param1:SimpleBomb, param2:GameInfo) : void
      {
         ...
         switch(this._type)
         {
            ...
            case ActionType.KILL_PLAYER:
               ...
               if(Boolean(_loc5_))
               {
                  if(Math.abs(_loc5_.blood - this._param4) > 30000 && param1 && param1.owner && param1.owner is Player && Boolean(param1.owner.playerInfo))
                  {
            ...
            case ActionType.DANER:
               ...
               if(Boolean(_loc8_) && _loc8_.isLiving)
               {
            ...
            case ActionType.PET:
               ...
               if(Boolean(_loc18_) && RoomManager.Instance.current.type != RoomInfo.ACTIVITY_DUNGEON_ROOM)
               {
