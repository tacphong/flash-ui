package game.objects
{
   ...
   public class GamePet extends GameLiving
   {
      ...
      private var _master:game.objects.GamePlayer;
      
      private var _effectClassLink:String;
      
      public function GamePet(param1:Living, param2:game.objects.GamePlayer)
      {
         super(param1);
         this._master = param2;
      ...
      public function get master() : game.objects.GamePlayer
      {
         return this._master;
      }
