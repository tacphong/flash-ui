package game.view.smallMap
{
   ...
   public class SmallMapTitleBar extends Sprite implements Disposeable
   {
      ...
      private var _turnButton:game.view.smallMap.GameTurnButton;
      ...
      private function configUI() : void
      {
         ...
         if(!RoomManager.Instance.current.isDungeonType && _loc1_ != RoomInfo.FIGHT_LIB_ROOM && _loc1_ != RoomInfo.FRESHMAN_ROOM && _loc1_ != RoomInfo.CONSORTIA_BATTLE)
         {
      ...
      public function get turnButton() : game.view.smallMap.GameTurnButton
      {
