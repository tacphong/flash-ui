package game.view.tool
{
   ...
   public class ToolStripView extends Sprite implements Disposeable
   {
      ...
      private var _bloodStrip:game.view.tool.BloodStrip;
      
      private var _powerStrip:game.view.tool.PowerStrip;
      ...
      private var _danderBar:game.view.tool.DanderBar;
      ...
      private function initView() : void
      {
         ...
         addChild(this._bg);
         this._bloodStrip = new game.view.tool.BloodStrip();
         ...
         this._danderBar = new game.view.tool.DanderBar(GameManager.Instance.Current.selfGamePlayer,this);
         ...
         this._powerStrip = new game.view.tool.PowerStrip();
