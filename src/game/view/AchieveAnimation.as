package game.view
{
   ...
   public class AchieveAnimation extends Sprite implements Disposeable
   {
      ...
      private var _numShape:game.view.AchievNumShape;
      
      private var _center:Point;
      
      private var _holdTimeField:TextField;
      
      private var _shine:game.view.AchievShineShape;
      ...
      public function AchieveAnimation(param1:int, param2:int, param3:int, param4:int)
      {
         ...
         this._numShape = new game.view.AchievNumShape();
      ...
      public function set time(param1:String) : void
      {
         ...
         if(_loc2_.length == 4)
         {
            this._flashTime = _loc2_[0] > 0 ? Number(_loc2_[0]) : Number(0.6);
            this._holdTime = _loc2_[1] > 0 ? Number(_loc2_[1]) : Number(2);
            this._fadeOutTime = _loc2_[2] > 0 ? Number(_loc2_[2]) : Number(0.6);
            this._shineTime = _loc2_[3] > 0 ? Number(_loc2_[3]) : Number(0.6);
            return;
         }
      ...
      {
         this._num = param1 > 0 ? int(param1) : int(0);
         this.drawNum();
         if(this._state == Hold)
         {
            this._elapsed = 0;
