package game.view.playerThumbnail
{
   ...
   public class NPCThumbnail extends Sprite implements Disposeable
   {
      ...
      private var _blood:game.view.playerThumbnail.BloodItem;
      ...
      {
         this._headFigure = new game.view.playerThumbnail.HeadFigure(28,28,this._living);
         this._blood = new game.view.playerThumbnail.BloodItem(this._living.maxBlood);
