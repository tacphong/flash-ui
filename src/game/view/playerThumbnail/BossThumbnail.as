package game.view.playerThumbnail
{
   ...
   public class BossThumbnail extends Sprite implements Disposeable
   {
      ...
      private var _headFigure:game.view.playerThumbnail.HeadFigure;
      
      private var _blood:game.view.playerThumbnail.BossBloodItem;
      ...
      public function init() : void
      {
         ...
         addChild(this._bg);
         this._headFigure = new game.view.playerThumbnail.HeadFigure(62,62,this._living);
         ...
         {
            this._blood = new game.view.playerThumbnail.BossBloodItem(WorldBossManager.Instance.bossInfo.total_Blood);
         ...
         {
            this._blood = new game.view.playerThumbnail.BossBloodItem(this._living.maxBlood);
      ...
      private function __shineChange(param1:LivingEvent) : void
      {
         ...
         if(Boolean(_loc2_) && _loc2_.isAttacking)
         {
         }
      }
