   ...
   public class ItemContainer extends SimpleTileList
   {
      ...
      public function ItemContainer(param1:Number, param2:Number = 1, param3:Boolean = true, param4:Boolean = false, param5:Boolean = false, param6:String = "")
      {
         ...
         while(_loc8_ < param1)
         {
            ...
            _loc7_.addEventListener(ItemEvent.ITEM_CLICK,this.__itemClick);
            _loc7_.addEventListener(ItemEvent.ITEM_OVER,this.__itemOver);
            _loc7_.addEventListener(ItemEvent.ITEM_OUT,this.__itemOut);
            _loc7_.addEventListener(ItemEvent.ITEM_MOVE,this.__itemMove);
            addChild(_loc7_);
            this.list.push(_loc7_);
            _loc8_++;
         }
