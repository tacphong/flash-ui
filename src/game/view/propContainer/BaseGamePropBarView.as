package game.view.propContainer
{
   ...
   public class BaseGamePropBarView extends Sprite
   {
      ...
      protected var _itemContainer:game.view.propContainer.ItemContainer;
      ...
      public function BaseGamePropBarView(param1:LocalPlayer, param2:Number, param3:Number, param4:Boolean, param5:Boolean, param6:Boolean, param7:String = "")
      {
         super();
         this._self = param1;
         this._itemContainer = new game.view.propContainer.ItemContainer(param2,param3,param4,param5,param6,param7);
      ...
      public function get itemContainer() : game.view.propContainer.ItemContainer
      {
