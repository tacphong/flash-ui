package game.view
{
   ...
   public class DungeonHelpView extends Sprite implements Disposeable
   {
      ...
      private var _barrier:game.view.DungeonInfoView;
      ...
      public function DungeonHelpView(param1:GameTurnButton, param2:game.view.DungeonInfoView, param3:DisplayObjectContainer)
      {
         super();
         this._isFirst = true;
         buttonMode = false;
      ...
      private function setText() : void
      {
         ...
         _loc2_ = null;
         if(GameManager.Instance.Current.missionInfo != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._container.parent))
         {
