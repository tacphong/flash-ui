package game.view
{
   ...
   public class WindPowerManager
   {
      ...
      private static var _instance:game.view.WindPowerManager;
      ...
      public static function get Instance() : game.view.WindPowerManager
      {
         if(_instance == null)
         {
            _instance = new game.view.WindPowerManager();
         }
         return _instance;
      }
