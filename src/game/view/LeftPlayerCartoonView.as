   ...
   public class LeftPlayerCartoonView extends Sprite implements Disposeable
   {
      ...
      protected function update() : void
      {
         if(Boolean(this._info))
         {
            ...
            {
               if(Boolean(this._info.playerInfo))
               {
                  ...
                  if(Boolean(this._info.playerInfo.showDesignation))
                  {
               ...
               else if(Boolean(this._badge.parent))
               {
      ...
      private function setBodyBitmap(param1:DisplayObject, param2:Boolean = false) : void
      {
         ...
         {
            if(Boolean(this._body) && Boolean(this._body.parent))
            {
