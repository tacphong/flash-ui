package game.view
{
   ...
   public class FightAchievBar extends Sprite implements Disposeable
   {
      ...
      private var _animates:Vector.<game.view.AchieveAnimation>;
      
      private var _displays:Vector.<game.view.AchieveAnimation>;
      ...
      public function addAnimate(param1:game.view.AchieveAnimation) : void
      {
      ...
      private function playAnimate(param1:game.view.AchieveAnimation) : void
      {
         var _loc2_:game.view.AchieveAnimation = null;
         param1.play();
         addChild(param1);
      ...
      {
         var _loc2_:game.view.AchieveAnimation = param1.currentTarget as AchieveAnimation;
      ...
      private function __onFrame(param1:Event) : void
      {
         ...
         for each(_loc2_ in this._animates)
         {
            ...
            {
               this.playAnimate(_loc2_);
            }
         }
      }
      
      public function removeAnimate(param1:game.view.AchieveAnimation) : void
      {
      ...
      public function rePlayAnimate(param1:game.view.AchieveAnimation) : void
      {
      }
      
      public function getAnimate(param1:int) : game.view.AchieveAnimation
      {
         var _loc2_:game.view.AchieveAnimation = null;
         for each(_loc2_ in this._animates)
         {
      ...
      {
         var _loc1_:int = int(this._displays.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            if(_loc2_ == 0)
