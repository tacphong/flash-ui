package game.view.experience
{
   ...
   public class ExpTweenManager
   {
      ...
      private static var _instance:game.view.experience.ExpTweenManager;
      ...
      public static function get Instance() : game.view.experience.ExpTweenManager
      {
         if(!_instance)
         {
            _instance = new game.view.experience.ExpTweenManager();
         }
         return _instance;
      }
