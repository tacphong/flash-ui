package game.view.experience
{
   ...
   public class ExpTotalItem extends Sprite implements Disposeable
   {
      ...
      private var _expNumTxt:game.view.experience.ExpTotalNums;
      
      private var _exploitNumTxt:game.view.experience.ExpTotalNums;
      ...
      {
         this._exploitNumTxt = new game.view.experience.ExpTotalNums(ExpTotalNums.EXPLOIT);
      ...
      {
         this._expNumTxt = new game.view.experience.ExpTotalNums(ExpTotalNums.EXPERIENCE);
