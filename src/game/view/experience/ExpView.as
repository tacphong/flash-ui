package game.view.experience
{
   ...
   public class ExpView extends Sprite implements Disposeable
   {
      ...
      private var _leftView:game.view.experience.ExpLeftView;
      
      private var _rightView:Sprite;
      
      private var _shape:Shape;
      
      private var _resultSeal:game.view.experience.ExpResultSeal;
      
      private var _titleBitmap:Bitmap;
      
      private var _fightView:game.view.experience.ExpFightExpItem;
      
      private var _attatchView:game.view.experience.ExpAttatchExpItem;
      
      private var _exploitView:game.view.experience.ExpExploitItem;
      
      private var _totalView:game.view.experience.ExpTotalItem;
      ...
      public function show() : void
      {
         ...
         switch(_loc3_ && _loc3_.gameOverType)
         {
      ...
      {
         this._leftView = new game.view.experience.ExpLeftView();
      ...
      private function resultSealView() : void
      {
         ...
         this._resultSeal = new game.view.experience.ExpResultSeal(_loc1_,this._luckyExp,this._luckyOffer);
      ...
      private function fightView() : void
      {
         ...
         this._fightView = new game.view.experience.ExpFightExpItem(this._fightNums);
         ...
         this._totalView = new game.view.experience.ExpTotalItem();
      ...
      {
         this._attatchView = new game.view.experience.ExpAttatchExpItem(this._attatchNums);
      ...
      private function exploitView() : void
      {
         ...
         this._exploitView = new game.view.experience.ExpExploitItem(this._exploitNums);
      ...
      private function __updateTotalExp(param1:Event) : void
      {
         ...
         if(Boolean(this._expObj) && this._expObj.hasOwnProperty("luckyExp"))
         {
         ...
         {
            _loc2_ = int(GameManager.Instance.Current.selfGamePlayer.expObj.gainGP);
      ...
      private function __updateTotalExploit(param1:Event) : void
      {
         ...
         if(Boolean(this._expObj) && this._expObj.hasOwnProperty("luckyOffer"))
         {
      ...
      private function setDefyInfo() : void
      {
         ...
         for each(_loc1_ in this._gameInfo.livings)
         {
            ...
            {
               _loc4_.unshift(_loc2_.playerInfo.NickName);
            }
         }
         _loc5_[0] = _loc3_;
         _loc5_[1] = _loc4_;
         RoomManager.Instance.setRoomDefyInfo(_loc5_);
      }
