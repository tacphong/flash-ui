package game.view.effects
{
   ...
   public class MirariEffectIconManager
   {
      ...
      private static var _instance:game.view.effects.MirariEffectIconManager;
      ...
      public static function getInstance() : game.view.effects.MirariEffectIconManager
      {
         if(_instance == null)
         {
            _instance = new game.view.effects.MirariEffectIconManager(new SingletonEnforce());
         }
         return _instance;
      }
...
class SingletonEnforce
{
   ...
   public function SingletonEnforce()
   {
      super();
   }
}
