package game.view.control
{
   ...
   public class LiveState extends ControlState
   {
      ...
      override protected function configUI() : void
      {
         ...
         var _loc3_:Point = ComponentFactory.Instance.creatCustomObject("asset.game.ArrowViewPos");
         this._arrow.x = _loc3_.x;
         this._arrow.y = _loc3_.y;
         addChild(this._arrow);
         this._energy = new EnergyView(_self);
         _loc1_ = ComponentFactory.Instance.creatCustomObject("asset.game.energyPos");
         this._energy.x = _loc1_.x;
         this._energy.y = _loc1_.y;
         ...
         _loc2_ = ComponentFactory.Instance.creatCustomObject("asset.game.toolPos");
         this._tool.x = _loc2_.x;
         this._tool.y = _loc2_.y;
         addChild(this._tool);
      ...
      override public function leaving(param1:Function = null) : void
      {
         ...
         if(Boolean(this._weaponPropBar))
         {
            this._weaponPropBar.leaving();
         }
         if(Boolean(this._energy))
         {
