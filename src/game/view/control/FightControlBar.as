package game.view.control
{
   ...
   public class FightControlBar implements Disposeable
   {
      ...
      private var _current:game.view.control.ControlState;
      
      private var _next:game.view.control.ControlState;
      ...
      private static function getFightControlState(param1:int, param2:LocalPlayer) : game.view.control.ControlState
      {
         switch(param1)
         {
            case LIVE:
      ...
      public function setState(param1:int) : game.view.control.ControlState
      {
         var _loc2_:game.view.control.ControlState = null;
      ...
      private function enterNext(param1:game.view.control.ControlState) : void
      {
