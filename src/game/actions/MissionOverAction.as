package game.actions
{
   ...
   public class MissionOverAction extends BaseAction
   {
      ...
      {
         var _loc9_:PackageIn = null;
         var _loc2_:Object = null;
         var _loc3_:BaseSettleInfo = null;
         ...
         var _loc8_:uint = 0;
         _loc9_ = param1.pkg;
         var _loc10_:GameInfo = GameManager.Instance.Current;
         _loc10_.missionInfo.missionOverPlayer = [];
         _loc10_.missionInfo.tackCardType = _loc9_.readInt();
         _loc10_.hasNextMission = _loc9_.readBoolean();
         if(_loc10_.hasNextMission)
         {
            _loc10_.missionInfo.pic = _loc9_.readUTF();
         }
         _loc10_.missionInfo.canEnterFinall = _loc9_.readBoolean();
         var _loc11_:int = _loc9_.readInt();
         var _loc12_:int = 0;
         while(_loc12_ < _loc11_)
         {
            _loc2_ = new Object();
            _loc3_ = new BaseSettleInfo();
            _loc3_.playerid = _loc9_.readInt();
            _loc3_.level = _loc9_.readInt();
            _loc3_.treatment = _loc9_.readInt();
            _loc4_ = _loc10_.findGamerbyPlayerId(_loc3_.playerid);
            _loc2_.gainGP = _loc9_.readInt();
            _loc4_.isWin = _loc9_.readBoolean();
            _loc5_ = _loc9_.readInt();
            _loc6_ = _loc9_.readInt();
            _loc4_.GetCardCount = _loc5_;
            _loc4_.BossCardCount = _loc5_;
            _loc4_.hasLevelAgain = _loc9_.readBoolean();
            _loc4_.hasGardGet = _loc9_.readBoolean();
            if(_loc4_.isWin)
            {
               if(_loc5_ == 0)
               {
                  _loc2_.gameOverType = ExpView.GAME_OVER_TYPE_0;
               }
               else if(_loc5_ == 1 && !_loc10_.hasNextMission)
               {
                  _loc2_.gameOverType = ExpView.GAME_OVER_TYPE_6;
               }
               else if(_loc5_ == 1 && _loc10_.hasNextMission)
               {
                  _loc2_.gameOverType = ExpView.GAME_OVER_TYPE_2;
               }
               else if(_loc5_ == 2 && _loc10_.hasNextMission)
               {
                  _loc2_.gameOverType = ExpView.GAME_OVER_TYPE_3;
               }
               else if(_loc5_ == 2 && !_loc10_.hasNextMission)
               {
                  _loc2_.gameOverType = ExpView.GAME_OVER_TYPE_4;
               }
               else
               {
                  _loc2_.gameOverType = ExpView.GAME_OVER_TYPE_0;
            ...
            {
               _loc2_.gameOverType = ExpView.GAME_OVER_TYPE_5;
            ...
            _loc4_.expObj = _loc2_;
            if(_loc4_.playerInfo.ID == _loc10_.selfGamePlayer.playerInfo.ID)
            {
               _loc10_.selfGamePlayer.BossCardCount = _loc4_.BossCardCount;
            }
            _loc10_.missionInfo.missionOverPlayer.push(_loc3_);
            _loc12_++;
         }
         if(_loc10_.selfGamePlayer.BossCardCount > 0)
         {
            _loc7_ = _loc9_.readInt();
            _loc10_.missionInfo.missionOverNPCMovies = [];
            _loc8_ = 0;
            while(_loc8_ < _loc7_)
            {
               _loc10_.missionInfo.missionOverNPCMovies.push(_loc9_.readUTF());
               _loc8_++;
            }
         }
         _loc10_.missionInfo.nextMissionIndex = _loc10_.missionInfo.missionIndex + 1;
      }
