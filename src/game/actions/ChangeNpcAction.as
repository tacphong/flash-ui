package game.actions
{
   ...
   public class ChangeNpcAction extends BaseAction
   {
      ...
      private function syncMap() : void
      {
         ...
         if(Boolean(this._pkg))
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               _loc11_ = uint(this._pkg.readInt());
      ...
      {
         var _loc1_:SmallEnemy = null;
         var _loc2_:Living = null;
         var _loc3_:int = -1;
         var _loc4_:int = GameManager.Instance.Current.selfGamePlayer.pos.x;
      ...
      private function focusOnSmallEnemy() : void
      {
         ...
         if(Boolean(_loc1_))
         {
            if(Boolean(_loc1_.LivingID) && Boolean(this._map.getPhysical(_loc1_.LivingID)))
            {
