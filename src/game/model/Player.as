package game.model
{
   ...
   public class Player extends TurnedLiving
   {
      ...
      protected var _petLiving:game.model.PetLiving;
      
      public var hasLevelAgain:Boolean = false;
      
      public var hasGardGet:Boolean = false;
      
      private var _pet:game.model.Pet;
      
      private var _snapPet:game.model.Pet;
      ...
      public function set dander(param1:int) : void
      {
         ...
         {
            this._dander = param1 > TOTAL_DANDER ? int(TOTAL_DANDER) : int(param1);
         }
      ...
      {
         if(Boolean(param1.changedProperties["WeaponID"]))
         {
            this.setWeaponInfo();
         }
         else if(Boolean(param1.changedProperties["DeputyWeaponID"]))
         {
            this.setDeputyWeaponInfo();
         }
         if(Boolean(param1.changedProperties["Grade"]) && StateManager.currentStateType != StateType.MISSION_ROOM)
         {
      ...
      public function get petLiving() : game.model.PetLiving
      {
         return this._petLiving;
      }
      
      public function set petLiving(param1:game.model.PetLiving) : void
      {
         this._petLiving = param1;
      }
      
      public function get currentPet() : game.model.Pet
      {
         return this._pet;
      }
      
      public function set currentPet(param1:game.model.Pet) : void
      {
         this._pet = param1;
      }
      
      public function get currentSnapPet() : game.model.Pet
      {
         return this._snapPet;
      }
      
      public function set currentSnapPet(param1:game.model.Pet) : void
      {
