package game.model
{
   ...
   public class PetLiving extends Living
   {
      ...
      private var _master:game.model.Player;
      ...
      public function PetLiving(param1:PetInfo, param2:game.model.Player, param3:int, param4:int, param5:int)
      {
      ...
      public function get master() : game.model.Player
      {
         return this._master;
      }
