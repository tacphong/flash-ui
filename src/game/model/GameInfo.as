package game.model
{
   ...
   public class GameInfo extends EventDispatcher
   {
      ...
      private var _selfGamePlayer:game.model.LocalPlayer;
      ...
      public var currentLiving:game.model.Living;
      ...
      {
         var _loc1_:game.model.Living = null;
      ...
      public function addGamePlayer(param1:game.model.Living) : void
      {
         var _loc2_:game.model.Living = this.livings[param1.LivingID];
         if(Boolean(_loc2_))
         {
            _loc2_.dispose();
         }
      ...
      public function addGameViewer(param1:game.model.Living) : void
      {
         var _loc2_:game.model.Living = this.viewers[param1.playerInfo.ID];
         if(Boolean(_loc2_))
         {
            _loc2_.dispose();
         }
      ...
      {
         var _loc2_:game.model.Living = this.viewers[param1];
         if(Boolean(_loc2_))
         {
      ...
      {
         var _loc3_:game.model.Living = this.findLivingByPlayerID(param1,param2);
         if(Boolean(_loc3_))
         {
      ...
      public function addTeamPlayer(param1:game.model.Living) : void
      {
      ...
      public function removeTeamPlayer(param1:game.model.Living) : void
      {
         var _loc2_:DictionaryData = this.teams[param1.team];
         if(Boolean(_loc2_) && Boolean(_loc2_[param1.LivingID]))
         {
            _loc2_.remove(param1.LivingID);
         }
      }
      
      public function setSelfGamePlayer(param1:game.model.Living) : void
      {
         this._selfGamePlayer = param1 as LocalPlayer;
      }
      
      public function removeGamePlayer(param1:int) : game.model.Living
      {
         var _loc2_:game.model.Living = this.livings[param1];
         if(Boolean(_loc2_))
         {
      ...
      {
         var _loc3_:game.model.Living = null;
         var _loc4_:game.model.Living = null;
         for each(_loc3_ in this.livings)
         {
            if(_loc3_ is Player && Boolean(_loc3_.playerInfo))
            {
      ...
      {
         var _loc2_:game.model.Living = null;
      ...
      public function get allias() : Vector.<Player>
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.roomPlayers.length)
         {
            _loc1_ = this.roomPlayers[_loc4_] as RoomPlayer;
            if(Boolean(_loc1_))
            {
               _loc2_ = this.findPlayerByPlayerID(_loc1_.playerInfo.ID);
               if(_loc2_ && _loc2_.team == this.selfGamePlayer.team && _loc2_ != this.selfGamePlayer && Boolean(_loc2_.expObj))
               {
                  _loc3_.push(_loc2_);
               }
            }
      ...
      public function findLiving(param1:int) : game.model.Living
      {
      ...
      public function get selfGamePlayer() : game.model.LocalPlayer
      {
