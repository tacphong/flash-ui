package game.model
{
   ...
   public class Living extends EventDispatcher implements ICommandedAble
   {
      ...
      {
         this._blood = param1 > this.maxBlood ? int(this.maxBlood) : int(param1);
      }
      ...
      private function __beatenBy(param1:LivingEvent) : void
      {
         ...
         var _loc3_:int = int(param1.paras[2]);
         var _loc4_:int = param1.value;
         var _loc5_:int = int(param1.paras[3]);
         if(this.isLiving)
         {
            this.isHidden = false;
      ...
      {
         if(Boolean(this.commandList[param1]))
         {
      ...
      public function setProperty(param1:String, param2:String) : void
      {
         ...
         var _loc5_:StringObject = new StringObject(_loc4_);
         if(false ? Boolean(0) : Boolean(0))
         {
         }
         try
         {
            if(_loc5_.isBoolean)
            {
               this[_loc3_] = _loc5_.getBoolean();
               return;
            }
            if(_loc5_.isInt)
            {
               this[_loc3_] = _loc5_.getInt();
               return;
            }
            this[_loc3_] = _loc5_;
         }
      ...
      {
         return this._psychic >= 0 ? int(this._psychic) : int(0);
      }
      ...
      public function set energy(param1:Number) : void
      {
         ...
         {
            this._energy = param1 >= 0 ? Number(param1) : Number(0);
      ...
      {
         var _loc2_:int = int(this._petBuffs.length);
         ...
         if(param1.buffPic == "-1" && Boolean(this._noPicPetBuff[param1.id]))
         {
