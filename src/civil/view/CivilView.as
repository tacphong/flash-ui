package civil.view
{
   ...
   public class CivilView extends Sprite implements Disposeable
   {
      ...
      private var _civilLeftView:civil.view.CivilLeftView;
      
      private var _civilRightView:civil.view.CivilRightView;
      ...
      {
         this._civilLeftView = new civil.view.CivilLeftView(this._controller,this._model);
         this._civilRightView = new civil.view.CivilRightView(this._controller,this._model);
