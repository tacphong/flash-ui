package civil.view
{
   ...
   public class CivilPlayerItemFrame extends Sprite implements Disposeable
   {
      ...
      private function upView() : void
      {
         ...
         {
            this._stateIcon.setFrame(Boolean(this._info.info.playerState.StateID) ? int(1) : int(3));
         }
         else
         {
            this._stateIcon.setFrame(Boolean(this._info.info.playerState.StateID) ? int(2) : int(3));
         }
      }
