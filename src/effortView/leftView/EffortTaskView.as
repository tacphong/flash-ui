package effortView.leftView
{
   ...
   public class EffortTaskView extends Sprite implements Disposeable
   {
      ...
      private function initQuestInfo() : void
      {
         ...
         var _loc3_:QuestItemReward = new QuestItemReward(11408,2,"","true");
         _loc2_ = new InventoryItemInfo();
         _loc2_.ValidDate = _loc3_.ValidateTime;
         _loc2_.TemplateID = 11408;
         _loc2_.IsJudge = true;
         _loc2_.IsBinds = _loc3_.isBind;
         _loc2_.AttackCompose = _loc3_.AttackCompose;
         _loc2_.DefendCompose = _loc3_.DefendCompose;
         _loc2_.AgilityCompose = _loc3_.AgilityCompose;
         _loc2_.LuckCompose = _loc3_.LuckCompose;
         _loc2_.StrengthenLevel = _loc3_.StrengthenLevel;
         _loc2_.Count = _loc3_.count;
         if(_loc3_.IsCount && this._questInfo.data && Boolean(this._questInfo.data.quality))
         {
            _loc2_.Count = _loc3_.count * this._questInfo.data.quality;
         }
         ItemManager.fill(_loc2_);
         if(Boolean(_loc2_) && _loc2_.TemplateID != 0)
         {
      ...
      private function updateText() : void
      {
         ...
         _loc1_ = _loc1_ > this._questInfo._conditions[0].param2 ? int(_loc1_) : int(this._questInfo._conditions[0].param2);
