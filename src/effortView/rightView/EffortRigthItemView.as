package effortView.rightView
{
   ...
   public class EffortRigthItemView extends Sprite implements Disposeable, IListCell
   {
      ...
      protected var _scaleStrip:effortView.rightView.EffortScaleStrip;
      ...
      protected var _effortIcon:effortView.rightView.EffortIconView;
      
      protected var _maxHeight:int;
      
      protected var _minHeight:int;
      
      protected var _achievementPointView:effortView.rightView.AchievementPointView;
      ...
      {
         var _loc1_:EffortCompleteIconView = null;
         var _loc2_:Point = null;
         _loc1_ = null;
         this._bg_01 = ComponentFactory.Instance.creat("effortView.EffortRigthItemView.rightItemBg_01");
         addChild(this._bg_01);
         this._effortIcon = new effortView.rightView.EffortIconView();
         this._effortIcon.x = EFFORT_ICON_POS;
         this._effortIcon.y = EFFORT_ICON_POS;
         addChild(this._effortIcon);
         this._achievementPointView = new effortView.rightView.AchievementPointView();
         _loc2_ = ComponentFactory.Instance.creatCustomObject("effortView.EffortRigthItemView.achievementPointViewPos");
         this._achievementPointView.x = _loc2_.x;
         this._achievementPointView.y = _loc2_.y;
         ...
         this._scaleStrip = new effortView.rightView.EffortScaleStrip(0);
         ...
         while(_loc3_ < 5)
         {
            _loc1_ = new EffortCompleteIconView();
            _loc1_.visible = false;
            this._iconArray.push(_loc1_);
            this._iconContent.addChild(_loc1_);
            _loc3_++;
         }
      }
      ...
      {
         var _loc1_:EffortQualificationInfo = null;
         ...
         var _loc2_:int = 0;
         for each(_loc1_ in this._info.EffortQualificationList)
         {
            _loc2_ = _loc1_.Condiction_Para2;
         }
         this._scaleStrip.setInfo(_loc2_);
      ...
      private function __onTextClicked(param1:TextEvent) : void
      {
         ...
         var _loc5_:Object = {};
         var _loc6_:Array = param1.text.split("|");
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            if(Boolean(_loc6_[_loc7_].indexOf(":")))
            {
               _loc3_ = _loc6_[_loc7_].split(":");
               _loc5_[_loc3_[0]] = _loc3_[1];
            }
            _loc7_++;
         }
         if(int(_loc5_.clicktype) == ChatFormats.CLICK_GOODS)
         {
            _loc2_ = this._honor.localToGlobal(new Point(this._honor.mouseX,this._honor.mouseY));
            _loc4_ = ItemManager.Instance.getTemplateById(_loc5_.templeteIDorItemID);
            _loc4_.BindType = _loc5_.isBind == "true" ? int(0) : int(1);
            this._showLinkGoodsInfo(_loc4_,_loc2_);
         }
      }
      ...
      protected function honorName() : void
      {
         ...
         else
         {
            this._honor.text = "";
            this._honorII.text = "";
            this._honor.visible = this._honor.visible = true;
         }
      }
