package effortView.rightView
{
   ...
   public class EffortFullView extends Sprite implements Disposeable
   {
      ...
      private var _fullScaleStrip:effortView.rightView.EffortScaleStrip;
      
      private var _integrationScaleStrip:effortView.rightView.EffortScaleStrip;
      
      private var _taskScaleStrip:effortView.rightView.EffortScaleStrip;
      
      private var _roleScaleStrip:effortView.rightView.EffortScaleStrip;
      
      private var _duplicateScaleStrip:effortView.rightView.EffortScaleStrip;
      
      private var _combatScaleStrip:effortView.rightView.EffortScaleStrip;
      
      private var _honorScaleStrip:effortView.rightView.EffortScaleStrip;
      ...
      private function init() : void
      {
         ...
         this._fullScaleStrip = new effortView.rightView.EffortScaleStrip(this.fullArray.length,EffortCategoryTitleItem.FULL,FULL_SIZE[0],FULL_SIZE[1]);
         ...
         this._roleScaleStrip = new effortView.rightView.EffortScaleStrip(this.roleArray.length,EffortCategoryTitleItem.PART,COMMON_SIZE[0],COMMON_SIZE[1]);
         ...
         this._taskScaleStrip = new effortView.rightView.EffortScaleStrip(this.taskArray.length,EffortCategoryTitleItem.TASK,COMMON_SIZE[0],COMMON_SIZE[1]);
         ...
         this._duplicateScaleStrip = new effortView.rightView.EffortScaleStrip(this.duplicateArray.length,EffortCategoryTitleItem.DUNGEON,COMMON_SIZE[0],COMMON_SIZE[1]);
         ...
         this._combatScaleStrip = new effortView.rightView.EffortScaleStrip(this.combatArray.length,EffortCategoryTitleItem.FIGHT,COMMON_SIZE[0],COMMON_SIZE[1]);
         ...
         this._integrationScaleStrip = new effortView.rightView.EffortScaleStrip(this.integrationArray.length,EffortCategoryTitleItem.INTEGRATION,COMMON_SIZE[0],COMMON_SIZE[1]);
         ...
         this._honorScaleStrip = new effortView.rightView.EffortScaleStrip(this.integrationArray.length,EffortCategoryTitleItem.HONOR,COMMON_SIZE[0],COMMON_SIZE[1]);
      ...
      private function updateScheduleArray() : void
      {
         ...
         var _loc2_:DictionaryData = EffortManager.Instance.fullList;
         this.fullArray = [];
         ...
         {
            this.fullArray.push(_loc1_);
            switch(_loc1_.PlaceID)
            {
               case 0:
                  this.integrationArray.push(_loc1_);
                  break;
               case 1:
                  this.roleArray.push(_loc1_);
                  break;
               case 2:
                  this.taskArray.push(_loc1_);
                  break;
               case 3:
                  this.duplicateArray.push(_loc1_);
                  break;
               case 4:
                  this.combatArray.push(_loc1_);
                  break;
            }
         }
      }
      ...
      private function getCurrentSchedule(param1:Array) : int
      {
         ...
         if(EffortManager.Instance.isSelf)
         {
            ...
            {
               if(Boolean((param1[_loc2_] as EffortInfo).CompleteStateInfo))
               {
                  _loc4_++;
               }
               _loc2_++;
      ...
      private function updateItem() : void
      {
         ...
         var _loc1_:EffortFullItemView = null;
         this.cleanList();
         this._recentlyList = ComponentFactory.Instance.creatComponentByStylename("effortView.EffortFullView.ItemList");
         _loc2_ = ComponentFactory.Instance.creatCustomObject("effortView.EffortFullView.ItemListPos");
         this._recentlyList.x = _loc2_.x;
         this._recentlyList.y = _loc2_.y;
         ...
         var _loc3_:int = 0;
         while(_loc3_ < this._recentlyInfoArray.length)
         {
            if(_loc3_ > 3)
            {
               break;
            }
            _loc1_ = new EffortFullItemView(this._recentlyInfoArray[_loc3_]);
            this._recentlyList.addChild(_loc1_);
            _loc3_++;
         }
      }
      ...
      private function cleanList() : void
      {
         ...
         if(Boolean(this._recentlyList) && Boolean(this._recentlyList.parent))
         {
