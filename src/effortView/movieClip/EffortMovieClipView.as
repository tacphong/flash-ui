package effortView.movieClip
{
   ...
   public class EffortMovieClipView extends Sprite implements Disposeable
   {
      ...
      protected function init() : void
      {
         ...
         _loc2_ = ComponentFactory.Instance.creatCustomObject("effortView.EffortMovieClipView.AchievementPointView");
         ...
         this._movieClipView.x = _loc1_.x;
         this._movieClipView.y = _loc1_.y;
