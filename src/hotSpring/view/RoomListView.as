package hotSpring.view
{
   ...
   public class RoomListView extends Sprite implements Disposeable
   {
      ...
      private var _roomListItem:hotSpring.view.RoomListItemView;
      ...
      public function setRoomList(param1:HotSpringRoomListEvent = null) : void
      {
         ...
         var _loc3_:hotSpring.view.RoomListItemView = null;
         _loc4_ = null;
         this.removeRoomList();
         ...
         var _loc5_:Array = this._model.roomList.list.slice(this._pageIndex * this._pageSize - this._pageSize,this._pageIndex * this._pageSize <= this._model.roomList.length ? this._pageIndex * this._pageSize : this._model.roomList.length);
         var _loc6_:int = 0;
         for each(_loc2_ in _loc5_)
         {
            _loc3_ = new hotSpring.view.RoomListItemView(this._model,_loc2_);
            _loc4_ = ComponentFactory.Instance.creatComponentByStylename("asset.HotSpringMainView.roomListItemBtn");
            _loc4_.backgound = _loc3_;
            _loc4_.mouseChildren = true;
            _loc3_.addEventListener(MouseEvent.CLICK,this.rootListItemClick);
