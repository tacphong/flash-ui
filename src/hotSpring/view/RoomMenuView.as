package hotSpring.view
{
   ...
   public class RoomMenuView extends Sprite implements Disposeable
   {
      ...
      public function RoomMenuView(param1:HotSpringRoomController, param2:HotSpringRoomModel, param3:Function)
      {
         super();
         this._controller = param1;
         this._model = param2;
         this._continu = param3;
         this.initialize();
      }
