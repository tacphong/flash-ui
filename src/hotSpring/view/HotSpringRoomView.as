package hotSpring.view
{
   ...
   public class HotSpringRoomView extends Sprite
   {
      ...
      private var _roomMenuView:hotSpring.view.RoomMenuView;
      ...
      protected function initialize() : void
      {
         ...
         if(Boolean(this._hotSpringViewAsset))
         {
         ...
         this._roomMenuView = new hotSpring.view.RoomMenuView(this._controller,this._model,this.addTimeFrame);
      ...
      {
         var _loc2_:int = 0;
         if(Boolean(this._playerListCellLoadCount) && this._playerListCellLoadCount.length > 0)
         {
            _loc2_ = Boolean(this._playerListCellLoadCount[param1.playerInfo.ID]) ? int(int(this._playerListCellLoadCount[param1.playerInfo.ID])) : int(0);
            if(_loc2_ >= 3)
            {
               this._controller.roomPlayerRemoveSend(LanguageMgr.GetTranslation("tank.hotSpring.room.load.error"));
               return;
      ...
      private function addPlayerCallBack(param1:HotSpringPlayer, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(!param2)
         {
            ...
            this._playerList.remove(_loc4_.playerInfo.ID);
            this._playerListFailure.add(_loc4_.playerInfo.ID,_loc4_);
            if(Boolean(param1))
            {
               param1.dispose();
            }
      ...
      private function addSceneDay() : void
      {
         ...
         if(Boolean(this._playerLayer.house.dayHouse) && !this._playerLayer.house.contains(this._playerLayer.house.dayHouse))
         {
            this._playerLayer.house.addChild(this._playerLayer.house.dayHouse);
         }
         if(Boolean(this._playerLayer.tree.dayTree) && !this._playerLayer.tree.contains(this._playerLayer.tree.dayTree))
         {
            this._playerLayer.tree.addChild(this._playerLayer.tree.dayTree);
         }
         if(Boolean(this._playerLayer.stove.dayStove) && !this._playerLayer.stove.contains(this._playerLayer.stove.dayStove))
         {
      ...
      {
         if(Boolean(this._sceneFront) && Boolean(this._sceneFront.parent))
         {
            this._sceneFront.parent.removeChild(this._sceneFront);
         }
         this._sceneFront = null;
         if(Boolean(this._sceneFront2) && Boolean(this._sceneFront2.parent))
         {
            this._sceneFront2.parent.removeChild(this._sceneFront2);
         }
         this._sceneFront2 = null;
         if(Boolean(this._sceneBack) && Boolean(this._sceneBack.parent))
         {
            this._sceneBack.parent.removeChild(this._sceneBack);
         }
         this._sceneBack = null;
         if(Boolean(this._playerLayer.house.dayHouse) && Boolean(this._playerLayer.house.dayHouse.parent))
         {
            this._playerLayer.house.dayHouse.parent.removeChild(this._playerLayer.house.dayHouse);
         }
         if(Boolean(this._playerLayer.tree.dayTree) && Boolean(this._playerLayer.tree.dayTree.parent))
         {
            this._playerLayer.tree.dayTree.parent.removeChild(this._playerLayer.tree.dayTree);
         }
         if(Boolean(this._playerLayer.stove.dayStove) && Boolean(this._playerLayer.stove.dayStove.parent))
         {
      ...
      private function addSceneNight() : void
      {
         ...
         if(Boolean(this._playerLayer.house.nightHouse) && !this._playerLayer.house.contains(this._playerLayer.house.nightHouse))
         {
            this._playerLayer.house.addChild(this._playerLayer.house.nightHouse);
         }
         if(Boolean(this._playerLayer.tree.nightTree) && !this._playerLayer.tree.contains(this._playerLayer.tree.nightTree))
         {
            this._playerLayer.tree.addChild(this._playerLayer.tree.nightTree);
         }
         if(Boolean(this._playerLayer.stove.nightStove) && !this._playerLayer.stove.contains(this._playerLayer.stove.nightStove))
         {
      ...
      {
         if(Boolean(this._sceneFrontNight) && Boolean(this._sceneFrontNight.parent))
         {
            this._sceneFrontNight.parent.removeChild(this._sceneFrontNight);
         }
         this._sceneFrontNight = null;
         if(Boolean(this._sceneFrontNight2) && Boolean(this._sceneFrontNight2.parent))
         {
            this._sceneFrontNight2.parent.removeChild(this._sceneFrontNight2);
         }
         this._sceneFrontNight2 = null;
         if(Boolean(this._sceneBackNight) && Boolean(this._sceneBackNight.parent))
         {
            this._sceneBackNight.parent.removeChild(this._sceneBackNight);
         }
         this._sceneBackNight = null;
         if(Boolean(this._playerLayer.house.nightHouse) && Boolean(this._playerLayer.house.nightHouse.parent))
         {
            this._playerLayer.house.nightHouse.parent.removeChild(this._playerLayer.house.nightHouse);
         }
         if(Boolean(this._playerLayer.tree.nightTree) && Boolean(this._playerLayer.tree.nightTree.parent))
         {
            this._playerLayer.tree.nightTree.parent.removeChild(this._playerLayer.tree.nightTree);
         }
         if(Boolean(this._playerLayer.stove.nightStove) && Boolean(this._playerLayer.stove.nightStove.parent))
         {
      ...
      private function dayAndNight() : void
      {
         ...
         if(this._sysDateTime >= this._dayStart && this._sysDateTime <= this._dayEnd)
         {
            ...
            _loc1_ = (this._sysDateTime.getHours() - 5) * 60 - 30 + this._sysDateTime.minutes;
            _loc2_ = Number((_loc1_ / _loc3_ * 100).toFixed(2));
            if(Boolean(this._sceneFront2.daySun) && Boolean(this._sceneFront2.daySun.parent))
            {
               this._sceneFront2.daySun.parent.removeChild(this._sceneFront2.daySun);
            }
            this._sceneFront2.daySun = null;
            if(Boolean(this._sceneFront2.dayFlower) && Boolean(this._sceneFront2.dayFlower.parent))
            {
               this._sceneFront2.dayFlower.parent.removeChild(this._sceneFront2.dayFlower);
            }
            this._sceneFront2.dayFlower = null;
            this._sceneFront.alpha = this._sceneFront2.alpha = this._sceneBack.alpha = this._playerLayer.house.dayHouse.alpha = this._playerLayer.tree.dayTree.alpha = this._playerLayer.stove.dayStove.alpha = _loc2_ / 100;
            this._sceneFrontNight2.nightFirefly.alpha = 1 - _loc2_ / 100;
            if(_loc2_ / 100 >= 1)
            {
               this.removeSceneNight();
            }
         ...
         else if(this._sysDateTime >= this._nightStart && this._sysDateTime <= this._nightEnd)
         {
            ...
            _loc1_ = (this._sysDateTime.getHours() - 17) * 60 - 30 + this._sysDateTime.minutes;
            _loc2_ = Number((_loc1_ / _loc3_ * 100).toFixed(2));
            if(Boolean(this._sceneFront2.daySun) && Boolean(this._sceneFront2.daySun.parent))
            {
               this._sceneFront2.daySun.parent.removeChild(this._sceneFront2.daySun);
            ...
            this._sceneFront2.daySun = null;
            if(Boolean(this._sceneFrontNight2.nightFirefly) && Boolean(this._sceneFrontNight2.nightFirefly.parent))
            {
            ...
            this._sceneFrontNight.alpha = this._sceneFrontNight2.alpha = this._sceneBackNight.alpha = this._playerLayer.house.nightHouse.alpha = this._playerLayer.tree.nightTree.alpha = this._playerLayer.stove.nightStove.alpha = _loc2_ / 100;
            this._sceneFront2.dayFlower.alpha = 1 - _loc2_ / 100;
            if(_loc2_ / 100 >= 1)
            {
               this.removeSceneDay();
            }
      ...
      private function roomToolMenu(param1:MouseEvent) : void
      {
         ...
         switch(param1.currentTarget)
         {
            case this._ShowNameBtn:
               ...
               this._ShowNameBtn.setFrame(this._isShowName ? int(1) : int(2));
               break;
            case this._ShowPaoBtn:
               this._isChatBall = !this._isChatBall;
               this._ShowPaoBtn.setFrame(this._isChatBall ? int(1) : int(2));
               break;
            case this._ShowPlayerBtn:
               this._isShowPalyer = !this._isShowPalyer;
               this._ShowPlayerBtn.setFrame(this._isShowPalyer ? int(1) : int(2));
         }
      ...
      {
         var _loc1_:HotSpringPlayer = null;
         var _loc2_:int = 0;
         while(_loc2_ < this._playerLayer.numChildren)
         {
            _loc1_ = this._playerLayer.getChildAt(_loc2_) as HotSpringPlayer;
            if(Boolean(_loc1_))
            {
               _loc1_.isShowName = this._isShowName;
               _loc1_.isChatBall = this._isChatBall;
               _loc1_.isShowPlayer = this._isShowPalyer;
               if(_loc1_.playerVO.playerInfo.ID != PlayerManager.Instance.Self.ID)
               {
                  _loc1_.character.visible = this._isShowPalyer;
               }
               _loc1_.visible = _loc1_.playerVO.playerInfo.ID != PlayerManager.Instance.Self.ID ? Boolean(this._isShowPalyer) : Boolean(true);
            }
            _loc2_++;
         }
      }
      ...
      private function BuildEntityDepth() : void
      {
         ...
         var _loc8_:int = this._playerLayer.numChildren;
         var _loc9_:int = 0;
         while(_loc9_ < _loc8_ - 1)
         {
            _loc1_ = this._playerLayer.getChildAt(_loc9_);
            _loc2_ = this.getPointDepth(_loc1_.x,_loc1_.y);
            _loc4_ = Number.MAX_VALUE;
            _loc5_ = _loc9_ + 1;
            while(_loc5_ < _loc8_)
            {
               _loc6_ = this._playerLayer.getChildAt(_loc5_);
            ...
            if(_loc2_ > _loc4_)
            {
               this._playerLayer.swapChildrenAt(_loc9_,_loc3_);
            }
            _loc9_++;
         }
      }
      ...
      private function removePlayer(param1:HotSpringRoomEvent) : void
      {
         ...
         var _loc4_:HotSpringPlayer = this._hotSpringPlayerList[_loc3_] as HotSpringPlayer;
         this._hotSpringPlayerList.remove(_loc3_);
         if(Boolean(this._playerList))
         {
            this._playerList.remove(_loc3_);
         }
         if(Boolean(this._playerListFailure))
         {
            this._playerListFailure.remove(_loc3_);
         }
         if(Boolean(this._playerListCellLoadCount))
         {
            this._playerListCellLoadCount.remove(_loc3_);
         }
         if(!_loc4_)
         {
            _loc2_ = 0;
            while(_loc2_ < this._playerLayer.numChildren)
            {
               _loc4_ = this._playerLayer.getChildAt(_loc2_) as HotSpringPlayer;
               if(Boolean(_loc4_) && _loc4_.playerVO.playerInfo.ID == _loc3_)
               {
                  _loc4_.removeEventListener(SceneCharacterEvent.CHARACTER_ACTION_CHANGE,this.playerActionChange);
      ...
      public function expUpPlayer(param1:int) : void
      {
         ...
         this._expUpBox.y = this._selfPlayer.playerVO.currentlyArea == 1 ? Number(-this._selfPlayer.playerHeight - 30) : Number(-this._selfPlayer.playerHeight + 33);
      ...
      {
         if(Boolean(this._expUpBox) && Boolean(this._expUpBox.parent))
         {
      ...
      {
         SoundManager.instance.play("008");
         var _loc1_:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("tank.hotSpring.continu"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),false,false,false,LayerManager.BLCAK_BLOCKGOUND);
         _loc1_.moveEnable = false;
         _loc1_.addEventListener(FrameEvent.RESPONSE,this.__alertResponse);
      }
      ...
      private function addTime() : void
      {
         ...
         {
            _loc1_ = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("tank.room.RoomIIView2.notenoughmoney.content"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),false,false,false,LayerManager.BLCAK_BLOCKGOUND);
            _loc1_.moveEnable = false;
      ...
      public function dispose() : void
      {
         ...
         {
            if(Boolean(this._roomMenuView.parent))
            {
         ...
         this._sceneBackNight = null;
         if(Boolean(this._hotSpringViewAsset.maskPath) && Boolean(this._hotSpringViewAsset.maskPath.parent))
         {
            this._hotSpringViewAsset.maskPath.parent.removeChild(this._hotSpringViewAsset.maskPath);
         }
         if(Boolean(this._hotSpringViewAsset.layerWater) && Boolean(this._hotSpringViewAsset.layerWater.parent))
         {
            this._hotSpringViewAsset.layerWater.parent.removeChild(this._hotSpringViewAsset.layerWater);
         }
         if(Boolean(this._sceneBackBox) && Boolean(this._sceneBackBox.parent))
         {
         ...
         while(Boolean(this._model.roomPlayerList) && this._model.roomPlayerList.list.length > 0)
         {
         ...
         if(Boolean(this._model.roomPlayerList))
         {
            this._model.roomPlayerList.clear();
         }
         while(Boolean(this._playerList) && this._playerList.length > 0)
         {
         ...
         if(Boolean(this._hotSpringPlayerList))
         {
         ...
         if(Boolean(this._playerLayer) && Boolean(this._playerLayer.parent))
         {
         ...
         while(Boolean(this._playerWalkPath) && this._playerWalkPath.length > 0)
         {
         ...
         if(Boolean(this._hotSpringViewAsset) && Boolean(this._hotSpringViewAsset.parent))
         {
