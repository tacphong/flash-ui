package hotSpring.model
{
   ...
   public class HotSpringRoomModel extends EventDispatcher
   {
      ...
      private static var _instance:hotSpring.model.HotSpringRoomModel;
      ...
      public static function get Instance() : hotSpring.model.HotSpringRoomModel
      {
         if(_instance == null)
         {
            _instance = new hotSpring.model.HotSpringRoomModel();
         }
         return _instance;
      }
      ...
      public function roomPlayerAddOrUpdate(param1:PlayerVO) : void
      {
         ...
         if(Boolean(this._roomPlayerList[param1.playerInfo.ID]))
         {
      ...
      {
         if(Boolean(this._roomPlayerList))
         {
