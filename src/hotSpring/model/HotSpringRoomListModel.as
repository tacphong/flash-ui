package hotSpring.model
{
   ...
   public class HotSpringRoomListModel extends EventDispatcher
   {
      ...
      private static var _instance:hotSpring.model.HotSpringRoomListModel;
      ...
      public static function get Instance() : hotSpring.model.HotSpringRoomListModel
      {
         if(_instance == null)
         {
            _instance = new hotSpring.model.HotSpringRoomListModel();
         }
         return _instance;
      }
      ...
      {
         if(Boolean(HotSpringManager.instance.roomCurrently) && HotSpringManager.instance.roomCurrently.roomID == param1.roomID)
         {
