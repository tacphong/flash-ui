package pet.sprite
{
   ...
   public class PetSprite extends Sprite
   {
      ...
      private var _petController:pet.sprite.PetSpriteController;
      ...
      public function PetSprite(param1:pet.sprite.PetSpriteModel, param2:pet.sprite.PetSpriteController)
      {
         super();
      ...
      private function updateSize() : void
      {
         ...
         {
            this._msgBg.y = this._petHeight > 100 ? Number(this._petMovie.y - this._petHeight + 40) : Number(this._petMovie.y - this._petHeight - 10);
         }
