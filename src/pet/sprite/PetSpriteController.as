package pet.sprite
{
   ...
   public class PetSpriteController extends EventDispatcher
   {
      ...
      private static var _instance:pet.sprite.PetSpriteController;
      
      private static const ACTION:Array = ["walkA","walkB","standA","bsetC"];
       
      
      private var _petSprite:pet.sprite.PetSprite;
      
      private var _petModel:pet.sprite.PetSpriteModel;
      ...
      public function PetSpriteController(param1:SingletonEnforcer)
      {
         ...
         super();
         this._petModel = new pet.sprite.PetSpriteModel();
      }
      
      public static function get Instance() : pet.sprite.PetSpriteController
      {
         if(!_instance)
         {
            _instance = new pet.sprite.PetSpriteController(new SingletonEnforcer());
         }
         return _instance;
      }
      ...
      {
         var _loc1_:FieldVO = null;
         var _loc2_:Boolean = false;
         var _loc3_:Vector.<FieldVO> = FarmModelController.instance.model.selfFieldsInfo;
         for each(_loc1_ in _loc3_)
         {
            if(_loc1_.plantGrownPhase == 2)
            {
               _loc2_ = true;
               break;
            }
      ...
      public function get model() : pet.sprite.PetSpriteModel
      {
      ...
      public function get petSprite() : pet.sprite.PetSprite
      {
         return this._petSprite;
      }
      
      public function set petSprite(param1:pet.sprite.PetSprite) : void
      {
...
class PetMessage
{
   ...
   public function PetMessage(param1:int, param2:String, param3:String, param4:Boolean)
   {
      super();
      this.type = param1;
      this.action = param2;
