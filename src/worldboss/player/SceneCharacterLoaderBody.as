package worldboss.player
{
   ...
   public class SceneCharacterLoaderBody
   {
      ...
      private var _loaders:Vector.<worldboss.player.WorldBossSceneCharacterLayer>;
      ...
      private function initLoaders() : void
      {
         ...
         this._loaders.push(new worldboss.player.WorldBossSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],1,this._playerInfo.Sex));
         this._loaders.push(new worldboss.player.WorldBossSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],2,this._playerInfo.Sex));
      }
