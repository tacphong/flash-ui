package worldboss.player
{
   ...
   public class WorldRoomPlayer extends WorldRoomPlayerBase
   {
      ...
      private var _playerVO:worldboss.player.PlayerVO;
      ...
      public function WorldRoomPlayer(param1:worldboss.player.PlayerVO, param2:Function = null)
      {
      ...
      public function get playerVO() : worldboss.player.PlayerVO
      {
         return this._playerVO;
      }
      
      public function set playerVO(param1:worldboss.player.PlayerVO) : void
      {
         this._playerVO = param1;
      }
