package worldboss.player
{
   ...
   public class WorldRoomPlayerBase extends SceneCharacterPlayerBase
   {
      ...
      private var _sceneCharacterLoaderBody:worldboss.player.SceneCharacterLoaderBody;
      
      private var _sceneCharacterLoaderHead:SceneCharacterLoaderHead;
      
      public function WorldRoomPlayerBase(param1:PlayerInfo, param2:Function = null)
      {
      ...
      {
         this._sceneCharacterLoaderBody = new worldboss.player.SceneCharacterLoaderBody(this._playerInfo);
         this._sceneCharacterLoaderBody.load(this.sceneCharacterLoaderBodyNaturalCallBack);
      }
      
      private function sceneCharacterLoaderBodyNaturalCallBack(param1:worldboss.player.SceneCharacterLoaderBody, param2:Boolean) : void
      {
