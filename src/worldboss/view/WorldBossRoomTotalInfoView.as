   ...
   public class WorldBossRoomTotalInfoView extends Sprite implements Disposeable
   {
      ...
      private function creatTxtInfo() : void
      {
         ...
         while(_loc2_ < 20)
         {
            ...
            _loc1_.y += int(_loc2_ % 10) * 24;
            addChild(_loc1_);
            this._txtArr.push(_loc1_);
            _loc2_++;
         }
      ...
      private function __showTotalInfo(param1:MouseEvent) : void
      {
         ...
         this._show_totalInfoBtnIMG.setFrame(this._open_show ? int(int(2)) : int(int(1)));
      ...
      public function updataRanking(param1:Array) : void
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            this._txtArr[_loc3_].text = _loc3_ + 1 + "." + _loc2_.name;
            this._txtArr[_loc3_ + 10].text = _loc2_.damage;
            _loc3_++;
         }
      }
