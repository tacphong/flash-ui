package worldboss.view
{
   ...
   public class BuffItem extends Component
   {
      ...
      private function __buffIconComplete(param1:LoaderEvent) : void
      {
         ...
         tipDirctions = "5,1";
         var _loc3_:WorldBossBuffInfo = WorldBossManager.Instance.bossInfo.getbuffInfoByID(this._buffId);
         tipData = _loc3_.name + ":" + LanguageMgr.GetTranslation("worldboss.buff.limit") + "\n" + _loc3_.decription;
      }
   }
}
