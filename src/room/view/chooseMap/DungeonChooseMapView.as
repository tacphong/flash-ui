package room.view.chooseMap
{
   ...
   public class DungeonChooseMapView extends Sprite implements Disposeable
   {
      ...
      public static const DUNGEON_NO:int = 14;
      ...
      private var _currentSelectedItem:room.view.chooseMap.DungeonMapItem;
      ...
      {
         var _loc1_:room.view.chooseMap.DungeonMapItem = null;
         ...
         {
            _loc1_ = new room.view.chooseMap.DungeonMapItem();
            this._dungeonList.addChild(_loc1_);
            _loc1_.addEventListener(Event.SELECT,this.__onItemSelect);
            this._maps.push(_loc1_);
            _loc2_++;
         }
         ...
         _loc3_.graphics.drawRect(this._explainTxt.x,this._explainTxt.y,this._explainTxt.width,this._explainTxt.height);
      ...
      public function isBossBtnCanClick() : Boolean
      {
         if(PlayerManager.Instance.Self.VIPLevel >= 2 && PlayerManager.Instance.Self.IsVIP)
         {
            return true;
         }
         return false;
      ...
      {
         this._bossBtn.visible = param1;
         this._bossBtnStrip.visible = param1;
      }
      ...
      private function initInfo() : void
      {
         ...
         var _loc2_:int = RoomManager.Instance.current.mapId;
         if(_loc2_ > 0 && _loc2_ != DEFAULT_MAP)
         {
            for each(_loc1_ in this._maps)
            {
               if(_loc1_.mapId == _loc2_)
               {
                  this._currentSelectedItem = _loc1_;
      ...
      private function updateCommonItem() : void
      {
         ...
         this.reset();
         var _loc3_:int = 1;
         while(_loc3_ < DUNGEON_NO)
         {
            _loc2_ = MapManager.getByOrderingDungeonInfo(_loc3_);
            if(_loc2_)
            {
               _loc1_ = this._maps[_loc3_ - 1] as DungeonMapItem;
               _loc1_.mapId = MapManager.getByOrderingDungeonInfo(_loc3_).ID;
               _loc1_.setBattleNum(_loc2_.FightPower);
            }
            _loc3_++;
         }
      }
      ...
      private function updateSpecialItem() : void
      {
         ...
         while(_loc3_ < DUNGEON_NO)
         {
            _loc2_ = MapManager.getByOrderingSpecialDungeonInfo(_loc3_);
            if(_loc2_)
            {
               _loc1_ = this._maps[_loc3_ - 1] as DungeonMapItem;
               _loc1_.mapId = MapManager.getByOrderingSpecialDungeonInfo(_loc3_).ID;
               _loc1_.setBattleNum(_loc2_.FightPower);
            }
            _loc3_++;
         }
      ...
      private function updateActivityItem() : void
      {
         ...
         while(_loc3_ < DUNGEON_NO)
         {
            _loc2_ = MapManager.getByOrderingActivityDungeonInfo(_loc3_);
            if(Boolean(MapManager.getByOrderingActivityDungeonInfo(_loc3_)))
            {
               _loc1_ = this._maps[_loc3_ - 1] as DungeonMapItem;
               _loc1_.mapId = MapManager.getByOrderingActivityDungeonInfo(_loc3_).ID;
               _loc1_.setBattleNum(_loc2_.FightPower);
            }
            _loc3_++;
         }
      ...
      private function updateAdvancedItem() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 1;
         while(_loc4_ < DUNGEON_NO)
         {
            _loc2_ = MapManager.getByOrderingAdvancedDungeonInfo(_loc4_);
            if(_loc2_)
            {
               _loc1_ = this._maps[_loc3_++] as DungeonMapItem;
               _loc1_.mapId = MapManager.getByOrderingAdvancedDungeonInfo(_loc4_).ID;
               _loc1_.setBattleNum(_loc2_.FightPower);
            }
            _loc4_++;
         }
      ...
      private function reset() : void
      {
         ...
         var _loc2_:int = 1;
         while(_loc2_ < this._maps.length)
         {
            _loc1_ = this._maps[_loc2_ - 1] as DungeonMapItem;
            _loc1_.selected = false;
            _loc1_.stopShine();
            _loc1_.mapId = DEFAULT_MAP;
            _loc2_++;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this._btns.length)
         {
            this._btns[_loc3_].selected = false;
            this._btns[_loc3_].stopShine();
            _loc3_++;
         }
      }
      ...
      {
         if(this._passTxt.visible = false)
         {
            this._passTxt.text = "";
         }
      ...
      {
         var _loc2_:ShineSelectButton = null;
         this._bossBtn.selected = false;
         var _loc3_:room.view.chooseMap.DungeonMapItem = param1.target as DungeonMapItem;
         if(Boolean(this._currentSelectedItem) && this._currentSelectedItem != _loc3_)
         {
      ...
      private function updateBattleNum() : void
      {
         if(this._currentSelectedItem == null)
         {
            return;
         }
         var _loc1_:DungeonInfo = MapManager.getDungeonInfo(this._currentSelectedItem.mapId);
         this._currentSelectedItem.setBattleNum(_loc1_.FightPower,this._selectedLevel);
      }
