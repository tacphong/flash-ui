package room.view.bigMapInfoPanel
{
   ...
   public class MatchRoomBigMapInfoPanel extends Sprite implements Disposeable
   {
      ...
      {
         --this._eliteTime;
         this._eliteTime = this._eliteTime < 0 ? int(0) : int(this._eliteTime);
      ...
      {
         if(this._freeModeBtn && this._gameModeIcon && Boolean(this._matchingPic))
         {
            if(Boolean(this._info))
            {
               if(this._info.type == RoomInfo.RANK_ROOM)
      ...
      private function updateBtns() : void
      {
         ...
         if(Boolean(this._freeModeBtn) && Boolean(this._gameModeIcon))
         {
            ...
            this._guildModeBtn.enable = this._guildModeBtn.buttonMode = Boolean(this._info) && this._info.selfRoomPlayer.isHost && _loc1_;
            this._freeModeBtn.gray = false;
            this._freeModeBtn.buttonMode = Boolean(this._info) && _loc1_ && this._info.selfRoomPlayer.isHost;
