package room.model
{
   ...
   public class RoomPlayer extends EventDispatcher
   {
      ...
      private var _webSpeedInfo:room.model.WebSpeedInfo;
      ...
      public function RoomPlayer(param1:PlayerInfo)
      {
         ...
         this.initEvents();
         this._webSpeedInfo = new room.model.WebSpeedInfo(this._playerInfo.webSpeed);
      ...
      public function get webSpeedInfo() : room.model.WebSpeedInfo
      {
