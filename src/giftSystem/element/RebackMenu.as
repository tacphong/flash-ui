package giftSystem.element
{
   ...
   public class RebackMenu extends Sprite
   {
      ...
      private static var _instance:giftSystem.element.RebackMenu;
      ...
      public static function get Instance() : giftSystem.element.RebackMenu
      {
         if(_instance == null)
         {
            _instance = new giftSystem.element.RebackMenu();
         }
         return _instance;
      }
