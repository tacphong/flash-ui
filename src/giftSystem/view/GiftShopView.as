package giftSystem.view
{
   ...
   public class GiftShopView extends Sprite implements Disposeable
   {
      ...
      private var _goodsList:giftSystem.view.GiftGoodsListView;
