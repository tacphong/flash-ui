package giftSystem
{
   ...
   public class GiftController extends EventDispatcher
   {
      ...
      private static var _instance:giftSystem.GiftController;
      ...
      public static function get Instance() : giftSystem.GiftController
      {
         if(_instance == null)
         {
            _instance = new giftSystem.GiftController();
         }
         return _instance;
      }
