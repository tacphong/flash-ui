package character
{
   ...
   public class SimpleBitmapCharacter extends CrossFrameItem implements ICharacter
   {
      ...
      public function set description(param1:XML) : void
      {
         ...
         var _loc5_:SimpleFrameAction = null;
         ...
         var _loc6_:XMLList = param1..action;
         for each(_loc2_ in _loc6_)
         {
            _loc5_ = new SimpleFrameAction(CharacterUtils.creatFrames(_loc2_.@frames),_loc2_.@name,_loc2_.@next,_loc2_.@priority);
            this._actionSet.addAction(_loc5_);
            _loc5_.endStop = String(_loc2_.@endStop) == "true";
            _loc5_.sound = _loc2_.@sound;
         }
