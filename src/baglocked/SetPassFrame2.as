package baglocked
{
   ...
   public class SetPassFrame2 extends Frame
   {
      ...
      private var _bagLockedController:baglocked.BagLockedController;
      ...
      public function set bagLockedController(param1:baglocked.BagLockedController) : void
      {
      ...
      private function __listItemClick(param1:Event) : void
      {
         ...
         SoundManager.instance.play("008");
         var _loc4_:ComboBox = param1.currentTarget as ComboBox;
         if(_loc4_.currentSelectedIndex == _loc4_.listPanel.vectorListModel.elements.length - 1)
         {
            stage.focus = _loc4_.textField;
            _loc4_.textField.type = TextFieldType.INPUT;
            _loc4_.textField.autoSize = "none";
            _loc4_.textField.maxChars = 14;
            _loc4_.textField.width = 200;
            _loc4_.textField.text = "";
            _loc4_.textField.selectable = true;
            _loc4_.textField.wordWrap = false;
            _loc4_.textField.multiline = false;
            _loc2_ = true;
         }
         else
         {
            _loc4_.textField.type = TextFieldType.DYNAMIC;
            _loc4_.textField.selectable = false;
            _loc4_.textField.mouseEnabled = false;
         }
         _loc3_ = true;
         if(_loc4_ == this._bag_Combox1)
         {
            this._bagLockedController.bagLockedInfo.isSelectCustomQuestion1 = _loc2_;
            this._bagLockedController.bagLockedInfo.isSelectQuestion1 = _loc3_;
         }
         else
         {
            this._bagLockedController.bagLockedInfo.isSelectCustomQuestion2 = _loc2_;
            this._bagLockedController.bagLockedInfo.isSelectQuestion2 = _loc3_;
         }
      }
