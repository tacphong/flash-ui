package farm.viewx.shop
{
   ...
   public class FarmShopView extends Frame
   {
      ...
      private var _goodItems:Vector.<farm.viewx.shop.FarmShopItem>;
      ...
      {
         var _loc2_:farm.viewx.shop.FarmShopItem = param1.currentTarget as FarmShopItem;
      }
