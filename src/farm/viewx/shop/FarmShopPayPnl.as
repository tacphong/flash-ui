package farm.viewx.shop
{
   ...
   public class FarmShopPayPnl extends BaseAlerFrame
   {
      ...
      public function set goodsID(param1:int) : void
      {
         ...
         {
            _loc2_ = 1;
            if(Boolean(this._shopItemInfo.getItemPrice(_loc2_).goldValue))
            {
               this._gold.enable = true;
               this._group.selectIndex = GOLD;
            }
            if(Boolean(this._shopItemInfo.getItemPrice(_loc2_).giftValue))
            {
               this._gift.enable = true;
               this._group.selectIndex = GIFT;
            }
            if(Boolean(this._shopItemInfo.getItemPrice(_loc2_).moneyValue))
            {
      ...
      private function isPetSocrePay() : void
      {
         ...
         this.height = 235;
         this._alertTips.y = this._alertTips2.y = 136;
         this._totalBg.y = 130;
      }
