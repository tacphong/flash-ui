package farm.viewx
{
   ...
   public class FarmMainView extends Sprite implements Disposeable
   {
      ...
      private var _friendListView:farm.viewx.FarmFriendListView;
      ...
      private var _farmShovelBtn:farm.viewx.FarmKillCropCell;
      ...
      private var _fieldView:farm.viewx.FarmFieldsView;
      ...
      private var _farmBuyExpFrame:farm.viewx.FarmBuyExpFrame;
      
      private var _selectedView:farm.viewx.ManureOrSeedSelectedView;
      ...
      private function init() : void
      {
         ...
         this._fieldView = new farm.viewx.FarmFieldsView();
         ...
         this._friendListView = new farm.viewx.FarmFriendListView();
      ...
      public function addSelfPlayer() : void
      {
         ...
         this._mouseMovie = new _loc2_() as MovieClip;
         ...
         if(!this._selfPlayer)
         {
            ...
            this._currentLoadingPlayer = new FarmPlayer(_loc1_,this.addPlayerCallBack);
         }
      }
      ...
      protected function initToolBtn() : void
      {
         ...
         this._farmShovelBtn = new farm.viewx.FarmKillCropCell();
      ...
      {
         var _loc1_:int = int(this._fieldView.fields.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      protected function __onFieldBlockClick(param1:FarmEvent) : void
      {
         ...
         {
            this._selectedView = new farm.viewx.ManureOrSeedSelectedView();
            addChild(this._selectedView);
         }
         var _loc3_:int = int(this._fieldView.fields.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            if(param1.currentTarget == this._fieldView.fields[_loc4_])
            {
               _loc2_ = PositionUtils.creatPoint("farm.fieldsView.fieldPos" + _loc4_);
            }
            _loc4_++;
         }
         ...
         this._selectedView.x = _loc2_.x + this._fieldView.x;
         ...
         this._selectedView.y = _loc2_.y + this._fieldView.y - this._selectedView.height;
