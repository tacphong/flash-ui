package farm.viewx
{
   ...
   public class FarmBuyFieldView extends Sprite implements Disposeable
   {
      ...
      private function upMoney() : void
      {
         ...
         {
            this._moneyNum = this._group.selectIndex == 0 ? int(FarmModelController.instance.model.payFieldMoneyToWeek) : int(FarmModelController.instance.model.payFieldMoneyToMonth);
         }
         _loc1_ = "money";
      ...
      protected function __ok(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = this._group.selectIndex == 0 ? int(FarmModelController.instance.model.payFieldTimeToWeek) : int(FarmModelController.instance.model.payFieldTimeToMonth);
