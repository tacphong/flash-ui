package farm.viewx.newPet
{
   ...
   public class NewPetViewFrame extends Frame
   {
      ...
      private var _newPetItem:farm.viewx.newPet.NewPetShowItem;
      
      private var _PetSkillPnl:farm.viewx.newPet.NewPetSkillPanel;
      ...
      public function set petInfo(param1:PetInfo) : void
      {
         if(!this._newPetItem)
         {
            this._newPetItem = new farm.viewx.newPet.NewPetShowItem(param1);
