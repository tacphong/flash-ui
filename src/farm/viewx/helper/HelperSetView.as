package farm.viewx.helper
{
   ...
   public class HelperSetView extends Frame
   {
      ...
      private var _seedList:farm.viewx.helper.SeedSelect;
      
      private var _fertilizerList:farm.viewx.helper.FertilizerSelect;
      ...
      private var _buyFrame:farm.viewx.helper.HelperBuyAlertFrame;
      ...
      private function initView() : void
      {
         ...
         this._seedList = new farm.viewx.helper.SeedSelect();
         this._fertilizerList = new farm.viewx.helper.FertilizerSelect();
      ...
      public function update(param1:FilterFrameText, param2:FilterFrameText, param3:FilterFrameText, param4:FilterFrameText) : void
      {
         ...
         var _loc7_:Vector.<ShopItemInfo> = ShopManager.Instance.getValidGoodByType(ShopType.FARM_SEED_TYPE);
         ...
         while(_loc10_ < _loc7_.length)
         {
            ...
            _loc8_[_loc5_.TemplateInfo.Name] = _loc5_.TemplateInfo.TemplateID;
            _loc10_++;
         }
         var _loc11_:Vector.<ShopItemInfo> = ShopManager.Instance.getValidGoodByType(ShopType.FARM_MANURE_TYPE);
         var _loc12_:int = 0;
         while(_loc12_ < _loc11_.length)
         {
            _loc6_ = _loc11_[_loc12_];
            _loc9_[_loc6_.TemplateInfo.Name] = _loc6_.TemplateInfo.TemplateID;
            _loc12_++;
         }
         var _loc13_:int = int(_loc8_[param1.text]);
         var _loc14_:int = int(_loc9_[param3.text]);
         this._result.info = ItemManager.Instance.getTemplateById(_loc13_);
         this._fertiliresult.info = ItemManager.Instance.getTemplateById(_loc14_);
      ...
      private function __okHandler(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this._result.info))
         {
            _loc6_ = FarmModelController.instance.model.findItemInfo(EquipType.SEED,this._result.info.TemplateID);
         }
         if(Boolean(this._fertiliresult.info))
         {
            _loc7_ = FarmModelController.instance.model.findItemInfo(EquipType.MANURE,this._fertiliresult.info.TemplateID);
         }
         if(Boolean(_loc6_))
         {
            if(_loc6_.CategoryID == EquipType.SEED && _loc6_.Count < this.seednum)
            {
               this.buyAlert();
               return;
            }
         ...
         if(_loc6_ == null && this.seednum > 0)
         {
            this.buyAlert();
            return;
         }
         if(_loc7_ == null && this.manure > 0)
         {
            this.buyAlert();
            return;
         }
         if(Boolean(_loc7_))
         {
            if(_loc7_.CategoryID == EquipType.MANURE && _loc7_.Count < this.manure)
            {
               this.buyAlert();
               return;
            }
         ...
         {
            _loc4_ = true;
            _loc8_.seedId = this._result.info.TemplateID;
            _loc8_.seedNum = this.seednum;
         }
         if(Boolean(this._fertiliresult.info))
         {
            _loc5_ = true;
            _loc8_.manureId = this._fertiliresult.info.TemplateID;
            _loc8_.manureNum = this.manure;
         }
         _loc8_.isSeed = _loc4_;
         _loc8_.isManure = _loc5_;
         if(this._findNumState != null)
         {
            _loc2_ = _loc8_.seedId;
            if(!_loc2_)
            {
               _loc2_ = 0;
            }
            _loc3_ = _loc8_.manureId;
            if(!_loc3_)
            {
               _loc3_ = 0;
            }
            if(this._findNumState.call(this,_loc2_,_loc3_) > 0)
            {
               this.buyAlert();
               return;
            }
         ...
         {
            this._helperSetViewSelectResult.call(this,_loc8_);
         }
         this.dispose();
      }
