package farm.viewx.helper
{
   ...
   public class FarmHelperView extends Frame
   {
      ...
      private var _beginFrame:farm.viewx.helper.HelperBeginFrame;
      ...
      private function setComboxContent() : void
      {
         ...
         var _loc3_:VectorListModel = this._farmChoose.listPanel.vectorListModel;
         _loc3_.clear();
         ...
         {
            if(_loc4_[_loc5_] && _loc4_[_loc5_].TemplateInfo.CategoryID == 32 && _loc4_[_loc5_].TemplateInfo.Property7 == "1")
            {
            ...
            if(PlayerManager.Instance.Self.Grade >= _loc4_[_loc5_].LimitGrade)
            {
               _loc1_ = _loc4_[_loc5_].TemplateInfo.Name;
               _loc2_ = _loc4_[_loc5_].TemplateID;
               this._listArray.push(_loc1_);
               this._listArrayID.push(_loc2_);
               this._listSeedNum.push(int(_loc4_[_loc5_].TemplateInfo.Property2));
               _loc3_.append(_loc1_);
               if(PlayerManager.Instance.Self.isFarmHelper && _loc4_[_loc5_].TemplateID == FarmModelController.instance.model.helperArray[1])
               {
                  this._farmChoose.textField.text = _loc4_[_loc5_].TemplateInfo.Name;
               }
            }
         }
         ...
         var _loc6_:VectorListModel = this._timeChoose.listPanel.vectorListModel;
         _loc6_.clear();
         _loc6_.append(this._listTimeTextArray[0]);
         _loc6_.append(this._listTimeTextArray[1]);
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:int = this.findSeedTimebyID(this._currentID);
         var _loc3_:int = 0;
         var _loc4_:Vector.<FieldVO> = FarmModelController.instance.model.fieldsInfo;
         var _loc5_:int = 0;
         while(_loc5_ < FarmModelController.instance.model.fieldsInfo.length)
         {
            _loc1_ = (new Date().getTime() - _loc4_[_loc5_].payTime.getTime()) / (1000 * 60 * 60);
            if(_loc4_[_loc5_].fieldValidDate > _loc1_ || _loc4_[_loc5_].fieldValidDate == -1)
            {
               _loc3_++;
            }
            _loc5_++;
         }
         var _loc6_:int = int(_loc3_ * this._currentTime / _loc2_);
         this._getSeedNum = _loc3_ * this._currentTime / _loc2_ * this._getSeedNumOne;
         return _loc6_;
      }
      ...
      private function __onekeyStartClick(param1:MouseEvent) : void
      {
         ...
         if(FarmModelController.instance.model.isHelperMay || PlayerManager.Instance.Self.IsVIP && PlayerManager.Instance.Self.VIPLevel >= FarmModelController.instance.model.vipLimitLevel)
         {
            _loc2_ = FarmModelController.instance.model.getSeedCountByID(this._currentID);
            _loc3_ = this.getseedCountByID();
            _loc4_ = 0;
            ...
            this._beginFrame.needCount = _loc3_ > _loc2_ ? int(_loc3_ - _loc2_) : int(0);
            this._beginFrame.haveCount = _loc2_ > _loc3_ ? int(_loc3_) : int(_loc2_);
