package farm.view.compose
{
   ...
   public class FarmComposeView extends Frame
   {
      ...
      private var _hosePnl:farm.view.compose.FarmHousePnl;
      
      private var _composePnl:farm.view.compose.FarmComposePnl;
      ...
      private function initView() : void
      {
         ...
         this._hosePnl = new farm.view.compose.FarmHousePnl();
      ...
      private function switchView(param1:Boolean) : void
      {
         ...
         {
            this._composePnl = new farm.view.compose.FarmComposePnl();
