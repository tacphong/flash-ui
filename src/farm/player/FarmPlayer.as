package farm.player
{
   ...
   public class FarmPlayer extends FarmPlayerBase
   {
      ...
      private function characterMirror() : void
      {
         ...
         {
            this.character.scaleX = sceneCharacterDirection.isMirror ? Number(-1) : Number(1);
            this.character.x = sceneCharacterDirection.isMirror ? Number(playerWitdh / 2) : Number(-playerWitdh / 2);
         }
         else
         {
