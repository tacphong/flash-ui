package farm.player
{
   ...
   public class FarmSceneCharacterLoaderLayer
   {
      ...
      private var _loaders:Vector.<farm.player.FarmSceneCharacterLayer>;
      ...
      {
         this._loaders = new Vector.<FarmSceneCharacterLayer>();
         this._recordStyle = this._playerInfo.Style.split(",");
         this._recordColor = this._playerInfo.Colors.split(",");
         this._loaders.push(new farm.player.FarmSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],1,this._playerInfo.Sex,this._sceneCharacterLoaderPath));
         this._loaders.push(new farm.player.FarmSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],2,this._playerInfo.Sex,this._sceneCharacterLoaderPath));
      }
