package farm.player
{
   ...
   public class FarmPlayerBase extends SceneCharacterPlayerBase
   {
      ...
      private var _sceneCharacterLoaderBody:farm.player.FarmSceneCharacterLoaderLayer;
      ...
      {
         this._sceneCharacterLoaderBody = new farm.player.FarmSceneCharacterLoaderLayer(this._playerInfo);
         this._sceneCharacterLoaderBody.load(this.sceneCharacterLoaderBodyNaturalCallBack);
      }
      
      private function sceneCharacterLoaderBodyNaturalCallBack(param1:farm.player.FarmSceneCharacterLoaderLayer, param2:Boolean) : void
      {
