package winGuildRank.views
{
   ...
   public class WinGuildRankItem extends Sprite implements Disposeable
   {
      ...
      private var vo:WinGuildRankVo;
      
      public function WinGuildRankItem(param1:int)
      {
         super();
         this.index = param1;
         this.initView();
      ...
      public function setData(param1:WinGuildRankVo, param2:GiftBagInfo) : void
      {
