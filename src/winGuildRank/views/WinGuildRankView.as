package winGuildRank.views
{
   ...
   public class WinGuildRankView extends Sprite implements IRightView
   {
      ...
      public function WinGuildRankView()
      {
         super();
      }
      ...
      {
         WinGuildRankManager.instance.view = this;
         this.initView();
         this.updateView();
         this.initTimer();
      }
      ...
      {
         this._bg = ComponentFactory.Instance.creat("wonderfulactivity.winGuildRank.bg");
         addChild(this._bg);
         ...
         this._rankLabelTxt.text = LanguageMgr.GetTranslation("winGuildRank.rankLabel",5000);
      ...
      public function updateView() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:WinGuildRankVo = null;
         var _loc3_:GmActivityInfo = WinGuildRankManager.instance.xmlData;
         ...
         this._checkBg.tipData = LanguageMgr.GetTranslation("winGuildRank.helpTxt",_loc3_.remain2);
         _loc6_ = WinGuildRankManager.instance.rankList;
         _loc1_ = WinGuildRankManager.instance.myConsume;
         this._myRank = -1;
         var _loc7_:int = 0;
         while(_loc7_ <= _loc6_.length - 1)
         {
            _loc2_ = _loc6_[_loc7_] as WinGuildRankVo;
         ...
         if(this._myRank >= 0)
         {
            ...
            else
            {
               ...
               _loc8_ = (_loc6_[this._myRank - 1] as WinGuildRankVo).consume - _loc1_ + 1;
               this._rankLabelTxt.text = LanguageMgr.GetTranslation("winGuildRank.rankLabel",_loc8_);
            }
            if(WinGuildRankManager.instance.status == 2)
            {
               this._rankLabelTxt.visible = true;
         ...
         else
         {
            ...
            if(_loc6_.length > 0)
            {
               _loc8_ = (_loc6_[_loc6_.length - 1] as WinGuildRankVo).consume - _loc1_ + 1;
            }
            else
            {
               _loc8_ = 1;
            ...
            this._rankLabelTxt.text = LanguageMgr.GetTranslation("winGuildRank.outOfRankLabel",_loc1_,_loc8_);
            if(WinGuildRankManager.instance.status == 2)
            {
               this._rankLabelTxt.visible = true;
               this._rankLabelTxt.textColor = 16711680;
      ...
      {
         var _loc1_:WinGuildRankItem = null;
         var _loc2_:Array = WinGuildRankManager.instance.rankList;
         var _loc3_:Array = WinGuildRankManager.instance.xmlData.giftbagArray;
         this._vbox.removeAllChild();
         var _loc4_:int = 0;
         while(_loc4_ <= _loc2_.length - 1)
         {
            _loc1_ = new WinGuildRankItem(_loc4_);
      ...
      {
         var _loc1_:Date = DateUtils.getDateByStr(WinGuildRankManager.instance.xmlData.endTime);
      ...
      {
         WinGuildRankManager.instance.view = null;
         WonderfulActivityManager.Instance.delTimerFun("consumeRank");
