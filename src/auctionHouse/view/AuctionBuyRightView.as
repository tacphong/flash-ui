package auctionHouse.view
{
   ...
   public class AuctionBuyRightView extends Sprite implements Disposeable
   {
      ...
      private var _strips:Vector.<auctionHouse.view.AuctionBuyStripView>;
      
      private var _selectStrip:auctionHouse.view.AuctionBuyStripView;
      ...
      {
         var _loc2_:auctionHouse.view.AuctionBuyStripView = new auctionHouse.view.AuctionBuyStripView();
         _loc2_.info = param1;
      ...
      {
         this.panel.vScrollProxy = this._list.height > this.panel.height ? int(ScrollPanel.ON) : int(ScrollPanel.OFF);
      ...
      {
         var _loc1_:auctionHouse.view.AuctionBuyStripView = null;
      ...
      {
         var _loc2_:auctionHouse.view.AuctionBuyStripView = null;
      ...
      private function __selectStrip(param1:AuctionHouseEvent) : void
      {
         ...
         var _loc2_:auctionHouse.view.AuctionBuyStripView = param1.target as AuctionBuyStripView;
