package auctionHouse.view
{
   ...
   public class AuctionCellView extends LinkedBagCell
   {
      ...
      {
         var _loc2_:AuctionSellLeftAler = null;
         ...
         if(Boolean(_loc3_) && param1.action != DragEffect.SPLIT)
         {
            ...
            else
            {
               ...
               if(bagCell.itemInfo.Count > 1)
               {
                  ...
                  _loc2_.show(this._temporaryInfo.Count);
                  _loc2_.addEventListener(AuctionSellEvent.SELL,this._alerSell);
                  _loc2_.addEventListener(AuctionSellEvent.NOTSELL,this._alerNotSell);
               }
