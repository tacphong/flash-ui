package auctionHouse.view
{
   ...
   public class AuctionHouseView extends Sprite implements IAuctionHouse, Disposeable
   {
      ...
      private var _browse:auctionHouse.view.AuctionBrowseView;
      
      private var _buy:auctionHouse.view.AuctionBuyView;
      
      private var _sell:auctionHouse.view.AuctionSellView;
      ...
      private function initView() : void
      {
         ...
         this._browse = new auctionHouse.view.AuctionBrowseView(this._controller,this._model);
         this._buy = new auctionHouse.view.AuctionBuyView();
         this._sell = new auctionHouse.view.AuctionSellView(this._controller,this._model);
         this.update();
         this.updateAccount();
      }
      ...
      private function update() : void
      {
         ...
         else if(this._model.state == AuctionState.BUY)
         {
            ...
            if(Boolean(_loc1_) && _loc1_.length > 0)
            {
               ...
               _loc2_ = String(_loc1_[0].toString());
               if(_loc3_ > 1)
               {
                  _loc4_ = 1;
                  while(_loc4_ < _loc3_)
