package auctionHouse.view
{
   ...
   public class BrowseLeftMenuItem extends Sprite implements Disposeable, IMenuItem
   {
      ...
      private var accect:auctionHouse.view.BrowserLeftStripAsset;
      ...
      public function BrowseLeftMenuItem(param1:auctionHouse.view.BrowserLeftStripAsset, param2:CateCoryInfo, param3:Boolean = false)
      {
         super();
         this.accect = param1;
         this._info = param2;
