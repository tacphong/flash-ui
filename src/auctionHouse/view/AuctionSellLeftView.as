package auctionHouse.view
{
   ...
   public class AuctionSellLeftView extends Sprite implements Disposeable
   {
      ...
      private var _cellsItems:Vector.<auctionHouse.view.AuctionCellView>;
      
      private var _cell:auctionHouse.view.AuctionCellView;
      
      private var _dragArea:auctionHouse.view.AuctionDragInArea;
      ...
      private function initView() : void
      {
         ...
         this._dragArea = new auctionHouse.view.AuctionDragInArea(this._cellsItems);
      ...
      private function initInfo() : void
      {
         ...
         if(SharedManager.Instance.AuctionInfos != null && SharedManager.Instance.AuctionInfos[this._cell.info.Name] != null)
         {
            ...
            if(Boolean(_loc1_))
            {
               this._mouthfulM.text = _loc1_.mouthfulPrice == 0 ? "" : String(_loc1_.mouthfulPrice);
      ...
      private function auctionGood() : void
      {
         ...
         if(Boolean(this._cell.info))
         {
            ...
            _loc4_ = this._mouthfulM.text == "" ? int(0) : int(Math.floor(Number(this._mouthfulM.text)));
