package auctionHouse.view
{
   ...
   public class BaseStripView extends Sprite implements Disposeable
   {
      ...
      private var _cell:auctionHouse.view.AuctionCellViewII;
      ...
      protected function initView() : void
      {
         ...
         this._cell = new auctionHouse.view.AuctionCellViewII();
      ...
      private function update() : void
      {
         ...
         this.stripSelect_bit.visible = this._isSelect ? Boolean(true) : Boolean(false);
      }
