package auctionHouse.view
{
   ...
   public class AuctionBrowseView extends Sprite implements Disposeable
   {
      ...
      private var _list:auctionHouse.view.BrowseLeftMenuView;
      ...
      private var _right:auctionHouse.view.AuctionRightView;
      ...
      private function getBidPrice() : int
      {
         ...
         if(Boolean(_loc1_))
         {
            return _loc1_.BuyerName == "" ? int(_loc1_.Price) : int(_loc1_.Price + _loc1_.Rise);
         }
         return 0;
      }
      ...
      {
         var _loc1_:AuctionGoodsInfo = this._right.getSelectInfo();
         return Boolean(_loc1_) ? int(_loc1_.Price) : int(0);
      }
      
      private function getMouthful() : int
      {
         var _loc1_:AuctionGoodsInfo = this._right.getSelectInfo();
         return Boolean(_loc1_) ? int(_loc1_.Mouthful) : int(0);
      }
      ...
      private function __selectRightStrip(param1:AuctionHouseEvent) : void
      {
         ...
         if(Boolean(param1) && param1.currentTarget == this._right)
         {
            this._mouthfulAndbid.visible = true;
         }
         this._mouthful_btnR.enable = this._mouthful_btn.enable = _loc2_.Mouthful == 0 ? Boolean(false) : Boolean(true);
      ...
      public function get Right() : auctionHouse.view.AuctionRightView
      {
         return this._right;
      }
