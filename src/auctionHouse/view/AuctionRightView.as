package auctionHouse.view
{
   ...
   public class AuctionRightView extends Sprite implements Disposeable
   {
      ...
      private var _selectStrip:auctionHouse.view.StripView;
      ...
      private function initView() : void
      {
         ...
         var _loc2_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.RightBG1");
         addChild(_loc2_);
         var _loc3_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.RightBG2");
         addChild(_loc3_);
         var _loc4_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.auctionHouse.topLeft");
         addChild(_loc4_);
         _loc4_.x = 10;
         var _loc5_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.auctionHouse.topRight");
         addChild(_loc5_);
         _loc5_.x = 677;
         var _loc6_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.auctionHouse.Browse.PageCountBg");
         addChild(_loc6_);
         ...
         var _loc7_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.auctionHouse.BidNumber");
         addChild(_loc7_);
         var _loc8_:BaseButton = ComponentFactory.Instance.creat("auctionHouse.GoodsName_btn");
         var _loc9_:BaseButton = ComponentFactory.Instance.creat("auctionHouse.RemainingTime_btn");
         var _loc10_:BaseButton = ComponentFactory.Instance.creat("auctionHouse.BidPerson_btn");
         var _loc11_:BaseButton = ComponentFactory.Instance.creat("auctionHouse.SellPerson_btn");
         var _loc12_:BaseButton = ComponentFactory.Instance.creat("auctionHouse.BidPrice_btn");
         this._sortBtItems[0] = _loc8_;
         this._sortBtItems[2] = _loc9_;
         this._sortBtItems[3] = _loc11_;
         this._sortBtItems[4] = _loc12_;
         this._sortBtItems[5] = _loc10_;
         var _loc13_:int = 0;
         while(_loc13_ < this._sortBtItems.length)
         {
            if(_loc13_ != 1)
            {
               if(_loc13_ == 3)
               {
                  ...
                  {
                     addChild(this._sortBtItems[_loc13_]);
                  }
               }
               else if(_loc13_ == 5)
               {
      ...
      {
         var _loc2_:auctionHouse.view.StripView = param1.cell as StripView;
