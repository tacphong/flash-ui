package socialContact.copyBitmap
{
   ...
   public class CopyBitmapSaveBmp
   {
      ...
      private var _jpgEncder:socialContact.copyBitmap.JPGEncoder;
      
      private var _bitmapData:BitmapData;
      
      public function CopyBitmapSaveBmp()
      {
         this._jpgEncder = new socialContact.copyBitmap.JPGEncoder();
         super();
      }
      ...
      public function copyBmp(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:int = param1 < param3 ? int(param1) : int(param3);
         var _loc7_:int = param2 < param4 ? int(param2) : int(param4);
