package socialContact.copyBitmap
{
   ...
   public class JPGEncoder
   {
      ...
      private function initQuantTables(param1:int) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:Array = [16,11,10,16,24,40,51,61,12,12,14,19,26,58,60,55,14,13,16,24,40,57,69,56,14,17,22,29,51,87,80,62,18,22,37,56,68,109,103,77,24,35,55,64,81,104,113,92,49,64,78,87,103,121,120,101,72,92,95,98,112,100,103,99];
         _loc2_ = 0;
         while(_loc2_ < 64)
         {
         ...
         while(_loc2_ < 64)
         {
            _loc3_ = Math.floor((_loc6_[_loc2_] * param1 + 50) / 100);
            if(_loc3_ < 1)
            {
               _loc3_ = 1;
            }
         ...
         while(_loc8_ < 8)
         {
            ...
            while(_loc4_ < 8)
            {
               this.fdtbl_Y[_loc2_] = 1 / (this.YTable[this.ZigZag[_loc2_]] * _loc7_[_loc8_] * _loc7_[_loc4_] * 8);
               this.fdtbl_UV[_loc2_] = 1 / (this.UVTable[this.ZigZag[_loc2_]] * _loc7_[_loc8_] * _loc7_[_loc4_] * 8);
               _loc2_++;
               _loc4_++;
            }
            _loc8_++;
      ...
      private function computeHuffmanTbl(param1:Array, param2:Array) : Array
      {
         ...
         {
            _loc3_ = 1;
            while(_loc3_ <= param1[_loc7_])
            {
               _loc6_[param2[_loc5_]] = new BitString();
               _loc6_[param2[_loc5_]].val = _loc4_;
               _loc6_[param2[_loc5_]].len = _loc7_;
               _loc5_++;
               _loc4_++;
               _loc3_++;
            }
      ...
      private function processDU(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:BitString = param5[0];
         var _loc11_:BitString = param5[240];
         var _loc12_:Array = this.fDCTQuant(param1,param2);
         _loc6_ = 0;
         while(_loc6_ < 64)
         {
            this.DU[this.ZigZag[_loc6_]] = _loc12_[_loc6_];
            _loc6_++;
         }
         var _loc13_:int = this.DU[0] - param3;
         ...
         {
            this.writeBits(param4[this.category[32767 + _loc13_]]);
            this.writeBits(this.bitcode[32767 + _loc13_]);
         }
         var _loc14_:int = 63;
         while(_loc14_ > 0 && this.DU[_loc14_] == 0)
         {
            _loc14_--;
         }
         if(_loc14_ == 0)
         {
            this.writeBits(_loc10_);
            return param3;
         }
         _loc6_ = 1;
         ...
         {
            _loc7_ = _loc6_;
            while(this.DU[_loc6_] == 0 && _loc6_ <= _loc14_)
            {
               _loc6_++;
            }
            ...
            {
               _loc9_ = 1;
               while(_loc9_ <= _loc8_ / 16)
               {
                  this.writeBits(_loc11_);
                  _loc9_++;
               }
               _loc8_ = int(_loc8_ & 15);
            }
            this.writeBits(param5[_loc8_ * 16 + this.category[32767 + this.DU[_loc6_]]]);
            this.writeBits(this.bitcode[32767 + this.DU[_loc6_]]);
            _loc6_++;
         }
         if(_loc14_ != 63)
         {
      ...
      private function RGB2YUV(param1:BitmapData, param2:int, param3:int) : void
      {
         ...
         while(_loc10_ < 8)
         {
            ...
            while(_loc4_ < 8)
            {
               _loc5_ = param1.getPixel32(param2 + _loc4_,param3 + _loc10_);
               _loc6_ = Number(_loc5_ >> 16 & 255);
               _loc7_ = Number(_loc5_ >> 8 & 255);
               _loc8_ = Number(_loc5_ & 255);
               this.YDU[_loc9_] = 0.299 * _loc6_ + 0.587 * _loc7_ + 0.114 * _loc8_ - 128;
               this.UDU[_loc9_] = -0.16874 * _loc6_ + -0.33126 * _loc7_ + 0.5 * _loc8_;
               this.VDU[_loc9_] = 0.5 * _loc6_ + -0.41869 * _loc7_ + -0.08131 * _loc8_;
               _loc9_++;
               _loc4_++;
            }
            _loc10_++;
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc7_ < param1.height)
         {
            ...
            {
               this.RGB2YUV(param1,_loc2_,_loc7_);
               _loc4_ = this.processDU(this.YDU,this.fdtbl_Y,_loc4_,this.YDC_HT,this.YAC_HT);
               _loc5_ = this.processDU(this.UDU,this.fdtbl_UV,_loc5_,this.UVDC_HT,this.UVAC_HT);
               _loc6_ = this.processDU(this.VDU,this.fdtbl_UV,_loc6_,this.UVDC_HT,this.UVAC_HT);
               _loc2_ += 8;
            }
            _loc7_ += 8;
         }
         if(this.bytepos >= 0)
         {
            _loc3_ = new BitString();
            _loc3_.len = this.bytepos + 1;
            _loc3_.val = (1 << this.bytepos + 1) - 1;
            this.writeBits(_loc3_);
         }
