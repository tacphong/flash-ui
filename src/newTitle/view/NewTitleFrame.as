package newTitle.view
{
   ...
   public class NewTitleFrame extends Frame
   {
      ...
      private var _titleList:newTitle.view.NewTitleListView;
      ...
      private function initView() : void
      {
         ...
         this._titleList = new newTitle.view.NewTitleListView();
      ...
      {
         var _loc1_:String = "";
         this._propertyText.text = "Tấn công: " + this._selectTitle.Att + "\n" + "Phòng thủ: " + this._selectTitle.Def + "\n" + "Nhanh nhẹn: " + this._selectTitle.Agi + "\n" + "May mắn: " + this._selectTitle.Luck + "\n" + "Thời hạn: " + this._selectTitle.Valid + " ngày" + "\n" + "Mô tả: " + this._selectTitle.Desc;
      ...
      private function isOwnTitle(param1:String) : Boolean
      {
         ...
         var _loc4_:Array = EffortManager.Instance.getHonorArray();
         _loc2_ = 0;
         while(_loc2_ < _loc4_.length)
         {
            if(param1 == _loc4_[_loc2_].Name)
            {
               _loc3_ = true;
               break;
            }
      ...
      protected function __onComplete(param1:LoaderEvent) : void
      {
         ...
         if(Boolean(_loc3_))
         {
            ...
            {
               this._currentTitle = new Bitmap(_loc3_.bitmapData.clone());
            ...
            {
               _loc3_.x = (this._titleSprite.width - _loc3_.width) / 2;
               _loc3_.y = (this._titleSprite.height - _loc3_.height) / 2;
               this._titleSprite.addChild(_loc3_);
            }
         }
      }
