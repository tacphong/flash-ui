package noviceactivity
{
   ...
   public class NoviceActivityRightView extends Sprite implements Disposeable
   {
      ...
      private var _record:noviceactivity.NoviceActivityInfo;
      
      private var _info:noviceactivity.NoviceActivityInfo;
      ...
      public function setInfo(param1:noviceactivity.NoviceActivityInfo, param2:noviceactivity.NoviceActivityInfo) : void
      {
         this._record = param1;
         this._info = param2;
