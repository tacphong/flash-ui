package noviceactivity
{
   ...
   public class NoviceActivityManager extends EventDispatcher
   {
      ...
      private static var _instance:noviceactivity.NoviceActivityManager;
      ...
      private var _frame:noviceactivity.NoviceActivityFrame;
      ...
      public static function get instance() : noviceactivity.NoviceActivityManager
      {
         if(_instance == null)
         {
            _instanceClass = new NoviceActivityManagerInstanceClass();
            _instance = new noviceactivity.NoviceActivityManager(_instanceClass);
         }
         return _instance;
      }
...
class NoviceActivityManagerInstanceClass
{
   ...
   public function NoviceActivityManagerInstanceClass()
   {
      super();
   }
}
