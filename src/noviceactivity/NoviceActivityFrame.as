package noviceactivity
{
   ...
   public class NoviceActivityFrame extends Frame
   {
      ...
      private var _leftview:noviceactivity.NoviceActivityLeftView;
      
      private var _rightview:noviceactivity.NoviceActivityRightView;
      ...
      private function initView() : void
      {
         ...
         this._leftview = new noviceactivity.NoviceActivityLeftView();
         PositionUtils.setPos(this._leftview,"noviceactivity.mainframe.leftview.pos");
         addToContent(this._leftview);
         this._rightview = new noviceactivity.NoviceActivityRightView();
