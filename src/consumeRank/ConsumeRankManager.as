package consumeRank
{
   ...
   public class ConsumeRankManager
   {
      ...
      private static var _instance:consumeRank.ConsumeRankManager;
      ...
      public static function get instance() : consumeRank.ConsumeRankManager
      {
         if(!_instance)
         {
            _instance = new consumeRank.ConsumeRankManager();
         }
         return _instance;
      }
      ...
      protected function __updateInfo(param1:ConsumeRankEvent) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc8_[this.actId] = new LeftViewInfoVo(ActivityType.CONSUME_RANK,"· " + this.xmlData.activityName,this.xmlData.icon);
