package winRank.views
{
   ...
   public class WinRankItem extends Sprite implements Disposeable
   {
      ...
      private var vo:WinRankVo;
      
      public function WinRankItem(param1:int)
      {
         super();
         this.index = param1;
         this.initView();
      ...
      public function setData(param1:WinRankVo, param2:GiftBagInfo) : void
      {
