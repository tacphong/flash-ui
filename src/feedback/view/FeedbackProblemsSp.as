package feedback.view
{
   ...
   public class FeedbackProblemsSp extends Sprite implements Disposeable
   {
      ...
      private var _submitFrame:feedback.view.FeedbackSubmitFrame;
      ...
      public function setFeedbackInfo() : void
      {
         ...
         this._submitFrame.feedbackInfo.activity_is_error = this._selectedButtonGroup.selectIndex == 0 ? Boolean(true) : Boolean(false);
         this._submitFrame.feedbackInfo.activity_name = this._problemsActivityTitleInput.text;
      }
      
      public function set submitFrame(param1:feedback.view.FeedbackSubmitFrame) : void
      {
