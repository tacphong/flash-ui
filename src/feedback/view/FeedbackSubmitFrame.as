package feedback.view
{
   ...
   public class FeedbackSubmitFrame extends Frame
   {
      ...
      private function _init() : void
      {
         ...
         var _loc3_:Number = new Date().getFullYear();
         this._yearCombox.textField.text = String(_loc3_);
         this._yearCombox.snapItemHeight = true;
         this._yearCombox.selctedPropName = "text";
         _loc2_ = _loc3_;
         while(_loc2_ >= _loc3_ - 2)
         {
            this._yearCombox.listPanel.vectorListModel.append(_loc2_);
            _loc2_--;
         }
         ...
         while(_loc2_ <= 12)
         {
            this._monthCombox.listPanel.vectorListModel.append(_loc2_);
            _loc2_++;
         }
         ...
         var _loc6_:Number = DateUtils.getDays(_loc3_,_loc4_);
         _loc2_ = 1;
         while(_loc2_ <= _loc6_)
         {
            this._dayCombox.listPanel.vectorListModel.append(_loc2_);
            _loc2_++;
         }
