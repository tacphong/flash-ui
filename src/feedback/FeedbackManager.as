package feedback
{
   ...
   public class FeedbackManager extends EventDispatcher
   {
      ...
      private static var _instance:feedback.FeedbackManager;
      ...
      public static function get instance() : feedback.FeedbackManager
      {
         if(_instance == null)
         {
            _instance = new feedback.FeedbackManager();
         }
         return _instance;
      }
