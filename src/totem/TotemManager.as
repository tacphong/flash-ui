package totem
{
   ...
   public class TotemManager extends EventDispatcher
   {
      ...
      private static var _instance:totem.TotemManager;
      ...
      public static function get instance() : totem.TotemManager
      {
         if(_instance == null)
         {
            _instance = new totem.TotemManager();
         }
         return _instance;
      }
      ...
      public function getNextInfoById(param1:int) : TotemDataVo
      {
         ...
         {
            _loc2_ = int(this._dataList[param1].Point);
         }
