package totem.view
{
   ...
   public class TotemLeftWindowView extends Sprite implements Disposeable
   {
      ...
      private var _totemPointList:Vector.<totem.view.TotemLeftWindowTotemCell>;
      ...
      private var _openCartoonSprite:totem.view.TotemLeftWindowOpenCartoonView;
      
      private var _propertyTxtSprite:totem.view.TotemLeftWindowPropertyTxtView;
      
      private var _tipView:totem.view.TotemPointTipView;
      
      private var _chapterIcon:totem.view.TotemLeftWindowChapterIcon;
      ...
      private function init() : void
      {
         ...
         this._openCartoonSprite = new totem.view.TotemLeftWindowOpenCartoonView(this._totemPointLocationList,this.refreshGlowFilter,this.refreshTotemPoint);
         this._propertyTxtSprite = new totem.view.TotemLeftWindowPropertyTxtView();
         ...
         this._tipView = new totem.view.TotemPointTipView();
      ...
      {
         var _loc6_:int = 0;
         var _loc5_:totem.view.TotemLeftWindowTotemCell = null;
         _loc6_ = 0;
         _loc5_ = null;
         _loc6_ = 0;
         var _loc7_:totem.view.TotemLeftWindowTotemCell = null;
         ...
         while(_loc6_ < _loc11_)
         {
            ...
            _loc5_ = new totem.view.TotemLeftWindowTotemCell(_loc8_,_loc9_);
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:int = int(this._totemPointList.length);
         _loc3_ = 0;
         while(_loc3_ < _loc4_)
         {
      ...
      private function refreshTotemPoint(param1:int, param2:TotemDataVo, param3:Boolean) : void
      {
         ...
         var _loc7_:int = int(this._totemPointList.length);
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
      ...
      {
         var _loc2_:totem.view.TotemLeftWindowTotemCell = null;
      ...
      public function dispose() : void
      {
         ...
         var _loc3_:totem.view.TotemLeftWindowTotemCell = null;
