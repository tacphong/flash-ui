package totem.view
{
   ...
   public class TotemMainView extends Sprite implements Disposeable
   {
      ...
      private var _leftView:totem.view.TotemLeftView;
      
      private var _rightView:totem.view.TotemRightView;
      
      private var _activateProtectView:totem.view.TotemActivateProtectView;
      ...
      private function initView() : void
      {
         ...
         this._activateProtectView = new totem.view.TotemActivateProtectView();
