package totem.view
{
   ...
   public class TotemInfoView extends Sprite implements Disposeable
   {
      ...
      private var _windowView:totem.view.TotemLeftWindowView;
      ...
      private var _propertyList:Vector.<totem.view.TotemInfoViewTxtCell>;
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:totem.view.TotemInfoViewTxtCell = null;
         _loc1_ = 0;
         _loc2_ = null;
         _loc1_ = 0;
         _loc2_ = null;
