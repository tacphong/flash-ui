package totem.view
{
   ...
   public class TotemRightView extends Sprite implements Disposeable
   {
      ...
      private var _honorTxt1:totem.view.TotemRightViewIconTxtCell;
      
      private var _expTxt1:totem.view.TotemRightViewIconTxtCell;
      
      private var _titleTxt2:FilterFrameText;
      
      private var _honorTxt2:totem.view.TotemRightViewIconTxtCell;
      
      private var _expTxt2:totem.view.TotemRightViewIconTxtCell;
      
      private var _titleTxt3:FilterFrameText;
      
      private var _propertyList:Vector.<totem.view.TotemRightViewTxtTxtCell>;
      
      private var _tipTxt:FilterFrameText;
      
      private var _honorUpIcon:totem.view.HonorUpIcon;
      
      private var _nextInfo:TotemDataVo;
      
      private var _totemRightViewIconTxtDragonBoatCell:totem.view.TotemRightViewIconTxtDragonBoatCell;
      
      private var _totemSignTxt:FilterFrameText;
      
      private var _totemSignTxtCell:totem.view.TotemSignTxtCell;
      ...
      {
         var _loc1_:totem.view.TotemRightViewTxtTxtCell = null;
         var _loc2_:int = 0;
         _loc1_ = null;
         _loc2_ = 0;
         _loc1_ = null;
      ...
      private function refreshGPTxt() : void
      {
         ...
         if(Boolean(this._nextInfo))
         {
            ...
            _loc4_ = _loc4_ = Math.round(this._nextInfo.ConsumeExp * (ServerConfigManager.instance.totemSignDiscount / 100));
            if(_loc2_ > _loc4_)
            {
               _loc2_ = _loc4_;
            }
            if(Boolean(this._nextInfo) && PlayerManager.Instance.Self.Money + _loc2_ < this._nextInfo.ConsumeExp)
            {
               _loc1_ = true;
            }
      ...
      {
         if(Boolean(param1.changedProperties["myHonor"]))
         {
            this.refreshHonorTxt();
         }
         if(Boolean(param1.changedProperties["GP"]))
         {
            this.refreshGPTxt();
         }
      }
