package bagAndInfo.ReworkName
{
   ...
   public class ReworkNameConsortia extends ReworkNameFrame
   {
      ...
      override protected function submitCheckCallBack(param1:ReworkNameAnalyzer) : void
      {
         ...
         complete = true;
         var _loc3_:XML = param1.result;
         this.setCheckTxt(_loc3_.@message);
         if(this.nameInputCheck() && _isCanRework)
         {
            _loc2_ = _nicknameInput.text;
            SocketManager.Instance.out.sendUseConsortiaReworkName(PlayerManager.Instance.Self.ConsortiaID,_bagType,_place,_loc2_);
            reworkNameComplete();
         }
      }
   }
