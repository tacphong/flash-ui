package bagAndInfo.bag
{
   ...
   public class KeySetFrame extends BaseAlerFrame
   {
      ...
      private var _defaultSetPalel:bagAndInfo.bag.KeyDefaultSetPanel;
      
      private var _currentSet:bagAndInfo.bag.KeySetItem;
      ...
      private function initContent() : void
      {
         ...
         this._defaultSetPalel = new bagAndInfo.bag.KeyDefaultSetPanel();
      ...
      private function creatCell() : void
      {
         ...
         var _loc3_:bagAndInfo.bag.KeySetItem = null;
         this.clearItemList();
         for(_loc1_ in this._tempSets)
         {
            ...
            if(Boolean(_loc2_))
            {
               _loc3_ = new bagAndInfo.bag.KeySetItem(int(_loc1_),int(_loc1_),this._tempSets[_loc1_],PropItemView.createView(_loc2_.Pic,40,40));
