package bagAndInfo.bag
{
   ...
   public class SellGoodsFrame extends Frame
   {
      ...
      public function set itemInfo(param1:InventoryItemInfo) : void
      {
         ...
         if(param1.ReclaimType == 3 && param1.IsBinds == false && param1.CategoryID == 7)
         {
            this._descript.htmlText = LanguageMgr.GetTranslation("bagAndInfo.sellFrame.explainTxt",param1.Count) + "                    " + LanguageMgr.GetTranslation("shop.ShopIIShoppingCarItem.money");
         }
         else if(param1.ReclaimType == 3 && param1.IsBinds == false && param1.CategoryID == 11)
         {
            this._descript.htmlText = LanguageMgr.GetTranslation("bagAndInfo.sellFrame.explainTxt",param1.Count) + "                    " + LanguageMgr.GetTranslation("shop.ShopIIShoppingCarItem.money");
         }
         else if(param1.ReclaimType == 3 && param1.IsBinds == false && param1.CategoryID == 18)
         {
            this._descript.htmlText = LanguageMgr.GetTranslation("bagAndInfo.sellFrame.explainTxt",param1.Count) + "                    " + LanguageMgr.GetTranslation("shop.ShopIIShoppingCarItem.money");
         }
         else
         {
            this._descript.htmlText = LanguageMgr.GetTranslation("bagAndInfo.sellFrame.explainTxt",param1.Count) + "                    " + LanguageMgr.GetTranslation("shop.ShopIIShoppingCarItem.gold");
         }
