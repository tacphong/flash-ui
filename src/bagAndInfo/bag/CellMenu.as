package bagAndInfo.bag
{
   ...
   public class CellMenu extends Sprite
   {
      ...
      private static var _instance:bagAndInfo.bag.CellMenu;
      ...
      public static function get instance() : bagAndInfo.bag.CellMenu
      {
         if(_instance == null)
         {
            _instance = new bagAndInfo.bag.CellMenu(new SingletonFoce());
         }
         return _instance;
      }
      ...
      public function show(param1:BagCell, param2:int, param3:int) : void
      {
         ...
         else if(EquipType.isPetEgg(_loc4_.CategoryID))
         {
            this._list.addChild(this._openitem);
         }
