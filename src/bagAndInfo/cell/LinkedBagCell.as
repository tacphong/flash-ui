package bagAndInfo.cell
{
   ...
   public class LinkedBagCell extends bagAndInfo.cell.BagCell
   {
       
      
      protected var _bagCell:bagAndInfo.cell.BagCell;
      ...
      public function get bagCell() : bagAndInfo.cell.BagCell
      {
         return this._bagCell;
      }
      
      public function set bagCell(param1:bagAndInfo.cell.BagCell) : void
      {
      ...
      override public function dragStop(param1:DragEffect) : void
      {
         ...
         if(Boolean(this._bagCell))
         {
            if(param1.action != DragEffect.NONE || Boolean(param1.target))
            {
