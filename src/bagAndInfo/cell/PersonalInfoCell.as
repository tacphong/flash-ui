package bagAndInfo.cell
{
   ...
   public class PersonalInfoCell extends BagCell
   {
      ...
      override public function dragDrop(param1:DragEffect) : void
      {
         ...
         if(_loc3_.Place < 29 && _loc3_.BagType != BagInfo.PROPBAG)
         {
            return;
         }
         if((_loc3_.BindType == 1 || _loc3_.BindType == 2 || _loc3_.BindType == 3) && _loc3_.IsBinds == false && _loc3_.TemplateID != EquipType.WISHBEAD_ATTACK && _loc3_.TemplateID != EquipType.WISHBEAD_DEFENSE && _loc3_.TemplateID != EquipType.WISHBEAD_AGILE)
         {
            ...
            _loc2_.addEventListener(FrameEvent.RESPONSE,this.__onBindResponse);
            temInfo = _loc3_;
         ...
         if(Boolean(_loc3_))
         {
            ...
            {
               if(_loc3_.CategoryID == 50 && int(_loc3_.Property2) <= PetBagController.instance().petModel.currentPetInfo.Level)
               {
                  SocketManager.Instance.out.addPetEquip(_loc3_.Place,PetBagController.instance().petModel.currentPetInfo.Place,BagInfo.EQUIPBAG);
               }
               else if(_loc3_.CategoryID == 51 && int(_loc3_.Property2) <= PetBagController.instance().petModel.currentPetInfo.Level)
               {
                  SocketManager.Instance.out.addPetEquip(_loc3_.Place,PetBagController.instance().petModel.currentPetInfo.Place,BagInfo.EQUIPBAG);
               }
               else if(_loc3_.CategoryID == 52 && int(_loc3_.Property2) <= PetBagController.instance().petModel.currentPetInfo.Level)
               {
                  SocketManager.Instance.out.addPetEquip(_loc3_.Place,PetBagController.instance().petModel.currentPetInfo.Place,BagInfo.EQUIPBAG);
               }
               else
