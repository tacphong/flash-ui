   ...
   public class BagCell extends BaseCell
   {
      ...
      override public function dragDrop(param1:DragEffect) : void
      {
         ...
         if(param1.data is InventoryItemInfo)
         {
            ...
            {
               if(this._bagType == 11 || _loc2_.BagType == 11 || this._bagType == 51 || _loc2_.BagType == 51)
               {
                  ...
                  else if((this._bagType == 11 || _loc2_.BagType == 11) && PlayerManager.Instance.Self.consortiaInfo.StoreLevel < 1)
                  {
      ...
      override public function dragStop(param1:DragEffect) : void
      {
         ...
         if(param1.action == DragEffect.MOVE && param1.target == null)
         {
            if(_loc4_.CategoryID == 50 || _loc4_.CategoryID == 51 || _loc4_.CategoryID == 52)
            {
               if(param1.target is BagCell)
               {
                  ...
                  {
                     if(this.placeArr.indexOf(_loc4_.Place) != -1)
                     {
                     ...
                     SocketManager.Instance.out.addPetEquip(_loc2_,PetBagController.instance().petModel.currentPetInfo.Place,BagInfo.EQUIPBAG);
                  }
               }
               else
               {
         ...
         if(param1.action == DragEffect.MOVE && param1.target == null)
         {
            ...
            else if(_loc4_ && _loc4_.BagType == BagInfo.CONSORTIA || _loc4_.BagType == BagInfo.BANKBAG)
            {
               param1.action = DragEffect.NONE;
               super.dragStop(param1);
            }
            else if(Boolean(_loc4_) && _loc4_.BagType == BagInfo.STOREBAG)
            {
               locked = false;
            }
