   package bagAndInfo
{
   ...
   public class BagAndGiftFrame extends Frame
   {
      ...
      private static const TOTEM_OPEN_LEVEL:int = 35;
      ...
      private var _infoFrame:bagAndInfo.BagAndInfoFrame;
      ...
      private function avatarCollBtnEnable() : void
      {
         ...
         if(PlayerManager.Instance.Self.Grade >= 10)
         {
            ...
            if(!PlayerManager.Instance.Self.isNewOnceFinish(106) && !GiftController.Instance.inChurch)
            {
               _loc1_ = {};
               _loc1_["color"] = "gold";
               this._avatarCollBtnShine = EffectManager.Instance.creatEffect(3,this._avatarCollBtn,_loc1_);
      ...
      private function __avatarCollBtnOverHandler(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Point = this._avatarCollBtn.localToGlobal(new Point(0,0));
         this._avatarCollBtnTip.x = _loc2_.x - 12;
      ...
      private function petBtnEnable() : void
      {
         ...
         else
         {
            ...
            if(!this._petBtnSprite)
            {
               ...
               this._petBtnTip.tipData = "Chức năng PET sẽ mở khi bạn đạt cấp 25.";
      ...
      public function __addPet(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc8_)
         {
            ...
            _loc2_ = ComponentFactory.Instance.creat("bagAndInfo.petAddItem",[_loc8_]);
            _loc4_ = new AlertInfo(_loc8_.Name);
