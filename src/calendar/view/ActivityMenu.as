package calendar.view
{
   ...
   public class ActivityMenu extends Sprite implements Disposeable
   {
      ...
      private var _cells:Vector.<calendar.view.ActivityCell>;
      
      private var _model:CalendarModel;
      
      private var _contentHolder:calendar.view.ActivityContentHolder;
      
      private var _selectedItem:calendar.view.ActivityCell;
      ...
      {
         var _loc1_:calendar.view.ActivityCell = this._cells.shift();
         while(_loc1_ != null)
         {
      ...
      public function setActivityDate(param1:Date) : void
      {
         ...
         var _loc4_:calendar.view.ActivityCell = null;
         this.cleanCells();
         var _loc5_:int = int(this._model.eventActives.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc3_ = this._model.eventActives[_loc6_];
            if(this.isAfterToday(param1) && _loc3_.IsAdvance && this.isInValidDate(param1,_loc3_) || this.isBeforeToday(param1) && this.isInValidDate(param1,_loc3_))
            {
               _loc4_ = new calendar.view.ActivityCell(_loc3_);
               _loc4_.y = _loc6_ * 44;
               _loc4_.addEventListener(MouseEvent.CLICK,this.__cellClick);
               addChild(_loc4_);
      ...
      public function setSeletedItem(param1:calendar.view.ActivityCell) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:int = 0;
      ...
      {
         var _loc2_:calendar.view.ActivityCell = param1.currentTarget as ActivityCell;
      ...
      {
         var _loc2_:calendar.view.ActivityCell = null;
