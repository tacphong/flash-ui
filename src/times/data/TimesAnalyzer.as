package times.data
{
   ...
   public class TimesAnalyzer extends DataAnalyzer
   {
      ...
      override public function analyze(param1:*) : void
      {
         ...
         var i:int = 0;
         var k:int = 0;
         var info:times.data.TimesPicInfo = null;
         var info1:times.data.TimesPicInfo = null;
         var info2:times.data.TimesPicInfo = null;
         var data:* = param1;
         ...
         if(xml.@value == "true")
         {
            ...
            {
               info = new times.data.TimesPicInfo();
            ...
            while(i < xmllist.length())
            {
               info1 = new times.data.TimesPicInfo();
            ...
            while(k < 4)
            {
               ...
               while(i < xmllist.length())
               {
                  info2 = new times.data.TimesPicInfo();
