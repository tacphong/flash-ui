package times.data
{
   ...
   public class TimesEvent extends Event
   {
      ...
      public var info:times.data.TimesPicInfo;
      
      public var params:Array;
      
      public function TimesEvent(param1:String, param2:times.data.TimesPicInfo = null, param3:Array = null, param4:Boolean = false, param5:Boolean = false)
      {
         this.info = param2;
         this.params = param3;
