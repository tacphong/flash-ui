package times
{
   ...
   public class TimesManager
   {
      ...
      private static var _instance:times.TimesManager;
      ...
      private var _controller:times.TimesController;
      ...
      public static function get Instance() : times.TimesManager
      {
         if(!_instance)
         {
            _instance = new times.TimesManager();
         }
         return _instance;
      }
      ...
      public function showButton() : void
      {
         ...
         {
            if(Boolean(this._timesBtn) && Boolean(this._timesBtn.parent))
            {
               return;
            }
      ...
      private function _QQshowComplete() : void
      {
         ...
         var _loc5_:TimesPicInfo = new TimesPicInfo();
         while(_loc1_ < _loc4_.length)
         {
            _loc2_ = 0;
            while(_loc2_ < _loc4_[_loc1_].length)
            {
               _loc3_++;
               if(_loc3_ == this._page)
               {
                  _loc5_.targetCategory = _loc1_;
                  _loc5_.targetPage = _loc2_;
               }
               _loc2_++;
            }
            _loc1_++;
         }
         this._controller.dispatchEvent(new TimesEvent(TimesEvent.GOTO_CONTENT,_loc5_));
      }
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:Vector.<int> = this._statistics.stayTime;
         var _loc3_:int = 0;
         ...
         _loc4_["Forum1"] = _loc2_[0];
         _loc4_["Forum2"] = _loc2_[1];
         _loc4_["Forum3"] = _loc2_[2];
         _loc4_["Forum4"] = _loc2_[3];
         _loc4_["Forum5"] = _loc2_[4];
