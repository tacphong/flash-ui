package times.view
{
   ...
   public class TimesThumbnailPointTip extends Sprite implements ITip
   {
      ...
      public function set tipData(param1:Object) : void
      {
         ...
         if(this._bitmapDatas && this._bitmapDatas[param1.category] && Boolean(this._bitmapDatas[param1.category][param1.page]))
         {
      ...
      {
         if(Boolean(this._bitmap) && Boolean(this._bitmap.parent))
         {
