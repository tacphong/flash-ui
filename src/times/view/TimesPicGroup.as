package times.view
{
   ...
   public class TimesPicGroup extends Sprite implements Disposeable
   {
      ...
      private var _pics:Vector.<times.view.TimesPicBase>;
      ...
      public function init() : void
      {
         ...
         {
            this._pics.push(new times.view.TimesPicBase(this._infos[_loc1_]));
      ...
      private function tryLoad(param1:int) : void
      {
         ...
         if(param1 < this._pics.length && Boolean(this._pics[param1]))
         {
