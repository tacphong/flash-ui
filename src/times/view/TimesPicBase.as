   ...
   public class TimesPicBase extends Sprite implements Disposeable
   {
      ...
      protected function __onLoadCompleted(param1:Event) : void
      {
         if(Boolean(this._loader))
         {
            ...
            if(Boolean(this._loadingMc) && Boolean(this._loadingMc.parent))
            {
      ...
      public function set playEffect(param1:Boolean) : void
      {
         ...
         if(value && this._glowFilter && Boolean(this._glowFilter2))
         {
            y -= 5;
         ...
         if(Boolean(this._glowFilter) && Boolean(this._glowFilter2))
         {
            y += 5;
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._glowFilter2))
         {
            TweenMax.killTweensOf(this._glowFilter2);
         }
         removeEventListener(MouseEvent.CLICK,this.__picClick);
         if(Boolean(this._whiteShape))
         {
            if(Boolean(this._whiteShape.parent))
            {
         ...
         if(Boolean(this._loadingMc) && Boolean(this._loadingMc.parent))
         {
            if(Boolean(this._loadingMc.parent))
            {
               this._loadingMc.parent.removeChild(this._loadingMc);
            }
