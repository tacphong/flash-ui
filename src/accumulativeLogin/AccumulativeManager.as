package accumulativeLogin
{
   ...
   public class AccumulativeManager extends EventDispatcher
   {
      ...
      private static var _instance:accumulativeLogin.AccumulativeManager;
      ...
      public static function get instance() : accumulativeLogin.AccumulativeManager
      {
         if(_instance == null)
         {
            _instance = new accumulativeLogin.AccumulativeManager();
         }
         return _instance;
      }
