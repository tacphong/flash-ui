   ...
   public class FightLibAlertView extends Sprite implements Disposeable
   {
      ...
      private function ShowWeaponIcon(param1:Array) : void
      {
         ...
         while(_loc3_ < _loc8_)
         {
            ...
            _loc2_ = ItemManager.Instance.getTemplateById(param1[_loc3_]);
            _loc5_ = new BaseCell(_loc4_,_loc2_,true,false);
            _loc5_.x = 30 + _loc3_ * 70;
            _loc5_.y = 59;
            addChild(_loc5_);
            this._WeaponCellArr.push(_loc5_);
            _loc6_ = _loc2_.Name.slice(2);
            _loc7_ = ComponentFactory.Instance.creatComponentByStylename("fightLib.WeaponNameField");
            _loc7_.x = 39 + _loc3_ * 70;
            _loc7_.y = 107;
            _loc7_.text = _loc6_;
            addChild(_loc7_);
            _loc3_++;
