package fightLib.view
{
   ...
   public class FightLibGameView extends GameView
   {
      ...
      private var _frame:fightLib.view.FightLibQuestionFrame;
      ...
      private function __popupQuestionFrame(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc12_:PackageIn = param1.pkg;
         var _loc13_:Boolean = _loc12_.readBoolean();
         if(_loc13_)
         {
            _loc2_ = _loc12_.readInt();
            _loc3_ = _loc12_.readInt();
            _loc4_ = _loc12_.readInt();
            _loc5_ = _loc12_.readInt();
            _loc6_ = _loc12_.readInt();
            _loc7_ = _loc12_.readUTF();
            _loc8_ = _loc12_.readUTF();
            _loc9_ = _loc12_.readUTF();
            _loc10_ = _loc12_.readUTF();
            _loc11_ = _loc12_.readUTF();
            if(Boolean(this._frame))
            {
               this._frame.close();
            }
            this._frame = ComponentFactory.Instance.creatCustomObject("fightLib.view.FightLibQuestionFrame",[_loc2_,_loc7_,_loc3_,_loc4_,_loc5_,_loc8_,_loc9_,_loc10_,_loc11_,_loc6_]);
            this._frame.show();
         }
