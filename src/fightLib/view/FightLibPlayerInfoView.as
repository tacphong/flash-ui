package fightLib.view
{
   ...
   public class FightLibPlayerInfoView extends Sprite implements Disposeable
   {
      ...
      {
         if(Boolean(param1.changedProperties["Effectiveness"]) || Boolean(param1.changedProperties["DutyLevel"]) || Boolean(param1.changedProperties["ConsortiaName"]) || Boolean(param1.changedProperties["SpouseName"]) || Boolean(param1.changedProperties["Grade"]) || Boolean(param1.changedProperties["Repute"]))
         {
            this.update();
         }
      }
