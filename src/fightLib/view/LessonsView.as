package fightLib.view
{
   ...
   public class LessonsView extends Sprite implements Disposeable
   {
      ...
      private var _measureButton:fightLib.view.LessonButton;
      
      private var _twentyButton:fightLib.view.LessonButton;
      
      private var _sixtyFiveButton:fightLib.view.LessonButton;
      
      private var _highThrowButton:fightLib.view.LessonButton;
      
      private var _highGapButton:fightLib.view.LessonButton;
      
      private var _lassButton:fightLib.view.LessonButton;
      
      private var _levelGroup:SelectedButtonGroup;
      
      private var _lowButton:fightLib.view.LevelButton;
      
      private var _mediumButton:fightLib.view.LevelButton;
      
      private var _highButton:fightLib.view.LevelButton;
      ...
      private var _selectedLesson:fightLib.view.LessonButton;
      
      private var _selectedLevel:fightLib.view.LevelButton;
      
      private var _lessonButtons:Vector.<fightLib.view.LessonButton>;
      
      private var _levelButtons:Vector.<fightLib.view.LevelButton>;
      
      private var _sencondType:int = 3;
      
      private var _guildMovie:MovieClip;
      
      private var _awardView:fightLib.view.FightLibAwardView;
      ...
      {
         if(Boolean(param1.changedProperties["fightLibMission"]))
         {
            this.updateLessonButtonState();
            this.updateLevelButtonState();
            this.updateAward();
      ...
      {
         var _loc2_:fightLib.view.LevelButton = null;
         var _loc3_:fightLib.view.LessonButton = null;
      ...
      {
         var _loc2_:fightLib.view.LessonButton = null;
         var _loc3_:fightLib.view.LevelButton = null;
         var _loc4_:fightLib.view.LessonButton = param1.currentTarget as LessonButton;
         var _loc5_:int = _loc4_.type;
         SoundManager.instance.play("008");
         if(Boolean(this._selectedLesson) && this._selectedLesson.type == _loc5_)
         {
            return;
         }
         ...
         this.updateModel();
         this.updateLevelButtonState();
         if(_loc5_ == LessonType.Measure && FightLibManager.Instance.script && FightLibManager.Instance.script is FightLibGuideScripit)
         {
            FightLibManager.Instance.script.continueScript();
         }
      }
      ...
      {
         var _loc1_:fightLib.view.LessonButton = null;
      ...
      public function set selectedLesson(param1:fightLib.view.LessonButton) : void
      {
         var _loc2_:fightLib.view.LessonButton = this._selectedLesson;
         this._selectedLesson = param1;
         this._selectedLesson.selected = true;
         if(Boolean(_loc2_) && _loc2_ != this._selectedLesson)
         {
            _loc2_.selected = false;
         }
      }
      
      public function get selectedLesson() : fightLib.view.LessonButton
      {
         return this._selectedLesson;
      }
      
      public function set selectedLevel(param1:fightLib.view.LevelButton) : void
      {
         var _loc2_:fightLib.view.LevelButton = this._selectedLevel;
         this._selectedLevel = param1;
         this._selectedLevel.selected = true;
         if(Boolean(_loc2_) && _loc2_ != this._selectedLevel)
         {
            _loc2_.selected = false;
         }
      }
      
      public function get selectedLevel() : fightLib.view.LevelButton
      {
