package chickActivation.view
{
   ...
   public class ChickActivationViewFrame extends Frame
   {
      ...
      private var _priceView:chickActivation.view.ChickActivationCoinsView;
      ...
      private var _levelPacks:chickActivation.view.ChickActivationLevelPacks;
      
      private var _ativationItems:chickActivation.view.ChickActivationItems;
      ...
      private var totalPrestige:int = 0;
      ...
      private function initView() : void
      {
         ...
         this._helpTxt.text = "1.Có thể mua từ trang chủ hoặc shop trong game." + "\n" + "2.Code Gà Tân Binh và code Gà Đội Trưởng không thể sử dụng cùng lúc, code có thời hạn" + "\n" + "60 ngày." + "\n" + "3.Kích hoạt thành công mỗi ngày, mỗi tuần đều có phần thưởng phong phú, 3 ngày cuối" + "\n" + "tuần cũng có thể nhận thưởng.";
         ...
         while(_loc2_ < 4)
         {
            _loc1_ = ClassUtils.CreatInstance("assets.chickActivation.promptMovie");
            PositionUtils.setPos(_loc1_,"chickActivation.promptMoviePos" + _loc2_);
            _loc1_.mouseChildren = false;
            _loc1_.mouseEnabled = false;
            _loc1_.visible = false;
            addToContent(_loc1_);
            this._promptMovies.push(_loc1_);
            _loc2_++;
         }
      ...
      private function updateShine() : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:Array = ChickActivationManager.instance.model.gainArr;
         var _loc15_:int = ChickActivationManager.instance.model.getRemainingDay();
         if(ChickActivationManager.instance.model.isKeyOpened > 0 && ChickActivationManager.instance.model.keyOpenedType == this._group.selectIndex + 1 && _loc15_ > 0)
         {
            if(Boolean(_loc14_) && _loc14_.length > 0)
            {
               _loc3_ = TimeManager.Instance.Now().day;
               if(_loc3_ == 0)
               {
                  _loc3_ = 7;
               }
               _loc1_ = _loc3_ - 1;
               _loc4_ = int(_loc14_[_loc1_]);
               if(_loc4_ <= 0)
               {
                  _loc5_ = true;
               }
               MovieClip(this._promptMovies[0]).visible = _loc5_;
               MovieClip(this._promptMovies[1]).visible = _loc14_[10] <= 0;
               if(_loc3_ == 5)
               {
                  _loc1_ = 7;
               }
               ...
               if(_loc1_ > 6)
               {
                  _loc7_ = int(_loc14_[_loc1_]);
                  if(_loc7_ <= 0)
                  {
                     _loc6_ = true;
                  }
               }
               MovieClip(this._promptMovies[2]).visible = _loc6_;
               if(this._group.selectIndex == 0)
               {
                  _loc8_ = -1;
                  _loc9_ = PlayerManager.Instance.Self.Grade;
                  _loc10_ = 0;
                  while(_loc10_ < this._levelPacks.packsLevelArr.length)
                  {
                     if(this._levelPacks.packsLevelArr[_loc10_].level <= _loc9_)
                     {
                        _loc8_ = _loc10_;
                     }
                     _loc10_++;
                  ...
                  {
                     _loc12_ = ChickActivationManager.instance.model.getGainLevel(_loc11_ + 1);
                     if(!_loc12_)
                     {
                        _loc2_ = true;
                        break;
                  ...
                  MovieClip(this._promptMovies[3]).visible = _loc2_;
               }
               else
               {
                  MovieClip(this._promptMovies[3]).visible = false;
         ...
         {
            _loc13_ = 0;
            while(_loc13_ < this._promptMovies.length)
            {
               MovieClip(this._promptMovies[_loc13_]).visible = false;
               _loc13_++;
            }
         }
      }
      ...
      private function updateGetBtn() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:int = ChickActivationManager.instance.model.getRemainingDay();
         if(ChickActivationManager.instance.model.isKeyOpened > 0 && ChickActivationManager.instance.model.keyOpenedType == this._group.selectIndex + 1 && _loc4_ > 0)
         {
            _loc1_ = ChickActivationManager.instance.model.gainArr;
            _loc2_ = this.getNowGainArrIndex();
      ...
      private function __getRewardHandler(param1:ChickActivationEvent) : void
      {
         ...
         var _loc5_:int = int(ChickActivationManager.instance.model.qualityDic[_loc3_]);
      ...
      private function updatePriceView() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:ChickActivationInfo = null;
         var _loc5_:int = ChickActivationManager.instance.model.findQualityValue(this.getQualityKey());
         if(ChickActivationManager.instance.model.itemInfoList.hasOwnProperty(_loc5_))
         {
            _loc2_ = ChickActivationManager.instance.model.itemInfoList[_loc5_];
            _loc3_ = 0;
            while(_loc3_ < _loc2_.length)
            {
               _loc4_ = ChickActivationInfo(_loc2_[_loc3_]);
               _loc1_ += _loc4_.Probability;
               _loc3_++;
            }
         }
      ...
      {
         var _loc1_:Array = null;
         var _loc2_:Array = ChickActivationManager.instance.model.itemInfoList;
         var _loc3_:Dictionary = ChickActivationManager.instance.model.qualityDic;
         var _loc4_:int = ChickActivationManager.instance.model.findQualityValue(this.getQualityKey());
         if(_loc2_.hasOwnProperty(_loc4_))
         {
            _loc1_ = _loc2_[_loc4_];
            this._ativationItems.update(_loc1_);
         }
         else
         {
      ...
      private function playDropGoodsMovie(param1:Array) : void
      {
         ...
         var _loc3_:Point = ComponentFactory.Instance.creatCustomObject("chickActivation.dropGoodsBeginPos");
         var _loc4_:Point = ComponentFactory.Instance.creatCustomObject("chickActivation.dropGoodsEndPos");
         var _loc5_:Array = [];
         var _loc6_:int = 0;
         while(_loc6_ < this._ativationItems.arrData.length)
         {
            _loc2_ = ChickActivationManager.instance.model.getInventoryItemInfo(this._ativationItems.arrData[_loc6_]);
            if(Boolean(_loc2_))
            {
               _loc5_.push(_loc2_);
            }
         ...
         DropGoodsManager.play(_loc5_,_loc3_,_loc4_,true);
      }
      
      private function getQualityKey() : String
      {
         var _loc1_:int = 0;
         var _loc2_:int = this._group.selectIndex;
         var _loc3_:int = this._groupTwo.selectIndex;
      ...
      private function __clickLevelPacksHandler(param1:ChickActivationEvent) : void
      {
         ...
         var _loc4_:int = int(param1.resultData);
         var _loc5_:Array = ServerConfigManager.instance.chickenActiveKeyLvAwardNeedPrestige;
         if(Boolean(_loc5_) && _loc5_.length > 0)
         {
            _loc2_ = int(_loc5_[_loc4_ - 1]);
            _loc3_ = this.totalPrestige;
            if(_loc3_ < _loc2_)
            {
               MessageTipManager.getInstance().show(LanguageMgr.GetTranslation("tank.chickActivation.totalPrestigeMsg",_loc2_));
               return;
            }
         }
         SocketManager.Instance.out.sendChickActivationGetAward(12,_loc4_);
      }
