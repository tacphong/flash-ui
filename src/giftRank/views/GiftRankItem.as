package giftRank.views
{
   ...
   public class GiftRankItem extends Sprite implements Disposeable
   {
      ...
      private var vo:GiftRankVo;
      
      public function GiftRankItem(param1:int)
      {
         super();
         this.index = param1;
         this.initView();
      ...
      public function setData(param1:GiftRankVo, param2:GiftBagInfo) : void
      {
