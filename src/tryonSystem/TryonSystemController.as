package tryonSystem
{
   ...
   public class TryonSystemController
   {
      ...
      private static var _instance:tryonSystem.TryonSystemController;
      ...
      public static function get Instance() : tryonSystem.TryonSystemController
      {
         if(_instance == null)
         {
            _instance = new tryonSystem.TryonSystemController();
         }
         return _instance;
      }
      
      public function get model() : tryonSystem.TryonModel
      {
         return this._model;
      }
      ...
      {
         this._model = new tryonSystem.TryonModel(param1);
