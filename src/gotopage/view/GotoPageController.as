package gotopage.view
{
   ...
   public class GotoPageController
   {
      ...
      private static var _instance:gotopage.view.GotoPageController;
       
      
      public var _gotoPageView:gotopage.view.GotoPageView;
      ...
      public static function get Instance() : gotopage.view.GotoPageController
      {
         if(_instance == null)
         {
            _instance = new gotopage.view.GotoPageController();
         }
         return _instance;
      }
