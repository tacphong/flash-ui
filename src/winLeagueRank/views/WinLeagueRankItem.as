package winLeagueRank.views
{
   ...
   public class WinLeagueRankItem extends Sprite implements Disposeable
   {
      ...
      private var vo:WinLeagueRankVo;
      
      public function WinLeagueRankItem(param1:int)
      {
         super();
         this.index = param1;
         this.initView();
      ...
      public function setData(param1:WinLeagueRankVo, param2:GiftBagInfo) : void
      {
