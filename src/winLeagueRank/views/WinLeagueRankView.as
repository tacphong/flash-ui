package winLeagueRank.views
{
   ...
   import winLeagueRank.data.WinLeagueRankVo;
   import wonderfulActivity.WonderfulActivityManager;
   import wonderfulActivity.data.GmActivityInfo;
   import wonderfulActivity.views.IRightView;
   
   public class WinLeagueRankView extends Sprite implements IRightView
   {
      ...
      public function WinLeagueRankView()
      {
         super();
      }
      ...
      {
         WinLeagueRankManager.instance.view = this;
         this.initView();
         this.updateView();
         this.initTimer();
      }
      ...
      {
         this._bg = ComponentFactory.Instance.creat("wonderfulactivity.winLeagueRank.bg");
         addChild(this._bg);
         ...
         this._rankLabelTxt.text = LanguageMgr.GetTranslation("winLeagueRank.rankLabel",5000);
      ...
      public function updateView() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:WinLeagueRankVo = null;
         var _loc3_:GmActivityInfo = WinLeagueRankManager.instance.xmlData;
         ...
         this._checkBg.tipData = LanguageMgr.GetTranslation("winLeagueRank.helpTxt",_loc3_.remain2);
         _loc6_ = WinLeagueRankManager.instance.rankList;
         _loc1_ = WinLeagueRankManager.instance.myConsume;
         this._myRank = -1;
         var _loc7_:int = 0;
         while(_loc7_ <= _loc6_.length - 1)
         {
            _loc2_ = _loc6_[_loc7_] as WinLeagueRankVo;
         ...
         if(this._myRank >= 0)
         {
            ...
            else
            {
               ...
               _loc8_ = (_loc6_[this._myRank - 1] as WinLeagueRankVo).consume - _loc1_ + 1;
               this._rankLabelTxt.text = LanguageMgr.GetTranslation("winLeagueRank.rankLabel",_loc8_);
            }
            if(WinLeagueRankManager.instance.status == 2)
            {
               this._rankLabelTxt.visible = true;
         ...
         else
         {
            ...
            if(_loc6_.length > 0)
            {
               _loc8_ = (_loc6_[_loc6_.length - 1] as WinLeagueRankVo).consume - _loc1_ + 1;
            }
            else
            {
               _loc8_ = 1;
            ...
            this._rankLabelTxt.text = LanguageMgr.GetTranslation("winLeagueRank.outOfRankLabel",_loc1_,_loc8_);
            if(WinLeagueRankManager.instance.status == 2)
            {
               this._rankLabelTxt.visible = true;
               this._rankLabelTxt.textColor = 16711680;
      ...
      {
         var _loc1_:WinLeagueRankItem = null;
         var _loc2_:Array = WinLeagueRankManager.instance.rankList;
         var _loc3_:Array = WinLeagueRankManager.instance.xmlData.giftbagArray;
         this._vbox.removeAllChild();
         var _loc4_:int = 0;
         while(_loc4_ <= _loc2_.length - 1)
         {
            _loc1_ = new WinLeagueRankItem(_loc4_);
      ...
      {
         var _loc1_:Date = DateUtils.getDateByStr(WinLeagueRankManager.instance.xmlData.endTime);
      ...
      {
         WinLeagueRankManager.instance.view = null;
         WonderfulActivityManager.Instance.delTimerFun("consumeRank");
