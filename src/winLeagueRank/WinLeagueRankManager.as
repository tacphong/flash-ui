package winLeagueRank
{
   ...
   public class WinLeagueRankManager
   {
      
      private static var _instance:winLeagueRank.WinLeagueRankManager;
      ...
      public var view:WinLeagueRankView;
      ...
      public function WinLeagueRankManager()
      {
         super();
      }
      
      public static function get instance() : winLeagueRank.WinLeagueRankManager
      {
         if(!_instance)
         {
            _instance = new winLeagueRank.WinLeagueRankManager();
         }
         return _instance;
      }
      ...
      {
         SocketManager.Instance.addEventListener(WinLeagueRankEvent.UPDATE,this.__updateInfo);
      }
      
      protected function __updateInfo(param1:WinLeagueRankEvent) : void
      {
         var _loc2_:* = 0;
         var _loc3_:* = 0;
         var _loc4_:WinLeagueRankVo = null;
         ...
         if(_loc6_)
         {
            ...
            {
               _loc8_[this.actId] = new LeftViewInfoVo(ActivityType.WIN_LEAGUE_RANK,"· " + this.xmlData.activityName,this.xmlData.icon);
