package firstRecharge
{
   ...
   public class FirstRechargeManager extends EventDispatcher
   {
      ...
      private static var _instance:firstRecharge.FirstRechargeManager;
      ...
      private var _frame:firstRecharge.FirstRechargeFrame;
      ...
      public static function get instance() : firstRecharge.FirstRechargeManager
      {
         if(_instance == null)
         {
            _instanceClass = new firstRechargeInstanceClass();
            _instance = new firstRecharge.FirstRechargeManager(_instanceClass);
         }
         return _instance;
      }
      ...
      {
         if(Boolean(this._icon) && Boolean(this._icon.parent))
         {
...
class firstRechargeInstanceClass
{
   ...
   public function firstRechargeInstanceClass()
   {
      super();
   }
}
