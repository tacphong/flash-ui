package newChickenBox.view
{
   ...
   public class NewChickenBoxItem extends Sprite
   {
      ...
      private var _cell:newChickenBox.view.NewChickenBoxCell;
      ...
      public function NewChickenBoxItem(param1:newChickenBox.view.NewChickenBoxCell, param2:MovieClip)
      {
         super();
         this._cell = param1;
         this._bg = param2;
      ...
      public function get cell() : newChickenBox.view.NewChickenBoxCell
      {
         return this._cell;
      }
      
      public function set cell(param1:newChickenBox.view.NewChickenBoxCell) : void
      {
