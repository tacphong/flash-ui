package newChickenBox.model
{
   ...
   public class NewChickenBoxModel extends EventDispatcher
   {
      ...
      private static var _instance:newChickenBox.model.NewChickenBoxModel = null;
      ...
      public static function get instance() : newChickenBox.model.NewChickenBoxModel
      {
         if(_instance == null)
         {
            _instance = new newChickenBox.model.NewChickenBoxModel();
         }
         return _instance;
      }
