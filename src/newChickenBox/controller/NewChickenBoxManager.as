package newChickenBox.controller
{
   ...
   public class NewChickenBoxManager extends EventDispatcher
   {
      ...
      private static var _instance:newChickenBox.controller.NewChickenBoxManager = null;
      ...
      public static function get instance() : newChickenBox.controller.NewChickenBoxManager
      {
         if(_instance == null)
         {
            _instance = new newChickenBox.controller.NewChickenBoxManager();
         }
         return _instance;
      }
      ...
      private function __getItem(param1:CrazyTankSocketEvent) : void
      {
         ...
         this._model.lastFlushTime = _loc3_.readDate();
         this._model.freeFlushTime = _loc3_.readInt();
         this._model.freeRefreshBoxCount = _loc3_.readInt();
         this._model.freeEyeCount = _loc3_.readInt();
         this._model.freeOpenCardCount = _loc3_.readInt();
         this._model.isShowAll = _loc3_.readBoolean();
         this._model.boxCount = _loc3_.readInt();
         var _loc4_:int = 0;
         while(_loc4_ < this._model.boxCount)
         {
            ...
            _loc2_.Position = _loc3_.readInt();
            _loc2_.IsSelected = _loc3_.readBoolean();
            _loc2_.IsSeeded = _loc3_.readBoolean();
            ...
            if(this._model.isShowAll)
            {
               if(this.firstEnter)
               {
                  ...
                  {
                     this._model.templateIDList[_loc4_] = _loc2_;
                  }
                  else
                  {
                     this._model.templateIDList.push(_loc2_);
                  }
                  this._model.countTime = 0;
                  this._model.countEye = 0;
               }
      ...
      private function __openCard(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc3_:PackageIn = param1.pkg;
         var _loc4_:NewChickenBoxGoodsTempInfo = new NewChickenBoxGoodsTempInfo();
         _loc4_.TemplateID = _loc3_.readInt();
         _loc4_.info = ItemManager.Instance.getTemplateById(_loc4_.TemplateID);
         _loc4_.StrengthenLevel = _loc3_.readInt();
         _loc4_.Count = _loc3_.readInt();
         _loc4_.ValidDate = _loc3_.readInt();
         _loc4_.AttackCompose = _loc3_.readInt();
         _loc4_.DefendCompose = _loc3_.readInt();
         _loc4_.AgilityCompose = _loc3_.readInt();
         _loc4_.LuckCompose = _loc3_.readInt();
         _loc4_.Position = _loc3_.readInt();
         _loc4_.IsSelected = _loc3_.readBoolean();
         _loc4_.IsSeeded = _loc3_.readBoolean();
         _loc4_.IsBinds = _loc3_.readBoolean();
         this._model.freeOpenCardCount = _loc3_.readInt();
         var _loc5_:Sprite = new Sprite();
         _loc5_.graphics.beginFill(16777215,0);
         _loc5_.graphics.drawRect(0,0,39,39);
         _loc5_.graphics.endFill();
         var _loc6_:NewChickenBoxCell = new NewChickenBoxCell(_loc5_,_loc4_.info);
         if(_loc4_.IsSelected)
         {
            _loc2_ = ClassUtils.CreatInstance("asset.newChickenBox.chickenOver") as MovieClip;
         }
         else if(_loc4_.IsSeeded)
         {
            _loc2_ = ClassUtils.CreatInstance("asset.newChickenBox.chicken360") as MovieClip;
         }
         var _loc7_:NewChickenBoxItem = new NewChickenBoxItem(_loc6_,_loc2_);
         _loc7_.info = _loc4_;
         _loc7_.position = _loc4_.Position;
         this.newChickenBoxFrame.newBoxView.removeChild(this._model.itemList[_loc4_.Position]);
         this._model.itemList[_loc4_.Position] = _loc7_;
         this.newChickenBoxFrame.newBoxView.addChild(this._model.itemList[_loc4_.Position]);
         this._model.itemList[_loc4_.Position].bg = _loc2_;
         this._model.itemList[_loc4_.Position].cell = _loc6_;
         this._model.itemList[_loc4_.Position].cell.visible = false;
         var _loc8_:String = "newChickenBox.itemPos" + _loc4_.Position;
         PositionUtils.setPos(this._model.itemList[_loc4_.Position],_loc8_);
         ++this._model.countTime;
