package inviteFriends
{
   ...
   public class InviteFriendsManager extends EventDispatcher
   {
      ...
      private static var _instance:inviteFriends.InviteFriendsManager;
      ...
      public static function get Instance() : inviteFriends.InviteFriendsManager
      {
         if(_instance == null)
         {
            _instance = new inviteFriends.InviteFriendsManager();
         }
         return _instance;
      }
