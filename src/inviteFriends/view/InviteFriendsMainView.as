package inviteFriends.view
{
   ...
   public class InviteFriendsMainView extends Frame
   {
      ...
      private var _rewardItem1:inviteFriends.view.InviteFriendItem;
      
      private var _rewardItem2:inviteFriends.view.InviteFriendItem;
      
      private var _rewardItem3:inviteFriends.view.InviteFriendItem;
      
      private var _rewardItem4:inviteFriends.view.InviteFriendItem;
      ...
      {
         this._rewardItem1 = new inviteFriends.view.InviteFriendItem();
         ...
         this._rewardItem2 = new inviteFriends.view.InviteFriendItem();
         ...
         this._rewardItem3 = new inviteFriends.view.InviteFriendItem();
         ...
         this._rewardItem4 = new inviteFriends.view.InviteFriendItem();
