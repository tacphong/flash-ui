package petsBag.petsAdvanced
{
   ...
   public class PetsAdvancedManager extends EventDispatcher
   {
      ...
      private static var _instance:petsBag.petsAdvanced.PetsAdvancedManager;
      ...
      public var frame:petsBag.petsAdvanced.PetsAdvancedFrame;
      ...
      public static function get Instance() : petsBag.petsAdvanced.PetsAdvancedManager
      {
         if(_instance == null)
         {
            _instance = new petsBag.petsAdvanced.PetsAdvancedManager();
         }
         return _instance;
      }
