package petsBag.view
{
   ...
   public class AdoptPetsView extends Frame
   {
      ...
      private var _refreshPetPnl:petsBag.view.RefreshPetAlertFrame;
      ...
      {
         this._adoptItemBtn.enable = this._adoptBtn.enable = this._petsImgVec.length > 0 && Boolean(this.currentPet) ? Boolean(true) : Boolean(false);
      ...
      private function removeItemByPetInfo(param1:PetInfo) : void
      {
         ...
         {
            if(Boolean(this._petsImgVec[_loc2_].info))
            {
      ...
      private function removeItemByPlace(param1:int) : void
      {
         ...
         while(_loc2_ < this._petsImgVec.length)
         {
            if(Boolean(this._petsImgVec[_loc2_].itemInfo) && param1 == this._petsImgVec[_loc2_].place)
            {
               this._petsImgVec[_loc2_].removeEventListener(PetItemEvent.ITEM_CLICK,this.__petItemClick);
               this._petsImgVec[_loc2_].dispose();
               this._petsImgVec[_loc2_] = null;
      ...
      private function setSelectUnSelect(param1:AdoptItem, param2:Boolean = false) : void
      {
         ...
         {
            if(Boolean(this._petsImgVec[_loc3_]) && this._petsImgVec[_loc3_] != param1)
            {
      ...
      private function __updateRefreshPet(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc7_:PetSkill = null;
         var _loc8_:int = 0;
         var _loc9_:AdoptItemInfo = null;
         var _loc10_:PackageIn = param1.pkg;
         var _loc11_:Boolean = _loc10_.readBoolean();
         ...
         while(_loc13_ < _loc12_)
         {
            if(_loc11_)
            {
               ...
               _loc3_ = _loc10_.readInt();
               _loc4_ = new PetInfo();
               _loc4_.TemplateID = _loc3_;
               PetInfoManager.fillPetInfo(_loc4_);
               _loc4_.Name = _loc10_.readUTF();
               _loc4_.Attack = _loc10_.readInt();
               _loc4_.Defence = _loc10_.readInt();
               _loc4_.Luck = _loc10_.readInt();
               _loc4_.Agility = _loc10_.readInt();
               _loc4_.Blood = _loc10_.readInt();
               _loc4_.Damage = _loc10_.readInt();
               _loc4_.Guard = _loc10_.readInt();
               _loc4_.AttackGrow = _loc10_.readInt();
               _loc4_.DefenceGrow = _loc10_.readInt();
               _loc4_.LuckGrow = _loc10_.readInt();
               _loc4_.AgilityGrow = _loc10_.readInt();
               _loc4_.BloodGrow = _loc10_.readInt();
               _loc4_.DamageGrow = _loc10_.readInt();
               _loc4_.GuardGrow = _loc10_.readInt();
               _loc4_.Level = _loc10_.readInt();
               _loc4_.GP = _loc10_.readInt();
               _loc4_.MaxGP = _loc10_.readInt();
               _loc4_.Hunger = _loc10_.readInt();
               _loc4_.MP = _loc10_.readInt();
               _loc5_ = _loc10_.readInt();
               _loc6_ = 0;
               while(_loc6_ < _loc5_)
               {
                  _loc8_ = _loc10_.readInt();
                  _loc7_ = new PetSkill(_loc8_);
                  _loc4_.addSkill(_loc7_);
                  _loc10_.readInt();
                  _loc6_++;
               }
               _loc4_.MaxActiveSkillCount = _loc10_.readInt();
               _loc4_.MaxStaticSkillCount = _loc10_.readInt();
               _loc4_.MaxSkillCount = _loc10_.readInt();
               _loc4_.Place = _loc2_;
               if(_loc4_.Place != -1)
               {
                  PetBagController.instance().petModel.adoptPets.add(_loc4_.Place,_loc4_);
               }
               else
               {
                  PetBagController.instance().newPetInfo = _loc4_;
               }
            }
            else
            {
         ...
         _loc12_ = _loc10_.readInt();
         var _loc14_:int = 0;
         while(_loc14_ < _loc12_)
         {
            _loc9_ = new AdoptItemInfo();
            _loc9_.place = _loc10_.readInt();
            _loc9_.itemTemplateId = _loc10_.readInt();
            _loc9_.itemAmount = _loc10_.readInt();
            PetBagController.instance().petModel.adoptItems.add(_loc9_.place,_loc9_);
            _loc14_++;
         }
