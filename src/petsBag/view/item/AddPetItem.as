package petsBag.view.item
{
   ...
   public class AddPetItem extends Component
   {
      ...
      protected var _petIcon:petsBag.view.item.PetSmallIcon;
      
      protected var _icon:Bitmap;
      
      protected var _star:petsBag.view.item.StarBar;
      ...
      protected function initView() : void
      {
         ...
         {
            this._petIcon = new petsBag.view.item.PetSmallIcon(PetBagController.instance().getPicStrByLv(this._info));
