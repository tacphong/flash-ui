package petsBag.view
{
   ...
   public class PetsBagView extends Sprite implements Disposeable
   {
      ...
      protected var _petMoveScroll:petsBag.view.PetMoveScroll;
      ...
      protected var _showPet:petsBag.view.ShowPet;
      
      protected var _happyBarPet:petsBag.view.PetHappyBar;
      
      protected var _petExpProgress:petsBag.view.PetExpProgress;
      
      protected var _petSkillPnl:petsBag.view.PetSkillPnl;
      ...
      protected function initView() : void
      {
         ...
         this._petMoveScroll = new petsBag.view.PetMoveScroll();
      ...
      public function updatePetBagView() : void
      {
         ...
         this._petExpProgress.setProgress(Boolean(_loc1_) ? Number(_loc1_.GP) : Number(0),Boolean(_loc1_) ? Number(_loc1_.MaxGP) : Number(0));
         this.updatePetsPropByEvolution();
      ...
      public function updatePetsPropByEvolution() : void
      {
         ...
         for each(_loc1_ in PetsAdvancedManager.Instance.evolutionDataList)
         {
            ...
            if(_loc1_.ID == this._infoPlayer.evolutionGrade)
            {
         ...
         if(Boolean(_loc2_))
         {
            this._attackPbtn.propValue = _loc2_.IsEquip ? int(_loc2_.Attack + this._currentGradeInfo.Attack) : int(_loc2_.Attack);
            this._defencePbtn.propValue = _loc2_.IsEquip ? int(_loc2_.Defence + this._currentGradeInfo.Defence) : int(_loc2_.Defence);
            this._HPPbtn.propValue = _loc2_.IsEquip ? int(_loc2_.Blood + this._currentGradeInfo.Blood) : int(_loc2_.Blood);
            this._agilityPbtn.propValue = _loc2_.IsEquip ? int(_loc2_.Agility + this._currentGradeInfo.Agility) : int(_loc2_.Agility);
            this._luckPbtn.propValue = _loc2_.IsEquip ? int(_loc2_.Luck + this._currentGradeInfo.Lucky) : int(_loc2_.Luck);
         }
      }
      ...
      protected function updatePropertyTip() : void
      {
         if(Boolean(this._currentPet) && Boolean(this._currentGradeInfo))
         {
            ...
            this._attackPbtn.addedPropValue = this._currentPet.IsEquip ? int(this._currentGradeInfo.Attack) : int(0);
            this._defencePbtn.currentPropValue = this._currentPet.Defence;
            this._defencePbtn.addedPropValue = this._currentPet.IsEquip ? int(this._currentGradeInfo.Defence) : int(0);
            this._agilityPbtn.currentPropValue = this._currentPet.Agility;
            this._agilityPbtn.addedPropValue = this._currentPet.IsEquip ? int(this._currentGradeInfo.Agility) : int(0);
            this._luckPbtn.currentPropValue = this._currentPet.Luck;
            this._luckPbtn.addedPropValue = this._currentPet.IsEquip ? int(this._currentGradeInfo.Lucky) : int(0);
            this._HPPbtn.currentPropValue = this._currentPet.Blood;
            this._HPPbtn.addedPropValue = this._currentPet.IsEquip ? int(this._currentGradeInfo.Blood) : int(0);
      ...
      protected function disableAllObj() : void
      {
         ...
         while(_loc2_ < this.numChildren)
         {
            ...
            {
               this.disableObj(_loc1_ as InteractiveObject);
            }
            _loc2_++;
         }
      }
