package petsBag.view
{
   ...
   public class AdoptPetsGuideView extends Frame
   {
      ...
      {
         this._adoptBtn.enable = this._petsImgVec.length > 0 && Boolean(this.currentPet) ? Boolean(true) : Boolean(false);
      }
      ...
      private function __updateRefreshPet(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc10_:Boolean = _loc9_.readBoolean();
         ...
         while(_loc12_ < _loc11_)
         {
            if(_loc10_)
            {
               ...
               _loc4_.Name = _loc9_.readUTF();
               _loc4_.Attack = _loc9_.readInt();
               _loc4_.Defence = _loc9_.readInt();
               _loc4_.Luck = _loc9_.readInt();
               _loc4_.Agility = _loc9_.readInt();
               _loc4_.Blood = _loc9_.readInt();
               _loc4_.Damage = _loc9_.readInt();
               _loc4_.Guard = _loc9_.readInt();
               _loc4_.AttackGrow = _loc9_.readInt();
               _loc4_.DefenceGrow = _loc9_.readInt();
               _loc4_.LuckGrow = _loc9_.readInt();
               _loc4_.AgilityGrow = _loc9_.readInt();
               _loc4_.BloodGrow = _loc9_.readInt();
               _loc4_.DamageGrow = _loc9_.readInt();
               _loc4_.GuardGrow = _loc9_.readInt();
               _loc4_.Level = _loc9_.readInt();
               _loc4_.GP = _loc9_.readInt();
               _loc4_.MaxGP = _loc9_.readInt();
               _loc4_.Hunger = _loc9_.readInt();
               _loc4_.MP = _loc9_.readInt();
               ...
               _loc4_.MaxActiveSkillCount = _loc9_.readInt();
               _loc4_.MaxStaticSkillCount = _loc9_.readInt();
               _loc4_.MaxSkillCount = _loc9_.readInt();
               _loc4_.Place = _loc2_;
               if(_loc4_.Place != -1)
               {
      ...
      private function __refreshPet(param1:MouseEvent) : void
      {
         ...
         SoundManager.instance.play("008");
         var _loc3_:int = int(LanguageMgr.GetTranslation("ddt.pet.refreshNeed"));
         var _loc4_:Number = PlayerManager.Instance.Self.Money;
         if(PlayerManager.Instance.Self.Money < _loc3_ && int(this._refreshVolumeTxt.text) <= 0)
         {
