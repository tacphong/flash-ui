package ddt.command
{
   ...
   public class QuickBuyFrameView extends Sprite implements Disposeable
   {
      ...
      private var _number:ddt.command.NumberSelecter;
      ...
      private function initView() : void
      {
         ...
         addChild(_loc1_);
         var _loc3_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.core.QuickBuyMoneyTip");
         addChild(_loc3_);
         this._number = ComponentFactory.Instance.creatCustomObject("core.numberSelecter");
         addChild(this._number);
         _loc2_ = new Sprite();
         _loc2_.addChild(ComponentFactory.Instance.creatBitmap("asset.core.EquipCellBG"));
      ...
      private function refreshNumText() : void
      {
         ...
         {
            case 0:
               this._price = this._shopItem == null ? int(0) : int(this._shopItem.getItemPrice(1).moneyValue);
               ...
               break;
            case 1:
               this._price = this._shopItem == null ? int(0) : int(this._shopItem.getItemPrice(1).hardCurrencyValue);
               ...
               break;
            case 2:
               this._price = this._shopItem == null ? int(0) : int(this._shopItem.getItemPrice(1).gesteValue);
               this.totalText.text = String(this._stoneNumber * this._price) + LanguageMgr.GetTranslation("gongxun");
               break;
            case 3:
               this._price = this._shopItem == null ? int(0) : int(this._shopItem.getItemPrice(this._time).moneyValue);
               if(this._isBand)
               {
               ...
               break;
            case 5:
               this._price = this._shopItem == null ? int(0) : int(this._shopItem.getItemPrice(1).scoreValue);
      ...
      {
         this._bandMoney.visible = this._selectedBandBtn.visible = false;
         this._moneyTxt.x += 50;
      ...
      {
         this._moneyTxt.visible = this._selectedBtn.visible = false;
