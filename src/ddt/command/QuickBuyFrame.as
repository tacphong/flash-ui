package ddt.command
{
   ...
   public class QuickBuyFrame extends Frame
   {
      ...
      private var _view:ddt.command.QuickBuyFrameView;
      ...
      {
         this._view = new ddt.command.QuickBuyFrameView();
      ...
      private function doPay(param1:Event) : void
      {
         ...
         var _loc10_:ItemTemplateInfo = ItemManager.Instance.getTemplateById(this._view._itemID);
         if(_loc10_.CategoryID == 11)
         {
            if(_loc10_.TemplateID == 100100)
            {
