package ddt.manager
{
   ...
   public class SelectListManager
   {
      ...
      private static var _instance:ddt.manager.SelectListManager;
      ...
      public static function get Instance() : ddt.manager.SelectListManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.SelectListManager();
         }
         return _instance;
      }
