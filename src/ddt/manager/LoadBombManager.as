package ddt.manager
{
   ...
   public class LoadBombManager
   {
      ...
      private static var _instance:ddt.manager.LoadBombManager;
      ...
      public static function get Instance() : ddt.manager.LoadBombManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.LoadBombManager();
         }
         return _instance;
      }
