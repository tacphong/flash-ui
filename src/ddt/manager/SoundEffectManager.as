package ddt.manager
{
   ...
   public class SoundEffectManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.SoundEffectManager;
      ...
      public static function get Instance() : ddt.manager.SoundEffectManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.SoundEffectManager();
         }
         return _instance;
      }
