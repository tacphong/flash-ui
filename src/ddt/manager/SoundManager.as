package ddt.manager
{
   ...
   public class SoundManager
   {
      ...
      private static var _instance:ddt.manager.SoundManager;
      ...
      public static function get instance() : ddt.manager.SoundManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.SoundManager();
         }
         return _instance;
      }
      ...
      {
         var _loc2_:* = null;
         var _loc3_:SoundChannel = param1.currentTarget as SoundChannel;
         _loc3_.removeEventListener(Event.SOUND_COMPLETE,this.__soundComplete);
         _loc3_.stop();
         for(_loc2_ in this._currentSound)
         {
            if(this._currentSound[_loc2_] == _loc3_)
            {
               this._currentSound[_loc2_] = null;
               return;
            }
         }
      }
      ...
      {
         if(Boolean(this._currentSound[param1]))
         {
      ...
      {
         return this._currentSound[param1] == null ? Boolean(false) : Boolean(true);
      }
