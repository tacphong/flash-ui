package ddt.manager
{
   public class StatisticManager
   {
      ...
      private static var _instance:ddt.manager.StatisticManager;
      ...
      public static function Instance() : ddt.manager.StatisticManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.StatisticManager();
         }
         return _instance;
      }
