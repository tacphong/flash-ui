package ddt.manager
{
   ...
   public class RouletteManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.RouletteManager = null;
      ...
      public static function get instance() : ddt.manager.RouletteManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.RouletteManager();
         }
         return _instance;
      }
      ...
      private function _showRoultteView(param1:CrazyTankSocketEvent) : void
      {
         ...
         while(_loc4_ < 18)
         {
            try
            {
               ...
               _loc2_.IsBind = _loc3_.readBoolean();
               _loc2_.ItemCount = _loc3_.readByte();
               _loc2_.ItemValid = _loc3_.readByte();
      ...
      private function _randomTemplateID() : void
      {
         ...
         while(_loc3_ < this._templateIDList.length)
         {
            ...
            _loc2_ = this._templateIDList[_loc3_] as BoxGoodsTempInfo;
            this._templateIDList[_loc3_] = this._templateIDList[_loc1_];
            this._templateIDList[_loc1_] = _loc2_;
            _loc3_++;
         }
      }
      ...
      private function __getBadLuckHandler(param1:CrazyTankSocketEvent) : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            _loc2_["Count"] = _loc4_.readInt();
            _loc2_["TemplateID"] = _loc4_.readInt();
            _loc2_["Nickname"] = _loc4_.readUTF();
            this.dataList.push(_loc2_);
            _loc7_++;
         }
         if(_loc6_ == 0 || this.dataList[0].TemplateID == 0)
         {
            _loc3_ = new CaddyEvent(CaddyEvent.UPDATE_BADLUCK);
            _loc3_.lastTime = _loc5_;
            _loc3_.dataList = this.dataList;
            dispatchEvent(_loc3_);
         }
