package ddt.manager
{
   ...
   public class AcademyManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.AcademyManager;
      ...
      public static function get Instance() : ddt.manager.AcademyManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.AcademyManager();
         }
         return _instance;
      }
      ...
      private function __apprenticeSystemAnswer(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc16_:int = param1.pkg.readByte();
         switch(_loc16_)
         {
            case AcademyPackageType.ACADEMY_FOR_APPRENTICE:
               ...
               AcademyFrameManager.Instance.showAcademyAnswerMasterFrame(_loc2_,_loc3_,_loc4_);
               break;
            case AcademyPackageType.ACADEMY_FOR_MASTER:
               ...
               AcademyFrameManager.Instance.showAcademyAnswerApprenticeFrame(_loc5_,_loc6_,_loc7_);
               break;
            case AcademyPackageType.UPDATE_APP_STATES:
               ...
               if(Boolean(this._myAcademyPlayers) && _loc8_ != -1)
               {
                  this._myAcademyPlayers.remove(_loc8_);
               }
            ...
            case AcademyPackageType.APPRENTICESHIPSYSTEM_ALERT:
               ...
               _loc15_ = param1.pkg.readBoolean();
               this.academyAlert(_loc14_,_loc15_);
         }
      }
