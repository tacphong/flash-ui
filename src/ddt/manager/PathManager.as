package ddt.manager
{
   ...
   public class PathManager
   {
      ...
      public static function get ConfigInfo() : PathInfo
      {
         return info;
      }
      ...
      public static function solveGoodsPath(param1:Number, param2:String, param3:Boolean = true, param4:String = "show", param5:String = "A", param6:String = "1", param7:int = 1, param8:Boolean = false, param9:int = 0, param10:String = "") : String
      {
         ...
         if(param1 == EquipType.UNFRIGHTPROP || param1 == 24 || param1 == 65 || param1 == 68 || param1 == 69 || param1 == 72)
         {
      ...
      public static function solveLitteGameCharacterPath(param1:Number, param2:Boolean, param3:int, param4:int, param5:String = "") : String
      {
         ...
         var _loc8_:String = info.SITE + "image/world/player/" + param3 + "/";
         switch(param1)
         {
            ...
            case EquipType.FACE:
               _loc6_ = "face";
               _loc7_ = param5;
               return _loc8_ + (param2 ? "M" : "F") + "/" + _loc6_ + "/" + _loc7_ + "/" + param4 + ".png";
            case EquipType.CLOTH:
               _loc6_ = "body";
               _loc7_ = "default";
               return _loc8_ + (param2 ? "M" : "F") + "/" + _loc6_ + "/" + _loc7_ + "/" + param4 + ".png";
      ...
      public static function get ItemAdvanceEnable() : Boolean
      {
         return info.ITEMADVANCE_ENABLE;
      }
      
      public static function get LatenEnergyEnable() : Boolean
      {
         return info.LATEN_ENABLE;
      }
      
      public static function get GemStoneEnable() : Boolean
      {
         return info.GEMSTONE_ENABLE_STORE;
      }
      ...
      public static function get LoveRingEnable() : Boolean
      {
         return info.LOVERING_ENABLE;
      }
