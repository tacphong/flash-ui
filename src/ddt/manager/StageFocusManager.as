package ddt.manager
{
   ...
   public class StageFocusManager
   {
      ...
      private static var instance:ddt.manager.StageFocusManager;
      ...
      public static function getInstance() : ddt.manager.StageFocusManager
      {
         if(instance == null)
         {
            instance = new ddt.manager.StageFocusManager();
         }
         return instance;
      }
      ...
      {
         this.stopFade();
         if(Boolean(this._view.stage) && Boolean(this._currentActiveObject))
         {
