package ddt.manager
{
   ...
   public class FineSuitManager
   {
      ...
      private static var _instance:ddt.manager.FineSuitManager;
      ...
      public static function get Instance() : ddt.manager.FineSuitManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.FineSuitManager();
         }
         return _instance;
      }
      ...
      public function getTipsPropertyInfoList(param1:int, param2:String) : Array
      {
         ...
         {
            _loc3_ = String(this.propertyList[_loc7_]);
