package ddt.manager
{
   ...
   public class AcademyFrameManager
   {
      ...
      private static var _instance:ddt.manager.AcademyFrameManager;
      ...
      public static function get Instance() : ddt.manager.AcademyFrameManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.AcademyFrameManager();
         }
         return _instance;
      }
