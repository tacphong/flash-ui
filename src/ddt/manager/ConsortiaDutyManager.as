package ddt.manager
{
   ...
   public class ConsortiaDutyManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.ConsortiaDutyManager;
      ...
      public static function get Instance() : ddt.manager.ConsortiaDutyManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.ConsortiaDutyManager();
         }
         return _instance;
      }
   }
