package ddt.manager
{
   ...
   public class MessageTipManager
   {
      ...
      private static var instance:ddt.manager.MessageTipManager;
      ...
      public static function getInstance() : ddt.manager.MessageTipManager
      {
         if(instance == null)
         {
            instance = new ddt.manager.MessageTipManager();
         }
         return instance;
      }
...
class HeadHolder extends Sprite implements Disposeable
{
   ...
   public function HeadHolder(param1:Boolean = true)
   {
