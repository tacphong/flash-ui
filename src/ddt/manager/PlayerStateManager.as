package ddt.manager
{
   ...
   public class PlayerStateManager
   {
      ...
      private static var _instance:ddt.manager.PlayerStateManager;
      ...
      public static function get Instance() : ddt.manager.PlayerStateManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.PlayerStateManager(new SingleTonForce());
         }
         return _instance;
      }
