package ddt.manager
{
   ...
   public class PreviewFrameManager
   {
      ...
      private static var _instance:ddt.manager.PreviewFrameManager;
      ...
      public static function get Instance() : ddt.manager.PreviewFrameManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.PreviewFrameManager();
         }
         return _instance;
      }
