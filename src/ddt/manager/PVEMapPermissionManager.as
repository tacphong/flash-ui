package ddt.manager
{
   ...
   public class PVEMapPermissionManager
   {
      ...
      private static var _instance:ddt.manager.PVEMapPermissionManager;
      ...
      public static function get Instance() : ddt.manager.PVEMapPermissionManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.PVEMapPermissionManager();
         }
         return _instance;
      }
      ...
      public function getPermission(param1:int, param2:int, param3:String) : Boolean
      {
         ...
         if(param2 == 1)
         {
            return _loc4_ != "1" ? Boolean(true) : Boolean(false);
         }
         if(param2 == 2)
         {
         ...
         if(param2 == 3)
         {
            return _loc4_ == "F" ? Boolean(true) : Boolean(false);
         }
         return false;
      }
   }
