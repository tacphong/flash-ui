package ddt.manager
{
   ...
   public class SkillManager
   {
      ...
      {
         var _loc3_:ReduceStrengthEffect = null;
         var _loc4_:Living = GameManager.Instance.Current.findLiving(param1);
         if(_loc4_.isPlayer() && _loc4_.isLiving)
         {
            _loc3_ = MirariEffectIconManager.getInstance().createEffectIcon(MirariType.ReduceStrength) as ReduceStrengthEffect;
      ...
      {
         var _loc3_:LimitMaxForceEffectIcon = null;
         var _loc4_:Living = GameManager.Instance.Current.findLiving(param1);
         if(_loc4_.isPlayer() && _loc4_.isLiving)
         {
            _loc3_ = MirariEffectIconManager.getInstance().createEffectIcon(MirariType.LimitMaxForce) as LimitMaxForceEffectIcon;
            _loc3_.force = param2;
            if(_loc3_ != null)
            {
            }
      ...
      private static function applyChangeTurnTime(param1:int, param2:int, param3:int) : void
      {
         ...
         var _loc5_:Living = GameManager.Instance.Current.findLiving(param1);
      ...
      private static function removeResolveHurt(param1:int, param2:PackageIn) : void
      {
         var _loc3_:Player = null;
         var _loc4_:Living = GameManager.Instance.Current.findLiving(param1);
         if(_loc4_ && _loc4_.isPlayer() && _loc4_.isLiving)
         {
            _loc3_ = Player(_loc4_);
            _loc3_.removeSkillMovie(2);
            _loc3_.removeMirariEffect(MirariEffectIconManager.getInstance().createEffectIcon(MirariType.ResolveHurt));
         }
         var _loc5_:int = param2.readInt();
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc4_ = GameManager.Instance.Current.findLiving(param2.readInt());
            if(_loc4_.isPlayer() && _loc4_.isLiving)
            {
               _loc3_ = Player(_loc4_);
               _loc3_.removeSkillMovie(2);
