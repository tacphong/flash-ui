package ddt.manager
{
   ...
   public class DailyLeagueManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.DailyLeagueManager;
      ...
      public static function get Instance() : ddt.manager.DailyLeagueManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.DailyLeagueManager();
         }
         return _instance;
      }
