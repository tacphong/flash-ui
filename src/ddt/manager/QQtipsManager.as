package ddt.manager
{
   ...
   public class QQtipsManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.QQtipsManager;
      ...
      public static function get instance() : ddt.manager.QQtipsManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.QQtipsManager();
         }
         return _instance;
      }
