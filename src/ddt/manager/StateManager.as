package ddt.manager
{
   ...
   public class StateManager
   {
      ...
      private static function addNextToStage() : void
      {
         ...
         if(Boolean(_loc1_))
         {
            if(Boolean(_loc1_.getView().parent))
            {
         ...
         if(CatchBeastManager.instance.RoomType == RoomInfo.CATCH_BEAST && currentStateType == "main")
         {
      ...
      {
         return param1 != StateType.FIGHTING && param1 != StateType.MATCH_ROOM && param1 != StateType.MISSION_ROOM && param1 != StateType.DUNGEON_ROOM && param1 != StateType.CHALLENGE_ROOM && param1 != StateType.ROOM_LOADING && param1 != StateType.FIGHT_LIB && param1 != StateType.TRAINER && param1 != StateType.CONSORTIA_BATTLE_SCENE;
      }
   }
}
