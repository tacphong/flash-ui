package ddt.manager
{
   ...
   public class EnthrallManager
   {
      ...
      private static var _instance:ddt.manager.EnthrallManager;
      ...
      public static function getInstance() : ddt.manager.EnthrallManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.EnthrallManager(new SingletonEnfocer());
         }
         return _instance;
      }
