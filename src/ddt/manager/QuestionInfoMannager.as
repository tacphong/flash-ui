package ddt.manager
{
   ...
   public class QuestionInfoMannager
   {
      ...
      private static var _instance:ddt.manager.QuestionInfoMannager;
      ...
      public static function get Instance() : ddt.manager.QuestionInfoMannager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.QuestionInfoMannager();
         }
         return _instance;
      }
      ...
      private function hideQuestionFrame() : void
      {
         ...
         {
            if(Boolean(this._questionGoogsView) && Boolean(this._questionGoogsView.parent))
            {
