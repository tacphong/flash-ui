package ddt.manager
{
   ...
   public class HotSpringManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.HotSpringManager;
      ...
      public static function get instance() : ddt.manager.HotSpringManager
      {
         if(!_instance)
         {
            _instance = new ddt.manager.HotSpringManager();
         }
         return _instance;
      }
      ...
      {
         if(Boolean(param1) && (!this._roomCurrently || this._roomCurrently.roomID != param1.roomID))
         {
