package ddt.manager
{
   ...
   public class ChurchManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.ChurchManager;
      ...
      public static function get instance() : ddt.manager.ChurchManager
      {
         if(!_instance)
         {
            _instance = new ddt.manager.ChurchManager();
         }
         return _instance;
      }
      ...
      private function __marryApplyReply(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc5_)
         {
            ...
            PlayerManager.Instance.Self.SpouseID = _loc4_;
            PlayerManager.Instance.Self.SpouseName = _loc6_;
            TaskManager.onMarriaged();
            TaskManager.requestCanAcceptTask();
            if(PathManager.solveExternalInterfaceEnabel())
            {
               ExternalInterfaceManager.sendToAgent(7,PlayerManager.Instance.Self.ID,PlayerManager.Instance.Self.NickName,ServerManager.Instance.zoneName,-1,"",_loc6_);
            }
         }
         if(_loc7_)
         {
            ...
            if(_loc5_)
            {
               ...
               _loc3_ = "<" + _loc6_ + ">" + LanguageMgr.GetTranslation("tank.manager.PlayerManager.isApplicant");
               this._churchDialogueAgreePropose = ComponentFactory.Instance.creat("common.church.ChurchDialogueAgreePropose");
               this._churchDialogueAgreePropose.msgInfo = _loc6_;
            ...
            else
            {
               ...
               _loc3_ = "<" + _loc6_ + ">" + LanguageMgr.GetTranslation("tank.manager.PlayerManager.refuseMarry");
               ...
               this._churchDialogueRejectPropose.msgInfo = _loc6_;
            ...
            _loc2_.msg = StringHelper.rePlaceHtmlTextField(_loc3_);
            ChatManager.Instance.chat(_loc2_);
         }
         else if(_loc5_)
         {
            this._alertMarried = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("tank.view.task.TaskCatalogContentView.tip"),LanguageMgr.GetTranslation("tank.manager.PlayerManager.youAndOtherMarried",_loc6_),LanguageMgr.GetTranslation("ok"),"",false,false,false,0,CacheConsts.ALERT_IN_FIGHT);
      ...
      private function __marryPropGet(param1:CrazyTankSocketEvent) : void
      {
         ...
         PlayerManager.Instance.Self.IsMarried = _loc3_.readBoolean();
         PlayerManager.Instance.Self.SpouseID = _loc3_.readInt();
         PlayerManager.Instance.Self.SpouseName = _loc3_.readUTF();
         ...
         if(_loc4_)
         {
            if(!ChurchManager.instance.selfRoom)
            {
               ...
               _loc2_.id = _loc5_;
               ChurchManager.instance.selfRoom = _loc2_;
            }
         }
         else
         {
      ...
      private function __roomLogin(param1:CrazyTankSocketEvent) : void
      {
         ...
         ChurchManager.instance.currentScene = _loc6_ == 1 ? Boolean(false) : Boolean(true);
      ...
      {
         if(Boolean(this._currentRoom) && Boolean(param1))
         {
