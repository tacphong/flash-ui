package ddt.manager
{
   ...
   public class GameInSocketOut
   {
	  ...
	  {
		  var _loc4_:PackageOut;
		  _loc4_ = new PackageOut(ePackageType.ITEM_CELL_IS_LOCKED);
		  _loc4_.writeInt(param1);
		  _loc4_.writeInt(param2);
		  _loc4_.writeBoolean(param3);
		  sendPackage(_loc4_);
	  ...
	  {
		  var _loc4_:int = 0;
		  var _loc3_:PackageOut = new PackageOut(ePackageType.EQUIP_BRING_UP);
		  _loc3_.writeInt(param1);
		  if(param1 > 0)
		  {
			  rest = rest[0];
	  ...
	  public static function sendCultureBringUp(param1:int, param2:int, param3:int) : void
	  {
		  var _loc4_:PackageOut;
		  _loc4_ = new PackageOut(ePackageType.EQUIP_BRING_UP);
		  _loc4_.writeInt(1);
		  _loc4_.writeInt(param1);
		  _loc4_.writeInt(param2);
		  _loc4_.writeInt(param3);
