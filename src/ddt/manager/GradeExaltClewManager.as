package ddt.manager
{
   ...
   public class GradeExaltClewManager
   {
      ...
      private static var instance:ddt.manager.GradeExaltClewManager;
      ...
      public static function getInstance() : ddt.manager.GradeExaltClewManager
      {
         if(instance == null)
         {
            instance = new ddt.manager.GradeExaltClewManager();
         }
         return instance;
      }
