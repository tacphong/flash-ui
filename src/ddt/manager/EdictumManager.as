package ddt.manager
{
   ...
   public class EdictumManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.EdictumManager;
      ...
      public static function get Instance() : ddt.manager.EdictumManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.EdictumManager();
         }
         return _instance;
      }
