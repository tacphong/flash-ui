package ddt.manager
{
   ...
   public class DesktopManager
   {
      ...
      private static var _instance:ddt.manager.DesktopManager;
      ...
      public static function get Instance() : ddt.manager.DesktopManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.DesktopManager();
         }
         return _instance;
      }
