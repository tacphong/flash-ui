package ddt.manager
{
   ...
   public class ItemManager extends EventDispatcher
   {
      ...
      private static var _instance:ddt.manager.ItemManager;
      ...
      public static function get Instance() : ddt.manager.ItemManager
      {
         if(_instance == null)
         {
            _instance = new ddt.manager.ItemManager();
         }
         return _instance;
      }
      ...
      public function searchGoodsNameByStr(param1:String) : Array
      {
         ...
         for each(_loc2_ in this._goodsTemplates)
         {
