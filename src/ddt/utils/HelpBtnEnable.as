package ddt.utils
{
   ...
   public class HelpBtnEnable
   {
      ...
      private static var instance:ddt.utils.HelpBtnEnable;
      ...
      public static function getInstance() : ddt.utils.HelpBtnEnable
      {
         if(!instance)
         {
            instance = new ddt.utils.HelpBtnEnable(new inner());
         }
         return instance;
      }
      ...
      {
         if(Boolean(this._hasForbiddenDic[param1.name]))
         {
            return true;
         }
         return false;
