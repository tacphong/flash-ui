package ddt.utils
{
   ...
   public class StaticFormula
   {
      ...
      public static function getDamage(param1:PlayerInfo) : int
      {
         ...
         if(Boolean(_loc4_))
         {
            _loc2_ = getHertAddition(int(_loc4_.Property7),_loc4_.StrengthenLevel + (_loc4_.isGold ? 1 : 0)) + int(_loc4_.Property7) + getJewelDamage(_loc4_);
            _loc3_ = getGhostPropertyData(_loc4_);
            if(_loc3_)
            {
               _loc2_ += _loc3_.mainProperty;
            }
         }
         ...
         return int(_loc2_ + SyahManager.Instance.totalDamage + param1.manualProInfo.pro_Damage);
      }
      ...
      public static function getRecovery(param1:PlayerInfo) : int
      {
         ...
         var _loc4_:InventoryItemInfo = param1.Bag.items[0] as InventoryItemInfo;
         if(Boolean(_loc4_))
         {
            _loc2_ = getDefenseAddition(int(_loc4_.Property7),_loc4_.StrengthenLevel + (_loc4_.isGold ? 1 : 0)) + int(_loc4_.Property7) + getJewelRecovery(_loc4_);
            _loc3_ = getGhostPropertyData(_loc4_);
            if(_loc3_)
            {
               _loc2_ += _loc3_.mainProperty;
         ...
         _loc4_ = param1.Bag.items[4] as InventoryItemInfo;
         if(Boolean(_loc4_))
         {
            _loc2_ += getDefenseAddition(int(_loc4_.Property7),_loc4_.StrengthenLevel + (_loc4_.isGold ? 1 : 0)) + int(_loc4_.Property7) + getJewelRecovery(_loc4_);
            _loc3_ = getGhostPropertyData(_loc4_);
         ...
         _loc4_ = param1.Bag.items[6] as InventoryItemInfo;
         if(Boolean(_loc4_))
         {
            _loc2_ += getJewelRecovery(_loc4_);
         }
         _loc2_ += TotemManager.instance.getAddInfo(TotemManager.instance.getTotemPointLevel(param1.totemId)).Guard;
         return int(_loc2_ + SyahManager.Instance.totalArmor + param1.manualProInfo.pro_Armor);
      }
