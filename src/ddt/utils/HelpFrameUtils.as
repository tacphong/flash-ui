package ddt.utils
{
   ...
   public class HelpFrameUtils
   {
      ...
      private static var _instance:ddt.utils.HelpFrameUtils;
      ...
      public static function get Instance() : ddt.utils.HelpFrameUtils
      {
         if(_instance == null)
         {
            _instance = new ddt.utils.HelpFrameUtils();
         }
         return _instance;
      }
      ...
      private function __helpButtonClick(param1:MouseEvent) : void
      {
         ...
         if(param1.currentTarget.hasOwnProperty("tipData") && param1.currentTarget.tipData && Boolean(param1.currentTarget.tipData.helpFrameData))
         {
