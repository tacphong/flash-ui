package ddt.view.sceneCharacter
{
   ...
   public class SceneCharacterLoaderBody
   {
      ...
      private function initLoaders() : void
      {
         ...
         this._loaders.push(new ddt.view.sceneCharacter.SceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],1,this._playerInfo.Sex,this._sceneCharacterLoaderPath));
         this._loaders.push(new ddt.view.sceneCharacter.SceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],2,this._playerInfo.Sex,this._sceneCharacterLoaderPath));
      }
