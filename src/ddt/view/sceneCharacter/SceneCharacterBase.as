package ddt.view.sceneCharacter
{
   ...
   public class SceneCharacterBase extends Sprite
   {
      ...
      private function loadFrame(param1:int) : void
      {
         ...
         if(Boolean(this._frameBitmap) && Boolean(this._frameBitmap[param1]))
         {
      ...
      public function set sceneCharacterActionItem(param1:ddt.view.sceneCharacter.SceneCharacterActionItem) : void
      {
         this._sceneCharacterActionItem = param1;
         this._frameIndex = 0;
      }
      
      public function get sceneCharacterActionItem() : ddt.view.sceneCharacter.SceneCharacterActionItem
      {
