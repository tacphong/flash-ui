package ddt.view.scenePathSearcher
{
   ...
   public class SceneScene extends EventDispatcher
   {
      ...
      private var _hitTester:ddt.view.scenePathSearcher.PathIHitTester;
      
      private var _pathSearcher:ddt.view.scenePathSearcher.PathIPathSearcher;
      ...
      public function get HitTester() : ddt.view.scenePathSearcher.PathIHitTester
      {
      ...
      public function setPathSearcher(param1:ddt.view.scenePathSearcher.PathIPathSearcher) : void
      {
         this._pathSearcher = param1;
      }
      
      public function setHitTester(param1:ddt.view.scenePathSearcher.PathIHitTester) : void
      {
