package ddt.view.tips
{
   ...
   public class LevelTip extends BaseTip implements ITip
   {
      ...
      private static var _instance:ddt.view.tips.LevelTip;
      ...
      private var _repute:ddt.view.tips.Repute;
      
      private var _winRate:ddt.view.tips.WinRate;
      
      private var _battle:ddt.view.tips.Battle;
      
      private var _exploit:ddt.view.tips.Exploit;
      ...
      public static function get instance() : ddt.view.tips.LevelTip
      {
         if(!instance)
         {
            _instance = new ddt.view.tips.LevelTip();
         }
         return _instance;
      }
      ...
      private function createLevelTip() : void
      {
         ...
         this._repute = new ddt.view.tips.Repute(this._reputeCount,this._level);
         this._repute.align = Repute.LEFT;
         this._winRate = new ddt.view.tips.WinRate(this._win,this._total);
         this._battle = new ddt.view.tips.Battle(this._battleNum);
         this._exploit = new ddt.view.tips.Exploit(this._exploitValue);
