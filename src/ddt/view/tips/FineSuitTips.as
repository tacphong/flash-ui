package ddt.view.tips
{
   ...
   public class FineSuitTips extends BaseTip
   {
      ...
      private var _itemList:Vector.<ddt.view.tips.FineSuitTipsItem>;
      ...
      {
         var _loc1_:ddt.view.tips.FineSuitTipsItem = null;
         ...
         while(_loc3_ < 12)
         {
            if(_loc3_ < 5)
            {
               _loc1_ = new ddt.view.tips.FineSuitTipsItem();
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:ddt.view.tips.FineSuitTipsItem = null;
         var _loc7_:int = 0;
         _loc1_ = 0;
         _loc2_ = null;
         var _loc3_:int = 0;
         ...
         _loc7_ = _loc6_.type == 0 ? int(1) : int(_loc6_.type);
         var _loc8_:int = _loc6_.level;
         if(_loc8_ > 14)
         {
            _loc8_ = _loc8_ == 0 ? int(0) : (_loc8_ % 14 == 0 ? int(14) : int(_loc8_ % 14));
         }
         _loc1_ = 43;
         ...
         while(_loc3_ < 5)
         {
            ...
            if(_loc3_ + 1 == _loc7_)
            {
               ...
               while(_loc4_ < 7)
               {
                  ...
                  _loc5_.setFrame(_loc8_ >= (_loc4_ + 1) * 2 ? int(1) : int(2));
                  _loc5_.y = _loc1_;
