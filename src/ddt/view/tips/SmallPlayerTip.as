package ddt.view.tips
{
   ...
   public class SmallPlayerTip extends BaseTip implements ITip
   {
      ...
      private static var _instance:ddt.view.tips.SmallPlayerTip;
      ...
      public static function get instance() : ddt.view.tips.SmallPlayerTip
      {
         if(!instance)
         {
            _instance = new ddt.view.tips.SmallPlayerTip();
         }
         return _instance;
      }
