package ddt.view.tips
{
   ...
   public class PlayerTip extends Sprite implements Disposeable
   {
      ...
      private var _friendGroup:ddt.view.tips.FriendGroupTip;
      ...
      private function init() : void
      {
         ...
         this._friendGroup = new ddt.view.tips.FriendGroupTip();
      ...
      public function update() : void
      {
         ...
         {
            this.btnChallenge.enable = StateManager.currentStateType == StateType.ROOM_LIST || StateManager.currentStateType == StateType.DUNGEON_LIST ? Boolean(true) : Boolean(false);
      ...
      {
         if(Boolean(param1.changedProperties["DutyLevel"]))
         {
