package ddt.view.buff.buffButton
{
   ...
   public class PayBuffButton extends BuffButton
   {
      ...
      private function shop() : void
      {
         ...
         var _loc3_:Array = [];
         _loc1_ = ShopManager.Instance.getGoodsByTemplateID(EquipType.Caddy_Good);
         _loc2_ = new ShopCarItemInfo(_loc1_.ShopID,_loc1_.TemplateID);
         ObjectUtils.copyProperties(_loc2_,_loc1_);
         _loc3_.push(_loc2_);
         _loc1_ = ShopManager.Instance.getGoodsByTemplateID(EquipType.Save_Life);
         _loc2_ = new ShopCarItemInfo(_loc1_.ShopID,_loc1_.TemplateID);
         ObjectUtils.copyProperties(_loc2_,_loc1_);
         _loc3_.push(_loc2_);
         _loc1_ = ShopManager.Instance.getGoodsByTemplateID(EquipType.Agility_Get);
         _loc2_ = new ShopCarItemInfo(_loc1_.ShopID,_loc1_.TemplateID);
         ObjectUtils.copyProperties(_loc2_,_loc1_);
         _loc3_.push(_loc2_);
         _loc1_ = ShopManager.Instance.getGoodsByTemplateID(EquipType.ReHealth);
         _loc2_ = new ShopCarItemInfo(_loc1_.ShopID,_loc1_.TemplateID);
         ObjectUtils.copyProperties(_loc2_,_loc1_);
         _loc3_.push(_loc2_);
         _loc1_ = ShopManager.Instance.getGoodsByTemplateID(EquipType.Train_Good);
         _loc2_ = new ShopCarItemInfo(_loc1_.ShopID,_loc1_.TemplateID);
         ObjectUtils.copyProperties(_loc2_,_loc1_);
         _loc3_.push(_loc2_);
         _loc1_ = ShopManager.Instance.getGoodsByTemplateID(EquipType.Level_Try);
         _loc2_ = new ShopCarItemInfo(_loc1_.ShopID,_loc1_.TemplateID);
         ObjectUtils.copyProperties(_loc2_,_loc1_);
         _loc3_.push(_loc2_);
         _loc1_ = ShopManager.Instance.getGoodsByTemplateID(EquipType.Card_Get);
         _loc2_ = new ShopCarItemInfo(_loc1_.ShopID,_loc1_.TemplateID);
         ObjectUtils.copyProperties(_loc2_,_loc1_);
         _loc3_.push(_loc2_);
         var _loc4_:SetsShopView = new SetsShopView();
         _loc4_.initialize(_loc3_);
