package ddt.view.common
{
   ...
   public class GameMasterIcon extends Sprite implements ITipedDisplay
   {
      ...
      public function GameMasterIcon()
      {
         super();
         this._icon = ComponentFactory.Instance.creatBitmap("asset.core.GameMasterIcon");
         addChild(this._icon);
