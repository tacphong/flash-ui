package ddt.view.common
{
   ...
   public class PlayerIconSpan extends VBox
   {
      ...
      private var _levelIcon:ddt.view.common.LevelIcon;
      
      private var _vipIcon:ddt.view.common.VipLevelIcon;
      
      private var _marriedIcon:ddt.view.common.MarriedIcon;
      ...
      override protected function init() : void
      {
         ...
         if(Boolean(this._info))
         {
            ...
            {
               this._levelIcon = new ddt.view.common.LevelIcon();
            }
            ...
            if(this._info.ID == PlayerManager.Instance.Self.ID || this._info.IsVIP)
            {
               ...
               {
                  this._vipIcon = new ddt.view.common.VipLevelIcon();
            ...
            if(this._info.SpouseID > 0)
            {
               ...
               {
                  this._marriedIcon = new ddt.view.common.MarriedIcon();
               }
