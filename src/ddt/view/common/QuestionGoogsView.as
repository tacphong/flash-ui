package ddt.view.common
{
   ...
   public class QuestionGoogsView extends Frame
   {
      ...
      {
         var _loc1_:QuestionItemView = null;
         _loc1_ = null;
         this._itemArray = [];
         var _loc2_:int = 0;
         while(_loc2_ < 4)
