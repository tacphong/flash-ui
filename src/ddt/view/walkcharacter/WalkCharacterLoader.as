package ddt.view.walkcharacter
{
   ...
   public class WalkCharacterLoader extends EventDispatcher implements Disposeable
   {
      ...
      private var _layers:Vector.<ddt.view.walkcharacter.WalkCharaterLayer>;
      ...
      public function load() : void
      {
         ...
         this.initLoaders();
         var _loc1_:int = int(this._layers.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
      ...
      private function initLoaders() : void
      {
         ...
         this._layers.push(new ddt.view.walkcharacter.WalkCharaterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[5].split("|")[0])),this._recordColor[5]));
         this._layers.push(new ddt.view.walkcharacter.WalkCharaterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[2].split("|")[0])),this._recordColor[2]));
         this._layers.push(new ddt.view.walkcharacter.WalkCharaterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[3].split("|")[0])),this._recordColor[3]));
         this._layers.push(new ddt.view.walkcharacter.WalkCharaterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],1,this._playerInfo.Sex,this._clothPath));
         this._layers.push(new ddt.view.walkcharacter.WalkCharaterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],2,this._playerInfo.Sex,this._clothPath));
      }
