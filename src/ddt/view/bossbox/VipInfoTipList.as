package ddt.view.bossbox
{
   ...
   public class VipInfoTipList extends Sprite implements Disposeable
   {
      ...
      private var _cells:Vector.<ddt.view.bossbox.BoxVipTipsInfoCell>;
      
      private var _currentCell:ddt.view.bossbox.BoxVipTipsInfoCell;
      ...
      public function get currentCell() : ddt.view.bossbox.BoxVipTipsInfoCell
      {
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:ddt.view.bossbox.BoxVipTipsInfoCell = null;
      ...
      {
         var _loc1_:ddt.view.bossbox.BoxVipTipsInfoCell = null;
