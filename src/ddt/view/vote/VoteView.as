package ddt.view.vote
{
   ...
   public class VoteView extends Frame
   {
      ...
      override protected function init() : void
      {
         ...
         this._cell1.y = this._cell2.y = 17;
         this._cell1.x = 24;
         this._cell2.x = 233;
      ...
      private function update() : void
      {
         ...
         for(_loc1_ in this._voteInfo.answer)
         {
            _loc3_++;
            _loc2_ = ComponentFactory.Instance.creatComponentByStylename("vote.answer.selectedBtn");
            _loc2_.text = _loc3_ + "、" + this._voteInfo.answer[_loc1_];
            this._answerBG.addChild(_loc2_);
            this._answerGroup.addSelectItem(_loc2_);
            _loc2_.addEventListener(MouseEvent.CLICK,this.__playSound);
            _loc2_.y = (_loc2_.height + 10) * (_loc3_ - 1) + 15;
            this._itemArr.push(_loc2_);
            this._answerIDArr.push(_loc1_);
         }
