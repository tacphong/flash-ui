package ddt.view.caddyII.card
{
   ...
   public class CardViewII extends RightView
   {
      ...
      public static var _instance:ddt.view.caddyII.card.CardViewII;
      ...
      public static function get instance() : ddt.view.caddyII.card.CardViewII
      {
         if(_instance == null)
         {
            _instance = new ddt.view.caddyII.card.CardViewII();
         }
         return _instance;
      }
      ...
      private function getCardPlace(param1:int) : int
      {
         ...
         var _loc3_:Array = PlayerManager.Instance.Self.Bag.findCellsByTempleteID(this._cardID);
