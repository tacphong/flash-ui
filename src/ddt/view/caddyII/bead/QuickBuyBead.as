package ddt.view.caddyII.bead
{
   ...
   public class QuickBuyBead extends BaseAlerFrame
   {
      ...
      private var _cellItems:Vector.<ddt.view.caddyII.bead.QuickBuyItem>;
      ...
      private var _selectedItem:ddt.view.caddyII.bead.QuickBuyItem;
      ...
      {
         var _loc1_:ddt.view.caddyII.bead.QuickBuyItem = null;
      ...
      private function creatCell() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this._cellId.length)
         {
            _loc1_ = new ddt.view.caddyII.bead.QuickBuyItem();
            _loc1_.itemID = this._cellId[_loc2_];
            _loc1_.addEventListener(Event.CHANGE,this._numberChange);
            _loc1_.addEventListener(MouseEvent.CLICK,this.__itemClick);
            _loc1_.addEventListener(NumberSelecter.NUMBER_CLOSE,this._numberClose);
            _loc1_.addEventListener(NumberSelecter.NUMBER_ENTER,this._numberEnter);
            this._list.addChild(_loc1_);
            this._cellItems.push(_loc1_);
            _loc2_++;
         }
      ...
      private function __itemClick(param1:MouseEvent) : void
      {
         ...
         var _loc2_:ddt.view.caddyII.bead.QuickBuyItem = param1.currentTarget as QuickBuyItem;
      ...
      {
         var _loc2_:ddt.view.caddyII.bead.QuickBuyItem = null;
         var _loc3_:ddt.view.caddyII.bead.QuickBuyItem = null;
         var _loc4_:int = 0;
         for each(_loc2_ in this._cellItems)
         {
            _loc4_ += _loc2_.count * ShopManager.Instance.getMoneyShopItemByTemplateID(_loc2_.info.TemplateID).getItemPrice(1).moneyValue;
         }
         this.money = _loc4_;
         _loc3_ = param1.currentTarget as QuickBuyItem;
      ...
      private function buy() : void
      {
         ...
         for each(_loc1_ in this._cellItems)
         {
            ...
            {
               _loc3_.push(ShopManager.Instance.getMoneyShopItemByTemplateID(_loc1_.info.TemplateID).GoodsID);
               _loc4_.push(1);
               _loc5_.push("");
               _loc6_.push(false);
               _loc7_.push("");
         ...
         SocketManager.Instance.out.sendBuyGoods(_loc3_,_loc4_,_loc5_,_loc8_,_loc6_,_loc7_,5);
      }
      ...
      public function get selectedItem() : ddt.view.caddyII.bead.QuickBuyItem
      {
         return this._selectedItem;
      }
      
      public function set selectedItem(param1:ddt.view.caddyII.bead.QuickBuyItem) : void
      {
         var _loc2_:ddt.view.caddyII.bead.QuickBuyItem = this._selectedItem;
