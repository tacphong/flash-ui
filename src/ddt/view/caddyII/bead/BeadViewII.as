package ddt.view.caddyII.bead
{
   ...
   public class BeadViewII extends RightView
   {
      ...
      private var _smeltBeadCell:ddt.view.caddyII.bead.BeadItem;
      
      private var _beadQuickBuyBtn:BaseButton;
      
      private var _turnCell:ddt.view.caddyII.bead.BeadCell;
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:ddt.view.caddyII.bead.BeadItem = null;
         _loc1_ = 0;
         _loc2_ = null;
         if(this._hasCell)
         {
         ...
         {
            _loc2_ = new ddt.view.caddyII.bead.BeadItem();
      ...
      {
         var _loc1_:ddt.view.caddyII.bead.BeadItem = null;
      ...
      private function initView() : void
      {
         ...
         this._turnCell = new ddt.view.caddyII.bead.BeadCell();
