package ddt.view.caddyII
{
   ...
   public class CaddyTurn extends Sprite implements Disposeable
   {
      ...
      private function configMovie() : void
      {
         ...
         if(Boolean(_loc1_) && _loc1_ != this._movie)
         {
      ...
      {
         this._cells[this._cellNumber].visible = this._showCellAble ? Boolean(true) : Boolean(false);
      ...
      {
         this._goodsNameTxt.text = this._selectedCell.info.Name;
         this._selectSprite.scaleX = this._selectSprite.scaleY = 1.8;
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(Boolean(this._cells) && _loc1_ < this._cells.length)
         {
