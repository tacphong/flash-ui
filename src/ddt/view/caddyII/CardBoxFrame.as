package ddt.view.caddyII
{
   ...
   public class CardBoxFrame extends Frame
   {
      
      public static const VerticalOffset:int = -50;
       
      
      private var _view:ddt.view.caddyII.RightView;
      
      private var _bag:ddt.view.caddyII.CaddyBagView;
      
      private var _reader:CaddyUpdate;
      
      private var _moveSprite:ddt.view.caddyII.MoveSprite;
      ...
      public function CardBoxFrame(param1:int, param2:ItemTemplateInfo = null)
      {
         super();
      ...
      {
         if(this._type == CaddyModel.BEAD_TYPE || this._type == CaddyModel.MYSTICAL_CARDBOX || this._type == CaddyModel.CARD_CARTON)
         {
