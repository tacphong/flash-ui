package ddt.view.caddyII
{
   ...
   public class LookTrophy extends Frame
   {
      ...
      private function initView() : void
      {
         ...
         var _loc2_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("caddy.TrophyBGI");
         var _loc3_:ScaleBitmapImage = ComponentFactory.Instance.creatComponentByStylename("caddy.TrophyBGII");
         var _loc4_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.caddy.lookFont");
         ...
         var _loc5_:int = 0;
         while(_loc5_ < SUM_NUMBER)
         {
            _loc1_ = new BagCell(_loc5_);
