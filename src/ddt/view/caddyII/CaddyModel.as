package ddt.view.caddyII
{
   ...
   public class CaddyModel extends EventDispatcher
   {
      ...
      public static var _instance:ddt.view.caddyII.CaddyModel;
      ...
      public static function get instance() : ddt.view.caddyII.CaddyModel
      {
         if(_instance == null)
         {
            _instance = new ddt.view.caddyII.CaddyModel();
         }
         return _instance;
      }
      ...
      {
         var _loc2_:int = param1.length > AWARDS_NUMBER ? int(AWARDS_NUMBER) : int(param1.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
