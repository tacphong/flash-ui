package ddt.view.caddyII.offerPack
{
   ...
   public class OfferQuickBuyFrame extends BaseAlerFrame
   {
      ...
      private var _cellItems:Vector.<ddt.view.caddyII.offerPack.OfferQuickCell>;
      ...
      private var _selectCell:ddt.view.caddyII.offerPack.OfferQuickCell;
      ...
      private function initShopInfo() : void
      {
         ...
         while(_loc3_ < 6)
         {
            ...
            {
               if(_loc2_.TemplateInfo.CategoryID == 11)
               {
                  this._shopInfoList.push(_loc2_);
               }
            }
            _loc3_++;
         }
      ...
      {
         var _loc1_:ddt.view.caddyII.offerPack.OfferQuickCell = null;
         this._list.beginChanges();
         var _loc2_:int = 0;
         while(_loc2_ < this._itemTempLateID.length)
         {
            _loc1_ = new ddt.view.caddyII.offerPack.OfferQuickCell();
            _loc1_.info = ItemManager.Instance.getTemplateById(this._itemTempLateID[_loc2_]);
            _loc1_.addEventListener(MouseEvent.CLICK,this._itemClick);
            this._itemGroup.addSelectItem(_loc1_);
