package ddt.view.caddyII.offerPack
{
   ...
   public class OfferPackViewII extends RightView
   {
      ...
      private var _selectedPackItem:ddt.view.caddyII.offerPack.OfferPackItem;
      ...
      {
         var _loc2_:ddt.view.caddyII.offerPack.OfferPackItem = null;
         ...
         var _loc4_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.bead.goodsNameBG");
         ...
         _loc8_ = ComponentFactory.Instance.creatCustomObject("offer.OfferPackViewII.PackBar.TopLeft");
         var _loc9_:int = int(this._itemTempLateID.length);
         var _loc10_:int = 0;
         while(_loc10_ < _loc9_)
         {
            _loc1_ = ItemManager.Instance.getTemplateById(this._itemTempLateID[_loc10_]);
            _loc2_ = ComponentFactory.Instance.creatCustomObject("ddt.view.caddyII.offerPack.OfferPackItem");
            _loc2_.x = _loc8_.x + (_loc2_.width + OfferPackItem.HSpace) * _loc10_;
            _loc2_.y = _loc8_.y;
            _loc2_.info = _loc1_;
            addChild(_loc2_);
            this._packItems.push(_loc2_);
            _loc2_.addEventListener(MouseEvent.CLICK,this.__packItemClick);
            _loc10_++;
         }
      ...
      {
         var _loc2_:ddt.view.caddyII.offerPack.OfferPackItem = this._packItems[param1];
      ...
      private function __packItemClick(param1:MouseEvent) : void
      {
         ...
         var _loc2_:ddt.view.caddyII.offerPack.OfferPackItem = param1.currentTarget as OfferPackItem;
         this.selectedItem = _loc2_;
      ...
      private function removeEvents() : void
      {
         ...
         var _loc1_:ddt.view.caddyII.offerPack.OfferPackItem = this._packItems.shift();
      ...
      public function get selectedItem() : ddt.view.caddyII.offerPack.OfferPackItem
      {
         return this._selectedPackItem;
      }
      
      public function set selectedItem(param1:ddt.view.caddyII.offerPack.OfferPackItem) : void
      {
         if(this._selectedPackItem == param1)
         {
            return;
         }
         var _loc2_:ddt.view.caddyII.offerPack.OfferPackItem = this._selectedPackItem;
