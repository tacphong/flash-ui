package ddt.view.caddyII
{
   ...
   public class CaddyViewII extends RightView
   {
      ...
      private var _lookTrophy:ddt.view.caddyII.LookTrophy;
      ...
      private var _turn:ddt.view.caddyII.CaddyTurn;
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:Vector.<BoxGoodsTempInfo> = BossBoxManager.instance.caddyBoxGoodsInfo;
         this._templateIDList = new Vector.<int>();
         var _loc3_:int = 0;
         var _loc4_:int = Math.floor(_loc2_.length / GOODSNUMBER);
         var _loc5_:int = Math.floor(Math.random() * _loc4_);
         _loc5_ = _loc5_ == 0 ? int(1) : int(_loc5_);
         var _loc6_:int = 1;
         while(_loc6_ <= GOODSNUMBER)
         {
            if(_loc5_ * _loc6_ < _loc2_.length)
            {
               this._templateIDList.push(_loc2_[_loc5_ * _loc6_].TemplateId);
            }
            _loc6_++;
         }
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         while(_loc8_ < this._templateIDList.length)
         {
            _loc1_ = Math.floor(Math.random() * this._templateIDList.length);
            _loc7_ = this._templateIDList[_loc8_];
            this._templateIDList[_loc8_] = this._templateIDList[_loc1_];
            this._templateIDList[_loc1_] = _loc7_;
            _loc8_++;
         }
      }
