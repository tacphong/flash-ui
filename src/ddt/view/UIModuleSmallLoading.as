package ddt.view
{
   ...
   public class UIModuleSmallLoading extends EventDispatcher
   {
      ...
      private static var _instance:ddt.view.UIModuleSmallLoading;
      ...
      public static function get Instance() : ddt.view.UIModuleSmallLoading
      {
         if(_instance == null)
         {
            _instance = new ddt.view.UIModuleSmallLoading();
