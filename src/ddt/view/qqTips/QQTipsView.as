package ddt.view.qqTips
{
   ...
   public class QQTipsView extends Sprite implements Disposeable
   {
      ...
      private var _qqInfo:ddt.view.qqTips.QQTipsInfo;
      ...
      public function set qqInfo(param1:ddt.view.qqTips.QQTipsInfo) : void
      {
         this._qqInfo = param1;
      ...
      public function get qqInfo() : ddt.view.qqTips.QQTipsInfo
      {
         return this._qqInfo;
      }
