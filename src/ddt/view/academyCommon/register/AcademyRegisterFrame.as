   ...
   public class AcademyRegisterFrame extends BaseAlerFrame implements Disposeable
   {
      ...
      public function isAmend(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            info = this._alertInfo;
            if(AcademyManager.Instance.selfDescribe != "" && Boolean(AcademyManager.Instance.selfDescribe))
            {
      ...
      override public function dispose() : void
      {
         ...
         if(Boolean(this._checkBoxLabel))
         {
