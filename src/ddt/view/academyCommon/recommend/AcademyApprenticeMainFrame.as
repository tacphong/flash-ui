package ddt.view.academyCommon.recommend
{
   ...
   public class AcademyApprenticeMainFrame extends BaseAlerFrame implements Disposeable
   {
      ...
      protected var _currentItem:ddt.view.academyCommon.recommend.RecommendPlayerCellView;
      ...
      {
         var _loc1_:ddt.view.academyCommon.recommend.RecommendPlayerCellView = null;
         this._items = [];
         var _loc2_:int = 0;
         while(_loc2_ < MAX_ITEM)
         {
            _loc1_ = new ddt.view.academyCommon.recommend.RecommendPlayerCellView();
            _loc1_.addEventListener(MouseEvent.CLICK,this.__itemClick);
            this._playerContainer.addChild(_loc1_);
      ...
      override public function dispose() : void
      {
         ...
         if(Boolean(this._tree9CornerImage))
         {
