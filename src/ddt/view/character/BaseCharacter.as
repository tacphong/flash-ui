package ddt.view.character
{
   ...
   public class BaseCharacter extends Sprite implements ICharacter, Disposeable
   {
      ...
      protected var _loader:ddt.view.character.ICharacterLoader;
      
      protected var _characterWidth:Number;
      
      protected var _characterHeight:Number;
      
      protected var _factory:ddt.view.character.ICharacterLoaderFactory;
      ...
      {
         if(Boolean(param1.changedProperties[PlayerInfo.STYLE]) || Boolean(param1.changedProperties[PlayerInfo.COLORS]))
         {
      ...
      {
         this._dir = param2 > 0 ? int(1) : int(-1);
         scaleX = this._dir;
      ...
      protected function __loadComplete(param1:ddt.view.character.ICharacterLoader) : void
      {
      ...
      public function setFactory(param1:ddt.view.character.ICharacterLoaderFactory) : void
      {
      ...
      protected function createFrames() : void
      {
         ...
         this._frames = [];
         var _loc3_:int = 0;
         while(_loc3_ < this._picLines)
         {
            _loc1_ = 0;
            while(_loc1_ < this._picsPerLine)
            {
               _loc2_ = new Rectangle(_loc1_ * this._characterWidth,_loc3_ * this._characterHeight,this._characterWidth,this._characterHeight);
               this._frames.push(_loc2_);
               _loc1_++;
            }
            _loc3_++;
         }
