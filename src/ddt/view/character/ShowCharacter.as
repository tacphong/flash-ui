package ddt.view.character
{
   ...
   public class ShowCharacter extends BaseCharacter
   {
      ...
      private var _light01:ddt.view.character.BaseLightLayer;
      
      private var _light02:ddt.view.character.SinpleLightLayer;
      ...
      {
         if(Boolean(param1.changedProperties[PlayerInfo.NIMBUS]))
         {
            this.updateLight();
         }
      }
      ...
      override public function set scaleX(param1:Number) : void
      {
         ...
         _container.x = param1 < 0 ? Number(-_characterWidth) : Number(0);
      }
      ...
      private function drawBitmapWithWingAndLight() : void
      {
         ...
         var _loc6_:Rectangle = _container.getBounds(_container);
         _loc5_ = new Sprite();
         _loc3_.removeChild(_container);
         _container.x = -_loc6_.x * _container.scaleX;
         _container.y = -_loc6_.y * _container.scaleX;
         ...
         if(this._showLight && this.currentAction == STAND)
         {
            if(this._recordNimbus != _info.Nimbus)
            {
               ...
               if(_info.getHaveLight())
               {
                  ...
                  this._light02 = new ddt.view.character.SinpleLightLayer(_info.Nimbus);
               ...
               if(_info.getHaveCircle())
               {
                  ...
                  this._light01 = new ddt.view.character.BaseLightLayer(_info.Nimbus);
      ...
      private function callBack01(param1:ddt.view.character.BaseLightLayer) : void
      {
         if(Boolean(this._light1) && Boolean(this._light1.parent))
         {
            this._light1.parent.removeChild(this._light1);
      ...
      private function callBack02(param1:ddt.view.character.SinpleLightLayer) : void
      {
         if(Boolean(this._light2) && Boolean(this._light2.parent))
         {
            this._light2.parent.removeChild(this._light2);
      ...
      override protected function setContent() : void
      {
         ...
         if(_loader != null)
         {
            ...
            if(Boolean(this._characterWithWeapon) && this._characterWithWeapon != _loc1_[0])
            {
               this._characterWithWeapon.dispose();
            }
            if(Boolean(this._characterWithoutWeapon) && this._characterWithoutWeapon != _loc1_[1])
            {
      ...
      private function updateWing() : void
      {
         ...
         _loc1_ = _loc1_ < 1 ? int(0) : int(_loc1_ - 1);
