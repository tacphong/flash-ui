package ddt.view.character
{
   ...
   public class RoomCharacter extends BaseCharacter
   {
      ...
      private var _currentAction:ddt.view.character.RoomPlayerAction;
      ...
      override protected function createFrames() : void
      {
         ...
         this._faceFrames = [];
         var _loc3_:int = 0;
         while(_loc3_ < _picLines)
         {
            _loc1_ = 0;
            while(_loc1_ < _picsPerLine)
            {
               _loc2_ = new Rectangle(_loc1_ * 250,_loc3_ * 232,250,232);
               this._faceFrames.push(_loc2_);
               _loc1_++;
            }
            _loc3_++;
         }
