package ddt.view.character
{
   ...
   public class LayerFactory implements ddt.view.character.ILayerFactory
   {
      ...
      private static var _instance:ddt.view.character.ILayerFactory;
      ...
      public static function get instance() : ddt.view.character.ILayerFactory
      {
         if(_instance == null)
         {
