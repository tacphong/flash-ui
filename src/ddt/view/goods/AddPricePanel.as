package ddt.view.goods
{
   ...
   public class AddPricePanel extends Frame
   {
      ...
      private static var _instance:ddt.view.goods.AddPricePanel;
      ...
      public static function get Instance() : ddt.view.goods.AddPricePanel
      {
         if(_instance == null)
         {
      ...
      protected function cartItemSelectVBoxInit() : void
      {
         ...
         while(_loc2_ < 4)
         {
            if(this._currentShopItem.getItemPrice(_loc2_).IsValid)
            {
               _loc1_ = ComponentFactory.Instance.creatComponentByStylename("shop.CartItemSelectBtn");
               _loc1_.text = this._currentShopItem.getItemPrice(_loc2_).toString() + "/" + this._currentShopItem.getTimeToString(_loc2_);
               this._cartItemSelectVBox.addChild(_loc1_);
               this._cartItemGroup.addSelectItem(_loc1_);
            }
            _loc2_++;
         }
      ...
      private function resetRadioBtn() : void
      {
         ...
         while(_loc1_ < this._shopItems.length)
         {
            if(!(Boolean(this._shopItems[_loc1_].getItemPrice(1).IsMixed) || Boolean(this._shopItems[_loc1_].getItemPrice(2).IsMixed) || Boolean(this._shopItems[_loc1_].getItemPrice(3).IsMixed)))
            {
               ...
               else if(Boolean(this._shopItems[_loc1_].getItemPrice(1).IsGiftType))
               {
