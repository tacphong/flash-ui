package ddt.view
{
   ...
   public class DailyButtunBar extends Sprite implements Disposeable
   {
      ...
      private static var instance:ddt.view.DailyButtunBar;
      ...
      public static function get Insance() : ddt.view.DailyButtunBar
      {
         if(instance == null)
         {
            instance = new ddt.view.DailyButtunBar();
         }
         return instance;
      }
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._complainShineEffect))
         {
      ...
      public function setComplainGlow(param1:Boolean) : void
      {
         ...
         else if(Boolean(this._complainShineEffect))
         {
