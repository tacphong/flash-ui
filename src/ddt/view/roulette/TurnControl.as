package ddt.view.roulette
{
   ...
   public class TurnControl extends EventDispatcher
   {
      ...
      private var _sound:ddt.view.roulette.TurnSoundControl;
      ...
      private function init() : void
      {
         ...
         this._timer.stop();
         this._sound = new ddt.view.roulette.TurnSoundControl();
      ...
      public function turnPlate(param1:Vector.<ddt.view.roulette.RouletteGoodsCell>, param2:int) : void
      {
      ...
      public function turnPlateII(param1:Vector.<ddt.view.roulette.RouletteGoodsCell>) : void
      {
         this._goodsList = param1;
         this.autoMove = true;
      }
      ...
      private function get prevSelected() : int
      {
         ...
         switch(this._turnType)
         {
            ...
            case TYPE_SPEED_DOWN:
               ...
               {
                  _loc1_ = this._moderationNumber >= 7 ? int(this._moderationNumber - 6) : int(1);
      ...
      public function set goodsList(param1:Vector.<ddt.view.roulette.RouletteGoodsCell>) : void
      {
         this._goodsList = param1;
      }
