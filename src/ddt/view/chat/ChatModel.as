package ddt.view.chat
{
   ...
   public final class ChatModel extends EventDispatcher
   {
      ...
      {
         return param1 == ChatOutputView.CHAT_OUPUT_CURRENT ? int(this._currentChats.length) : (param1 == ChatOutputView.CHAT_OUPUT_CLUB ? int(this._clubChats.length) : int(this._privateChats.length));
      }
