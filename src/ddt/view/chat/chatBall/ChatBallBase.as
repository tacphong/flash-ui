package ddt.view.chat.chatBall
{
   ...
   public class ChatBallBase extends Sprite
   {
      ...
      protected var _chatballBackground:ddt.view.chat.chatBall.ChatBallBackground;
      
      protected var _field:ddt.view.chat.chatBall.ChatBallTextAreaBase;
      ...
      protected function get field() : ddt.view.chat.chatBall.ChatBallTextAreaBase
      {
         return this._field;
      }
      ...
      protected function get paopao() : ddt.view.chat.chatBall.ChatBallBackground
      {
