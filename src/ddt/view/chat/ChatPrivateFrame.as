package ddt.view.chat
{
   ...
   public class ChatPrivateFrame extends BaseAlerFrame
   {
      ...
      override protected function init() : void
      {
         ...
         var _loc2_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("chat.PrivateFrameText");
         _loc2_.text = LanguageMgr.GetTranslation("tank.view.scenechatII.PrivateChatIIView.nick");
         var _loc3_:VectorListModel = this._comBox.listPanel.vectorListModel;
         ...
         var _loc4_:uint = 0;
         while(_loc4_ < this._friendList.length)
         {
            _loc1_ = this._friendList[_loc4_] as FriendListPlayer;
            _loc3_.append(_loc1_.NickName);
            _loc4_++;
         }
