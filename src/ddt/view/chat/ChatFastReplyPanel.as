package ddt.view.chat
{
   ...
   public class ChatFastReplyPanel extends ChatBasePanel
   {
      ...
      private var _items:Vector.<ddt.view.chat.ChatFastReplyItem>;
      ...
      private function __itemClick(param1:MouseEvent) : void
      {
         ...
         var _loc2_:ddt.view.chat.ChatFastReplyItem = param1.currentTarget as ChatFastReplyItem;
      ...
      {
         SoundManager.instance.play("008");
         var _loc2_:ddt.view.chat.ChatFastReplyItem = param1.data as ChatFastReplyItem;
      ...
      private function createCustomItem() : void
      {
         ...
         var _loc2_:ddt.view.chat.ChatFastReplyItem = new ddt.view.chat.ChatFastReplyItem(_loc1_,true);
      ...
      {
         var _loc1_:uint = uint(this._items.length - 5);
         y -= _loc1_ * 21;
      }
      ...
      {
         var _loc1_:* = null;
         var _loc2_:ddt.view.chat.ChatFastReplyItem = null;
         var _loc3_:ddt.view.chat.ChatFastReplyItem = null;
         super.init();
         ...
         {
            _loc2_ = new ddt.view.chat.ChatFastReplyItem(FASTREPLYS[_loc4_]);
            _loc2_.addEventListener(MouseEvent.CLICK,this.__itemClick);
            this._items.push(_loc2_);
            this._box.addChild(_loc2_);
            _loc4_++;
         ...
         for(_loc1_ in SharedManager.Instance.fastReplys)
         {
            _loc3_ = new ddt.view.chat.ChatFastReplyItem(SharedManager.Instance.fastReplys[_loc1_],true);
            _loc3_.addEventListener(MouseEvent.CLICK,this.__itemClick);
            _loc3_.addEventListener(ChatEvent.DELETE,this.__deleteItem);
            ChatManager.Instance.model.customFastReply.push(_loc3_.word);
