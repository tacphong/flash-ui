package ddt.view.chat
{
   ...
   public class ChatOutputView extends Sprite
   {
      ...
      private var _model:ddt.view.chat.ChatModel;
      
      private var _outputField:ddt.view.chat.ChatOutputField;
      ...
      private var _leftScroll:ddt.view.chat.ChatScrollBar;
      ...
      {
         if(Boolean(ChatManager.Instance.view.parent))
         {
      ...
      {
         if(Boolean(ChatManager.Instance.view.input.parent))
         {
            return;
         }
         if(this._leftBtnContainerInGame.contains(this._functionBtnInGame))
      ...
      public function set bg(param1:int) : void
      {
         ...
         if(this.isInGame())
         {
            if(Boolean(this._rightBtnContainer.parent))
            {
      ...
      public function get contentField() : ddt.view.chat.ChatOutputField
      {
      ...
      public function setBgVisible(param1:Boolean) : void
      {
         if(!this.isInGame())
         {
            ...
            else if(Boolean(this._bg.parent))
            {
               this._bg.parent.removeChild(this._bg);
            }
         }
      ...
      public function setChannelBtnVisible(param1:Boolean) : void
      {
         if(!this.isInGame())
         {
            ...
            else if(Boolean(this._rightBtnContainer.parent))
            {
               this._rightBtnContainer.parent.removeChild(this._rightBtnContainer);
            }
         }
      ...
      private function init() : void
      {
         ...
         this._model = new ddt.view.chat.ChatModel();
         this._bg.setFrame(1);
         addChild(this._bg);
      ...
      private function initBtns() : void
      {
         ...
         this._leftScroll = new ddt.view.chat.ChatScrollBar(this.__textFieldBindScroll);
      ...
      private function updateOutputViewState() : void
      {
         if(this._more.selected)
         {
            ...
            if(Boolean(PetSpriteController.Instance.petSprite))
            {
         ...
         else
         {
            ...
            if(Boolean(PetSpriteController.Instance.petSprite))
            {
               ...
               if(Boolean(PetSpriteController.Instance.petSprite.petSpriteLand))
               {
      ...
      public function updateCurrnetChannel() : void
      {
         ...
         {
            _loc1_ = this._model.getChatsByOutputChannel(this._channel,this._currentOffset,this._more.selected ? int(16) : int(6));
