package ddt.view.chat
{
   ...
   public class ChatView extends Sprite
   {
      ...
      private var _input:ddt.view.chat.ChatInputView;
      
      private var _output:ddt.view.chat.ChatOutputView;
      
      private var _state:int = -1;
      
      private var _stateArr:Vector.<ddt.view.chat.ChatViewInfo>;
      ...
      public function get input() : ddt.view.chat.ChatInputView
      {
         return this._input;
      }
      
      public function get output() : ddt.view.chat.ChatOutputView
      {
         return this._output;
      }
      ...
      private function updateViewState(param1:int) : void
      {
         ...
         this._output.contentField.chat_system::style = this._stateArr[param1].outputContentFieldStyle;
      ...
      {
         var _loc1_:ddt.view.chat.ChatViewInfo = null;
         var _loc2_:XML = null;
         ...
         while(_loc3_ <= 30)
         {
            _loc1_ = new ddt.view.chat.ChatViewInfo();
            _loc2_ = ComponentFactory.Instance.getCustomStyle("chatViewInfo.state_" + String(_loc3_));
            if(!_loc2_)
            {
               this._stateArr.push(_loc1_);
            }
            else
            {
               ObjectUtils.copyPorpertiesByXML(_loc1_,_loc2_);
               this._stateArr.push(_loc1_);
            }
            _loc3_++;
         }
