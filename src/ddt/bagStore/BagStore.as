package ddt.bagStore
{
   ...
   public class BagStore extends EventDispatcher
   {
      ...
      public static const OpenGrade_FineForge:int = 45;
      
      public static const OpenGrade_BringUp:int = 15;
      
      private static var _instance:ddt.bagStore.BagStore;
      ...
      public static function get instance() : ddt.bagStore.BagStore
      {
         if(_instance == null)
         {
            _instance = new ddt.bagStore.BagStore();
         }
         return _instance;
      }
