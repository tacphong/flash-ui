package ddt.data
{
   ...
   public class GoodsAdditioner
   {
      ...
      private static var _instance:ddt.data.GoodsAdditioner;
      ...
      public static function get Instance() : ddt.data.GoodsAdditioner
      {
         if(_instance == null)
         {
            _instance = new ddt.data.GoodsAdditioner();
         }
         return _instance;
      }
