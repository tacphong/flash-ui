package ddt.data.socket
{
   public class GameRoomPackageType
   {
      ...
      public static const SINGLE_ROOM_BEGIN:int = 18;
      
      public static const PASSED_WARRIORSARENA_10:int = 34;
      
      public static const No_WARRIORSARENA_TICKET:int = 35;
      
      public static const LAST_MISSION_FOR_WARRIORSARENA:int = 33;
       
      
      public function GameRoomPackageType()
      {
         super();
      }
   }
