   ...
   public class InventoryItemInfo extends ItemTemplateInfo
   {
      ...
      public function set isGold(param1:Boolean) : void
      {
         ...
         if(this._isGold)
         {
            ...
            this.StrengthenLevel = _loc2_.Strengthen == 13 ? int(_loc2_.Strengthen) : int(this.StrengthenLevel);
            Attack = _loc2_.Attack > 0 ? int(_loc2_.Attack) : int(Attack);
            Defence = _loc2_.Defence > 0 ? int(_loc2_.Defence) : int(Defence);
            Agility = _loc2_.Agility > 0 ? int(_loc2_.Agility) : int(Agility);
            Luck = _loc2_.Luck > 0 ? int(_loc2_.Luck) : int(Luck);
            this.Damage = _loc2_.Damage >= 0 ? int(_loc2_.Damage) : int(this.Damage);
            this.Guard = _loc2_.Guard >= 0 ? int(_loc2_.Guard) : int(this.Guard);
            this.Boold = _loc2_.Boold >= 0 ? int(_loc2_.Boold) : int(this.Boold);
