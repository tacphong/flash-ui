package ddt.data.effort
{
   ...
   public class EffortInfo extends EventDispatcher implements INotSameHeightListCellData
   {
      ...
      private var effortCompleteState:ddt.data.effort.EffortCompleteStateInfo;
      ...
      public function set CompleteStateInfo(param1:ddt.data.effort.EffortCompleteStateInfo) : void
      {
         this.effortCompleteState = param1;
      }
      
      public function get CompleteStateInfo() : ddt.data.effort.EffortCompleteStateInfo
      {
