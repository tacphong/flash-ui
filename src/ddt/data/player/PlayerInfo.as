package ddt.data.player
{
   ...
   public class PlayerInfo extends BasePlayer
   {
      ...
      {
         if(this._manualProInfo == null)
         {
            this._manualProInfo = new PlayerManualProInfo();
         }
         return this._manualProInfo;
      }
      
      public function getPropertyAdditionByType(param1:String) : DictionaryData
      {
         if(Boolean(this._propertyAddition) && this._propertyAddition.hasKey(param1))
         {
      ...
      private function parseStyle() : void
      {
         ...
         var _loc2_:Array = this._style.split(",");
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc1_ = this.getTID(_loc2_[_loc3_]);
            if((_loc1_ == "" || _loc1_ == "0" || _loc1_ == "-1") && _loc3_ + 1 != EquipType.ARM && _loc3_ < 7)
            {
               _loc2_[_loc3_] = this.replaceTID(_loc2_[_loc3_],String(_loc3_ + 1) + (Sex ? "1" : "2") + "01");
            }
            else if((_loc1_ == "" || _loc1_ == "0" || _loc1_ == "-1") && _loc3_ + 1 == EquipType.ARM)
            {
               _loc2_[_loc3_] = this.replaceTID(_loc2_[_loc3_],"700" + (Sex ? "1" : "2"),false);
            }
            if((_loc1_ == "" || _loc1_ == "0" || _loc1_ == "-1") && _loc3_ == 7)
            {
               _loc2_[_loc3_] = this.replaceTID(_loc2_[_loc3_],"13" + (Sex ? "1" : "2") + "01");
            }
            if((_loc1_ == "" || _loc1_ == "0" || _loc1_ == "-1") && _loc3_ == 8)
            {
               _loc2_[_loc3_] = this.replaceTID(_loc2_[_loc3_],"15001");
            }
            if((_loc1_ == "" || _loc1_ == "0" || _loc1_ == "-1") && _loc3_ == 9)
            {
               _loc2_[_loc3_] = this.replaceTID(_loc2_[_loc3_],"16000");
            }
            _loc3_++;
         }
         if(this._hidehat || this._hideGlass || this._suitesHide)
         {
            if(this._hidehat)
            {
               _loc2_[0] = this.replaceTID(_loc2_[0],"1" + (Sex ? "1" : "2") + "01");
            }
            if(this._hideGlass)
            {
               _loc2_[1] = this.replaceTID(_loc2_[1],"2" + (Sex ? "1" : "2") + "01");
            }
            if(this._suitesHide)
            {
               _loc2_[7] = this.replaceTID(_loc2_[7],"13" + (Sex ? "1" : "2") + "01");
            }
         }
         this._modifyStyle = _loc2_.join(",");
      }
      ...
      public function getSkinColor() : String
      {
         ...
         var _loc2_:String = String(_loc1_[EquipType.CategeryIdToPlace(EquipType.FACE)[0]].split("|")[1]);
      ...
      {
         var _loc1_:String = String(this._style.split(",")[9].split("|")[0]);
         _loc1_.slice(4);
      ...
      {
         var _loc1_:MyGiftCellInfo = null;
         var _loc2_:int = 0;
         for each(_loc1_ in this.myGiftData)
         {
      ...
      public function getLastDate() : int
      {
         ...
         return _loc3_ < 1 ? int(1) : int(_loc3_);
      }
