package ddt.data.player
{
   ...
   public class BasePlayer extends EventDispatcher
   {
      ...
      private var _matchInfo:ddt.data.player.MatchInfo;
      ...
      private var _state:ddt.data.player.PlayerState;
      ...
      public function get matchInfo() : ddt.data.player.MatchInfo
      {
         if(this._matchInfo == null)
         {
            this._matchInfo = new ddt.data.player.MatchInfo();
         }
         return this._matchInfo;
      }
      
      public function set matchInfo(param1:ddt.data.player.MatchInfo) : void
      {
      ...
      public function get playerState() : ddt.data.player.PlayerState
      {
         if(this._state == null)
         {
            this._state = new ddt.data.player.PlayerState(PlayerState.ONLINE);
         }
         return this._state;
      }
      
      public function set playerState(param1:ddt.data.player.PlayerState) : void
      {
