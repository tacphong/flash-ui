package ddt.data
{
   ...
   public class FightAchievModel
   {
      ...
      private static var _ins:ddt.data.FightAchievModel;
      ...
      public static function getInstance() : ddt.data.FightAchievModel
      {
         if(_ins == null)
         {
      ...
      {
         if(Boolean(this._colors) && param1 <= this._colors.length)
         {
