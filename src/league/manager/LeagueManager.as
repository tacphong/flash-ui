package league.manager
{
   ...
   public class LeagueManager extends EventDispatcher
   {
      ...
      private static var _instance:league.manager.LeagueManager;
      ...
      public static function get instance() : league.manager.LeagueManager
      {
         if(_instance == null)
         {
            _instance = new league.manager.LeagueManager();
         }
         return _instance;
      }
