package equipDebt
{
   ...
   public class EquipDebtManager extends EventDispatcher
   {
      ...
      private static var _instance:equipDebt.EquipDebtManager;
      ...
      public static function get Instance() : equipDebt.EquipDebtManager
      {
         if(_instance == null)
         {
            _instance = new equipDebt.EquipDebtManager();
         }
         return _instance;
      }
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._viewPrompt))
         {
            this._viewPrompt.dispose();
         }
         if(Boolean(this._viewDebt))
         {
