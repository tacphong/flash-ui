package littleGame
{
   ...
   public class LittleHall extends BaseStateView
   {
      ...
      private var _gameLoader:littleGame.LittleGameLoader;
      ...
      private function __loadGame(param1:LittleGameSocketEvent) : void
      {
         ...
         this._gameLoader = new littleGame.LittleGameLoader(this._game);
      ...
      {
         var _loc2_:littleGame.LittleGameLoader = param1.currentTarget as LittleGameLoader;
