package littleGame.model
{
   ...
   public class Scenario extends EventDispatcher implements IProcessObject
   {
      ...
      private var _selfPlayer:littleGame.model.LittleSelf;
      ...
      public function setSelfPlayer(param1:littleGame.model.LittleSelf) : void
      {
      ...
      public function get selfPlayer() : littleGame.model.LittleSelf
      {
