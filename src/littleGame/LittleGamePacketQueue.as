package littleGame
{
   ...
   public class LittleGamePacketQueue implements IProcessObject
   {
      ...
      private static var _ins:littleGame.LittleGamePacketQueue;
      ...
      public static function get Instance() : littleGame.LittleGamePacketQueue
      {
         return _ins = _ins || new littleGame.LittleGamePacketQueue();
      }
