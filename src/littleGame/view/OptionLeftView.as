package littleGame.view
{
   ...
   public class OptionLeftView extends Sprite implements Disposeable
   {
      ...
      private function initView() : void
      {
         ...
         this._titleField.text = "Đại chiến gà";
         addChild(this._titleField);
         this._previewLoader = LoaderManager.Instance.creatLoader(PathManager.solveLittleGameMapPreview(1),BaseLoader.BITMAP_LOADER);
      ...
      private function __previewMapComplete(param1:LoaderEvent) : void
      {
         ...
         {
            param1.loader.removeEventListener(LoaderEvent.COMPLETE,this.__previewMapComplete);
            ObjectUtils.disposeObject(this._previewMap);
            this._previewMap = null;
            this._previewMap = param1.loader.content as Bitmap;
