package littleGame.view
{
   ...
   public class GameLittleLiving extends Sprite implements Disposeable
   {
      ...
      {
         return Boolean(this._living) && this._living.lock;
      }
      ...
      {
         return Boolean(this._living) && this._living.inGame;
      }
      ...
      protected function createBody() : void
      {
         ...
         _loc1_ = null;
         _loc1_ = CharacterFactory.Instance.creatChacrater(this._living.ddt_internal::_modelID);
      ...
      {
         if(!this.lock && Boolean(this._body))
         {
      ...
      {
         if(!this.lock && this._living && Boolean(this._body))
         {
      ...
      protected function centerBody() : void
      {
         ...
         if(Boolean(this._body) && Boolean(_loc1_))
         {
      ...
      private function __posChanged(param1:LittleLivingEvent) : void
      {
         ...
         {
            x = this._living.pos.x * this._living.speed;
            y = this._living.pos.y * this._living.speed + this._living.ddt_internal::gridIdx;
            this.isMove = true;
         }
      }
