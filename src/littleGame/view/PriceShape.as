package littleGame.view
{
   ...
   public class PriceShape extends Bitmap implements Disposeable
   {
      ...
      {
         var _loc2_:BitmapData = LittleGameManager.Instance.Current.ddt_internal::priceBack;
         var _loc3_:int = _loc2_.width;
         var _loc4_:BitmapData = LittleGameManager.Instance.Current.ddt_internal::priceNum;
