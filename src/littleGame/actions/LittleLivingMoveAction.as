package littleGame.actions
{
   ...
   public class LittleLivingMoveAction extends LittleAction
   {
      ...
      override public function prepare() : void
      {
         ...
         if(Boolean(this._path))
         {
            _loc1_ = this._path[0];
            _loc2_ = new Point(_loc1_.x,_loc1_.y);
            if(Boolean(_living))
            {
               _living.ddt_internal::setNextDirection(_loc2_);
               _living.pos = _loc2_;
            }
         }
         super.prepare();
      ...
      override public function execute() : void
      {
         var _loc1_:Node = null;
         var _loc2_:Point = null;
         if(Boolean(this._path) && this._idx < this._path.length)
         {
      ...
      override protected function finish() : void
      {
         ...
         var _loc2_:Node = this._path[this._path.length - 1];
         if(Boolean(_loc2_))
         {
