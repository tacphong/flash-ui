package littleGame
{
   ...
   public class LittleGameLoader extends EventDispatcher implements IProcessObject
   {
      ...
      private var _scenarioLoader:littleGame.ScenarioLoader;
      
      private var _monsterLoader:littleGame.MonsterLoader;
      ...
      {
         this._scenarioLoader = new littleGame.ScenarioLoader(this._game);
         this._scenarioLoader.addEventListener(LoaderEvent.COMPLETE,this.__scenarioComplete);
         this._scenarioLoader.startup();
         this._monsterLoader = new littleGame.MonsterLoader(this._game.monsters.split(","));
