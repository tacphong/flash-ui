package littleGame.object
{
   ...
   public class BoguGiveUp extends Sprite implements ILittleObject
   {
      ...
      public function execute() : void
      {
         ...
         {
            _loc1_ = LittleGameManager.Instance.mainStage.getChildIndex(ChatManager.Instance.view);
            LittleGameManager.Instance.mainStage.addChildAt(this,_loc1_);
         }
         else
         {
