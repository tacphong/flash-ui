package littleGame.object
{
   ...
   public class NormalBoguInhaled extends Sprite implements ILittleObject
   {
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:GameLittleLiving = null;
         this._scene = param1;
         ...
         var _loc6_:GameScene = LittleGameManager.Instance.gameScene;
         this._gameLivings = new Dictionary();
         this._gameLivings[this._target.id] = _loc6_.findGameLiving(this._target.id);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_)
         {
            _loc3_ = param2.readInt();
            _loc4_ = _loc6_.findGameLiving(_loc3_);
            if(Boolean(_loc4_))
            {
               this._gameLivings[_loc3_] = _loc4_;
            }
            _loc7_++;
         }
      ...
      protected function releaseLivings() : void
      {
         ...
         var _loc3_:DisplayObjectContainer = null;
         var _loc4_:* = null;
         var _loc5_:GameScene = null;
         var _loc6_:int = 0;
         _loc7_ = new Array();
         for(_loc4_ in this._gameLivings)
         {
            _loc1_ = this._gameLivings[_loc4_];
            if(Boolean(_loc1_))
            {
               _loc1_.setInhaled(false);
            }
            if(_loc1_.inGame)
            {
               _loc1_.lock = false;
               _loc1_.living.stand();
               _loc1_.living.doAction("stand");
               _loc1_.x = _loc1_.living.pos.x * _loc1_.living.speed;
               _loc1_.y = _loc1_.living.pos.y * _loc1_.living.speed;
               _loc7_.push(_loc1_);
            }
         }
         _loc7_.sortOn("y",Array.NUMERIC);
         _loc5_ = LittleGameManager.Instance.gameScene;
         _loc6_ = 0;
         while(_loc6_ < _loc7_.length)
         {
            _loc5_.addToLayer(_loc7_[_loc6_] as DisplayObject,LittleGameManager.GameBackLayer);
            _loc6_++;
         }
      }
