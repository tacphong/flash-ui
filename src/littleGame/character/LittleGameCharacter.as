package littleGame.character
{
   ...
   public class LittleGameCharacter extends ComplexBitmapCharacter implements Disposeable
   {
      ...
      private var _loader:littleGame.character.LittleGameCharaterLoader;
      ...
      public function LittleGameCharacter(param1:PlayerInfo, param2:int = 1)
      {
         ...
         this._loader = new littleGame.character.LittleGameCharaterLoader(this._playerInfo,param2);
      ...
      override public function dispose() : void
      {
         ...
         super.dispose();
         if(Boolean(this._headBmd))
         {
            this._headBmd.dispose();
            this._headBmd = null;
         }
         if(Boolean(this._bodyBmd) && this.hasClothColor)
         {
         ...
         if(this.hasFaceColor && Boolean(this.headBmds))
         {
            _loc1_ = 0;
            while(_loc1_ < this.headBmds.length)
            {
               if(Boolean(this.headBmds[_loc1_]))
               {
