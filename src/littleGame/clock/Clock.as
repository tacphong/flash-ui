package littleGame.clock
{
   ...
   public class Clock extends EventDispatcher implements IProcessObject
   {
      ...
      private var _deltas:Vector.<littleGame.clock.TimeDelta>;
      ...
      private function addTimeDelta(param1:int, param2:int, param3:int) : void
      {
         ...
         var _loc7_:littleGame.clock.TimeDelta = new littleGame.clock.TimeDelta(_loc4_,_loc6_);
      ...
      {
         var _loc1_:Vector.<littleGame.clock.TimeDelta> = this._deltas.slice(0);
      ...
      private function determineAverage(param1:Vector.<littleGame.clock.TimeDelta>) : int
      {
         var _loc2_:littleGame.clock.TimeDelta = null;
         var _loc3_:Number = 0;
         var _loc4_:Number = 0;
      ...
      private function determineAverageLatency(param1:Vector.<littleGame.clock.TimeDelta>) : int
      {
         var _loc2_:littleGame.clock.TimeDelta = null;
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         ...
         var _loc5_:int = _loc3_ / param1.length;
         this._latencyError = Math.abs(TimeDelta(param1[param1.length - 1]).latency - _loc5_);
         return _loc5_;
      }
      
      private function pruneOutliers(param1:Vector.<littleGame.clock.TimeDelta>, param2:int, param3:Number) : void
      {
         var _loc4_:littleGame.clock.TimeDelta = null;
      ...
      private function determineMedian(param1:Vector.<littleGame.clock.TimeDelta>) : int
      {
      ...
      private function compare(param1:littleGame.clock.TimeDelta, param2:littleGame.clock.TimeDelta) : Number
      {
