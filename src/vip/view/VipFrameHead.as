package vip.view
{
   ...
   public class VipFrameHead extends Sprite implements Disposeable
   {
      ...
      private var _helpFrame:vip.view.VIPHelpFrame;
      ...
      {
         if(Boolean(param1.changedProperties["isVip"]) || Boolean(param1.changedProperties["VipExpireDay"]) || Boolean(param1.changedProperties["VIPNextLevelDaysNeeded"]))
         {
            this.upView();
         }
      }
      ...
      private function upView() : void
      {
         ...
         {
            _loc2_ = PlayerManager.Instance.Self.VIPExp - ServerConfigManager.instance.VIPExpNeededForEachLv[PlayerManager.Instance.Self.VIPLevel - 1];
            _loc3_ = ServerConfigManager.instance.VIPExpNeededForEachLv[PlayerManager.Instance.Self.VIPLevel] - ServerConfigManager.instance.VIPExpNeededForEachLv[PlayerManager.Instance.Self.VIPLevel - 1];
         }
