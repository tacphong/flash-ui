package explorerManual.view.page
{
   ...
   public class ExplorerPageUnActiveView extends ExplorerPageRightViewBase
   {
      ...
      {
         this._unActiveItem = ComponentFactory.Instance.creat("asset.explorerManual.pageRightView.unActiveItem");
         addChild(this._unActiveItem);
         super.initView();
      ...
      {
         super.dispose();
         ObjectUtils.disposeObject(this._unActiveItem);
         this._unActiveItem = null;
