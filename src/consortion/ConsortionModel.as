package consortion
{
   ...
   public class ConsortionModel extends EventDispatcher
   {
      ...
      public function get onlineConsortiaMemberList() : Array
      {
         ...
         var _loc2_:Array = [];
         for each(_loc1_ in this.memberList)
         {
      ...
      public function consortiaPlayerStateChange(param1:int, param2:int) : void
      {
         ...
         var _loc4_:ConsortiaPlayerInfo = this.getConsortiaMemberInfo(param1);
         if(_loc4_ == null)
         {
            return;
         }
         if(Boolean(_loc4_))
         {
            _loc3_ = new PlayerState(param2);
            _loc4_.playerState = _loc3_;
            this.updataMember(_loc4_);
         }
      }
      ...
      {
         var _loc2_:int = int(this.myApplyList.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      public function getskillInfoWithTypeAndLevel(param1:int, param2:int) : Vector.<ConsortionSkillInfo>
      {
         ...
         var _loc4_:int = int(this.skillInfoList.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
      ...
      {
         var _loc5_:int = int(this.skillInfoList.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
      ...
      {
         var _loc3_:int = int(this.skillInfoList.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
         ...
         switch(param1)
         {
            ...
            case SHOP:
               ...
               else
               {
                  ...
                  if(Boolean(this.getLevelData(param2 + 1)))
                  {
