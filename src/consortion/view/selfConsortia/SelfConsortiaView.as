package consortion.view.selfConsortia
{
   ...
   public class SelfConsortiaView extends Sprite implements Disposeable
   {
      ...
      private var _infoView:consortion.view.selfConsortia.ConsortionInfoView;
      
      private var _memberList:consortion.view.selfConsortia.MemberList;
      
      private var _placardAndEvent:consortion.view.selfConsortia.PlacardAndEvent;
      
      private var _buildingManager:consortion.view.selfConsortia.BuildingManager;
