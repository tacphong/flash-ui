package consortion.view.selfConsortia
{
   ...
   public class ConsortionShopItem extends Sprite implements Disposeable
   {
      ...
      private var _btnArr:Vector.<consortion.view.selfConsortia.ConsortionShopItemBtn>;
      ...
      private function upView() : void
      {
         ...
         this._limitCount.text = String(this._info.LimitCount);
         this._limitCount.visible = this._info.TemplateInfo.CategoryID == EquipType.NECKLACE ? (this._info.TemplateID == 14011 ? Boolean(false) : Boolean(true)) : Boolean(false);
         ...
         while(_loc1_ < 3)
         {
            ...
            {
               this._btnArr[_loc1_] = new consortion.view.selfConsortia.ConsortionShopItemBtn();
      ...
      private function __clickHandler(param1:MouseEvent) : void
      {
         ...
         var _loc3_:consortion.view.selfConsortia.ConsortionShopItemBtn = param1.currentTarget as ConsortionShopItemBtn;
         this._time = this._btnArr.indexOf(_loc3_) + 1;
         if(this.checkMoney())
         {
            _loc2_ = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("tank.view.common.AddPricePanel.pay"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),false,false,false,LayerManager.ALPHA_BLOCKGOUND);
