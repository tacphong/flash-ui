package consortion.view.selfConsortia
{
   ...
   public class TakeInMemberFrame extends Frame
   {
      ...
      private var _turnPage:consortion.view.selfConsortia.TakeInTurnPage;
      ...
      private function initView() : void
      {
         ...
         this._setRefuse.visible = PlayerManager.Instance.Self.consortiaInfo.ChairmanID == PlayerManager.Instance.Self.ID ? Boolean(true) : Boolean(false);
      ...
      {
         var _loc2_:TakeInMemberItem = null;
         this.clearList();
      ...
      private function sort(param1:String) : void
      {
         ...
         {
            _loc2_ = this._items[_loc4_] as TakeInMemberItem;
         ...
         {
            _loc3_ = this._items[_loc5_] as TakeInMemberItem;
      ...
      {
         var _loc1_:TakeInMemberItem = null;
         var _loc2_:Boolean = true;
         var _loc3_:int = 0;
         while(_loc3_ < this._items.length)
         {
            _loc1_ = this._items[_loc3_] as TakeInMemberItem;
            if(Boolean(_loc1_))
            {
               if(_loc1_.selected)
               {
                  SocketManager.Instance.out.sendConsortiaTryinPass(_loc1_.info.ID);
                  _loc2_ = false;
               }
            }
            _loc3_++;
      ...
      private function refuse() : void
      {
         ...
         while(_loc3_ < this._items.length)
         {
            ...
            if(Boolean(_loc1_))
            {
               ...
               {
                  SocketManager.Instance.out.sendConsortiaTryinDelete(_loc1_.info.ID);
                  _loc2_ = false;
               }
            }
            _loc3_++;
