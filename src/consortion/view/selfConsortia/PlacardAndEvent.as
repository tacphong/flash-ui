package consortion.view.selfConsortia
{
   ...
   public class PlacardAndEvent extends Sprite implements Disposeable
   {
      ...
      {
         var _loc2_:EventListItem = null;
         this._vbox.disposeAllChildren();
         var _loc3_:Vector.<ConsortiaEventInfo> = ConsortionModelControl.Instance.model.eventList;
      ...
      {
         this._editBtn.enable = this._cancelBtn.enable = true;
      ...
      {
         if(Boolean(param1.changedProperties[ConsortiaInfo.PLACARD]) || Boolean(param1.changedProperties[ConsortiaInfo.IS_VOTING]))
         {
            this.upPlacard();
         }
      }
