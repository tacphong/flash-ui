package consortion.view.selfConsortia
{
   ...
   public class ConsortionSkillFrame extends Frame
   {
      ...
      private var _items:Vector.<consortion.view.selfConsortia.ConsortionSkillItem>;
      ...
      {
         if(Boolean(param1.changedProperties[ConsortiaInfo.RICHES]) && this._btnGroup.selectIndex == 0)
         {
      ...
      {
         if((Boolean(param1.changedProperties["RichesRob"]) || Boolean(param1.changedProperties["RichesOffer"])) && this._btnGroup.selectIndex == 1)
         {
      ...
      private function showContent(param1:int) : void
      {
         ...
         var _loc5_:consortion.view.selfConsortia.ConsortionSkillItem = null;
         var _loc6_:int = 0;
         ...
         if(Boolean(this._items) && this._items.length == 0)
         {
            ...
            {
               _loc3_ = _loc2_ + 1 > PlayerManager.Instance.Self.consortiaInfo.BufferLevel ? Boolean(false) : Boolean(true);
               _loc4_ = param1 == 3 ? Boolean(true) : Boolean(false);
               _loc5_ = new consortion.view.selfConsortia.ConsortionSkillItem(_loc2_ + 1,_loc3_,_loc4_);
               _loc6_ = param1 == 3 ? int(2) : int(param1);
