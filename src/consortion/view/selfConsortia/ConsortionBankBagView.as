package consortion.view.selfConsortia
{
   ...
   public class ConsortionBankBagView extends BagView
   {
      ...
      private var _bank:consortion.view.selfConsortia.ConsortionBankListView;
      ...
      {
         if(Boolean(_keySetBtn) && _isSkillCanUse())
         {
            _keySetBtn.enable = true;
         }
         if(Boolean(_sortBagBtn))
         {
      ...
      {
         if(Boolean(_goldText))
         {
            _goldText.y += 31;
         }
         if(Boolean(_moneyText))
         {
            _moneyText.y += 31;
         }
         if(Boolean(_giftText))
         {
            _giftText.y += 31;
         }
         if(Boolean(_medalField))
         {
            _medalField.y += 31;
         }
      }
      ...
      override protected function initBackGround() : void
      {
         ...
         this._bank = new consortion.view.selfConsortia.ConsortionBankListView(11,PlayerManager.Instance.Self.consortiaInfo.StoreLevel);
      ...
      override public function dispose() : void
      {
         ...
         this.title = null;
         if(Boolean(this.smallBg))
         {
            ObjectUtils.disposeObject(this.smallBg);
         }
         this.smallBg = null;
         if(Boolean(this.numBg))
         {
