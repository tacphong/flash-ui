package consortion.view.selfConsortia
{
   ...
   public class ConsortionShopFrame extends Frame
   {
      ...
      private var _list:consortion.view.selfConsortia.ConsortionShopList;
      ...
      private function __propChangeHandler(param1:PlayerPropertyEvent) : void
      {
         ...
         if(Boolean(param1.changedProperties["Gold"]))
         {
            this._gold.text = String(PlayerManager.Instance.Self.Gold);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:Boolean = PlayerManager.Instance.Self.consortiaInfo.ShopLevel >= param1 ? Boolean(true) : Boolean(false);
         var _loc4_:Vector.<ConsortiaAssetLevelOffer> = ConsortionModelControl.Instance.model.useConditionList;
         ...
         {
            _loc2_ = ConsortionModelControl.Instance.model.useConditionList[param1 - 1].Riches;
         }
         this._list.list(ShopManager.Instance.consortiaShopLevelTemplates(param1),param1,_loc2_,_loc3_);
      }
