package consortion.view.selfConsortia
{
   ...
   public class ConsortionPollFrame extends Frame
   {
      ...
      private var _items:Vector.<consortion.view.selfConsortia.ConsortionPollItem>;
      
      private var _currentItem:consortion.view.selfConsortia.ConsortionPollItem;
      ...
      {
         var _loc2_:consortion.view.selfConsortia.ConsortionPollItem = null;
         this.clearList();
         if(param1 == null)
         {
            return;
         ...
         {
            _loc2_ = new consortion.view.selfConsortia.ConsortionPollItem();
