package consortion.view.selfConsortia
{
   ...
   public class ConsortionInfoView extends Sprite implements Disposeable
   {
      ...
      private var _badgeBtn:consortion.view.selfConsortia.BuyBadgeButton;
      
      private var _shopIcon:consortion.view.selfConsortia.BuildingLevelItem;
      
      private var _storeIcon:consortion.view.selfConsortia.BuildingLevelItem;
      
      private var _bankIcon:consortion.view.selfConsortia.BuildingLevelItem;
      
      private var _skillIcon:consortion.view.selfConsortia.BuildingLevelItem;
      ...
      {
         this._badgeBtn = new consortion.view.selfConsortia.BuyBadgeButton();
         PositionUtils.setPos(this._badgeBtn,"consortiaBadgeBtn.pos");
         this._shopIcon = new consortion.view.selfConsortia.BuildingLevelItem(ConsortionModel.SHOP);
         PositionUtils.setPos(this._shopIcon,"shopIcon.pos");
         this._storeIcon = new consortion.view.selfConsortia.BuildingLevelItem(ConsortionModel.STORE);
         PositionUtils.setPos(this._storeIcon,"storeIcon.pos");
         this._bankIcon = new consortion.view.selfConsortia.BuildingLevelItem(ConsortionModel.BANK);
         PositionUtils.setPos(this._bankIcon,"bankIcon.pos");
         this._skillIcon = new consortion.view.selfConsortia.BuildingLevelItem(ConsortionModel.SKILL);
      ...
      {
         if(Boolean(param1.changedProperties["consortiaInfo"]))
         {
            this.consortionInfo = PlayerManager.Instance.Self.consortiaInfo;
         }
      }
