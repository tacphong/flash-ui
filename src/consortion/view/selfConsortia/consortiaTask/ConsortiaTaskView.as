package consortion.view.selfConsortia.consortiaTask
{
   ...
   public class ConsortiaTaskView extends Sprite implements Disposeable
   {
      ...
      private var _myView:consortion.view.selfConsortia.consortiaTask.ConsortiaMyTaskView;
      ...
      {
         var _loc2_:int = 0;
         if(Boolean(param1.changedProperties["Right"]) && ConsortionModelControl.Instance.TaskModel.taskInfo != null)
         {
