package consortion.view.club
{
   ...
   public class ConsortionList extends VBox
   {
      ...
      private var _currentItem:consortion.view.club.ConsortionListItem;
      
      private var items:Vector.<consortion.view.club.ConsortionListItem>;
      ...
      override protected function init() : void
      {
         ...
         while(_loc1_ < 6)
         {
            this.items[_loc1_] = new consortion.view.club.ConsortionListItem();
      ...
      public function get currentItem() : consortion.view.club.ConsortionListItem
      {
      ...
      private function setStatus() : void
      {
         ...
         if(this._selfApplyList != null)
         {
            ...
            while(_loc1_ < 6)
            {
               _loc2_ = int(this._selfApplyList.length);
