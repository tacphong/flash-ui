package consortion.view.club
{
   ...
   public class ClubRecordList extends Sprite implements Disposeable
   {
      ...
      private var _items:Vector.<consortion.view.club.ClubRecordItem>;
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:consortion.view.club.ClubRecordItem = null;
         ...
         if(Boolean(param1) && param1.length > 0)
         {
            ...
            {
               _loc4_ = new consortion.view.club.ClubRecordItem(param2);
