package gemstone.views
{
   ...
   public class GemstoneObtainView extends Frame
   {
      ...
      override public function dispose() : void
      {
         ...
         this._bg = null;
         if(Boolean(this._numBg1))
         {
            ObjectUtils.disposeObject(this._numBg1);
         }
         this._numBg1 = null;
         if(Boolean(this._numBg2))
         {
