package gemstone.views
{
   ...
   public class GemstoneUpView extends Frame
   {
      ...
      private var _gemstoneCriView:gemstone.views.GemstoneCriView;
      ...
      private var _gemstoneInfoView:gemstone.views.GemstoneInfoView;
      
      private var _gemstoneCurInfo:gemstone.views.GemstoneCurInfo;
      ...
      private function initView() : void
      {
         ...
         this._gemstoneInfoView = new gemstone.views.GemstoneInfoView();
         ...
         this._gemstoneCurInfo = new gemstone.views.GemstoneCurInfo();
         this._gemstoneCurInfo.x = 365;
         this._gemstoneCurInfo.y = 22;
         this._gemstoneCriView = new gemstone.views.GemstoneCriView();
      ...
      public function upDatafitCount() : void
      {
         ...
         _loc2_ += _loc1_.getItemCountByTemplateId(201264);
      ...
      protected function btnClickHander(param1:MouseEvent) : void
      {
         ...
         if(param1.currentTarget.id == 1)
         {
            ...
            if(GemstoneManager.Instance.hariList.length > 0)
            {
               _loc3_ = GemstoneManager.Instance.hariList;
               this._fightSpiritId = GemstoneManager.Instance.hariList[0].fightSpiritId;
            }
            this._equipPlayce = GemstoneManager.HariPPLACE;
            _loc4_ = "gemstone.attckBig";
         ...
         else if(param1.currentTarget.id == 5)
         {
            ...
            {
               _loc3_ = GemstoneManager.Instance.decorationList;
         ...
         this._gemstoneCriView.initFigSkin(_loc4_);
         this._gemstoneCriView.upDataIcon(_loc2_);
         if(Boolean(_loc3_))
         {
            this._gemstoneCriView.resetGemstoneList(_loc3_);
         }
      ...
      private function mouseClickHander(param1:MouseEvent) : void
      {
         ...
         if(!(_loc5_ > 0 && this._isAutoSele == 0))
         {
            _loc2_ = 10010001;
            _loc3_ = 100100;
            _loc5_ += _loc4_.getItemCountByTemplateId(_loc3_);
            if(_loc5_ > 0)
            {
               this.sendFigSpiritUpGrade(_loc2_,_loc3_);
            }
      ...
      override public function dispose() : void
      {
         ...
         if(Boolean(this._gemstoneCriView))
         {
         ...
         this._expBar = null;
         if(Boolean(this._seletedBitMap))
         {
