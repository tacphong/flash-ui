package cardSystem.view.cardEquip
{
   ...
   public class CardEquipView extends Sprite implements Disposeable
   {
      ...
      private var _dragArea:cardSystem.view.cardEquip.CardEquipDragArea;
      ...
      private function initView() : void
      {
         ...
         this._dragArea = new cardSystem.view.cardEquip.CardEquipDragArea(this);
         ...
         while(_loc2_ < 5)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = new CardCell(ComponentFactory.Instance.creatComponentByStylename("asset.cardEquipView.mainBG"),_loc2_);
               _loc1_.setContentSize(118,167);
               _loc1_.setStarPos(59,154);
            }
            else
            {
               _loc1_ = new CardCell(ComponentFactory.Instance.creatComponentByStylename("CardEquipView.viceCardBG" + _loc2_),_loc2_);
               _loc1_.setContentSize(74,107);
            }
            if(this._clickEnable)
            {
            ...
            _loc1_.addEventListener(MouseEvent.MOUSE_OVER,this._cellOverEff);
            _loc1_.addEventListener(MouseEvent.MOUSE_OUT,this._cellOutEff);
            DoubleClickManager.Instance.enableDoubleClick(_loc1_);
            this._equipCells[_loc2_] = _loc1_;
            addChild(_loc1_);
            _loc2_++;
         }
         ...
         while(_loc3_ < 4)
         {
            this._viceCardBit[_loc3_] = ComponentFactory.Instance.creatBitmap("asset.cardEquipView.viceCardBG");
            addChild(this._viceCardBit[_loc3_]);
            _loc3_++;
         }
      ...
      {
         if(Boolean(this._equipCells))
         {
            this._equipCells[3].open = this._playerInfo.cardEquipDic[3] == null ? Boolean(false) : Boolean(true);
            ...
            else if(Boolean(this._cell3MouseSprite))
            {
               this.removeSprite(this._cell3MouseSprite,this._open3Btn);
            }
            this._equipCells[4].open = this._playerInfo.cardEquipDic[4] == null ? Boolean(false) : Boolean(true);
            ...
            else if(Boolean(this._cell4MouseSprite))
            {
      ...
      protected function __clickHandler(param1:Event) : void
      {
         ...
         var _loc3_:CardCell = param1.currentTarget as CardCell;
         if(Boolean(_loc3_))
         {
