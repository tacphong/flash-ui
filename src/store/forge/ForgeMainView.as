package store.forge
{
   ...
   public class ForgeMainView extends Sprite implements Disposeable
   {
      ...
      private function clickHandler(param1:MouseEvent) : void
      {
		 ...
		 if(this._tabSBList.indexOf(param1.currentTarget as SelectedButton) == 1 && PlayerManager.Instance.Self.Grade < 40)
         {
            MessageTipManager.getInstance().show(LanguageMgr.GetTranslation("tangcap.limitLevel.tipTxt"));
            param1.stopImmediatePropagation();
         }
         if(this._tabSBList.indexOf(param1.currentTarget as SelectedButton) == 3 && PlayerManager.Instance.Self.Grade < 50)
         {
