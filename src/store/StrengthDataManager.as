package store
{
   ...
   public class StrengthDataManager extends EventDispatcher
   {
      ...
      private static var _instance:store.StrengthDataManager;
      ...
      public static function get instance() : store.StrengthDataManager
      {
         if(_instance == null)
         {
            _instance = new store.StrengthDataManager();
         }
         return _instance;
      }
