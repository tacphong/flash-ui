package store.fineStore.view.pageBringUp
{
   ...
   public class FineBringUpView extends Sprite implements Disposeable, IObserver
   {
	  ...
	  private function onEatClick(param1:InventoryItemInfo) : Boolean
	  {
		  ...
		  if(_bringUpItemCell)
		  {
			  return FineBringUpController.getInstance().eatBtnClick(_bringUpItemCell.info as InventoryItemInfo,param1);
		  }
		  return true;
	  }
