package store.view.shortcutBuy
{
   ...
   public class ShortCutBuyView extends Sprite implements Disposeable
   {
      ...
      private var _list:store.view.shortcutBuy.ShortcutBuyList;
      ...
      private function init() : void
      {
         ...
         var _loc2_:ShopItemInfo = ShopManager.Instance.getShopItemByGoodsID(this._memoryItemID);
         if(Boolean(_loc2_) && this._templateItemIDList.indexOf(_loc2_.TemplateID) > -1)
         {
            this._list.selectedItemID = _loc2_.TemplateID;
         }
         else
         {
            this._list.selectedItemID = this._templateItemIDList[0];
         }
         if(_loc2_ && _loc2_.getItemPrice(1).IsGiftType && this._templateItemIDList.indexOf(_loc2_.TemplateID) > -1)
         {
         ...
         addChild(this._num);
         _loc1_ = ComponentFactory.Instance.creatBitmap("asset.store.shortCutPayTip");
         addChild(_loc1_);
      ...
      public function get List() : store.view.shortcutBuy.ShortcutBuyList
      {
         return this._list;
      }
      ...
      public function get totalPrice() : ItemPrice
      {
         ...
         if(Boolean(this.currentShopItem))
         {
