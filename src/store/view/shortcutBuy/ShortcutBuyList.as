package store.view.shortcutBuy
{
   ...
   public class ShortcutBuyList extends Sprite implements Disposeable
   {
      ...
      private var _cells:Vector.<store.view.shortcutBuy.ShortcutBuyCell>;
      ...
      {
         var _loc3_:store.view.shortcutBuy.ShortcutBuyCell = null;
         ...
         while(_loc4_ < param1.length)
         {
            ...
            _loc3_ = new store.view.shortcutBuy.ShortcutBuyCell(_loc2_);
            _loc3_.info = _loc2_;
            _loc3_.addEventListener(MouseEvent.CLICK,this.cellClickHandler);
      ...
      {
         var _loc1_:store.view.shortcutBuy.ShortcutBuyCell = null;
      ...
      {
         var _loc2_:store.view.shortcutBuy.ShortcutBuyCell = null;
