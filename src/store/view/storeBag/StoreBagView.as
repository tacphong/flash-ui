package store.view.storeBag
{
   ...
   public class StoreBagView extends Sprite implements Disposeable
   {
      ...
      private var _controller:store.view.storeBag.StoreBagController;
      
      private var _model:StoreModel;
      
      private var _equipmentView:store.view.storeBag.StoreBagListView;
      
      private var _propView:store.view.storeBag.StoreBagListView;
      
      private var _singleView:store.view.storeBag.StoreSingleBagListView;
      
      private var _bitmapBg:store.view.storeBag.StoreBagbgbmp;
      ...
      public function setup(param1:store.view.storeBag.StoreBagController) : void
      {
      ...
      {
         this._bitmapBg = new store.view.storeBag.StoreBagbgbmp();
      ...
      private function __cellClick(param1:CellEvent) : void
      {
         ...
         if(Boolean(_loc3_))
         {
            _loc2_ = _loc3_.info as InventoryItemInfo;
         }
         if(_loc2_ == null)
         {
            return;
      ...
      public function get EquipList() : store.view.storeBag.StoreBagListView
      {
         return this._equipmentView;
      }
      
      public function get PropList() : store.view.storeBag.StoreBagListView
      {
      ...
      {
         if(Boolean(param1.changedProperties["Money"]) || Boolean(param1.changedProperties["Gold"]) || Boolean(param1.changedProperties[PlayerInfo.GIFT]))
         {
            this.updateMoney();
         }
      }
