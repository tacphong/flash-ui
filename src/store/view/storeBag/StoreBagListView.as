package store.view.storeBag
{
   ...
   public class StoreBagListView extends Sprite implements Disposeable
   {
      ...
      protected var _controller:store.view.storeBag.StoreBagController;
      ...
      public function setup(param1:int, param2:store.view.storeBag.StoreBagController, param3:int) : void
      {
      ...
      public function setCellInfo(param1:int, param2:InventoryItemInfo) : void
      {
         if(param2 == null)
         {
            if(Boolean(this._cells) && Boolean(this._cells[String(param1)]))
            {
         ...
         else if(Boolean(this._cells[String(param1)]))
         {
      ...
      private function addGrid(param1:DictionaryData) : void
      {
         ...
         _loc3_ = (int((_loc4_ - 1) / 7) + 1) * 7;
         _loc3_ = _loc3_ < this.beginGridNumber ? int(this.beginGridNumber) : int(_loc3_);
