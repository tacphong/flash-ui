package store.view.strength
{
   ...
   public class LaterEquipmentView extends Component
   {
	  ...
	  private function createMainProperty() : void
	  {
		  ...
		  var _loc13_:* = NaN;
		  var _loc14_:uint = 0;
		  if((_loc11_ = this._tipData as GoodTipInfo) && EquipGhostManager.getInstance().isEquipGhosting())
		  {
		  ...
		  {
			  _loc12_ = 0;
			  if(_loc9_ && _loc9_.StrengthenLevel > 0)
			  {
				  _loc6_ = !!_loc9_.isGold ? int(int(_loc9_.StrengthenLevel + 1)) : int(int(_loc9_.StrengthenLevel));
