package store.view.Compose
{
   ...
   public class StoreIIComposeBG extends Sprite implements IStoreViewBG
   {
      ...
      public static const COMPOSE_TOP:int = 200;
      ...
      {
         this.composeRate = [0.8,0.5,0.3,0.1,0.05,0.02,0.005];
         super();
         this.init();
         this.initEvent();
      }
      ...
      private function init() : void
      {
         ...
         this._cpsShine.mouseChildren = this._cpsShine.mouseEnabled = false;
         ...
         while(_loc1_ < 3)
         {
            if(_loc1_ == 0)
            {
               _loc2_ = new ComposeStoneCell([StoneType.LUCKY],_loc1_);
            }
            else if(_loc1_ == 1)
            {
               _loc2_ = new ComposeItemCell(_loc1_);
            }
            else if(_loc1_ == 2)
            {
               _loc2_ = new ComposeStoneCell([StoneType.COMPOSE],_loc1_);
            }
         ...
         var _loc3_:String = LanguageMgr.GetTranslation("store.StoreIIComposeBG.ComposeStonStrip");
         var _loc4_:String = LanguageMgr.GetTranslation("store.StoreIIComposeBG.LuckSignStrip");
         var _loc5_:String = LanguageMgr.GetTranslation("store.StoreIIComposeBG.ConsortiaAddStrip");
         var _loc6_:String = LanguageMgr.GetTranslation("store.StoreIIComposeBG.noVIPAllNumStrip");
         if(PlayerManager.Instance.Self.ConsortiaID == 0)
         {
            _loc5_ = LanguageMgr.GetTranslation("tank.view.store.consortiaRateI");
         }
         this._showSuccessRate.showAllTips(_loc3_,_loc4_,_loc5_,_loc6_);
      ...
      private function getCellsPoint() : void
      {
         ...
         while(_loc2_ < 3)
         {
            _loc1_ = ComponentFactory.Instance.creatCustomObject("store.Composepoint" + _loc2_);
      ...
      public function dragDrop(param1:BagCell) : void
      {
            ...
            if(Boolean(_loc2_))
            {
               if(_loc2_ is StoneCell)
               {
                  if(_loc2_.info == null)
                  {
                     ...
                     {
                        SocketManager.Instance.out.sendMoveGoods(_loc3_.BagType,_loc3_.Place,BagInfo.STOREBAG,_loc2_.index,_loc3_.Count,true);
               ...
               else if(_loc2_ is ComposeItemCell)
               {
                  ...
                  {
                     if(_loc3_.AgilityCompose == COMPOSE_TOP && _loc3_.DefendCompose == COMPOSE_TOP && _loc3_.AttackCompose == COMPOSE_TOP && _loc3_.LuckCompose == COMPOSE_TOP)
                     {
         ...
         if(EquipType.isComposeStone(_loc3_) || _loc3_.CategoryID == 11 && _loc3_.Property1 == StoneType.SOULSYMBOL || _loc3_.CategoryID == 11 && _loc3_.Property1 == StoneType.LUCKY)
         {
            for each(_loc2_ in this._items)
            {
      ...
      private function getCountRate() : Number
      {
         ...
         return _loc1_ > 100 ? Number(100) : Number(_loc1_);
      }
      ...
      private function getCountRateI() : void
      {
         ...
         _loc1_ = _loc1_ > 100 ? Number(100) : Number(_loc1_);
         _loc2_ = _loc2_ > 100 ? Number(100) : Number(_loc2_);
         _loc3_ = _loc3_ > 100 ? Number(100) : Number(_loc3_);
         _loc4_ = _loc4_ > 100 ? Number(100) : Number(_loc4_);
         this._showSuccessRate.showAllNum(_loc1_,_loc2_,_loc3_,_loc4_);
      }
