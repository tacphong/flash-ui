package labyrinth
{
   ...
   public class LabyrinthManager extends EventDispatcher
   {
      ...
      private static var _instance:labyrinth.LabyrinthManager;
      ...
      public static function get Instance() : labyrinth.LabyrinthManager
      {
         if(_instance == null)
         {
            _instance = new labyrinth.LabyrinthManager();
         }
         return _instance;
      }
      ...
      protected function __onUpdataCleanOutInfo(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc4_:CleanOutInfo = new CleanOutInfo();
         _loc4_.FamRaidLevel = _loc3_.readInt();
         _loc4_.exp = _loc3_.readInt();
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            _loc2_["num"] = _loc3_.readInt();
            _loc4_.TemplateIDs.push(_loc2_);
            _loc6_++;
         }
         _loc4_.HardCurrency = _loc3_.readInt();
         if(Boolean(this._model.cleanOutInfos[_loc4_.FamRaidLevel]))
         {
            this._model.cleanOutInfos.remove(_loc4_.FamRaidLevel);
            delete this._model.cleanOutInfos[_loc4_.FamRaidLevel];
         }
         this._model.cleanOutInfos.add(_loc4_.FamRaidLevel,_loc4_);
      }
