package login.view
{
   ...
   public class ChooseRoleFrame extends Frame
   {
      ...
      private var _selectedItem:login.view.RoleItem;
      
      private var _disenabelFilter:ColorMatrixFilter;
      
      private var _rename:Boolean = false;
      
      private var _renameFrame:login.view.RoleRenameFrame;
      
      private var _consortiaRenameFrame:login.view.ConsortiaRenameFrame;
      ...
      {
         var _loc2_:login.view.RoleItem = param1.cell as RoleItem;
      ...
      public function get selectedItem() : login.view.RoleItem
      {
         return this._selectedItem;
      }
      
      public function set selectedItem(param1:login.view.RoleItem) : void
      {
         var _loc2_:login.view.RoleItem = null;
