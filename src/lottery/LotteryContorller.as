package lottery
{
   ...
   public class LotteryContorller extends BaseStateView
   {
      ...
      private function addEvent() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < btnArray.length)
         {
            _loc1_ = _loc2_;
            this._hallAsset[mcArray[_loc1_]].buttonMode = this._hallAsset[mcArray[_loc1_]].mouseEnable = this._hallAsset[mcArray[_loc1_]].mouseChildren = false;
            this._hallAsset[btnArray[_loc1_]].buttonMode = this._hallAsset[btnArray[_loc1_]].mouseEnable = this._hallAsset[btnArray[_loc1_]].mouseChildren = true;
            this._hallAsset[btnArray[_loc1_]].addEventListener(MouseEvent.CLICK,this.__onBtnClick);
            this._hallAsset[btnArray[_loc1_]].addEventListener(MouseEvent.MOUSE_OVER,this.__onBtnOver);
            this._hallAsset[btnArray[_loc1_]].addEventListener(MouseEvent.MOUSE_OUT,this.__onBtnOut);
            _loc2_++;
         }
      }
      ...
      private function removeEvent() : void
      {
         ...
         {
            _loc1_ = _loc2_;
            this._hallAsset[btnArray[_loc1_]].removeEventListener(MouseEvent.CLICK,this.__onBtnClick);
            this._hallAsset[btnArray[_loc1_]].removeEventListener(MouseEvent.MOUSE_OVER,this.__onBtnOver);
            this._hallAsset[btnArray[_loc1_]].removeEventListener(MouseEvent.MOUSE_OUT,this.__onBtnOut);
            _loc2_++;
         }
      }
      ...
      {
         var _loc2_:LuckyLotteryAwardFrame = null;
         if(param1 == null)
         {
            return;
         }
         var _loc3_:int = int(param1["code"]);
         if(_loc3_ == 1)
         {
            _loc2_ = new LuckyLotteryAwardFrame();
            _loc2_.setInfo(param1["TemplateId"],param1["timeLimit"]);
            this.popupFrame(_loc2_);
         }
         else if(_loc3_ == 2)
         {
      ...
      private function __onBtnClick(param1:MouseEvent) : void
      {
         ...
         var _loc2_:String = String(mcArray[btnArray.indexOf(param1.currentTarget.name)]);
      ...
      private function __onBtnOver(param1:MouseEvent) : void
      {
         ...
         var _loc3_:String = String(mcArray[_loc2_]);
