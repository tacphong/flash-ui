   ...
   public dynamic class TweenProxy extends Proxy
   {
      ...
      public function getCenter() : Point
      {
         ...
         if(this._target.parent == null)
         {
            _loc2_ = true;
            _loc1_ = new Sprite();
            _loc1_.addChild(this._target);
         }
         var _loc3_:Rectangle = this._target.getBounds(this._target.parent);
         var _loc4_:Point = new Point(_loc3_.x + _loc3_.width / 2,_loc3_.y + _loc3_.height / 2);
         if(_loc2_)
         {
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:Array = _dict[this._target];
      ...
      public function set skewX(param1:Number) : void
      {
         var _loc2_:Number = param1 * _DEG2RAD;
         var _loc3_:Matrix = this._target.transform.matrix;
         var _loc4_:Number = this._scaleY < 0 ? Number(-this._scaleY) : Number(this._scaleY);
      ...
      public function set skewY(param1:Number) : void
      {
         var _loc2_:Number = param1 * _DEG2RAD;
         var _loc3_:Matrix = this._target.transform.matrix;
         var _loc4_:Number = this._scaleX < 0 ? Number(-this._scaleX) : Number(this._scaleX);
