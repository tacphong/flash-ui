package com.greensock.core
{
   ...
   public class TweenCore
   {
      ...
      public function TweenCore(param1:Number = 0, param2:Object = null)
      {
         ...
         var _loc3_:com.greensock.core.SimpleTimeline = this.vars.timeline is SimpleTimeline ? this.vars.timeline : (Boolean(this.vars.useFrames) ? TweenLite.rootFramesTimeline : TweenLite.rootTimeline);
