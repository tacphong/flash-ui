package com.wirelust.as3zlib
{
   ...
   public final class ZStream
   {
      ...
      public var dstate:com.wirelust.as3zlib.Deflate;
      
      public var istate:com.wirelust.as3zlib.Inflate;
      
      public var data_type:int;
      
      public var adler:Number;
      
      public var _adler:com.wirelust.as3zlib.Adler32;
      
      public function ZStream()
      {
         this._adler = new com.wirelust.as3zlib.Adler32();
         super();
      }
      ...
      {
         this.istate = new com.wirelust.as3zlib.Inflate();
         return this.istate.inflateInit(this,param2 ? int(-param1) : int(param1));
      }
      ...
      {
         this.dstate = new com.wirelust.as3zlib.Deflate();
         return this.dstate.deflateInitWithBits(this,param1,param3 ? int(-param2) : int(param2));
      }
