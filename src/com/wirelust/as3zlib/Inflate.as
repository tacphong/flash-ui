package com.wirelust.as3zlib
{
   ...
   public final class Inflate
   {
      ...
      public var blocks:com.wirelust.as3zlib.InfBlocks;
      ...
      public function inflateReset(param1:ZStream) : int
      {
         ...
         param1.msg = null;
         param1.istate.mode = param1.istate.nowrap != 0 ? int(BLOCKS) : int(METHOD);
      ...
      public function inflateInit(param1:ZStream, param2:int) : int
      {
         ...
         this.wbits = param2;
         param1.istate.blocks = new com.wirelust.as3zlib.InfBlocks(param1,param1.istate.nowrap != 0 ? null : this,1 << param2);
      ...
      public function inflate(param1:ZStream, param2:int) : int
      {
         ...
         param2 = param2 == Z_FINISH ? int(Z_BUF_ERROR) : int(Z_OK);
         _loc3_ = Z_BUF_ERROR;
         while(true)
         {
            switch(param1.istate.mode)
            {
               ...
               case DICT3:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  param1.istate.need += (param1.next_in[param1.next_in_index++] & 255) << 16 & 16711680;
               ...
               case DICT2:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  param1.istate.need += (param1.next_in[param1.next_in_index++] & 255) << 8 & 65280;
               ...
               case CHECK1:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  param1.istate.need += param1.next_in[param1.next_in_index++] & 255;
