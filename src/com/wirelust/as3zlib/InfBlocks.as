package com.wirelust.as3zlib
{
   ...
   public final class InfBlocks
   {
         ...
         while(true)
         {
            switch(this.mode)
            {
               ...
               case LENS:
                  ...
                  _loc4_ = _loc5_ = 0;
                  this.mode = this.left != 0 ? int(STORED) : (this.last != 0 ? int(DRY) : int(TYPE));
                  continue;
               case STORED:
                  if(_loc7_ == 0)
                  {
                  ...
                  {
                     this.mode = this.last != 0 ? int(DRY) : int(TYPE);
                  }
                  continue;
               case TABLE:
                  while(_loc5_ < 14)
                  ...
                  this.table = _loc3_ = _loc4_ & 16383;
                  if((_loc3_ & 31) > 29 || (_loc3_ >> 5 & 31) > 29)
                  {
                     this.mode = BAD;
               ...
               case DTREE:
                  while(true)
                  {
                     ...
                     _loc3_ = int(this.hufts[(this.tb[0] + (_loc4_ & inflate_mask[_loc3_])) * 3 + 1]);
                     _loc17_ = int(this.hufts[(this.tb[0] + (_loc4_ & inflate_mask[_loc3_])) * 3 + 2]);
                     if(_loc17_ < 16)
                     {
                        _loc4_ >>>= _loc3_;
                        _loc5_ -= _loc3_;
                     ...
                     {
                        _loc15_ = _loc17_ == 18 ? int(7) : int(_loc17_ - 14);
                        _loc16_ = _loc17_ == 18 ? int(11) : int(3);
                        ...
                        _loc17_ = _loc17_ == 16 ? int(this.blens[_loc15_ - 1]) : int(0);
                        do
                        {
                           _loc19_ = _loc15_++;
                           this.blens[_loc19_] = _loc17_;
               ...
               case CODES:
                  ...
                  param1.next_in_index = _loc6_;
                  this.write = _loc8_;
                  if((param2 = int(this.codes.proc(this,param1,param2))) != Z_STREAM_END)
                  {
                     return this.inflate_flush(param1,param2);
                  }
                  param2 = Z_OK;
      ...
      {
         return this.mode == LENS ? int(1) : int(0);
      }
