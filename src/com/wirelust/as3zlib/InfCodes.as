package com.wirelust.as3zlib
{
   internal final class InfCodes
   {
      ...
      public function inflate_fast(param1:int, param2:int, param3:Array, param4:int, param5:Array, param6:int, param7:InfBlocks, param8:ZStream) : int
      {
         ...
         _loc18_ = _loc17_ < param7.read ? int(param7.read - _loc17_ - 1) : int(param7.end - _loc17_);
         _loc19_ = int(inflate_mask[param1]);
         _loc20_ = int(inflate_mask[param2]);
         do
         {
            while(_loc14_ < 20)
            {
            ...
            if((_loc12_ = int(_loc10_[_loc24_])) == 0)
            {
                  ...
                  if((_loc12_ & 16) != 0)
                  {
                     ...
                     while(true)
                     {
                        ...
                        if((_loc12_ & 64) != 0)
                        {
                           ...
                           _loc21_ = _loc14_ >> 3 < _loc21_ ? int(_loc14_ >> 3) : int(_loc21_);
                           _loc16_ += _loc21_;
                           _loc15_ -= _loc21_;
                           _loc14_ -= _loc21_ << 3;
                           param7.bitb = _loc13_;
      ...
      internal function proc(param1:InfBlocks, param2:ZStream, param3:int) : int
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         _loc14_ = param2.next_in_index;
         _loc8_ = param2.avail_in;
         _loc12_ = param1.bitb;
         _loc13_ = param1.bitk;
         _loc9_ = param1.write;
         _loc10_ = _loc9_ < param1.read ? int(param1.read - _loc9_ - 1) : int(param1.end - _loc9_);
         while(true)
         {
            switch(this.mode)
            {
               case START:
                  if(_loc10_ >= 258 && _loc8_ >= 10)
                  {
                     param1.bitb = _loc12_;
                     param1.bitk = _loc13_;
                     param2.avail_in = _loc8_;
                     param2.total_in += _loc14_ - param2.next_in_index;
                     param2.next_in_index = _loc14_;
                     param1.write = _loc9_;
                     ...
                     if(param3 != Z_OK)
                     {
                        this.mode = param3 == Z_STREAM_END ? int(WASH) : int(BADCODE);
                        continue;
                     }
                  }
               ...
               case LENEXT:
                  ...
                  while(_loc13_ < _loc4_)
                  {
                     ...
                     param3 = Z_OK;
                     _loc8_--;
                     _loc12_ |= (param2.next_in[_loc14_++] & 255) << _loc13_;
                     _loc13_ += 8;
                  }
                  this.len += _loc12_ & inflate_mask[_loc4_];
                  _loc12_ >>= _loc4_;
                  _loc13_ -= _loc4_;
               ...
               case DIST:
                  ...
                  _loc6_ = (this.tree_index + (_loc12_ & inflate_mask[_loc4_])) * 3;
                  _loc12_ >>= this.tree[_loc6_ + 1];
                  _loc13_ -= this.tree[_loc6_ + 1];
                  _loc7_ = int(this.tree[_loc6_]);
                  if((_loc7_ & 16) != 0)
                  {
               ...
               case DISTEXT:
                  ...
                  this.dist += _loc12_ & inflate_mask[_loc4_];
                  _loc12_ >>= _loc4_;
                  _loc13_ -= _loc4_;
                  this.mode = COPY;
               case COPY:
                  _loc11_ = _loc9_ - this.dist;
                  while(_loc11_ < 0)
                  {
                     _loc11_ += param1.end;
                  }
                  while(this.len != 0)
                  {
                     if(_loc10_ == 0)
                     {
                        if(_loc9_ == param1.end && param1.read != 0)
                        {
                           _loc9_ = 0;
                           _loc10_ = _loc9_ < param1.read ? int(param1.read - _loc9_ - 1) : int(param1.end - _loc9_);
                        }
                     ...
                     _loc15_ = _loc9_ + 1;
                     param1.window[_loc15_] = param1.window[_loc11_++];
                     _loc10_--;
                     if(_loc11_ == param1.end)
                     {
                        _loc11_ = 0;
                     }
                     --this.len;
