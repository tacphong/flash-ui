package com.wirelust.as3zlib
{
   ...
   public class Deflate
   {
      ...
      public var strm:com.wirelust.as3zlib.ZStream;
      ...
      {
         var _loc5_:Number = Number(param1[param2 * 2]);
         var _loc6_:Number = Number(param1[param3 * 2]);
      ...
      {
         var _loc3_:int = int(this.heap[param2]);
      ...
      internal function scan_tree(param1:Array, param2:int) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = -1;
         var _loc6_:int = int(param1[0 * 2 + 1]);
         var _loc7_:int = 0;
         var _loc8_:int = 7;
         var _loc9_:int = 4;
         if(_loc6_ == 0)
         ...
         {
            _loc4_ = _loc6_;
            _loc6_ = int(param1[(_loc3_ + 1) * 2 + 1]);
            if(!(++_loc7_ < _loc8_ && _loc4_ == _loc6_))
            {
               if(_loc7_ < _loc9_)
               {
                  this.bl_tree[_loc4_ * 2] += _loc7_;
               }
               else if(_loc4_ != 0)
               {
                  if(_loc4_ != _loc5_)
                  {
                     ++this.bl_tree[_loc4_ * 2];
                  }
         ...
         while(_loc3_ <= param2)
         {
            ...
            if(!(++_loc7_ < _loc8_ && _loc4_ == _loc6_))
            {
               if(_loc7_ < _loc9_)
               {
                  do
                  {
                     this.send_code(_loc4_,this.bl_tree);
                  }
                  while(--_loc7_ != 0);
      ...
      final public function put_byte(param1:ByteArray, param2:int, param3:int) : void
      {
      ...
      final public function putShortMSB(param1:int) : void
      {
         this.put_byte_withInt(param1 >> 8);
         this.put_byte_withInt(param1 & 255);
      }
      
      final public function send_code(param1:int, param2:Array) : void
      {
      ...
      public function send_bits(param1:int, param2:int) : void
      {
         ...
         if(this.bi_valid > int(Buf_size) - _loc4_)
         {
            _loc3_ = param1;
            this.bi_buf |= _loc3_ << this.bi_valid & 65535;
            this.put_short(this.bi_buf);
            this.bi_buf = _loc3_ >>> Buf_size - this.bi_valid;
            this.bi_buf = Cast.toShort(_loc3_ >>> Buf_size - this.bi_valid);
            this.bi_valid += _loc4_ - Buf_size;
         }
         else
         {
            this.bi_buf |= param1 << this.bi_valid & 65535;
            this.bi_valid += _loc4_;
         }
      }
      ...
      public function compress_block(param1:Array, param2:Array) : void
      {
         ...
         if(this.last_lit != 0)
         {
            do
            {
               _loc3_ = this.pending_buf[this.d_buf + _loc7_ * 2] << 8 & 65280 | this.pending_buf[this.d_buf + _loc7_ * 2 + 1] & 255;
               _loc4_ = this.pending_buf[this.l_buf + _loc7_] & 255;
               _loc7_++;
               if(_loc3_ == 0)
               {
               ...
               {
                  _loc5_ = int(Tree._length_code[_loc4_]);
                  this.send_code(_loc5_ + LITERALS + 1,param1);
                  _loc6_ = int(Tree.extra_lbits[_loc5_]);
                  if(_loc6_ != 0)
                  {
                     _loc4_ -= Tree.base_length[_loc5_];
                     this.send_bits(_loc4_,_loc6_);
                  }
                  _loc3_--;
                  _loc5_ = Tree.d_code(_loc3_);
                  this.send_code(_loc5_,param2);
                  _loc6_ = int(Tree.extra_dbits[_loc5_]);
                  if(_loc6_ != 0)
                  {
                     _loc3_ -= Tree.base_dist[_loc5_];
                     this.send_bits(_loc3_,_loc6_);
                  }
               }
            }
            while(_loc7_ < this.last_lit);
      ...
      internal function set_data_type() : void
      {
         ...
         this.data_type = _loc3_ > _loc2_ >>> 2 ? uint(Z_BINARY) : uint(Z_ASCII);
      }
      ...
      {
         this._tr_flush_block(this.block_start >= 0 ? int(this.block_start) : int(-1),this.strstart - this.block_start,param1);
      ...
      public function deflate_stored(param1:int) : int
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         if(_loc3_ > this.pending_buf_size - 5)
         {
            _loc3_ = this.pending_buf_size - 5;
         }
         while(true)
         {
            if(this.lookahead <= 1)
            ...
            this.lookahead = 0;
            _loc2_ = this.block_start + _loc3_;
            if(this.strstart == 0 || this.strstart >= _loc2_)
            {
               this.lookahead = int(this.strstart - _loc2_);
               this.strstart = int(_loc2_);
      ...
      public function deflate_fast(param1:int) : int
      {
         ...
         while(true)
         {
            ...
            if(this.lookahead >= MIN_MATCH)
            {
               ...
               _loc3_ = int(this.head[this.ins_h]);
               this.prev[this.strstart & this.w_mask] = this.head[this.ins_h];
               this.head[this.ins_h] = Cast.toShort(this.strstart);
            }
            if(_loc3_ != 0 && this.strstart - _loc3_ <= this.w_size - MIN_LOOKAHEAD)
            {
               if(this.strategy != Z_HUFFMAN_ONLY)
               {
                  this.match_length = this.longest_match(_loc3_);
               }
            }
            if(this.match_length >= MIN_MATCH)
            {
               _loc2_ = this._tr_tally(this.strstart - this.match_start,this.match_length - MIN_MATCH);
               ...
               if(this.match_length <= this.max_lazy_match && this.lookahead >= MIN_MATCH)
               {
                  ...
                  do
                  {
                     ++this.strstart;
                     this.ins_h = (this.ins_h << this.hash_shift ^ this.window[this.strstart + (MIN_MATCH - 1)] & 255) & this.hash_mask;
                     _loc3_ = this.head[this.ins_h] & 65535;
                     this.prev[this.strstart & this.w_mask] = this.head[this.ins_h];
                     this.head[this.ins_h] = Cast.toShort(this.strstart);
                  }
            ...
            {
               _loc2_ = this._tr_tally(0,this.window[this.strstart] & 255);
               --this.lookahead;
               ++this.strstart;
            }
            if(_loc2_)
      ...
      public function deflate_slow(param1:int) : int
      {
         ...
         while(true)
         {
            ...
            {
               this.ins_h = (this.ins_h << this.hash_shift ^ this.window[this.strstart + (MIN_MATCH - 1)] & 255) & this.hash_mask;
               _loc4_ = this.head[this.ins_h] & 65535;
               this.prev[this.strstart & this.w_mask] = this.head[this.ins_h];
               this.head[this.ins_h] = Cast.toShort(this.strstart);
            }
            ...
            if(_loc4_ != 0 && this.prev_length < this.max_lazy_match && (this.strstart - _loc4_ & 65535) <= this.w_size - MIN_LOOKAHEAD)
            {
               if(this.strategy != Z_HUFFMAN_ONLY)
               {
                  this.match_length = this.longest_match(_loc4_);
               }
            ...
            {
               _loc3_ = this.strstart + this.lookahead - MIN_MATCH;
               _loc2_ = this._tr_tally(this.strstart - 1 - this.prev_match,this.prev_length - MIN_MATCH);
               this.lookahead -= this.prev_length - 1;
               this.prev_length -= 2;
               do
               {
                  if(++this.strstart <= _loc3_)
                  {
                     this.ins_h = (this.ins_h << this.hash_shift ^ this.window[this.strstart + (MIN_MATCH - 1)] & 255) & this.hash_mask;
                     _loc4_ = this.head[this.ins_h] & 65535;
                     this.prev[this.strstart & this.w_mask] = this.head[this.ins_h];
            ...
            {
               _loc2_ = this._tr_tally(0,this.window[this.strstart - 1] & 255);
               if(_loc2_)
               {
                  this.flush_block_only(false);
               }
      ...
      internal function longest_match(param1:int) : int
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:int = this.max_chain_length;
         var _loc5_:int = this.strstart;
         var _loc6_:int = this.prev_length;
         var _loc7_:int = this.strstart > this.w_size - MIN_LOOKAHEAD ? int(this.strstart - (this.w_size - MIN_LOOKAHEAD)) : int(0);
         var _loc8_:int = this.nice_match;
         var _loc9_:int = this.w_mask;
         var _loc10_:int = this.strstart + MAX_MATCH;
         var _loc11_:uint = uint(this.window[_loc5_ + _loc6_ - 1]);
         var _loc12_:uint = uint(this.window[_loc5_ + _loc6_]);
         ...
         {
            _loc2_ = param1;
            if(!(this.window[_loc2_ + _loc6_] != _loc12_ || this.window[_loc2_ + _loc6_ - 1] != _loc11_ || this.window[_loc2_] != this.window[_loc5_] || this.window[++_loc2_] != this.window[_loc5_ + 1]))
            {
               _loc5_ += 2;
               _loc2_++;
               while(this.window[++_loc5_] == this.window[++_loc2_] && this.window[++_loc5_] == this.window[++_loc2_] && this.window[++_loc5_] == this.window[++_loc2_] && this.window[++_loc5_] == this.window[++_loc2_] && this.window[++_loc5_] == this.window[++_loc2_] && this.window[++_loc5_] == this.window[++_loc2_] && this.window[++_loc5_] == this.window[++_loc2_] && this.window[++_loc5_] == this.window[++_loc2_] && _loc5_ < _loc10_)
               {
               }
               _loc3_ = MAX_MATCH - int(_loc10_ - _loc5_);
               _loc5_ = _loc10_ - MAX_MATCH;
               if(_loc3_ > _loc6_)
               {
                  ...
                  _loc11_ = uint(this.window[_loc5_ + _loc6_ - 1]);
                  _loc12_ = uint(this.window[_loc5_ + _loc6_]);
               }
            }
         }
         while((param1 = this.prev[param1 & _loc9_] & 65535) > _loc7_ && --_loc4_ != 0);
      ...
      public function deflateInitWithBits(param1:com.wirelust.as3zlib.ZStream, param2:int, param3:int) : int
      {
         return this.deflateInit2(param1,param2,Z_DEFLATED,param3,DEF_MEM_LEVEL,Z_DEFAULT_STRATEGY);
      }
      
      public function deflateInit(param1:com.wirelust.as3zlib.ZStream, param2:int) : int
      {
         return this.deflateInitWithBits(param1,param2,MAX_WBITS);
      }
      
      public function deflateInit2(param1:com.wirelust.as3zlib.ZStream, param2:int, param3:int, param4:int, param5:int, param6:int) : int
      {
         var _loc7_:int = 0;
         param1.msg = null;
      ...
      internal function deflateReset(param1:com.wirelust.as3zlib.ZStream) : int
      {
         param1.total_in = param1.total_out = 0;
         param1.msg = null;
         ...
         this.status = this.noheader != 0 ? int(BUSY_STATE) : int(INIT_STATE);
      ...
      internal function deflateEnd() : int
      {
         ...
         this.prev = null;
         this.window = null;
         return this.status == BUSY_STATE ? int(Z_DATA_ERROR) : int(Z_OK);
      }
      
      internal function deflateParams(param1:com.wirelust.as3zlib.ZStream, param2:int, param3:int) : int
      {
         var _loc4_:int = Z_OK;
         if(param2 == Z_DEFAULT_COMPRESSION)
         {
      ...
      internal function deflateSetDictionary(param1:com.wirelust.as3zlib.ZStream, param2:ByteArray, param3:int) : int
      {
      ...
      public function deflate(param1:com.wirelust.as3zlib.ZStream, param2:int) : int
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         param1.flush_pending();
         this.noheader = -1;
         return this.pending != 0 ? int(Z_OK) : int(Z_STREAM_END);
      }
   }
}
