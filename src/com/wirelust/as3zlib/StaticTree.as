...
{
   internal final class StaticTree
   {
      ...
      public function StaticTree(param1:Array, param2:Array, param3:int, param4:int, param5:int)
      {
         super();
         this.static_tree = param1;
         this.extra_bits = param2;
         this.extra_base = param3;
         this.elems = param4;
         this.max_length = param5;
      }
   }
}
