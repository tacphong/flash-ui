package com.pickgliss.debug
{
   ...
   public class DebugStats extends Sprite
   {
      ...
      private static var _INSTANCE:com.pickgliss.debug.DebugStats;
      ...
      public static function get instance() : com.pickgliss.debug.DebugStats
      {
         return _INSTANCE;
      }
      ...
      private function _redrawWindow() : void
      {
         ...
         _loc1_ = this._minimized ? Number(_MIN_HEIGHT) : Number(_MAX_HEIGHT);
         ...
         this._min_max_btn.rotation = this._minimized ? Number(180) : Number(0);
      ...
      private function _redrawMemGraph() : void
      {
         ...
         while(_loc1_ >= 0)
         {
            ...
            else
            {
               ...
               {
                  _loc3_ = Number(this._mem_points[_loc1_]);
               }
            }
            _loc1_--;
         }
