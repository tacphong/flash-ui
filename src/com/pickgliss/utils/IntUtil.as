   ...
   public class IntUtil
   {
      ...
      public static function toHex(param1:int, param2:Boolean = false) : String
      {
         ...
         if(param2)
         {
            ...
            while(_loc3_ < 4)
            {
               _loc5_ += hexChars.charAt(param1 >> (3 - _loc3_) * 8 + 4 & 15) + hexChars.charAt(param1 >> (3 - _loc3_) * 8 & 15);
               _loc3_++;
            }
         }
         else
         {
            ...
            while(_loc4_ < 4)
            {
               _loc5_ += hexChars.charAt(param1 >> _loc4_ * 8 + 4 & 15) + hexChars.charAt(param1 >> _loc4_ * 8 & 15);
               _loc4_++;
            }
         }
         return _loc5_;
