package com.pickgliss.utils
{
   ...
   public class DisplayPool
   {
      ...
      private static var _instance:com.pickgliss.utils.DisplayPool;
      ...
      public static function get Instance() : com.pickgliss.utils.DisplayPool
      {
         if(_instance == null)
         {
            _instance = new com.pickgliss.utils.DisplayPool();
         }
         return _instance;
      }
      ...
      public function clearAll() : void
      {
         ...
         {
            if(Boolean(this._objects[_loc1_]))
            {
