package com.pickgliss.effect
{
   ...
   public final class EffectManager
   {
      ...
      private static var _instance:com.pickgliss.effect.EffectManager;
      ...
      public static function get Instance() : com.pickgliss.effect.EffectManager
      {
         if(_instance == null)
         {
            _instance = new com.pickgliss.effect.EffectManager();
         }
         return _instance;
      }
