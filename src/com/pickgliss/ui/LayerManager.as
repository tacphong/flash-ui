package com.pickgliss.ui
{
   ...
   public class LayerManager
   {
      ...
      private static var _instance:com.pickgliss.ui.LayerManager;
      ...
      public static function get Instance() : com.pickgliss.ui.LayerManager
      {
         if(_instance == null)
         {
            _instance = new com.pickgliss.ui.LayerManager();
         }
         return _instance;
      }
      ...
      public function addToLayer(param1:DisplayObject, param2:int, param3:Boolean = false, param4:int = 0, param5:Boolean = true) : void
      {
         ...
         _loc6_ = null;
         var _loc7_:SpriteLayer = this.getLayerByType(param2);
         if(param3)
         {
