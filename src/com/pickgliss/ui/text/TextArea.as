package com.pickgliss.ui.text
{
   ...
   public class TextArea extends ScrollPanel
   {
      ...
      protected var _textField:com.pickgliss.ui.text.FilterFrameText;
      ...
      public function get textField() : com.pickgliss.ui.text.FilterFrameText
      {
         return this._textField;
      }
      
      public function set textField(param1:com.pickgliss.ui.text.FilterFrameText) : void
      {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[P_textField]))
         {
