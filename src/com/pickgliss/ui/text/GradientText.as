package com.pickgliss.ui.text
{
   ...
   public class GradientText extends Component
   {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[P_textField]) || Boolean(_changedPropeties[P_color]) || Boolean(_changedPropeties[P_alpha]) || Boolean(_changedPropeties[P_ratio]) || Boolean(_changedPropeties[P_size]))
         {
            this.refreshBox();
         }
         if(Boolean(_changedPropeties[P_frameFilters]))
         {
