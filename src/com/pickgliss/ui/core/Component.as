package com.pickgliss.ui.core
{
   ...
   public class Component extends Sprite implements Disposeable, ITipedDisplay
   {
      ...
      {
         if(Boolean(this._changedPropeties[P_tipDirction]) || Boolean(this._changedPropeties[P_tipGap]) || Boolean(this._changedPropeties[P_tipStyle]) || Boolean(this._changedPropeties[P_tipData]))
         {
