package com.pickgliss.ui.controls
{
   ...
   public class Frame extends Component
   {
      ...
      protected var _closeButton:com.pickgliss.ui.controls.BaseButton;
      ...
      public function get closeButton() : com.pickgliss.ui.controls.BaseButton
      {
         return this._closeButton;
      }
      
      public function set closeButton(param1:com.pickgliss.ui.controls.BaseButton) : void
      {
      ...
      override public function dispose() : void
      {
         ...
         if(Boolean(_loc1_) && contains(_loc1_))
         {
      ...
      {
         if(this._autoExit == param1)
         {
            return;
         }
         this._autoExit = param1;
      }
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if((Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width])) && this._backgound != null)
         {
            this._backgound.width = _width;
            this._backgound.height = _height;
            this.updateClosePos();
         }
         if(Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width]) || Boolean(_changedPropeties[P_moveInnerRect]))
         {
            this.updateMoveRect();
         }
         if(Boolean(_changedPropeties[P_closeButton]))
         {
            this._closeButton.addEventListener(MouseEvent.CLICK,this.__onCloseClick);
         }
         if(Boolean(_changedPropeties[P_closeButton]) || Boolean(_changedPropeties[P_closeInnerRect]))
         {
            this.updateClosePos();
         }
         if(Boolean(_changedPropeties[P_containerX]) || Boolean(_changedPropeties[P_containerY]))
         {
            this.updateContainerPos();
         }
         if(Boolean(_changedPropeties[P_titleOuterRectPos]) || Boolean(_changedPropeties[P_titleText]) || Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width]))
         {
            if(this._title != null)
            {
         ...
         if(Boolean(_changedPropeties[P_moveEnable]))
         {
            if(this._moveEnable)
            {
