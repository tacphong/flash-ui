package com.pickgliss.ui.controls
{
   ...
   public class DisplayObjectViewport extends Component implements IViewprot
   {
      ...
      override public function dispose() : void
      {
         ...
         this._view = null;
         if(Boolean(this._mouseActiveObjectShape))
         {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width]))
         {
            this.updateShowMask();
         }
         if(Boolean(_changedPropeties[P_view]) || Boolean(_changedPropeties[P_viewPosition]))
         {
      ...
      {
         if(Boolean(param1.changedProperties[Component.P_height]) || Boolean(param1.changedProperties[Component.P_width]))
         {
            onPropertiesChanged(P_view);
         }
      }
