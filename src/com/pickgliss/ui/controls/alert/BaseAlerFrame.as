package com.pickgliss.ui.controls.alert
{
   ...
   public class BaseAlerFrame extends Frame
   {
      ...
      {
         if(this._isShowTheLog != param1)
         {
            this._isShowTheLog = param1;
            this._info.logText = param2;
            this.creatTheLog();
         }
      }
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[P_info]) || Boolean(_changedPropeties[P_submitButton]) || Boolean(_changedPropeties[P_cancelButton]))
         {
         ...
         if(Boolean(_changedPropeties[P_info]) || Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width]) || Boolean(_changedPropeties[P_buttonToBottom]))
         {
            this.updatePos();
         }
      }
