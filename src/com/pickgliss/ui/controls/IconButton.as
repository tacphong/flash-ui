package com.pickgliss.ui.controls
{
   ...
   public class IconButton extends TextButton
   {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[Component.P_width]) || Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[P_iconInnerRect]) || Boolean(_changedPropeties[P_icon]))
         {
            this.updateIconPos();
         }
      }
