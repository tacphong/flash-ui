package com.pickgliss.ui.controls
{
   ...
   public class OutMainListPanel extends Component implements ListDataListener
   {
      ...
      private var _vScrollbar:com.pickgliss.ui.controls.Scrollbar;
      ...
      private function syncScrollBar() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:int = int(this._factory.getCellHeight());
         this._needNum = Math.floor(_height / _loc4_);
         if(this._vScrollbar != null)
         {
            _loc1_ = this._needNum * this._factory.getCellHeight();
            _loc2_ = this._presentPos * this._factory.getCellHeight();
            _loc3_ = this._factory.getCellHeight() * this._model.elements.length;
            this._vScrollbar.unitIncrement = this._factory.getCellHeight();
            this._vScrollbar.blockIncrement = this._factory.getCellHeight();
            this._vScrollbar.getModel().setRangeProperties(_loc2_,_loc1_,0,_loc3_,false);
         }
         this.changeDate();
      }
      ...
      private function createCells() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:IListCell = null;
         var _loc4_:int = 0;
         var _loc5_:Vector.<IListCell> = null;
         var _loc6_:int = 0;
         var _loc7_:int = int(this._factory.getCellHeight());
         this._needNum = Math.floor(_height / _loc7_);
         ...
         if(this._cells.length < this._needNum)
         {
            _loc1_ = this._needNum - this._cells.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.createNewCell();
               _loc3_.y = this._factory.getCellHeight() * _loc2_;
               this.addCellToContainer(_loc3_);
               _loc2_++;
            }
         }
         else
         {
            _loc4_ = this._needNum;
            _loc5_ = this._cells.splice(_loc4_,this._cells.length - _loc4_);
            _loc6_ = 0;
            while(_loc2_ < _loc5_.length)
            {
               this.removeCellFromContainer(_loc5_[_loc6_]);
               _loc6_++;
            }
         }
      }
      ...
      protected function __onItemInteractive(param1:MouseEvent) : void
      {
         ...
         var _loc4_:int = this._model.indexOf(_loc3_.getCellValue());
         switch(param1.type)
         {
      ...
      public function get vScrollbar() : com.pickgliss.ui.controls.Scrollbar
      {
         return this._vScrollbar;
      }
      
      public function set vScrollbar(param1:com.pickgliss.ui.controls.Scrollbar) : void
      {
