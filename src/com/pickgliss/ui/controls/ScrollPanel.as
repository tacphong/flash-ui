package com.pickgliss.ui.controls
{
   ...
   public class ScrollPanel extends Component
   {
      ...
      protected var _hScrollbar:com.pickgliss.ui.controls.Scrollbar;
      ...
      protected var _vScrollbar:com.pickgliss.ui.controls.Scrollbar;
      ...
      public function get hScrollbar() : com.pickgliss.ui.controls.Scrollbar
      {
         return this._hScrollbar;
      }
      
      public function set hScrollbar(param1:com.pickgliss.ui.controls.Scrollbar) : void
      {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width]) || Boolean(_changedPropeties[P_vScrollbarInnerRect]) || Boolean(_changedPropeties[P_hScrollbarInnerRect]) || Boolean(_changedPropeties[P_vScrollbar]) || Boolean(_changedPropeties[P_hScrollbar]) || Boolean(_changedPropeties[P_viewportInnerRect]) || Boolean(_changedPropeties[P_viewSource]))
         {
            this.layoutComponent();
         }
         if(Boolean(_changedPropeties[P_viewSource]))
         {
            this.syncScrollPaneWithViewport();
         }
         if(Boolean(_changedPropeties[P_vScrollProxy]) || Boolean(_changedPropeties[P_hScrollProxy]))
         {
            if(Boolean(this._vScrollbar))
            {
