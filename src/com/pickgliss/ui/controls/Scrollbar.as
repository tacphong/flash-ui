package com.pickgliss.ui.controls
{
   ...
   public class Scrollbar extends Component implements IOrientable
   {
      ...
      protected var _decreaseButton:com.pickgliss.ui.controls.BaseButton;
      ...
      protected var _increaseButton:com.pickgliss.ui.controls.BaseButton;
      ...
      protected var _model:com.pickgliss.ui.controls.BoundedRangeModel;
      
      protected var _orientation:int;
      
      protected var _thumb:com.pickgliss.ui.controls.BaseButton;
      ...
      public function set decreaseButton(param1:com.pickgliss.ui.controls.BaseButton) : void
      {
         if(this._decreaseButton == param1)
         {
            return;
         }
         if(Boolean(this._decreaseButton))
         {
      ...
      override public function dispose() : void
      {
         ...
         if(Boolean(this._increaseButton))
         {
         ...
         if(Boolean(this._track) && this._track is InteractiveObject)
         {
      ...
      public function getModel() : com.pickgliss.ui.controls.BoundedRangeModel
      {
         return this._model;
      }
      ...
      public function set increaseButton(param1:com.pickgliss.ui.controls.BaseButton) : void
      {
      ...
      public function setupModel(param1:com.pickgliss.ui.controls.BoundedRangeModel) : void
      {
      ...
      public function set thumb(param1:com.pickgliss.ui.controls.BaseButton) : void
      {
      ...
      protected function getValueWithPosition(param1:Point) : int
      {
         ...
         var _loc7_:Rectangle = this._thumbAreaInnerRect.getInnerRect(_width,_height);
         if(this.isVertical())
         {
            _loc2_ = _loc7_.y;
            _loc3_ = _loc7_.y + _loc7_.height - this._thumbRect.height;
            _loc4_ = _loc6_;
         }
         else
         {
            _loc2_ = _loc7_.x;
            _loc3_ = _loc7_.x + _loc7_.width - this._thumbRect.width;
            _loc4_ = _loc5_;
         }
         return this.getValueWithThumbMaxMinPos(_loc2_,_loc3_,_loc4_);
      }
      
      override protected function init() : void
      {
         this.setupModel(new com.pickgliss.ui.controls.BoundedRangeModel());
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width]) || Boolean(_changedPropeties[P_decreaseButtonInnerRect]) || Boolean(_changedPropeties[P_increaseButtonInnerRect]) || Boolean(_changedPropeties[P_trackInnerRect]) || Boolean(_changedPropeties[P_thumbAreaInnerRect]))
         {
            this.layoutComponent();
         }
         if(Boolean(_changedPropeties[P_maximum]) || Boolean(_changedPropeties[P_minimum]) || Boolean(_changedPropeties[P_scrollValue]) || Boolean(_changedPropeties[P_valueIsAdjusting]) || Boolean(_changedPropeties[P_visibleAmount]) || Boolean(_changedPropeties[P_thumbAreaInnerRect]) || Boolean(_changedPropeties[P_thumbMinSize]) || Boolean(_changedPropeties[P_thumb]))
         {
            this.updatePosByScrollvalue();
         }
      }
      ...
      protected function scrollThumbToCurrentMousePosition() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:Point = getMousePosition();
         ...
         {
            _loc1_ = _loc7_.y;
            _loc2_ = _loc7_.y + _loc7_.height - this._thumbRect.height;
            _loc3_ = Math.min(_loc2_,Math.max(_loc1_,_loc6_ - this._thumbDownOffset));
            this.setThumbPosAndSize(this._thumbRect.x,_loc3_,this._thumbRect.width,this._thumbRect.height);
         }
         else
         {
            _loc1_ = _loc7_.x;
            _loc2_ = _loc7_.x + _loc7_.width - this._thumbRect.width;
            _loc3_ = Math.min(_loc2_,Math.max(_loc1_,_loc5_ - this._thumbDownOffset));
            this.setThumbPosAndSize(_loc3_,this._thumbRect.y,this._thumbRect.width,this._thumbRect.height);
         }
         var _loc8_:int = this.getValueWithThumbMaxMinPos(_loc1_,_loc2_,_loc3_);
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:int = this.getValueWithPosition(param1);
         if(_loc3_ > this.scrollValue && this._currentTrackClickDirction > 0)
         {
            _loc2_ = this.blockIncrement;
         }
         else
         {
            if(!(_loc3_ < this.scrollValue && this._currentTrackClickDirction < 0))
      ...
      protected function updatePosByScrollvalue() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:int = this.minimum;
         var _loc5_:int = this.visibleAmount;
         var _loc6_:int = this.maximum - _loc4_;
         var _loc7_:int = this.scrollValue;
         var _loc8_:Rectangle = this._thumbAreaInnerRect.getInnerRect(_width,_height);
         if(_loc6_ <= 0)
         {
         ...
         if(this.isVertical())
         {
            _loc1_ = _loc8_.height;
            _loc2_ = Math.floor(_loc1_ * (_loc5_ / _loc6_));
            this._thumb.visible = _loc2_ > 0 && _loc2_ < _loc8_.height;
         }
         else
         {
            _loc1_ = _loc8_.width;
            _loc2_ = Math.floor(_loc1_ * (_loc5_ / _loc6_));
            this._thumb.visible = _loc2_ < _loc8_.width;
         }
         this._increaseButton.mouseEnabled = this._decreaseButton.mouseEnabled = this._thumb.visible;
         if(_loc1_ > this.thumbMinSize)
         {
            _loc2_ = Math.max(_loc2_,this.thumbMinSize);
            this._increaseButton.mouseEnabled = this._decreaseButton.mouseEnabled = this._thumb.visible;
            ...
            {
               _loc3_ = Math.round(_loc9_ * ((_loc7_ - _loc4_) / (_loc6_ - _loc5_)));
            }
            if(this.isVertical())
            {
               this.setThumbPosAndSize(_loc8_.x,_loc3_ + _loc8_.y,_loc8_.width,_loc2_);
            }
            else
            {
               this.setThumbPosAndSize(_loc8_.x + _loc3_,_loc8_.y,_loc2_,_loc8_.height);
            }
            return;
         }
         this._thumb.visible = false;
