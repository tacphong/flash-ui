package com.pickgliss.ui.controls.list
{
   ...
   public class VectorListModel extends BaseListModel implements IMutableListModel, IListData
   {
      ...
      public function append(param1:*, param2:int = -1) : void
      {
         if(param2 == -1)
         {
            param2 = int(this._elements.length);
      ...
      public function clear() : void
      {
         ...
         var _loc2_:int = this.size() - 1;
         if(_loc2_ >= 0)
         {
            _loc1_ = this.toArray();
            this._elements.splice(0);
            fireIntervalRemoved(this,0,_loc2_,_loc1_);
         }
      }
      ...
      {
         var _loc2_:INotSameHeightListCellData = null;
         var _loc3_:Number = 0;
         var _loc4_:int = this.size();
         if(param1 > _loc4_)
         {
            param1 = _loc4_;
         }
         ...
         while(_loc5_ < param1)
         {
            ...
            _loc2_ = this.get(_loc5_);
            _loc3_ += _loc2_.getCellHeight();
            _loc5_++;
         }
         return _loc3_;
      }
      ...
      {
         var _loc1_:INotSameHeightListCellData = null;
         var _loc2_:Number = 0;
         var _loc3_:int = this.size();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc1_ = this.get(_loc4_);
            _loc2_ += _loc1_.getCellHeight();
            _loc4_++;
         }
         return _loc2_;
      }
      ...
      public function getStartIndexByPosY(param1:Number) : int
      {
         ...
         while(_loc6_ < _loc4_)
         {
            _loc2_ = this.get(_loc6_);
            _loc5_ += _loc2_.getCellHeight();
            if(_loc5_ >= param1)
            {
               _loc3_ = _loc6_;
               break;
