package com.pickgliss.ui.controls.list
{
   ...
   public class DropList extends Component implements Disposeable
   {
      ...
      private var _targetDisplay:com.pickgliss.ui.controls.list.IDropListTarget;
      ...
      public function set targetDisplay(param1:com.pickgliss.ui.controls.list.IDropListTarget) : void
      {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[P_backgound]) || Boolean(_changedPropeties[P_container]))
         {
            this.addChildren();
         }
      }
