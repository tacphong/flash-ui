package com.pickgliss.ui.controls
{
   ...
   public class MinimizeFrame extends Frame
   {
      ...
      protected var _minimizeButton:com.pickgliss.ui.controls.BaseButton;
      ...
      public function get minimizeButton() : com.pickgliss.ui.controls.BaseButton
      {
         return this._minimizeButton;
      }
      
      public function set minimizeButton(param1:com.pickgliss.ui.controls.BaseButton) : void
      {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[P_minimizeButton]))
         {
            this._minimizeButton.addEventListener(MouseEvent.CLICK,this.__onMinimizeClick);
         }
         if(Boolean(_changedPropeties[P_minimizeButton]) || Boolean(_changedPropeties[P_minimizeRect]))
         {
