package com.pickgliss.ui.controls
{
   ...
   public class BaseButton extends Component
   {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[P_pressEnable]))
         {
         ...
         if(Boolean(_changedPropeties[P_backStyle]) && this._autoSizeAble)
         {
         ...
         if(Boolean(_changedPropeties[P_backgoundRotation]))
         {
            if(Boolean(this._back))
            {
         ...
         if(Boolean(_changedPropeties[Component.P_width]) || Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[P_backStyle]) || Boolean(_changedPropeties[P_backgoundRotation]) || Boolean(_changedPropeties[P_transparentEnable]))
         {
            this.drawHitArea();
         }
         this.setFrame(this._currentFrameIndex);
         if(Boolean(_changedPropeties[P_stopMovieAtLastFrame]) && this._stopMovieAtLastFrame)
         {
