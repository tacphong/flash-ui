package com.pickgliss.ui.controls
{
   ...
   public class SelectedTextButton extends SelectedButton
   {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(_selected && Boolean(this._selectedTextField))
         {
            this._selectedTextField.text = this._text;
         }
         else if(!_selected && Boolean(this._unSelectedTextField))
         {
         ...
         if(_autoSizeAble)
         {
            if(_selected && Boolean(this._selectedTextField))
            {
               _loc1_ = this._selectedBackgoundInnerRect.getInnerRect(this._selectedTextField.textWidth,this._selectedTextField.textHeight);
               _width = _selectedButton.width = _loc1_.width;
               _height = _selectedButton.height = _loc1_.height;
            ...
            else if(!_selected && Boolean(this._unSelectedTextField))
            {
               ...
               _loc2_ = this._unselectedBackgoundInnerRect.getInnerRect(this._unSelectedTextField.textWidth,this._unSelectedTextField.textHeight);
               _width = _unSelectedButton.width = _loc2_.width;
               _height = _unSelectedButton.height = _loc2_.height;
