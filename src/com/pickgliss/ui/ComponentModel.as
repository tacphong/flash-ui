package com.pickgliss.ui
{
   ...
   public final class ComponentModel
   {
      ...
      private function __onShaderLoadComplete(param1:LoaderEvent) : void
      {
         ...
         var _loc3_:Object = this.findShaderDataByLoader(param1.loader);
         var _loc4_:Shader = new Shader(_loc3_.loader.content);
         var _loc5_:ShaderFilter = new ShaderFilter(_loc4_);
         var _loc6_:Array = ComponentFactory.parasArgs(_loc3_.xml.@paras);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc2_ = String(_loc6_[_loc7_]).split(":");
            if(_loc5_.shader.data.hasOwnProperty(_loc2_[0]))
            {
               _loc5_.shader.data[_loc2_[0]].value = [int(_loc2_[1])];
            }
            _loc7_++;
         }
         this._styleSets[String(_loc3_.xml.@shadername)] = _loc5_;
      }
      ...
      private function parasComponent(param1:XMLList) : void
      {
         ...
         {
            if(this._componentStyle[String(param1[_loc3_].@stylename)] != null)
            {
               throw new Error("样式重名。。。请注意检查!!!!!!!!" + String(param1[_loc3_].@stylename));
            }
            param1[_loc3_].@componentModule = this._currentComponentSet.@name;
            this._componentStyle[String(param1[_loc3_].@stylename)] = param1[_loc3_];
            _loc3_++;
         }
      }
      ...
      private function parasCustomObject(param1:XMLList) : void
      {
         ...
         while(_loc3_ < param1.length())
         {
            if(this._customObjectStyle[String(param1[_loc3_].@stylename)] != null)
            {
               throw new Error("样式重名。。。请注意检查!!!!!!!!" + String(param1[_loc3_].@stylename));
            }
            this._customObjectStyle[String(param1[_loc3_].@stylename)] = param1[_loc3_];
            _loc3_++;
         }
      }
