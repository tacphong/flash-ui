package com.pickgliss.ui
{
   ...
   public final class ShowTipManager
   {
      ...
      private static var _instance:com.pickgliss.ui.ShowTipManager;
      ...
      public static function get Instance() : com.pickgliss.ui.ShowTipManager
      {
         if(_instance == null)
         {
            _instance = new com.pickgliss.ui.ShowTipManager();
         }
         return _instance;
      }
      ...
      public function removeAllTip() : void
      {
         ...
         {
            if(Boolean(_loc1_.asDisplayObject().parent))
            {
      ...
      {
         var _loc4_:DirectionPos = null;
         var _loc5_:Point = null;
         var _loc6_:Point = null;
         var _loc7_:Point = null;
         var _loc8_:DirectionPos = null;
         var _loc9_:Array = param3.split(",");
         var _loc10_:Vector.<DirectionPos> = new Vector.<DirectionPos>();
         var _loc11_:Point = this._tipContainer.globalToLocal(param2.localToGlobal(StartPoint));
         var _loc12_:int = 0;
         while(_loc12_ < _loc9_.length)
         {
            _loc5_ = this.getTipPosByDirction(param1,param2,_loc9_[_loc12_]);
            _loc6_ = new Point(_loc5_.x + _loc11_.x,_loc5_.y + _loc11_.y);
            _loc7_ = new Point(_loc5_.x + _loc11_.x + param1.width,_loc5_.y + _loc11_.y + param1.height);
            _loc8_ = this.creatDirectionPos(_loc6_,_loc7_,int(_loc9_[_loc12_]));
            if(_loc8_.offsetX == 0 && _loc8_.offsetY == 0)
            {
               _loc4_ = _loc8_;
               break;
            }
         ...
         if(_loc4_ == null)
         {
            _loc4_ = this.searchFixedDirectionPos(_loc10_);
         }
         return _loc4_;
      }
      ...
      private function searchFixedDirectionPos(param1:Vector.<DirectionPos>) : DirectionPos
      {
         ...
         while(_loc6_ < _loc5_.length)
         {
            ...
            {
               _loc3_ = Math.abs(_loc5_[_loc6_].offsetX) + Math.abs(_loc5_[_loc6_].offsetY);
               _loc4_ = Math.abs(_loc2_.offsetX) + Math.abs(_loc2_.offsetY);
               if(_loc3_ <= _loc4_)
               {
                  _loc2_ = _loc5_[_loc6_];
               }
