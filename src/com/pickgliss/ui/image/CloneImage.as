package com.pickgliss.ui.image
{
   ...
   public class CloneImage extends Image
   {
      ...
      override protected function updateSize() : void
      {
         ...
         var _loc3_:int = 0;
         if(Boolean(_changedPropeties[Component.P_width]) || Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[P_direction]) || Boolean(_changedPropeties[P_gape]))
         {
            _loc1_ = 0;
