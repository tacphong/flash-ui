package com.pickgliss.manager
{
   ...
   public class CacheSysManager
   {
      ...
      private static var instance:com.pickgliss.manager.CacheSysManager;
      ...
      public static function getInstance() : com.pickgliss.manager.CacheSysManager
      {
         if(instance == null)
         {
            instance = new com.pickgliss.manager.CacheSysManager();
         }
         return instance;
      }
      ...
      {
         return Boolean(_lockDic[param1]) ? Boolean(true) : Boolean(false);
      }
      ...
      public function release(param1:String, param2:uint = 0) : void
      {
         ...
         if(Boolean(this._cacheDic[param1]))
         {
