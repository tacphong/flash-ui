package com.pickgliss.loader
{
   ...
   public class ModuleLoader extends DisplayLoader
   {
      ...
      public function analyMd5(param1:ByteArray) : void
      {
         ...
         var _loc3_:String = this.getName();
         if(ComponentSetting.USEMD5 && (ComponentSetting.md5Dic[_loc3_] || this.hasHead(param1)))
         {
            if(this.compareMD5(param1,_loc3_))
            {
               _loc2_ = new ByteArray();
               param1.position = 37;
               param1.readBytes(_loc2_);
               this.handleModule(_loc2_);
            }
            else
            {
