package com.pickgliss.loader
{
   ...
   public class LoaderManager extends EventDispatcher
   {
      ...
      private static var _instance:com.pickgliss.loader.LoaderManager;
      ...
      private var _loadingLoaderList:Vector.<com.pickgliss.loader.BaseLoader>;
      
      private var _waitingLoaderList:Vector.<com.pickgliss.loader.BaseLoader>;
      ...
      public static function get Instance() : com.pickgliss.loader.LoaderManager
      {
         if(_instance == null)
         {
            _instance = new com.pickgliss.loader.LoaderManager();
         }
         return _instance;
      }
      
      public function creatLoaderByType(param1:String, param2:int, param3:URLVariables, param4:String, param5:ApplicationDomain) : com.pickgliss.loader.BaseLoader
      {
         var _loc6_:com.pickgliss.loader.BaseLoader = null;
         switch(param2)
         {
            ...
            case BaseLoader.BYTE_LOADER:
               _loc6_ = new com.pickgliss.loader.BaseLoader(this.getNextLoaderID(),param1);
               break;
            ...
            case BaseLoader.COMPRESS_REQUEST_LOADER:
               ...
               break;
            case 9:
               _loc6_ = new CodeModuleLoader(this.getNextLoaderID(),param1,param5);
         }
         return _loc6_;
      }
      ...
      {
         var _loc5_:com.pickgliss.loader.BaseLoader = null;
      ...
      public function creatAndStartLoad(param1:String, param2:int, param3:URLVariables = null) : com.pickgliss.loader.BaseLoader
      {
         var _loc4_:com.pickgliss.loader.BaseLoader = this.creatLoader(param1,param2,param3);
         this.startLoad(_loc4_);
         return _loc4_;
      }
      
      public function getLoaderByID(param1:int) : com.pickgliss.loader.BaseLoader
      {
         return this._loaderSaveByID[param1];
      }
      
      public function getLoaderByURL(param1:String, param2:URLVariables) : com.pickgliss.loader.BaseLoader
      {
      ...
      public function saveFileToLocal(param1:com.pickgliss.loader.BaseLoader) : void
      {
      }
      
      public function startLoad(param1:com.pickgliss.loader.BaseLoader, param2:Boolean = false) : void
      {
         if(Boolean(param1))
         {
      ...
      {
         var _loc3_:com.pickgliss.loader.BaseLoader = this.getLoaderByID(param1);
      ...
      {
         var _loc1_:com.pickgliss.loader.BaseLoader = null;
         var _loc2_:int = 0;
         while(_loc2_ < this._waitingLoaderList.length)
         {
            if(this._loadingLoaderList.length < ALLOW_MUTI_LOAD_COUNT)
            {
               _loc1_ = this._waitingLoaderList.shift();
