package levelRank.views
{
   ...
   public class LevelRankView extends Sprite implements IRightView
   {
      ...
      {
         LevelRankManager.instance.view = this;
         this.initView();
         this.updateView();
         this.initTimer();
      }
      ...
      {
         this._bg = ComponentFactory.Instance.creat("wonderfulactivity.levelRank.bg");
         addChild(this._bg);
         ...
         this._rankLabelTxt.text = LanguageMgr.GetTranslation("levelRank.rankLabel",5000);
      ...
      public function updateView() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:LevelRankVo = null;
         var _loc3_:GmActivityInfo = LevelRankManager.instance.xmlData;
         ...
         this._checkBg.tipData = LanguageMgr.GetTranslation("levelRank.helpTxt",_loc3_.remain2);
         _loc6_ = LevelRankManager.instance.rankList;
         _loc1_ = LevelRankManager.instance.myConsume;
         this._myRank = -1;
         var _loc7_:int = 0;
         while(_loc7_ <= _loc6_.length - 1)
         {
            _loc2_ = _loc6_[_loc7_] as LevelRankVo;
         ...
         if(this._myRank >= 0)
         {
            ...
            else
            {
               ...
               _loc8_ = (_loc6_[this._myRank - 1] as LevelRankVo).consume - _loc1_ + 1;
               this._rankLabelTxt.text = LanguageMgr.GetTranslation("levelRank.rankLabel",_loc8_);
            }
            if(LevelRankManager.instance.status == 2)
            {
               this._rankLabelTxt.visible = true;
         ...
         else
         {
            ...
            if(_loc6_.length > 0)
            {
               _loc8_ = (_loc6_[_loc6_.length - 1] as LevelRankVo).consume - _loc1_ + 1;
            }
            else
            {
               _loc8_ = 1;
            }
            this._outOfRankLabel.text = LanguageMgr.GetTranslation("level.outOfRank");
            this._rankLabelTxt.text = LanguageMgr.GetTranslation("levelRank.outOfRankLabel",_loc1_,_loc8_);
            if(LevelRankManager.instance.status == 2)
            {
               this._rankLabelTxt.visible = true;
               this._rankLabelTxt.textColor = 16711680;
      ...
      {
         var _loc1_:LevelRankItem = null;
         var _loc2_:Array = LevelRankManager.instance.rankList;
         var _loc3_:Array = LevelRankManager.instance.xmlData.giftbagArray;
         this._vbox.removeAllChild();
         var _loc4_:int = 0;
         while(_loc4_ <= _loc2_.length - 1)
         {
            _loc1_ = new LevelRankItem(_loc4_);
      ...
      {
         var _loc1_:Date = DateUtils.getDateByStr(LevelRankManager.instance.xmlData.endTime);
      ...
      {
         LevelRankManager.instance.view = null;
         WonderfulActivityManager.Instance.delTimerFun("consumeRank");
