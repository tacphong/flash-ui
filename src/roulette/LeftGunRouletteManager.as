package roulette
{
   ...
   public class LeftGunRouletteManager extends EventDispatcher
   {
      ...
      private static var _instance:roulette.LeftGunRouletteManager = null;
      ...
      private var _rouletteView:roulette.RouletteFrame;
      
      private var _reward:String;
      
      private var _alertAward:BaseAlerFrame;
      
      private var _helpPage:roulette.HelpFrame;
      ...
      public static function get instance() : roulette.LeftGunRouletteManager
      {
         if(_instance == null)
         {
            _instance = new roulette.LeftGunRouletteManager();
         }
         return _instance;
      }
               ...
               switch(_loc3_)
               {
                  case TYPEI_ISOPEN:
                     ...
                     if(this.IsOpen)
                     {
                        ...
                        _loc6_ = 0;
                        while(_loc6_ < MAX_LENGTH)
                        {
                           _loc7_ = _loc2_.readInt();
                           this.ArrNum.push(_loc7_);
                           _loc6_++;
                        }
                        break;
                     }
      ...
      {
         if(Boolean(this._gunBtn) && Boolean(this._gunBtn.parent))
         {
            return;
         }
      ...
      public function hideGunButton() : void
      {
         ...
         if(Boolean(this._gunBtn))
         {
            if(Boolean(this._gunBtn.parent))
            {
      ...
      private function getReward(param1:String) : String
      {
         ...
         {
            _loc2_ = _loc6_.toString() + _loc5_.toString() + "0" + "%";
         }
         return _loc2_;
      }
      ...
      private function createFrame() : void
      {
         ...
         else
         {
            ...
            {
               this._rouletteView = new roulette.RouletteFrame();
            }
