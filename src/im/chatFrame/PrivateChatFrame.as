package im.chatFrame
{
   ...
   public class PrivateChatFrame extends MinimizeFrame
   {
      ...
      private var _recordFrame:im.chatFrame.PrivateRecordFrame;
      ...
      public function set playerInfo(param1:PlayerInfo) : void
      {
         ...
         else
         {
            ...
            if(Boolean(this._targetVipName))
            {
      ...
      {
         if(Boolean(this._recordFrame) && Boolean(this._recordFrame.parent))
         {
