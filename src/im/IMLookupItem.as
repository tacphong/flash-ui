package im
{
   ...
   public class IMLookupItem extends Sprite implements Disposeable
   {
      ...
      private function init() : void
      {
         ...
         _loc1_ = ComponentFactory.Instance.creatCustomObject("IM.IMLookup.SexPos");
         ...
         if(this.info is CMFriendInfo)
         {
            this._name.text = this.info.NickName == "" ? String(this.info.OtherName) : String(this.info.NickName);
         }
         else
         {
         ...
         else if(Boolean(this.info.IsExist))
         {
      ...
      private function _deleteBtnClick(param1:MouseEvent) : void
      {
         ...
         if(this.info is PlayerInfo)
         {
            if(Boolean(PlayerManager.Instance.friendList[this.info.ID]))
            {
      ...
      private function __privateChatBtnClick(param1:MouseEvent) : void
      {
         ...
         else if(this.info is CMFriendInfo && Boolean(this.info.IsExist))
         {
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._sex_icon) && Boolean(this._sex_icon.parent))
         {
         ...
         if(Boolean(this._name) && Boolean(this._name.parent))
         {
