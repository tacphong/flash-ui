package im
{
   ...
   public class IMListView extends Sprite implements Disposeable
   {
      ...
      private var _currentItem:im.IMListItemView;
      ...
      protected function __addNewGroup(param1:Event) : void
      {
         ...
         _loc3_.type = 0;
         _loc3_.titleType = IMController.Instance.customInfo.ID;
         _loc3_.titleIsSelected = false;
         _loc3_.titleText = IMController.Instance.customInfo.Name;
         if(this._titleList.length == 4)
         {
            this._titleList.splice(2,0,_loc3_);
            PlayerManager.Instance.customList.splice(1,0,IMController.Instance.customInfo);
         }
         else
         {
            _loc2_ = 2;
            while(_loc2_ < this._titleList.length - 2)
            {
               if(IMController.Instance.customInfo.ID < this._titleList[_loc2_].titleType)
               {
                  this._titleList.splice(_loc2_,0,_loc3_);
                  PlayerManager.Instance.customList.splice(_loc2_ - 1,0,IMController.Instance.customInfo);
                  break;
               }
               if(_loc2_ == this._titleList.length - 3)
               {
                  this._titleList.splice(_loc2_ + 1,0,_loc3_);
                  PlayerManager.Instance.customList.splice(_loc2_,0,IMController.Instance.customInfo);
                  break;
               }
               _loc2_++;
            }
      ...
      private function initTitle() : void
      {
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            _loc1_.type = 0;
            _loc1_.titleType = _loc2_[_loc3_].ID;
            ...
            {
               _loc1_.titleNumText = "[" + String(PlayerManager.Instance.getOnlineFriendForCustom(_loc2_[_loc3_].ID).length) + "/" + String(PlayerManager.Instance.getFriendForCustom(_loc2_[_loc3_].ID).length) + "]";
            }
            _loc1_.titleText = _loc2_[_loc3_].Name;
            this._titleList.push(_loc1_);
            _loc3_++;
         }
         ...
         _loc4_.titleNumText = "[" + String(PlayerManager.Instance.onlineRecentContactList.length) + "/" + String(PlayerManager.Instance.recentContacts.length) + "]";
         _loc4_.titleText = LanguageMgr.GetTranslation("tank.game.ToolStripView.recentContact");
         this._titleList.unshift(_loc4_);
         var _loc5_:FriendListPlayer = new FriendListPlayer();
         _loc5_.type = 0;
         _loc5_.titleType = 3;
         _loc5_.titleText = LanguageMgr.GetTranslation("tank.game.IM.custom");
      ...
      private function getInsertIndex(param1:FriendListPlayer) : int
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc8_:Array = this._listPanel.vectorListModel.elements;
         var _loc9_:int = 0;
         while(_loc9_ < this._titleList.length)
         {
            if(this._titleList[_loc9_].titleIsSelected)
            {
               _loc2_ = _loc9_ + 1;
            }
            _loc9_++;
         }
         if(_loc8_.length == this._titleList.length)
         {
            return _loc2_;
         }
         if(this._currentTitleInfo.titleType != 1 && this._currentTitleInfo.titleIsSelected)
         {
            ...
            {
               _loc4_ = PlayerManager.Instance.getOnlineFriendForCustom(this._currentTitleInfo.titleType).length + _loc2_ - 1;
               if(_loc4_ != 0)
               {
                  _loc5_ = _loc2_;
                  while(_loc5_ < _loc4_)
                  {
                     _loc3_ = _loc8_[_loc5_] as FriendListPlayer;
                     if(param1.IsVIP && _loc3_.IsVIP && param1.Grade < _loc3_.Grade)
                     {
                        _loc2_++;
                     }
            ...
            _loc4_ = PlayerManager.Instance.getOfflineFriendForCustom(this._currentTitleInfo.titleType).length + _loc2_ - 1;
            if(_loc4_ != 0)
            {
               _loc6_ = _loc2_;
               while(_loc6_ < _loc4_)
               {
                  _loc3_ = _loc8_[_loc6_] as FriendListPlayer;
                  if(param1.Grade > _loc3_.Grade)
                  {
                     break;
                  }
                  _loc2_++;
         ...
         _loc4_ = PlayerManager.Instance.blackList.length + _loc2_ - 1;
         if(_loc4_ != 0)
         {
            _loc7_ = _loc2_;
            while(_loc7_ < _loc4_)
            {
               _loc3_ = _loc8_[_loc7_] as FriendListPlayer;
               if(param1.Grade > _loc3_.Grade)
               {
                  break;
               }
      ...
      private function updateTitle() : void
      {
         ...
         if(Boolean(PlayerManager.Instance.friendList))
         {
            ...
            {
               _loc2_ = int(PlayerManager.Instance.getOnlineFriendForCustom(this._titleList[_loc1_].titleType).length);
      ...
      private function updateFriendList(param1:int = 0) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this._titleList.length)
         {
            this._playerArray.push(this._titleList[_loc4_]);
            if(param1 == this._titleList[_loc4_].titleType)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = PlayerManager.Instance.getOnlineFriendForCustom(param1);
         var _loc6_:Array = [];
         var _loc7_:Array = [];
         var _loc8_:int = 0;
         while(_loc8_ < _loc5_.length)
         {
            _loc2_ = _loc5_[_loc8_] as FriendListPlayer;
            if(_loc2_.IsVIP)
            {
               _loc6_.push(_loc2_);
            }
         ...
         _loc7_ = this.sort(_loc7_);
         _loc5_ = _loc6_.concat(_loc7_);
         _loc5_ = IMController.Instance.sortAcademyPlayer(_loc5_);
         this._playerArray = this._playerArray.concat(_loc5_);
         _loc5_ = PlayerManager.Instance.getOfflineFriendForCustom(param1);
         _loc5_ = this.sort(_loc5_);
         _loc5_ = IMController.Instance.sortAcademyPlayer(_loc5_);
         this._playerArray = this._playerArray.concat(_loc5_);
         var _loc9_:int = _loc3_ + 1;
         while(_loc9_ < this._titleList.length)
         {
            this._playerArray.push(this._titleList[_loc9_]);
            _loc9_++;
         }
         this._listPanel.vectorListModel.clear();
         this._listPanel.vectorListModel.appendAll(this._playerArray);
      ...
      private function updateRecentContactList() : void
      {
         ...
         var _loc4_:Array = [];
         var _loc5_:DictionaryData = PlayerManager.Instance.recentContacts;
         var _loc6_:Array = IMController.Instance.recentContactsList;
         if(Boolean(_loc6_))
         {
            _loc2_ = 0;
            while(_loc2_ < _loc6_.length)
            {
               if(_loc6_[_loc2_] != 0)
               {
                  _loc1_ = _loc5_[_loc6_[_loc2_]];
                  if(Boolean(_loc1_) && _loc4_.indexOf(_loc1_) == -1)
                  {
         ...
         var _loc7_:int = 1;
         while(_loc7_ < this._titleList.length)
         {
            this._playerArray.push(this._titleList[_loc7_]);
            _loc7_++;
         }
         this._listPanel.vectorListModel.clear();
         this._listPanel.vectorListModel.appendAll(this._playerArray);
