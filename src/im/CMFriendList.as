package im
{
   ...
   public class CMFriendList extends Sprite implements Disposeable
   {
      ...
      private var _title:im.IMListItemView;
      
      private var _titleInfo:FriendListPlayer;
      
      private var _titleII:im.IMListItemView;
      ...
      private function initTitle() : void
      {
         ...
         this._title = new im.IMListItemView();
         ...
         this._titleII = new im.IMListItemView();
      ...
      {
         var _loc1_:CMFriendItem = null;
         var _loc2_:int = 0;
         while(_loc2_ < LIST_MAX_NUM)
         {
            _loc1_ = new CMFriendItem();
            _loc1_.addEventListener(MouseEvent.CLICK,this.__itemClick);
            _loc1_.addEventListener(MouseEvent.MOUSE_OVER,this.__itemOver);
            _loc1_.addEventListener(MouseEvent.MOUSE_OUT,this.__itemOut);
            this._list.addChild(_loc1_);
            this._CMFriendItemArray.push(_loc1_);
            _loc2_++;
         }
         this.updateListPos();
      }
      ...
      private function updateItem() : void
      {
         ...
         if(this._currentTitleInfo.titleType == 0)
         {
            ...
            while(_loc4_ <= _loc2_)
            {
               if(Boolean(this._CMFriendArray[_loc4_] as CMFriendInfo) && Boolean(this._CMFriendItemArray[_loc3_]))
               {
               ...
               else if(Boolean(this._CMFriendItemArray[_loc3_]))
               {
         ...
         else if(this._currentTitleInfo.titleType == 1)
         {
            ...
            while(_loc8_ <= _loc6_)
            {
               if(Boolean(this._CMFriendArray[_loc8_] as CMFriendInfo) && Boolean(this._CMFriendItemArray[_loc3_]))
               {
