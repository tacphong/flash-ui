package im
{
   ...
   public class IMView extends Frame
   {
      ...
      private var _addBlackFrame:im.AddBlackFrame;
      ...
      private var _addFriendFrame:im.AddFriendFrame;
      ...
      private var _friendList:im.IMListView;
      
      private var _consortiaList:im.ConsortiaListView;
      
      private var _CMfriendList:im.CMFriendList;
      
      private var _likeFriendList:im.LikeFriendListView;
      ...
      private var _imLookupView:im.IMLookupView;
      
      private var _stateSelectBtn:im.StateIconButton;
      
      private var _stateList:DropList;
      
      private var _replyInput:im.AutoReplyInput;
      ...
      private function initContent() : void
      {
         ...
         this._imLookupView = new im.IMLookupView();
      ...
      private function setListType() : void
      {
         ...
         {
            case 0:
               this._friendList = new im.IMListView();
               ...
               break;
            case 1:
               this._consortiaList = new im.ConsortiaListView();
               ...
               break;
            case 2:
               this._CMfriendList = new im.CMFriendList();
            ...
            case LIKEFRIEND_LIST:
               this._likeFriendList = new im.LikeFriendListView();
      ...
      private function __onStateChange(param1:PlayerPropertyEvent) : void
      {
         ...
         if(Boolean(param1.changedProperties["State"]))
         {
            this._state.text = "[" + PlayerManager.Instance.Self.playerState.convertToString() + "]";
