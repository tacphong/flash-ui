package im.messagebox
{
   ...
   public class MessageBox extends Sprite implements Disposeable
   {
      ...
      private var _item:Vector.<im.messagebox.MessageBoxItem>;
      ...
      {
         var _loc2_:im.messagebox.MessageBoxItem = null;
         this.clearBox();
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            _loc2_ = new im.messagebox.MessageBoxItem();
            _loc2_.recordInfo = param1[_loc3_];
            _loc2_.addEventListener(MouseEvent.CLICK,this.__itemClickHandler);
            _loc2_.addEventListener(MessageBoxItem.DELETE,this.__itemDeleteHandler);
      ...
      {
         var _loc2_:im.messagebox.MessageBoxItem = param1.currentTarget as MessageBoxItem;
