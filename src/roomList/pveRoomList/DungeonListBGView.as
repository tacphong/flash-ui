package roomList.pveRoomList
{
   ...
   public class DungeonListBGView extends Sprite implements Disposeable
   {
      ...
      private var _createRoomView:roomList.pveRoomList.DungeonCreateRoomView;
      ...
      public function DungeonListBGView(param1:roomList.pveRoomList.DungeonListController, param2:roomList.pveRoomList.DungeonListModel)
      {
      ...
      private function addTipPanel() : void
      {
         ...
         var _loc3_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.roomList.mode_03");
         var _loc4_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.roomList.mode_04");
         var _loc5_:Point = ComponentFactory.Instance.creatCustomObject("roomList.DungeonList.DungeonListTipPanelSize");
         this._pveModelRoomListTipPanel = new RoomListTipPanel(_loc5_.x,_loc5_.y);
         this._pveModelRoomListTipPanel.addItem(_loc3_,LookupEnumerate.DUNGEON_LIST_DUNGEON);
         this._pveModelRoomListTipPanel.addItem(_loc4_,LookupEnumerate.DUNGEON_LIST_BOOS);
         _loc6_ = ComponentFactory.Instance.creatCustomObject("roomList.DungeonList.pveModelRoomListTipPanelPos");
         this._pveModelRoomListTipPanel.x = _loc6_.x;
         this._pveModelRoomListTipPanel.y = _loc6_.y;
         this._pveModelRoomListTipPanel.visible = false;
         LayerManager.Instance.addToLayer(this._pveModelRoomListTipPanel,LayerManager.GAME_DYNAMIC_LAYER);
         var _loc7_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.roomList.hardLevel_01");
         var _loc8_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.roomList.hardLevel_02");
         var _loc9_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.roomList.hardLevel_03");
         var _loc10_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.roomList.hardLevel_04");
         var _loc11_:Point = ComponentFactory.Instance.creatCustomObject("roomList.DungeonList.DungeonListTipPanelSizeII");
         this._pveHardLeveRoomListTipPanel = new RoomListTipPanel(_loc11_.x,_loc11_.y);
         this._pveHardLeveRoomListTipPanel.addItem(_loc7_,LookupEnumerate.DUNGEON_LIST_SIMPLE);
         this._pveHardLeveRoomListTipPanel.addItem(_loc8_,LookupEnumerate.DUNGEON_LIST_COMMON);
         this._pveHardLeveRoomListTipPanel.addItem(_loc9_,LookupEnumerate.DUNGEON_LIST_STRAIT);
         this._pveHardLeveRoomListTipPanel.addItem(_loc10_,LookupEnumerate.DUNGEON_LIST_HERO);
         _loc1_ = ComponentFactory.Instance.creatCustomObject("roomList.DungeonList.pveHardLeveRoomListTipPanelPos");
         this._pveHardLeveRoomListTipPanel.x = _loc1_.x;
         this._pveHardLeveRoomListTipPanel.y = _loc1_.y;
         this._pveHardLeveRoomListTipPanel.visible = false;
         LayerManager.Instance.addToLayer(this._pveHardLeveRoomListTipPanel,LayerManager.GAME_DYNAMIC_LAYER);
         _loc2_ = ComponentFactory.Instance.creatCustomObject("roomList.DungeonList.pveMapPanelPos");
         ...
         this._pveMapRoomListTipPanel.x = _loc2_.x;
         this._pveMapRoomListTipPanel.y = _loc2_.y;
         this._pveMapRoomListTipPanel.addItem(10000);
         var _loc13_:int = 1;
         while(_loc13_ < DungeonChooseMapView.DUNGEON_NO)
         {
            if(Boolean(MapManager.getByOrderingDungeonInfo(_loc13_)))
            {
         ...
         {
            if(Boolean(MapManager.getByOrderingSpecialDungeonInfo(_loc14_)))
            {
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._pveModelRoomListTipPanel) && Boolean(this._pveModelRoomListTipPanel.parent))
         {
         ...
         if(Boolean(this._boxButton) && Boolean(this._boxButton.parent))
         {
