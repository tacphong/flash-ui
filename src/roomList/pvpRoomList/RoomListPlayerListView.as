package roomList.pvpRoomList
{
   ...
   public class RoomListPlayerListView extends Sprite implements Disposeable
   {
      ...
      private var _currentItem:roomList.pvpRoomList.RoomListPlayerItem;
      ...
      private function getInsertIndex(param1:PlayerInfo) : int
      {
         ...
         var _loc4_:Array = this._playerList.vectorListModel.elements;
         if(_loc4_.length == 0)
         {
            return 0;
         }
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._vipIcon.filters))
         {
         ...
         if(Boolean(this._marriedIcon) && Boolean(this._marriedIcon.parent))
         {
