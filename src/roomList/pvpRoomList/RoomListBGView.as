package roomList.pvpRoomList
{
   ...
   public class RoomListBGView extends Sprite implements Disposeable
   {
      ...
      public function RoomListBGView(param1:roomList.pvpRoomList.RoomListController, param2:roomList.pvpRoomList.RoomListModel)
      {
         this._model = param2;
      ...
      private function updateList() : void
      {
         ...
         var _loc2_:RoomListItemView = null;
         var _loc3_:int = 0;
         while(_loc3_ < this._model.getRoomList().length)
         {
            _loc1_ = this._model.getRoomList().list[_loc3_];
            _loc2_ = new RoomListItemView(_loc1_);
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._createRoomView) && Boolean(this._createRoomView.parent))
         {
         ...
         if(Boolean(this._svrnameText) && Boolean(this._svrnameText.parent))
         {
