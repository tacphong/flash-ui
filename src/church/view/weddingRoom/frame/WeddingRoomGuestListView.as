package church.view.weddingRoom.frame
{
   ...
   public class WeddingRoomGuestListView extends Sprite implements Disposeable
   {
      ...
      private var _currentItem:church.view.weddingRoom.frame.WeddingRoomGuestListItemView;
      ...
      private function getGuestList() : void
      {
         ...
         {
            _loc1_ = (this._data.list[_loc2_] as PlayerVO).playerInfo;
            this._listPanel.vectorListModel.insertElementAt(_loc1_,this.getInsertIndex(_loc1_));
            this.upSelfItem();
            _loc2_++;
         }
      }
