package church.view.weddingRoom.frame
{
   ...
   public class WeddingRoomConfigView extends BaseAlerFrame
   {
      ...
      private function setView() : void
      {
         ...
         _loc2_ = ComponentFactory.Instance.creat("church.room.RoomNameTitlePos");
         this._roomNameTitle.x = _loc2_.x;
         this._roomNameTitle.y = _loc2_.y;
         ...
         _loc1_ = ComponentFactory.Instance.creatCustomObject("church.room.CreateIntroPos");
         this._roomIntroTitle.x = _loc1_.x;
         this._roomIntroTitle.y = _loc1_.y;
      ...
      private function removeView() : void
      {
         ...
         if(Boolean(this._configIntroMaxChBg))
         {
            if(Boolean(this._configIntroMaxChBg.parent))
            {
