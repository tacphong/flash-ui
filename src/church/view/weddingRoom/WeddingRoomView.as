package church.view.weddingRoom
{
   ...
   public class WeddingRoomView extends Sprite implements Disposeable
   {
      ...
      private var _weddingRoomMenuView:church.view.weddingRoom.WeddingRoomMenuView;
      
      private var _weddingRoomToolView:church.view.weddingRoom.WeddingRoomToolView;
      
      private var _weddingRoomMask:church.view.weddingRoom.WeddingRoomMask;
      ...
      protected function initialize() : void
      {
         ...
         this._weddingRoomMenuView = new church.view.weddingRoom.WeddingRoomMenuView(this._model);
      ...
      {
         this._weddingRoomToolView._toolSendCashBtn.enable = true;
         this._weddingRoomMask = new church.view.weddingRoom.WeddingRoomMask(this._controller);
