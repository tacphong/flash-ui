package church.view.weddingRoom
{
   ...
   public class WeddingRoomMask extends Sprite
   {
      ...
      private var switchMovie:church.view.weddingRoom.WeddingRoomSwitchMovie;
      ...
      {
         --this._totalTimes;
         if(Boolean(this._totalTimes % 2) && this._totalTimes >= 0)
         {
      ...
      private function __timerComplete(param1:TimerEvent) : void
      {
         ...
         this.switchMovie = new church.view.weddingRoom.WeddingRoomSwitchMovie(false);
         ...
         if(Boolean(this.countDownMovie) && Boolean(this.countDownMovie.parent))
         {
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this.countDownMovie))
         {
            if(Boolean(this.countDownMovie.parent))
            {
               this.countDownMovie.parent.removeChild(this.countDownMovie);
            }
