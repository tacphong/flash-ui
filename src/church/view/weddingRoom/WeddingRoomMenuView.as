package church.view.weddingRoom
{
   ...
   public class WeddingRoomMenuView extends Sprite implements Disposeable
   {
      ...
      {
         if(Boolean(this._menuShowName))
         {
            if(Boolean(this._menuShowName.parent))
            {
         ...
         if(Boolean(this._menuShowPao))
         {
            if(Boolean(this._menuShowPao.parent))
            {
         ...
         if(Boolean(this._menuShowFire))
         {
            if(Boolean(this._menuShowFire.parent))
            {
         ...
         if(Boolean(this._roomNameBg))
         {
            if(Boolean(this._roomNameBg.parent))
            {
         ...
         if(Boolean(this._txtRoomNameGroomName))
         {
            if(Boolean(this._txtRoomNameGroomName.parent))
            {
         ...
         if(Boolean(this._txtRoomNameAnd))
         {
            if(Boolean(this._txtRoomNameAnd.parent))
            {
         ...
         if(Boolean(this._txtRoomNameBrideName))
         {
            if(Boolean(this._txtRoomNameBrideName.parent))
            {
         ...
         if(Boolean(this._txtRoomNameWedding))
         {
            if(Boolean(this._txtRoomNameWedding.parent))
            {
         ...
         if(Boolean(this._moonBtn) && Boolean(this._moonBtn.parent))
         {
            this._moonBtn.parent.removeChild(this._moonBtn);
         }
         this._moonBtn = null;
         if(Boolean(this._roomNameBox) && Boolean(this._roomNameBox.parent))
         {
      ...
      public function revertConfig() : void
      {
         ...
         this._menuShowName.setFrame(this._model.playerNameVisible ? int(1) : int(2));
         this._menuShowPao.setFrame(this._model.playerChatBallVisible ? int(1) : int(2));
         this._menuShowFire.setFrame(this._model.playerFireVisible ? int(1) : int(2));
      }
      ...
      public function resetView() : void
      {
         ...
         {
            if(Boolean(this._roomNameBox.parent))
            {
               removeChild(this._roomNameBox);
            }
            if(Boolean(this._moonBtn.parent))
            {
         ...
         else
         {
            ...
            else if(Boolean(this._moonBtn.parent))
            {
               removeChild(this._moonBtn);
            }
         }
