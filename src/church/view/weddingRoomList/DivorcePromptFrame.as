package church.view.weddingRoomList
{
   ...
   public class DivorcePromptFrame extends BaseAlerFrame
   {
      ...
      private static var _instance:church.view.weddingRoomList.DivorcePromptFrame;
      ...
      public static function get Instance() : church.view.weddingRoomList.DivorcePromptFrame
      {
         if(_instance == null)
         {
