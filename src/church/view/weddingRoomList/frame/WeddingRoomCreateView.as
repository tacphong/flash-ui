package church.view.weddingRoomList.frame
{
   ...
   public class WeddingRoomCreateView extends BaseAlerFrame
   {
      ...
      private function removeView() : void
      {
         ...
         {
            if(Boolean(this._bgLeftTop.parent))
            {
         ...
         {
            if(Boolean(this._bgLeftBottom.parent))
            {
         ...
         if(Boolean(this._roomCreateIntroMaxChBg))
         {
            if(Boolean(this._roomCreateIntroMaxChBg.parent))
            {
