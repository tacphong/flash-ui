package church.view.weddingRoomList.frame
{
   ...
   public class WeddingRoomEnterConfirmView extends BaseAlerFrame
   {
      ...
      private var _weddingRoomEnterInputPasswordView:church.view.weddingRoomList.frame.WeddingRoomEnterInputPasswordView;
      ...
      private function removeView() : void
      {
         ...
         if(Boolean(this._bmpLine1))
         {
            if(Boolean(this._bmpLine1.parent))
            {
         ...
         this._bmpLine1 = null;
         if(Boolean(this._imgLine2))
         {
            if(Boolean(this._imgLine2.parent))
            {
         ...
         this._imgLine2 = null;
         if(Boolean(this._imgLine3))
         {
            if(Boolean(this._imgLine3.parent))
            {
         ...
         this._imgLine3 = null;
         if(Boolean(this._imgLine4))
         {
            if(Boolean(this._imgLine4.parent))
            {
         ...
         this._imgLine4 = null;
         if(Boolean(this._imgLine5))
         {
            if(Boolean(this._imgLine5.parent))
            {
