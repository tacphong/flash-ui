   ...
   public class WeddingRoomListItemView extends Sprite implements Disposeable
   {
      ...
      private function update() : void
      {
         if(Boolean(this._churchRoomInfo))
         {
            ...
            this._weddingRoomListItemName.x = this._churchRoomInfo.isLocked ? Number(this._roomListItemLockAsset.x + 20) : Number(this._roomListItemLockAsset.x);
            this._weddingRoomListItemName.width = this._churchRoomInfo.isLocked ? Number(186) : Number(208);
