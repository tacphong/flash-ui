package church.view.menu
{
   ...
   public class MenuPanel extends Sprite
   {
      ...
      private var _kickGuest:church.view.menu.MenuItem;
      
      private var _blackGuest:church.view.menu.MenuItem;
      ...
      public function MenuPanel()
      {
         ...
         _loc1_ = STARTPOS;
         this._kickGuest = new church.view.menu.MenuItem(LanguageMgr.GetTranslation("tank.room.RoomIIPlayerItem.exitRoom"));
         ...
         this._blackGuest = new church.view.menu.MenuItem(LanguageMgr.GetTranslation("tank.menu.AddBlack"));
