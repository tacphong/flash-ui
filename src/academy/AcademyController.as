package academy
{
   ...
   public class AcademyController extends BaseStateView
   {
      ...
      private var _model:academy.AcademyModel;
      ...
      {
         this._model = new academy.AcademyModel();
      ...
      public function get model() : academy.AcademyModel
      {
         return this._model;
      }
      ...
      private function __loadAcademyMemberList(param1:AcademyMemberListAnalyze) : void
      {
         ...
         if(Boolean(param1.selfDescribe) && param1.selfDescribe != "")
         {
