package academy.view
{
   ...
   public class AcademyMemberListView extends Sprite implements Disposeable
   {
      ...
      private var _items:Vector.<academy.view.AcademyMemberItem>;
      ...
      private var _selectedItem:academy.view.AcademyMemberItem;
      ...
      private function init() : void
      {
         ...
         addChild(this._list);
         this.creatItems();
         this._controller.model.state = PlayerManager.Instance.Self.Grade >= AcademyManager.ACADEMY_LEVEL_MIN ? Boolean(true) : Boolean(false);
      ...
      {
         var _loc1_:academy.view.AcademyMemberItem = null;
         this._items = new Vector.<AcademyMemberItem>();
         var _loc2_:int = 0;
         while(_loc2_ < ITEM_NUM)
         {
            _loc1_ = new academy.view.AcademyMemberItem();
