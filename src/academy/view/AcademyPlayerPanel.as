   ...
   public class AcademyPlayerPanel extends Sprite implements Disposeable
   {
      ...
      private function update() : void
      {
         ...
         if(Boolean(this._info))
         {
            ...
            _loc2_ = _loc1_.TotalCount > 0 ? Number(_loc1_.WinCount / _loc1_.TotalCount * 100) : Number(0);
            ...
            this._online.visible = _loc1_.playerState.StateID == PlayerState.ONLINE ? Boolean(true) : Boolean(false);
      ...
      private function updateIcon() : void
      {
         ...
         else if(Boolean(this._vipIcon) && !_loc1_.IsVIP)
         {
