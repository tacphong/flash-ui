package eliteGame
{
   ...
   public class EliteGameController extends EventDispatcher
   {
      ...
      private static var _instance:eliteGame.EliteGameController;
      ...
      private var _model:eliteGame.EliteGameModel;
      ...
      {
         super();
         this._model = new eliteGame.EliteGameModel();
      }
      
      public static function get Instance() : eliteGame.EliteGameController
      {
         if(_instance == null)
         {
            _instance = new eliteGame.EliteGameController();
         }
         return _instance;
      }
      
      public function get Model() : eliteGame.EliteGameModel
      {
         return this._model;
      }
      ...
      {
         var _loc2_:EliteGameTopSixteenInfo = null;
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         ...
         var _loc10_:Vector.<EliteGameTopSixteenInfo> = new Vector.<EliteGameTopSixteenInfo>();
         var _loc11_:DictionaryData = new DictionaryData();
         var _loc12_:int = 0;
         while(_loc12_ < _loc9_)
         {
            _loc2_ = new EliteGameTopSixteenInfo();
            _loc2_.id = _loc7_.readInt();
            _loc2_.name = _loc7_.readUTF();
            _loc2_.rank = _loc7_.readInt();
            _loc10_.push(_loc2_);
            _loc3_ = _loc7_.readInt();
            _loc4_ = _loc7_.readInt();
            _loc5_ = _loc4_ == 0 ? int(_loc3_ - 1) : int(_loc3_);
            _loc6_ = 1;
            while(_loc6_ <= _loc5_)
            {
               if(_loc11_[_loc6_] == null)
               {
                  _loc11_[_loc6_] = new Vector.<int>();
               }
               (_loc11_[_loc6_] as Vector.<int>).push(_loc2_.id);
               _loc6_++;
            }
            _loc12_++;
         }
         if(_loc8_ == 1)
         {
            this._model.topSixteen30_40 = _loc10_;
            this._model.paarungRound30_40 = _loc11_;
         }
         else if(_loc8_ == 2)
         {
            this._model.topSixteen41_50 = _loc10_;
            this._model.paarungRound41_50 = _loc11_;
         }
