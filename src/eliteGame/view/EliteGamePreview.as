package eliteGame.view
{
   ...
   public class EliteGamePreview extends Frame
   {
      ...
      private var _scoreRankView:eliteGame.view.EliteGameScoreRankView;
      
      private var _rule:eliteGame.view.EliteGameRuleView;
      ...
      private function showType(param1:int) : void
      {
         switch(param1)
         {
            ...
            case ELITEGAME_RULE:
               ...
               if(Boolean(this._scoreRankView))
               {
