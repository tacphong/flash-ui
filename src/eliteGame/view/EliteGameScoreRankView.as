package eliteGame.view
{
   ...
   public class EliteGameScoreRankView extends Sprite implements Disposeable
   {
      ...
      private var _items:Vector.<eliteGame.view.EliteGameScoreRankItem>;
      ...
      {
         this._list = param1;
         this._totalPage = Math.ceil(this._list.length / 8) == 0 ? int(1) : int(Math.ceil(this._list.length / 8));
      }
      ...
      private function setPage(param1:int) : void
      {
         ...
         {
            _loc2_ = (param1 - 1) * 8;
            _loc3_ = param1 * 8 > this._list.length ? int(this._list.length) : int(param1 * 8);
      ...
      {
         var _loc2_:eliteGame.view.EliteGameScoreRankItem = null;
         this.clearItems();
         this._items = new Vector.<EliteGameScoreRankItem>();
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            _loc2_ = new eliteGame.view.EliteGameScoreRankItem();
      ...
      public function dispose() : void
      {
         ...
         this._myScore = null;
         if(Boolean(this._mySRBG1))
         {
            ObjectUtils.disposeObject(this._mySRBG1);
         }
         this._mySRBG1 = null;
         if(Boolean(this._mySRBG2))
         {
