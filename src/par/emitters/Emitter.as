package par.emitters
{
   ...
   public class Emitter extends EventDispatcher
   {
      ...
      private var _info:par.emitters.EmitterInfo;
      ...
      public function get info() : par.emitters.EmitterInfo
      {
         return this._info;
      }
      
      public function set info(param1:par.emitters.EmitterInfo) : void
      {
         this._info = param1;
      ...
      {
         if(Boolean(this._enginee) && Boolean(this.info))
         {
            this._age += param1;
