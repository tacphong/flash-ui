package surpriseRoulette.view
{
   ...
   public class SurpriseRouletteView extends Sprite implements Disposeable
   {
      ...
      private var _list:Vector.<surpriseRoulette.view.SurpriseRouletteCell>;
      
      private var _selectedList:Vector.<surpriseRoulette.view.SurpriseRouletteCell>;
      ...
      {
         var _loc3_:surpriseRoulette.view.SurpriseRouletteCell = null;
         ...
         var _loc7_:surpriseRoulette.view.SurpriseRouletteCell = null;
         ...
         while(_loc8_ < NUM)
         {
            _loc1_ = ComponentFactory.Instance.creatCustomObject("surpriseRoulette.pos" + _loc8_);
            this._pos.push(_loc1_);
            _loc8_++;
         }
         ...
         this._mcBig.mouseChildren = this._mcBig.mouseEnabled = false;
         ...
         while(_loc9_ < NUM)
         {
            _loc2_ = ComponentFactory.Instance.creatBitmap("asset.awardSystem.surpriseRoulette.cellBg");
            _loc3_ = new surpriseRoulette.view.SurpriseRouletteCell(_loc2_,-19,1);
            _loc3_.x = this._pos[_loc9_].x;
            _loc3_.y = this._pos[_loc9_].y;
            addChild(_loc3_);
            _loc4_ = this._tidList[_loc9_] as BoxGoodsTempInfo;
         ...
         _loc10_ = ComponentFactory.Instance.creatCustomObject("surpriseRoulette.rect");
         this._tileSelected = new SimpleTileList(4);
         this._tileSelected.hSpace = _loc10_.width;
         this._tileSelected.vSpace = _loc10_.height;
         this._tileSelected.x = _loc10_.x;
         this._tileSelected.y = _loc10_.y;
         var _loc11_:int = 0;
         while(_loc11_ < MAX_SELECTED)
         {
            _loc6_ = ComponentFactory.Instance.creatBitmap("asset.awardSystem.surpriseRoulette.selectedCellBg");
            _loc7_ = new surpriseRoulette.view.SurpriseRouletteCell(_loc6_,-19,1);
            _loc7_.count = 0;
            this._tileSelected.addChild(_loc7_);
            this._selectedList.push(_loc7_);
            _loc11_++;
         }
      ...
      private function updateTurnList() : void
      {
         ...
         this.isTurn = this.turnCount >= MAX_SELECTED ? Boolean(true) : Boolean(false);
      }
      ...
      private function _moveToSelctView() : void
      {
         ...
         var _loc2_:surpriseRoulette.view.SurpriseRouletteCell = this._list.splice(this.turnSlectedNumber,1)[0] as SurpriseRouletteCell;
      ...
      {
         SoundManager.instance.play("008");
         var _loc2_:int = this._needKeyCount[this.turnCount] == 0 ? int(1) : int(this._needKeyCount[this.turnCount]);
