package email.view
{
   ...
   public class ReadingView extends Frame
   {
      ...
      private var _list:email.view.EmailListView;
      ...
      private function update() : void
      {
         ...
         if(Boolean(this._info) && (this._info.Type == 0 || this._info.Type == 6 || this._info.Type == 1 || this._info.Type == 7 || this._info.Type == 10 || this._info.Type > 100 || this._info.Type == 59))
         {
      ...
      private function showComplete() : void
      {
         ...
         _loc2_ = ComponentFactory.Instance.creatCustomObject("email.playerviewMaskPos");
         _loc1_.x = _loc2_.x;
         _loc1_.y = _loc2_.y;
      ...
      public function setListView(param1:Array, param2:int, param3:int, param4:Boolean = false) : void
      {
         ...
         this._leftPageBtn.enable = param3 == 0 || param3 == 1 ? Boolean(Boolean(false)) : Boolean(Boolean(true));
         this._rightPageBtn.enable = param3 == param2 ? Boolean(Boolean(false)) : Boolean(Boolean(true));
      }
      ...
      internal function set isCanReply(param1:Boolean) : void
      {
         if(this._info is EmailInfoOfSended)
         {
            return;
      ...
      private function __deleteSelectListener(param1:MouseEvent) : void
      {
         ...
         var _loc4_:Array = this._list.getSelectedMails();
         if(_loc4_.length > 0)
         {
            _loc2_ = 0;
            while(_loc2_ < _loc4_.length)
            {
               if(Boolean(_loc4_[_loc2_].hasAnnexs()) || _loc4_[_loc2_].Money != 0)
               {
                  _loc3_ = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("tank.view.task.TaskCatalogContentView.tip"),LanguageMgr.GetTranslation("tank.view.emailII.EmailIIStripView.delectEmail"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),false,true,true,LayerManager.ALPHA_BLOCKGOUND);
                  _loc3_.addEventListener(FrameEvent.RESPONSE,this.__simpleAlertResponse);
      ...
      private function __receiveExListener(param1:MouseEvent) : void
      {
         ...
         var _loc8_:Array = this._list.getSelectedMails();
         if(_loc8_.length > 0 || Boolean(this._info))
         {
            if(_loc8_.length > 0)
            {
               _loc2_ = 0;
               ...
               {
                  if(!((_loc8_[_loc2_] as EmailInfo).Type > 100 && (_loc8_[_loc2_] as EmailInfo).Money > 0))
                  {
                     _loc3_ = _loc8_[_loc2_] as EmailInfo;
                     if(!_loc3_.IsRead)
                     {
                        _loc4_ = _loc3_.SendTime;
                        _loc5_ = new Date(Number(_loc4_.substr(0,4)),Number(_loc4_.substr(5,2)) - 1,Number(_loc4_.substr(8,2)),Number(_loc4_.substr(11,2)),Number(_loc4_.substr(14,2)),Number(_loc4_.substr(17,2)));
                        _loc3_.ValidDate = 72 + (TimeManager.Instance.Now().time - _loc5_.time) / (60 * 60 * 1000);
                     }
                     MailManager.Instance.getAnnexToBag(_loc8_[_loc2_],0);
                  }
                  _loc2_++;
               }
            }
            if(Boolean(this._info))
            {
               ...
               {
                  _loc6_ = this._info.SendTime;
                  _loc7_ = new Date(Number(_loc6_.substr(0,4)),Number(_loc6_.substr(5,2)) - 1,Number(_loc6_.substr(8,2)),Number(_loc6_.substr(11,2)),Number(_loc6_.substr(14,2)),Number(_loc6_.substr(17,2)));
                  this._info.ValidDate = 72 + (TimeManager.Instance.Now().time - _loc7_.time) / (60 * 60 * 1000);
               }
