package email.view
{
   ...
   public class EmailView extends Sprite implements Disposeable
   {
      ...
      private var _read:email.view.ReadingView;
      
      private var _write:email.view.WritingView;
      ...
      private function __selectEmail(param1:EmailEvent) : void
      {
         ...
         {
            this._read.isCanReply = Boolean(null) ? Boolean(Boolean(true)) : Boolean(Boolean(false));
            this._read.readOnly = true;
            return;
         }
         this._read.isCanReply = Boolean(this._model.selectEmail) && this._model.selectEmail.canReply ? Boolean(Boolean(true)) : Boolean(Boolean(false));
      }
      ...
      public function get writeView() : email.view.WritingView
      {
         return this._write;
      }
   }
