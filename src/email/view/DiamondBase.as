package email.view
{
   ...
   internal class DiamondBase extends Sprite implements Disposeable
   {
      ...
      public var _cell:email.view.EmaillBagCell;
      ...
      protected function initView() : void
      {
         ...
         this._cell = new email.view.EmaillBagCell();
         this._cell.width = CELL_WIDTH;
         this._cell.height = CELL_HEIGHT;
         _loc1_ = ComponentFactory.Instance.creatCustomObject("email.cellPos");
