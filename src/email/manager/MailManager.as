package email.manager
{
   ...
   public class MailManager
   {
      ...
      private static var _instance:email.manager.MailManager;
      ...
      public static function get Instance() : email.manager.MailManager
      {
         if(_instance == null)
         {
            _instance = new email.manager.MailManager();
         }
         return _instance;
      }
      ...
      private function __getMailToBag(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc6_:EmailInfo = this._model.getMailByID(_loc4_);
         if(!_loc6_)
         {
            return;
         }
         if(_loc6_.Type > 100 && _loc6_.Money > 0)
         {
            _loc6_.ValidDate = 72;
            _loc6_.Money = 0;
         }
         ...
         while(_loc7_ < _loc5_)
         {
            ...
            this.deleteMailDiamond(_loc6_,_loc2_);
            _loc7_++;
         }
         this._model.changeEmail(_loc6_);
      }
      ...
      private function __responseMail(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc5_ == 5)
         {
            ...
            _loc2_["timeTick"] = Math.random();
            _loc3_ = LoaderManager.Instance.creatLoader(PathManager.solveRequestPath("ShopItemList.xml"),BaseLoader.COMPRESS_TEXT_LOADER,_loc2_);
