package overSeasCommunity
{
   ...
   public class OverSeasCommunController extends EventDispatcher
   {
      ...
      private static var _instance:overSeasCommunity.OverSeasCommunController;
      ...
      public static function instance() : overSeasCommunity.OverSeasCommunController
      {
         if(!_instance)
         {
            _instance = new overSeasCommunity.OverSeasCommunController();
         }
         return _instance;
      }
