package cityWide
{
   ...
   public class CityWideManager
   {
      ...
      private static var _instance:cityWide.CityWideManager;
       
      
      private var _cityWideView:cityWide.CityWideFrame;
      ...
      public static function get Instance() : cityWide.CityWideManager
      {
         if(_instance == null)
         {
            _instance = new cityWide.CityWideManager();
         }
         return _instance;
      }
      ...
      private function _submitExit(param1:Event) : void
      {
         ...
         {
            _loc2_ = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("tank.view.im.IMController.addFriend",200 + _loc3_ * 50),"","",false,false,false,LayerManager.ALPHA_BLOCKGOUND);
            _loc2_.addEventListener(FrameEvent.RESPONSE,this._close);
            return;
         }
