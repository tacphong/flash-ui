package fightPowerRank.views
{
   ...
   public class FightPowerRankItem extends Sprite implements Disposeable
   {
      ...
      private var vo:FightPowerRankVo;
      
      public function FightPowerRankItem(param1:int)
      {
         super();
         this.index = param1;
         this.initView();
      ...
      public function setData(param1:FightPowerRankVo, param2:GiftBagInfo) : void
      {
