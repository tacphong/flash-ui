package onlineRank.views
{
   ...
   public class OnlineRankItem extends Sprite implements Disposeable
   {
      ...
      private var vo:OnlineRankVo;
      
      public function OnlineRankItem(param1:int)
      {
         super();
         this.index = param1;
         this.initView();
      ...
      public function setData(param1:OnlineRankVo, param2:GiftBagInfo) : void
      {
